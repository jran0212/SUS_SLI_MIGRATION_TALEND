...
package sus_sli_etl.broker_ship_from_inbound_0_1;
...
/**
 * Job: Broker_Ship_From_Inbound Purpose: Migrating data from referp to BROKER_SHIP_FROM<br>
 * Description: Migrating data from referp to BROKER_SHIP_FROM <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Broker_Ship_From_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Broker_Ship_From_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Broker_Ship_From_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Broker_Ship_From_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_kZ538AjoEe27itDdtrBWEw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_kZ538AjoEe27itDdtrBWEw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Broker_Ship_From_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Broker_Ship_From_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Broker_Ship_From_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Broker_Ship_From_Inbound) {
...
System.out.println("Starting the Migrating Data from REFERP to BROKER_SHIP_FROM...........");
...
public static class BROKER_SHIP_FROMStruct implements routines.system.IPersistableRow<BROKER_SHIP_FROMStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Broker_Ship_From_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Broker_Ship_From_Inbound = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final BROKER_SHIP_FROMStruct other = (BROKER_SHIP_FROMStruct) obj;
	...
	public void copyDataTo(BROKER_SHIP_FROMStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.BROKER_ID = this.BROKER_ID;
	            other.SHIP_POINT = this.SHIP_POINT;
	...
	public void copyKeysDataTo(BROKER_SHIP_FROMStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Broker_Ship_From_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.SHIP_POINT = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.SHIP_POINT,dos);
    ...
    public String toString() {
		...
		sb.append(",SHIP_POINT="+SHIP_POINT);
     ...
     * Compare keys
     */
    public int compareTo(BROKER_SHIP_FROMStruct other) {
...
BROKER_SHIP_FROMStruct BROKER_SHIP_FROM = new BROKER_SHIP_FROMStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"BROKER_SHIP_FROM");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"BROKER_SHIP_FROM\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("BROKER_SHIP_FROM");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("BROKER_SHIP_FROM");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"BROKER_ID\",\"SHIP_POINT\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"FERP_SVOP\") VALUES (?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_BROKER_SHIP_FROM_tMap_1 = 0;
				
BROKER_SHIP_FROMStruct BROKER_SHIP_FROM_tmp = new BROKER_SHIP_FROMStruct();
// ###############################
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    REFERP.REFCAT,    REFERP.REFKEY,    REFERP.REFDAT FROM REFERP WHERE REFERP.REFCAT='AEK'\"");
                        log4jParamters_tDBInput_1.append(" | ");
	...
	final String decryptedPassword_tDBInput_1 = context.SUS_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  REFERP.REFCAT, \n  REFERP.REFKEY, \n  REFERP.REFDAT\nFROM REFERP WHERE REFERP.REFCAT='AEK'";
...
row2.BROKER_ID = row1.REFKEY;
row2.SHIP_POINT = row1.REFDAT.substring(0,2);
...
BROKER_SHIP_FROM = null;


// # Output table : 'BROKER_SHIP_FROM'
count_BROKER_SHIP_FROM_tMap_1++;

BROKER_SHIP_FROM_tmp.SITE_ID = row2.SITE_ID;
BROKER_SHIP_FROM_tmp.BROKER_ID = row2.BROKER_ID.trim();
BROKER_SHIP_FROM_tmp.SHIP_POINT = row2.SHIP_POINT.trim();
BROKER_SHIP_FROM_tmp.IS_DELETED = row2.IS_DELETED;
BROKER_SHIP_FROM_tmp.CREATED_ORIGIN = "SUS";
BROKER_SHIP_FROM_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
BROKER_SHIP_FROM_tmp.UPDATED_ORIGIN = "SUS";
BROKER_SHIP_FROM_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
BROKER_SHIP_FROM_tmp.FERP_SVOP = context.svop;
BROKER_SHIP_FROM = BROKER_SHIP_FROM_tmp;
log.debug("tMap_1 - Outputting the record " + count_BROKER_SHIP_FROM_tMap_1 + " of the output table 'BROKER_SHIP_FROM'.");
 ...
 */
// Start of branch "BROKER_SHIP_FROM"
if(BROKER_SHIP_FROM != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("BROKER_SHIP_FROM - " + (BROKER_SHIP_FROM==null? "": BROKER_SHIP_FROM.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(BROKER_SHIP_FROM.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, BROKER_SHIP_FROM.SITE_ID);
}

                    if(BROKER_SHIP_FROM.BROKER_ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, BROKER_SHIP_FROM.BROKER_ID);
}

                    if(BROKER_SHIP_FROM.SHIP_POINT == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, BROKER_SHIP_FROM.SHIP_POINT);
}

                    pstmt_tDBOutput_1.setBoolean(4, BROKER_SHIP_FROM.IS_DELETED);

                    if(BROKER_SHIP_FROM.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, BROKER_SHIP_FROM.CREATED_ORIGIN);
}

                    if(BROKER_SHIP_FROM.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(BROKER_SHIP_FROM.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.TIMESTAMP);
}

                    if(BROKER_SHIP_FROM.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, BROKER_SHIP_FROM.UPDATED_ORIGIN);
}

                    if(BROKER_SHIP_FROM.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(BROKER_SHIP_FROM.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.TIMESTAMP);
}

                    if(BROKER_SHIP_FROM.FERP_SVOP == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, BROKER_SHIP_FROM.FERP_SVOP);
}
...
} // End of branch "BROKER_SHIP_FROM"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'BROKER_SHIP_FROM': " + count_BROKER_SHIP_FROM_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"BROKER_SHIP_FROM");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Broker_Ship_From_Inbound Broker_Ship_From_InboundClass = new Broker_Ship_From_Inbound();

        int exitCode = Broker_Ship_From_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Broker_Ship_From_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Broker_Ship_From_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Broker_Ship_From_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/broker_ship_from_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Broker_Ship_From_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Broker_Ship_From_Inbound");
        }
...
/************************************************************************************************
 *     259718 characters generated by Talend Open Studio for Data Integration 
