...
package sus_sli_etl.initial_record_counts_0_1;
...
/**
 * Job: Initial_Record_Counts Purpose: Verification of migrated data from SUS to SLI<br>
 * Description: Verification of migrated data from SUS to SLI <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Initial_Record_Counts implements TalendJob {
	static {System.setProperty("TalendJob.log", "Initial_Record_Counts.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Initial_Record_Counts.class);
...
public String getSUS_Additional_Params(){
	...
	private final String jobName = "Initial_Record_Counts";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_0vZDQFFjEe2kV6ygOnFh1A", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_0vZDQFFjEe2kV6ygOnFh1A", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Initial_Record_Counts.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Initial_Record_Counts.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Initial_Record_Counts = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Initial_Record_Counts = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Initial_Record_Counts.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Initial_Record_Counts.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Initial_Record_Counts = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Initial_Record_Counts = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Initial_Record_Counts, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Initial_Record_Counts, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Initial_Record_Counts, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Initial_Record_Counts, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Initial_Record_Counts) {
...
public static class SUS_GIM_COUNT_COMPAREStruct implements routines.system.IPersistableRow<SUS_GIM_COUNT_COMPAREStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Initial_Record_Counts = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Initial_Record_Counts = new byte[0];
...
SUS_GIM_COUNT_COMPAREStruct SUS_GIM_COUNT_COMPARE = new SUS_GIM_COUNT_COMPAREStruct();
	...
	///////////////////////
        ...
        util_tLogRow_5.addRow(new String[]{"SITE_ID","TABLE_NAME","GIM_COUNT","SUS_COUNT","DIFFERENCE","PERCENTAGE",});        
...
// ###############################
// # Outputs initialization
				int count_SUS_GIM_COUNT_COMPARE_tMap_4 = 0;
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("SCHEMA_DB" + " = " + "context.GIM_Read_Only_Schema_Inventory");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USER" + " = " + "context.GIM_Read_Only_Login");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.GIM_Read_Only_Password)).substring(0, 4) + "...");     
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT 'DEMAND_HISTORY',count(*) FROM demand.\\\"DEMAND_HISTORY\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION   SELECT 'ITEM_PERIOD_DEMAND',count(*) FROM demand.\\\"ITEM_PERIOD_DEMAND\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'CRITICAL_ITEM_SUS',count(*) FROM inventory.\\\"CRITICAL_ITEM_SUS\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION   SELECT 'ITEM_TRANSACTION_HISTORY',count(*) FROM inventory.\\\"ITEM_TRANSACTION_HISTORY\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ITEM_WAREHOUSE_PARAM',count(*) FROM inventory.\\\"ITEM_WAREHOUSE_PARAM\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'BROKER_SHIP_FROM',count(*) FROM master.\\\"BROKER_SHIP_FROM\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'BUYER',count(*) FROM master.\\\"BUYER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'CUSTOMER',count(*) FROM master.\\\"CUSTOMER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'CUSTOMER_SHIP_TO',count(*) FROM master.\\\"CUSTOMER_SHIP_TO\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ENTITY',count(*) FROM master.\\\"ENTITY\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'HAZARD_DETAIL',count(*) FROM master.\\\"HAZARD_DETAIL\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ITEM_NOTE',count(*) FROM master.\\\"ITEM_NOTE\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ITEM_PAY_TO_VENDOR',count(*) FROM master.\\\"ITEM_PAY_TO_VENDOR\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ITEM_VENDOR_SHIP_FROM',count(*) FROM master.\\\"ITEM_VENDOR_SHIP_FROM\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'SHIP_VIA',count(*) FROM master.\\\"SHIP_VIA\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'STRATEGIC_BROKER',count(*) FROM master.\\\"STRATEGIC_BROKER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'STRATEGIC_BROKER_ITEM',count(*) FROM master.\\\"STRATEGIC_BROKER_ITEM\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'USER',count(*) FROM master.\\\"USER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'VENDOR_DETAIL',count(*) FROM master.\\\"VENDOR_DETAIL\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'VENDOR_INVENTORY1',count(*) FROM master.\\\"VENDOR_INVENTORY\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false AND \\\"BUYING_GROUP_FLAG\\\" = '1'  UNION  SELECT 'VENDOR_INVENTORY0',count(*) FROM master.\\\"VENDOR_INVENTORY\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false AND \\\"BUYING_GROUP_FLAG\\\" = '0'  UNION  SELECT 'VENDOR_SHIP_FROM',count(*) FROM master.\\\"VENDOR_SHIP_FROM\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ITEM_DETAIL',count(*) FROM master.\\\"ITEM_DETAIL\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'RDC_ITEM_PAY_TO_VENDOR',count(*) FROM master.\\\"RDC_ITEM_PAY_TO_VENDOR\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ORDER_PROCESS_HEADER',count(*) FROM orderprocessing.\\\"ORDER_PROCESS_HEADER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ORDER_PROCESS_DETAIL',count(*) FROM orderprocessing.\\\"ORDER_PROCESS_DETAIL\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'OBLIGATION_DETAIL',count(*) FROM orderprocessing.\\\"OBLIGATION_DETAIL\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false  UNION  SELECT 'PO_REASON_CODE',count(*) FROM purchaseorder.\\\"PO_REASON_CODE\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false  UNION  SELECT 'INBOUND_SCHEDULING_HEADER',count(*) FROM purchaseorder.\\\"INBOUND_SCHEDULING_HEADER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"UPDATED_ORIGIN\\\" = 'SUS' AND \\\"IS_DELETED\\\" is false AND \\\"IS_ACTIVE\\\" is true  UNION  SELECT 'PURCHASE_ORDER',count(*) FROM purchaseorder.\\\"PURCHASE_ORDER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"UPDATED_ORIGIN\\\" = 'SUS' AND \\\"IS_DELETED\\\" is false AND \\\"IS_ACTIVE\\\" is true  UNION  SELECT 'PURCHASE_ORDER_DETAIL',count(*) FROM purchaseorder.\\\"PURCHASE_ORDER_DETAIL\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"UPDATED_ORIGIN\\\" = 'SUS' AND \\\"IS_DELETED\\\" is false AND \\\"IS_ACTIVE\\\" is true  UNION  SELECT 'PROFORMA_ORDER_HEADER',count(*) FROM purchaseorder.\\\"PROFORMA_ORDER_HEADER\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"UPDATED_ORIGIN\\\" = 'SUS' AND \\\"IS_DELETED\\\" is false AND \\\"IS_ACTIVE\\\" is true  UNION  SELECT 'PROFORMA_ORDER_DETAIL',count(*) FROM purchaseorder.\\\"PROFORMA_ORDER_DETAIL\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"UPDATED_ORIGIN\\\" = 'SUS' AND \\\"IS_DELETED\\\" is false AND \\\"IS_ACTIVE\\\" is true\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("SPECIFY_DATASOURCE_ALIAS" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PROPERTIES" + " = " + "context.GIM_Read_Only_AdditionalParams");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TABLE_NAME")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("RECORD_COUNT")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
	...
	final String decryptedPassword_tDBInput_1 = context.GIM_Read_Only_Password; 
				...
				String url_tDBInput_1 = "jdbc:postgresql://" + context.GIM_Read_Only_Server + ":" + context.GIM_Read_Only_Port + "/" + context.GIM_Read_Only_Database + "?" + context.GIM_Read_Only_AdditionalParams;
...
+"E_ID\" = '" + context.opco + "' AND \"IS_DELETED\" is false AND \"BUYING_GROUP_FLAG\" = '1'\nUNION\nSELECT 'VENDOR_INVENTORY0',count(*) FROM master."
...
+"VENDOR_SHIP_FROM\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"IS_DELETED\" is false \nUNION\nSELECT 'ITEM_DETAIL',count(*) FROM master.\"ITEM_DETAIL\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"IS_DELETED\" is false \nUNION\nSELECT 'RDC_ITEM_PAY_TO_VENDOR',count(*) FROM master.\"RDC_ITEM_PAY_TO_VENDOR\" "
...
+"NG_HEADER\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"UPDATED_ORIGIN\" = 'SUS' AND \"IS_DELETED\" is false AND \"IS_ACTIVE\" is true\nUNION\nSELECT 'PURCHASE_ORDER',"
+"count(*) FROM purchaseorder.\"PURCHASE_ORDER\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"UPDATED_ORIGIN\" = 'SUS' AND \"IS_DELETED\" is false AND \"IS_ACTIVE\" is true\nUNION\nSELECT 'PURCHASE_ORDER_D"
+"ETAIL',count(*) FROM purchaseorder.\"PURCHASE_ORDER_DETAIL\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"UPDATED_ORIGIN\" = 'SUS' AND \"IS_DELETED\" is false AND \"IS_ACTIVE\" is true\nUNION\nSELECT 'PROFORMA_ORDER_H"
+"EADER',count(*) FROM purchaseorder.\"PROFORMA_ORDER_HEADER\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"UPDATED_ORIGIN\" = 'SUS' AND \"IS_DELETED\" is false AND \"IS_ACTIVE\" is true\nUNION\nSELECT 'PROFORMA_ORDER_D"
+"ETAIL',count(*) FROM purchaseorder.\"PROFORMA_ORDER_DETAIL\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"UPDATED_ORIGIN\" = 'SUS' AND \"IS_DELETED\" is false AND \"IS_ACTIVE\" is true";
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.TABLE_NAME = '" + row2HashKey.TABLE_NAME + "'");
								} // G 071
...
Var.PERCENTAGE = (row2.RECORD_COUNT > 0) ? (new Double(row2.RECORD_COUNT - row1.RECORD_COUNT)/new Double(row2.RECORD_COUNT))*100: 0.0 ;// ###############################
        // ###############################
        // # Output tables
...
count_SUS_GIM_COUNT_COMPARE_tMap_4++;
...
log.debug("tMap_4 - Outputting the record " + count_SUS_GIM_COUNT_COMPARE_tMap_4 + " of the output table 'SUS_GIM_COUNT_COMPARE'.");
...
if(SUS_GIM_COUNT_COMPARE != null) { 
	...
	currentComponent="tLogRow_5";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("SUS_GIM_COUNT_COMPARE - " + (SUS_GIM_COUNT_COMPARE==null? "": SUS_GIM_COUNT_COMPARE.toLogString()));
    			}
...
///////////////////////		
	    		...
	    		if(SUS_GIM_COUNT_COMPARE.SITE_ID != null) { //              
                 row_tLogRow_5[0]=    						    
				                String.valueOf(SUS_GIM_COUNT_COMPARE.SITE_ID)			
					          ;	
	    		...
	    		if(SUS_GIM_COUNT_COMPARE.TABLE_NAME != null) { //              
                 row_tLogRow_5[1]=    						    
				                String.valueOf(SUS_GIM_COUNT_COMPARE.TABLE_NAME)			
					          ;	
							
	    		} //			
    			              
                 row_tLogRow_5[2]=    						    
				                String.valueOf(SUS_GIM_COUNT_COMPARE.GIM_COUNT)			
					          ;	
										
    			              
                 row_tLogRow_5[3]=    						    
				                String.valueOf(SUS_GIM_COUNT_COMPARE.SUS_COUNT)			
					          ;	
										
    			              
                 row_tLogRow_5[4]=    						    
				                String.valueOf(SUS_GIM_COUNT_COMPARE.DIFFERENCE)			
					          ;	
										
    			   				
	    		if(SUS_GIM_COUNT_COMPARE.PERCENTAGE != null) { //              
                 row_tLogRow_5[5]=    						    
				                String.valueOf(SUS_GIM_COUNT_COMPARE.PERCENTAGE)			
					          ;	
...
// ###############################      
				log.debug("tMap_4 - Written records count in the table 'SUS_GIM_COUNT_COMPARE': " + count_SUS_GIM_COUNT_COMPARE_tMap_4 + ".");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT 'DEMAND_HISTORY',count(*) FROM immltppf  UNION   SELECT 'ITEM_PERIOD_DEMAND',count(*) FROM imitbepf  UNION  SELECT 'CRITICAL_ITEM_SUS',count(*) FROM imcig6ff  UNION   SELECT 'ITEM_TRANSACTION_HISTORY',count(*) FROM immmtupf  UNION  SELECT 'ITEM_WAREHOUSE_PARAM',count(*) FROM usizrzpf  UNION  SELECT 'BROKER_SHIP_FROM',count(*) FROM referp WHERE REFCAT='AEK'  UNION  SELECT 'BUYER',count(*) FROM referp WHERE REFCAT='JB'  UNION  SELECT 'CUSTOMER',count(*) FROM ardbfa.arpcu  UNION  SELECT 'CUSTOMER_SHIP_TO',count(*) FROM uscbjopf  UNION  SELECT 'ENTITY',count(*) FROM msliy5pf  UNION  SELECT 'HAZARD_DETAIL',count(*) FROM ushahuff  UNION  SELECT 'ITEM_NOTE',count(*) FROM usijc7pf  UNION  SELECT 'ITEM_PAY_TO_VENDOR',count(*) FROM usibjgpf  UNION  SELECT 'ITEM_VENDOR_SHIP_FROM',count(*) FROM usiufmpf  UNION  SELECT 'SHIP_VIA',count(*) FROM referp WHERE REFCAT='HA'  UNION  SELECT 'STRATEGIC_BROKER',count(*) FROM imvbserf  UNION  SELECT 'STRATEGIC_BROKER_ITEM',count(*) FROM usdvvbrf  UNION  SELECT 'USER',count(*) FROM sydbo4pf  UNION  SELECT 'VENDOR_DETAIL',count(*) FROM usvba2pf  UNION  SELECT 'VENDOR_INVENTORY1',count(*) FROM immatvtf  UNION  SELECT 'VENDOR_INVENTORY0',count(*) FROM immat0pf  UNION  SELECT 'VENDOR_SHIP_FROM',count(*) FROM usvfa6pf  UNION  SELECT 'ITEM_DETAIL',count(*) FROM usiajfpf  UNION  SELECT 'RDC_ITEM_PAY_TO_VENDOR',count(*) FROM usibmirf  UNION  SELECT 'ORDER_PROCESS_HEADER',count(*) FROM opnjb6pf  UNION  SELECT 'ORDER_PROCESS_DETAIL',count(*) FROM opnib7pf  UNION  SELECT 'OBLIGATION_DETAIL',count(*) FROM opnbb1pf  UNION  SELECT 'PO_REASON_CODE',count(*) FROM impol7rf  UNION  SELECT 'INBOUND_SCHEDULING_HEADER',count(*) FROM imldvxpf  UNION  SELECT 'PURCHASE_ORDER',count(*) FROM imhav3pf  UNION  SELECT 'PURCHASE_ORDER_DETAIL',count(*) FROM imhbv4pf  UNION  SELECT 'PROFORMA_ORDER_HEADER',count(*) FROM imhae8ff  UNION  SELECT 'PROFORMA_ORDER_DETAIL',count(*) FROM imhbe9ff\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("PROPERTIES" + " = " + "context.SUS_Additional_Params");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("TABLE_NAME")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("RECORD_COUNT")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
 ...
 */
    ...
    public static void main(String[] args){
        final Initial_Record_Counts Initial_Record_CountsClass = new Initial_Record_Counts();

        int exitCode = Initial_Record_CountsClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Initial_Record_Counts' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Initial_Record_Counts' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Initial_Record_Counts.class.getClassLoader().getResourceAsStream("sus_sli_etl/initial_record_counts_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Initial_Record_Counts.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Initial_Record_Counts");
        }
...
/************************************************************************************************
 *     275053 characters generated by Talend Open Studio for Data Integration 
 *     on the October 27, 2022 at 2:06:41 PM IST
 ************************************************************************************************/