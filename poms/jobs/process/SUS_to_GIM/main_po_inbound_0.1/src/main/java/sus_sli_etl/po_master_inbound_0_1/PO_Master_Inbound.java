...
package sus_sli_etl.po_master_inbound_0_1;
...
/**
 * Job: PO_Master_Inbound Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class PO_Master_Inbound implements TalendJob {
...
public String getSUS_Server(){
	...
	private final String jobName = "PO_Master_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_GXze8EliEe2O5Z_uzGYw9g", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_GXze8EliEe2O5Z_uzGYw9g", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				PO_Master_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PO_Master_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_PO_Master_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_PO_Master_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_PO_Master_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_PO_Master_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_PO_Master_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_PO_Master_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_PO_Master_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_PO_Master_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_PO_Master_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_PO_Master_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_PO_Master_Inbound) {
...
System.out.println("********************* Starting the Purchase Order Header Migration *********************");
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-Xms1024M");
              					...
              					String classpath_tRunJob_2_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;purchase_order_header_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(classpath_tRunJob_2_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "sus_sli_etl.purchase_order_header_inbound_0_1.Purchase_Order_Header_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-cp");
		      					...
		      					String classpath_tRunJob_2_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/purchase_order_header_inbound_0_1.jar:";
...
System.out.println("********************* Completed the Purchase Order Header Migration ********************");
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tChronometerStop_2:OnSubjobOk1", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
							...
							tJava_4Process(globalMap); 
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tChronometerStop_2:OnSubjobOk2", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
globalMap.put("svop", context.svop);
globalMap.put("server", context.server);
System.out.println("********************* Starting the Proforma Order Header and Detail Migration *********************");
System.out.println("Teaget OpCO No    : " + context.opco);
System.out.println("Source OpCO No    : " + context.sopco);
System.out.println("Migration SVOP    : " + context.svop);
System.out.println("Migration Server  : " + context.server);
			...
			if (osName_tRunJob_4 != null && osName_tRunJob_4.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_4.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_4_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;proforma_order_master_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, dealChildJobLibrary_tRunJob_4.replaceJarPathsFromCrcMap(classpath_tRunJob_4_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "sus_sli_etl.proforma_order_master_inbound_0_1.Proforma_Order_Master_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_4.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_4.addArgumentsTo(paraList_tRunJob_4, "-cp");
		      					...
		      					String classpath_tRunJob_4_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/proforma_order_master_inbound_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_4 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_4 {
                    ...
                    parentContextMap_tRunJob_4.put("GIM_Read_Only_AdditionalParams", context.GIM_Read_Only_AdditionalParams);
                    paraList_tRunJob_4.add("--context_type " + "GIM_Read_Only_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("GIM_Read_Only_Database", context.GIM_Read_Only_Database);
                    paraList_tRunJob_4.add("--context_type " + "GIM_Read_Only_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("GIM_Read_Only_Login", context.GIM_Read_Only_Login);
                    paraList_tRunJob_4.add("--context_type " + "GIM_Read_Only_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("GIM_Read_Only_Password", context.GIM_Read_Only_Password);
                    paraList_tRunJob_4.add("--context_type " + "GIM_Read_Only_Password" + "=" + "id_Password");
                    parentContextMap_tRunJob_4.put("GIM_Read_Only_Port", context.GIM_Read_Only_Port);
                    paraList_tRunJob_4.add("--context_type " + "GIM_Read_Only_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("GIM_Read_Only_Schema_Inventory", context.GIM_Read_Only_Schema_Inventory);
                    paraList_tRunJob_4.add("--context_type " + "GIM_Read_Only_Schema_Inventory" + "=" + "id_String");
                    parentContextMap_tRunJob_4.put("GIM_Read_Only_Server", context.GIM_Read_Only_Server);
                    paraList_tRunJob_4.add("--context_type " + "GIM_Read_Only_Server" + "=" + "id_String");
...
System.out.println("********************* Completed the Proforma Order Header and Detail Migration ********************");
System.out.println("Completed DateTime: " + java.time.LocalDate.now() + " " + java.time.LocalTime.now());  
System.out.println("**********************************************************************************");
...
globalMap.put("svop", context.svop);
globalMap.put("server", context.server);
System.out.println("********************* Starting the Inbound Scheduling Header Migration *********************");
System.out.println("Teaget OpCO No    : " + context.opco);
System.out.println("Source OpCO No    : " + context.sopco);
System.out.println("Migration SVOP    : " + context.svop);
System.out.println("Migration Server  : " + context.server);
			...
			if (osName_tRunJob_5 != null && osName_tRunJob_5.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_5.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_5_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;inbound_scheduling_header_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, dealChildJobLibrary_tRunJob_5.replaceJarPathsFromCrcMap(classpath_tRunJob_5_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "sus_sli_etl.inbound_scheduling_header_inbound_0_1.Inbound_Scheduling_Header_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_5.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_5.addArgumentsTo(paraList_tRunJob_5, "-cp");
		      					...
		      					String classpath_tRunJob_5_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/inbound_scheduling_header_inbound_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_5 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_5 {
                    ...
                    parentContextMap_tRunJob_5.put("GIM_Read_Only_AdditionalParams", context.GIM_Read_Only_AdditionalParams);
                    paraList_tRunJob_5.add("--context_type " + "GIM_Read_Only_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("GIM_Read_Only_Database", context.GIM_Read_Only_Database);
                    paraList_tRunJob_5.add("--context_type " + "GIM_Read_Only_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("GIM_Read_Only_Login", context.GIM_Read_Only_Login);
                    paraList_tRunJob_5.add("--context_type " + "GIM_Read_Only_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("GIM_Read_Only_Password", context.GIM_Read_Only_Password);
                    paraList_tRunJob_5.add("--context_type " + "GIM_Read_Only_Password" + "=" + "id_Password");
                    parentContextMap_tRunJob_5.put("GIM_Read_Only_Port", context.GIM_Read_Only_Port);
                    paraList_tRunJob_5.add("--context_type " + "GIM_Read_Only_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("GIM_Read_Only_Schema_Inventory", context.GIM_Read_Only_Schema_Inventory);
                    paraList_tRunJob_5.add("--context_type " + "GIM_Read_Only_Schema_Inventory" + "=" + "id_String");
                    parentContextMap_tRunJob_5.put("GIM_Read_Only_Server", context.GIM_Read_Only_Server);
                    paraList_tRunJob_5.add("--context_type " + "GIM_Read_Only_Server" + "=" + "id_String");
...
System.out.println("********************* Completed the Inbound Scheduling Header Migration ********************");
System.out.println("Completed DateTime: " + java.time.LocalDate.now() + " " + java.time.LocalTime.now());  
System.out.println("**********************************************************************************");
...
globalMap.put("svop", context.svop);
globalMap.put("server", context.server);
System.out.println("********************* Starting the PO Reason Code Migration *********************");
System.out.println("Teaget OpCO No    : " + context.opco);
System.out.println("Source OpCO No    : " + context.sopco);
System.out.println("Migration SVOP    : " + context.svop);
System.out.println("Migration Server  : " + context.server);
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_1_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;po_reason_code_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "sus_sli_etl.po_reason_code_inbound_0_1.PO_Reason_Code_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "-cp");
		      					...
		      					String classpath_tRunJob_1_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/po_reason_code_inbound_0_1.jar:";
...
System.out.println("********************* Completed the PO Reason Code Migration ********************");
System.out.println("Completed DateTime: " + java.time.LocalDate.now() + " " + java.time.LocalTime.now());  
System.out.println("**********************************************************************************");
...
globalMap.put("svop", context.svop);
globalMap.put("server", context.server);
System.out.println("********************* Starting the Purchase Order Detail Migration *********************");
System.out.println("Teaget OpCO No    : " + context.opco);
System.out.println("Source OpCO No    : " + context.sopco);
System.out.println("Migration SVOP    : " + context.svop);
System.out.println("Migration Server  : " + context.server);
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-Xms1024M");
              					...
              					String classpath_tRunJob_3_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/crypto-utils-0.31.12.jar;purchase_order_detail_inbound_0_1.jar;purchase_order_detail_insert_inbound_0_1.jar;purchase_order_detail_update_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(classpath_tRunJob_3_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "sus_sli_etl.purchase_order_detail_inbound_0_1.Purchase_Order_Detail_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-cp");
		      					...
		      					String classpath_tRunJob_3_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/purchase_order_detail_inbound_0_1.jar:$ROOT_PATH/purchase_order_detail_insert_inbound_0_1.jar:$ROOT_PATH/purchase_order_detail_update_inbound_0_1.jar:";
...
System.out.println("********************* Completed the Purchase Order Detail Migration ********************");
System.out.println("Completed DateTime: " + java.time.LocalDate.now() + " " + java.time.LocalTime.now());  
System.out.println("**********************************************************************************");
 ...
 */
    ...
    public static void main(String[] args){
        final PO_Master_Inbound PO_Master_InboundClass = new PO_Master_Inbound();

        int exitCode = PO_Master_InboundClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = PO_Master_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/po_master_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PO_Master_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PO_Master_Inbound");
        }
...
/************************************************************************************************
 *     378273 characters generated by Talend Open Studio for Data Integration 
 *     on the November 22, 2022 at 1:53:05 PM IST
 ************************************************************************************************/