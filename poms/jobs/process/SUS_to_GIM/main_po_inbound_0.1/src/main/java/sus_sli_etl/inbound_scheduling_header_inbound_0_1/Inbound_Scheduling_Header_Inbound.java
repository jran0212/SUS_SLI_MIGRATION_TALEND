...
} else {pstmt_tDBOutput_1.setString(1, INBOUND_SCHEDULING_HEADER.LOAD_NO);
}

                    if(INBOUND_SCHEDULING_HEADER.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, INBOUND_SCHEDULING_HEADER.SITE_ID);
}

                    if(INBOUND_SCHEDULING_HEADER.PURCHASE_ORDER_NO == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, INBOUND_SCHEDULING_HEADER.PURCHASE_ORDER_NO);
}

                    if(INBOUND_SCHEDULING_HEADER.SCHEDULE_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.SCHEDULE_DATE.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(5, INBOUND_SCHEDULING_HEADER.LOAD_STATUS);
}

                    if(INBOUND_SCHEDULING_HEADER.BUYER_NO == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, INBOUND_SCHEDULING_HEADER.BUYER_NO);
}

                    if(INBOUND_SCHEDULING_HEADER.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, INBOUND_SCHEDULING_HEADER.VENDOR_NO);
}

                    pstmt_tDBOutput_1.setBigDecimal(8, INBOUND_SCHEDULING_HEADER.ADDRESS_SEQUENCE_NUMBER);

                    if(INBOUND_SCHEDULING_HEADER.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.CREATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(10, INBOUND_SCHEDULING_HEADER.CREATED_USER_ID);
}

                    if(INBOUND_SCHEDULING_HEADER.VXPF_SVOP == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, INBOUND_SCHEDULING_HEADER.VXPF_SVOP);
}

                    if(INBOUND_SCHEDULING_HEADER.IS_ACTIVE == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_1.setBoolean(12, INBOUND_SCHEDULING_HEADER.IS_ACTIVE);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, INBOUND_SCHEDULING_HEADER.UPDATED_USER_ID);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_PROGRAM_ID == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, INBOUND_SCHEDULING_HEADER.UPDATED_PROGRAM_ID);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(15, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.UPDATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setBoolean(16, INBOUND_SCHEDULING_HEADER.IS_DELETED);
}

                    if(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN);
}

                    if(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(19, INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(20, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
/************************************************************************************************
 *     229012 characters generated by Talend Open Studio for Data Integration 
