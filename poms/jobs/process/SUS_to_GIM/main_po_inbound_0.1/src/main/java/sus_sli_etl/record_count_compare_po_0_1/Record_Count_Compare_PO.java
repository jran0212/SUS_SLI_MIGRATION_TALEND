...
package sus_sli_etl.record_count_compare_po_0_1;
...
/**
 * Job: Record_Count_Compare_PO Purpose: Verification of migrated data from SUS to SLI<br>
 * Description: Verification of migrated data from SUS to SLI <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Record_Count_Compare_PO implements TalendJob {
...
public String getSUS_Server(){
	...
	private final String jobName = "Record_Count_Compare_PO";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_PF16QFnCEe2rvrS6LVkqhw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_PF16QFnCEe2rvrS6LVkqhw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Record_Count_Compare_PO.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Record_Count_Compare_PO.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Record_Count_Compare_PO = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_PO, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Record_Count_Compare_PO) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.GIM_Read_Only_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT 'PO_REASON_CODE',count(*) FROM purchaseorder.\"PO_REASON_CODE\" WHERE \"SITE_ID\" = '" + context.opco + "' AND \"IS_DELETED\" is false\nUNION\nSELECT 'INBOUND_SCHEDULING_HEADER',count(*) FROM purchaseorder.\"INBOUND_SCHEDULI"
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.SUS_Password; 
		    ...
		    String dbquery_tDBInput_2 = "SELECT 'PO_REASON_CODE',count(*) FROM impol7rf\nUNION\nSELECT 'INBOUND_SCHEDULING_HEADER',count(*) FROM imldvxpf\nUNION"
+"\nSELECT 'PURCHASE_ORDER',count(*) FROM imhav3pf\nUNION\nSELECT 'PURCHASE_ORDER_DETAIL',count(*) FROM imhbv4pf\nUNION\nS"
+"ELECT 'PROFORMA_ORDER_HEADER',count(*) FROM imhae8ff\nUNION\nSELECT 'PROFORMA_ORDER_DETAIL',count(*) FROM imhbe9ff";
 ...
 */
    ...
    public static void main(String[] args){
        final Record_Count_Compare_PO Record_Count_Compare_POClass = new Record_Count_Compare_PO();

        int exitCode = Record_Count_Compare_POClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Record_Count_Compare_PO.class.getClassLoader().getResourceAsStream("sus_sli_etl/record_count_compare_po_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Record_Count_Compare_PO.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Record_Count_Compare_PO");
        }
...
/************************************************************************************************
 *     218618 characters generated by Talend Open Studio for Data Integration 
 *     on the November 22, 2022 at 1:53:02 PM IST
 ************************************************************************************************/