...
/**
 * Job: Item_Period_Demand_Inbound Purpose: Migrating data from IMITBEPF to ITEM_PERIOD_DEMAND<br>
...
public class Item_Period_Demand_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Item_Period_Demand_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Item_Period_Demand_Inbound.class);
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("__-pw8AjpEe27itDdtrBWEw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("__-pw8AjpEe27itDdtrBWEw", "0.1");
...
System.out.println("Starting the Migrating Data from IMITBEPF to ITEM_PERIOD_DEMAND...........");
...
public static class ITEM_PERIOD_DEMANDStruct implements routines.system.IPersistableRow<ITEM_PERIOD_DEMANDStruct> {
    ...
    public String loopKey;
			    ...
			    public String BEPF_SVOP;

				public String getBEPF_SVOP () {
					return this.BEPF_SVOP;
				}
	...
	public void copyDataTo(ITEM_PERIOD_DEMANDStruct other) {
		...
		other.SITE_ID = this.SITE_ID;
	            ...
	            other.BEPF_SVOP = this.BEPF_SVOP;
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.BEPF_SVOP,dos);
        	...
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(SPLIT_QTY_9 == null){
            				...
            				sb.append(SPLIT_QTY_9);
            			}
            		
        			sb.append("|");
        		
        				if(SPLIT_QTY_10 == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SPLIT_QTY_10);
            			}
            		
        			sb.append("|");
        		
        				if(SPLIT_QTY_11 == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SPLIT_QTY_11);
            			}
            		
        			sb.append("|");
        		
        				if(SPLIT_QTY_12 == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SPLIT_QTY_12);
            			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"ITEM_PERIOD_DEMAND\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"FISCAL_YEAR\",\"CASE_QTY_1\",\"CASE_QTY_2\",\"CASE_QTY_3\",\"CASE_QTY_4\",\"CASE_QTY_5\",\"CASE_QTY_6\",\"CASE_QTY_7\",\"CASE_QTY_8\",\"CASE_QTY_9\",\"CASE_QTY_10\",\"CASE_QTY_11\",\"CASE_QTY_12\",\"SPLIT_QTY_1\",\"SPLIT_QTY_2\",\"SPLIT_QTY_3\",\"SPLIT_QTY_4\",\"SPLIT_QTY_5\",\"SPLIT_QTY_6\",\"SPLIT_QTY_7\",\"SPLIT_QTY_8\",\"SPLIT_QTY_9\",\"SPLIT_QTY_10\",\"SPLIT_QTY_11\",\"SPLIT_QTY_12\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"BEPF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_ITEM_PERIOD_DEMAND_tMap_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"IMITBEPF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    IMITBEPF.BEITEM,    IMITBEPF.BECPVN,    IMITBEPF.BEAYRZ,    IMITBEPF.BECT01,    IMITBEPF.BECT02,    IMITBEPF.BECT03,    IMITBEPF.BECT04,    IMITBEPF.BECT05,    IMITBEPF.BECT06,    IMITBEPF.BECT07,    IMITBEPF.BECT08,    IMITBEPF.BECT09,    IMITBEPF.BECT10,    IMITBEPF.BECT11,    IMITBEPF.BECT12,    IMITBEPF.BESY01,    IMITBEPF.BESY02,    IMITBEPF.BESY03,    IMITBEPF.BESY04,    IMITBEPF.BESY05,    IMITBEPF.BESY06,    IMITBEPF.BESY07,    IMITBEPF.BESY08,    IMITBEPF.BESY09,    IMITBEPF.BESY10,    IMITBEPF.BESY11,    IMITBEPF.BESY12,    IMITBEPF.BEEADT,    IMITBEPF.BEEATM,    IMITBEPF.BEEAID,    IMITBEPF.BEMODT,    IMITBEPF.BEMOTM,    IMITBEPF.BEMOID FROM IMITBEPF ORDER BY IMITBEPF.BEEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"BESY03, \n  IMITBEPF.BESY04, \n  IMITBEPF.BESY05, \n  IMITBEPF.BESY06, \n  IMITBEPF.BESY07, \n  IMITBEPF.BESY08, \n  IMITBEPF."
+"BESY09, \n  IMITBEPF.BESY10, \n  IMITBEPF.BESY11, \n  IMITBEPF.BESY12, \n  IMITBEPF.BEEADT, \n  IMITBEPF.BEEATM, \n  IMITBEPF."
+"BEEAID, \n  IMITBEPF.BEMODT, \n  IMITBEPF.BEMOTM, \n  IMITBEPF.BEMOID\nFROM IMITBEPF ORDER BY IMITBEPF.BEEADT DESC";
...
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.BEEADT.toString(), row1.BEEATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.BEMODT.toString(), row1.BEMOTM.toString()) ;// ###############################
        // ###############################
        // # Output tables
...
count_ITEM_PERIOD_DEMAND_tMap_1++;

ITEM_PERIOD_DEMAND_tmp.SITE_ID = context.opco;
...
ITEM_PERIOD_DEMAND_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
ITEM_PERIOD_DEMAND_tmp.CREATED_USER_ID = row1.BEEAID ;
ITEM_PERIOD_DEMAND_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
ITEM_PERIOD_DEMAND_tmp.UPDATED_USER_ID = row1.BEMOID ;
ITEM_PERIOD_DEMAND_tmp.IS_DELETED = false;
ITEM_PERIOD_DEMAND_tmp.CREATED_ORIGIN = "SUS";
ITEM_PERIOD_DEMAND_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_PERIOD_DEMAND_tmp.UPDATED_ORIGIN = "SUS";
ITEM_PERIOD_DEMAND_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_PERIOD_DEMAND_tmp.BEPF_SVOP = context.svop;
ITEM_PERIOD_DEMAND = ITEM_PERIOD_DEMAND_tmp;
log.debug("tMap_1 - Outputting the record " + count_ITEM_PERIOD_DEMAND_tMap_1 + " of the output table 'ITEM_PERIOD_DEMAND'.");
...
if(ITEM_PERIOD_DEMAND != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("ITEM_PERIOD_DEMAND - " + (ITEM_PERIOD_DEMAND==null? "": ITEM_PERIOD_DEMAND.toLogString()));
    			}
...
} else {pstmt_tDBOutput_1.setString(1, ITEM_PERIOD_DEMAND.SITE_ID);
}

                    if(ITEM_PERIOD_DEMAND.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ITEM_PERIOD_DEMAND.ITEM_NO);
}

                    pstmt_tDBOutput_1.setBigDecimal(3, ITEM_PERIOD_DEMAND.FISCAL_YEAR);

                    pstmt_tDBOutput_1.setBigDecimal(4, ITEM_PERIOD_DEMAND.CASE_QTY_1);

                    pstmt_tDBOutput_1.setBigDecimal(5, ITEM_PERIOD_DEMAND.CASE_QTY_2);

                    pstmt_tDBOutput_1.setBigDecimal(6, ITEM_PERIOD_DEMAND.CASE_QTY_3);

                    pstmt_tDBOutput_1.setBigDecimal(7, ITEM_PERIOD_DEMAND.CASE_QTY_4);

                    pstmt_tDBOutput_1.setBigDecimal(8, ITEM_PERIOD_DEMAND.CASE_QTY_5);

                    pstmt_tDBOutput_1.setBigDecimal(9, ITEM_PERIOD_DEMAND.CASE_QTY_6);

                    pstmt_tDBOutput_1.setBigDecimal(10, ITEM_PERIOD_DEMAND.CASE_QTY_7);

                    pstmt_tDBOutput_1.setBigDecimal(11, ITEM_PERIOD_DEMAND.CASE_QTY_8);

                    pstmt_tDBOutput_1.setBigDecimal(12, ITEM_PERIOD_DEMAND.CASE_QTY_9);

                    pstmt_tDBOutput_1.setBigDecimal(13, ITEM_PERIOD_DEMAND.CASE_QTY_10);

                    pstmt_tDBOutput_1.setBigDecimal(14, ITEM_PERIOD_DEMAND.CASE_QTY_11);

                    pstmt_tDBOutput_1.setBigDecimal(15, ITEM_PERIOD_DEMAND.CASE_QTY_12);

                    pstmt_tDBOutput_1.setBigDecimal(16, ITEM_PERIOD_DEMAND.SPLIT_QTY_1);

                    pstmt_tDBOutput_1.setBigDecimal(17, ITEM_PERIOD_DEMAND.SPLIT_QTY_2);

                    pstmt_tDBOutput_1.setBigDecimal(18, ITEM_PERIOD_DEMAND.SPLIT_QTY_3);

                    pstmt_tDBOutput_1.setBigDecimal(19, ITEM_PERIOD_DEMAND.SPLIT_QTY_4);

                    pstmt_tDBOutput_1.setBigDecimal(20, ITEM_PERIOD_DEMAND.SPLIT_QTY_5);

                    pstmt_tDBOutput_1.setBigDecimal(21, ITEM_PERIOD_DEMAND.SPLIT_QTY_6);

                    pstmt_tDBOutput_1.setBigDecimal(22, ITEM_PERIOD_DEMAND.SPLIT_QTY_7);

                    pstmt_tDBOutput_1.setBigDecimal(23, ITEM_PERIOD_DEMAND.SPLIT_QTY_8);

                    pstmt_tDBOutput_1.setBigDecimal(24, ITEM_PERIOD_DEMAND.SPLIT_QTY_9);

                    pstmt_tDBOutput_1.setBigDecimal(25, ITEM_PERIOD_DEMAND.SPLIT_QTY_10);

                    pstmt_tDBOutput_1.setBigDecimal(26, ITEM_PERIOD_DEMAND.SPLIT_QTY_11);

                    pstmt_tDBOutput_1.setBigDecimal(27, ITEM_PERIOD_DEMAND.SPLIT_QTY_12);

                    if(ITEM_PERIOD_DEMAND.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(28, new java.sql.Timestamp(ITEM_PERIOD_DEMAND.CREATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(29, ITEM_PERIOD_DEMAND.CREATED_USER_ID);
}

                    if(ITEM_PERIOD_DEMAND.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(30, new java.sql.Timestamp(ITEM_PERIOD_DEMAND.UPDATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(31, ITEM_PERIOD_DEMAND.UPDATED_USER_ID);
}

                    pstmt_tDBOutput_1.setBoolean(32, ITEM_PERIOD_DEMAND.IS_DELETED);

                    if(ITEM_PERIOD_DEMAND.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(33, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(33, ITEM_PERIOD_DEMAND.CREATED_ORIGIN);
}

                    if(ITEM_PERIOD_DEMAND.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(34, new java.sql.Timestamp(ITEM_PERIOD_DEMAND.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(34, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_PERIOD_DEMAND.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(35, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(35, ITEM_PERIOD_DEMAND.UPDATED_ORIGIN);
}

                    if(ITEM_PERIOD_DEMAND.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(36, new java.sql.Timestamp(ITEM_PERIOD_DEMAND.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(36, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_PERIOD_DEMAND.BEPF_SVOP == null) {
pstmt_tDBOutput_1.setNull(37, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(37, ITEM_PERIOD_DEMAND.BEPF_SVOP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'ITEM_PERIOD_DEMAND': " + count_ITEM_PERIOD_DEMAND_tMap_1 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Item_Period_Demand_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Item_Period_Demand_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Item_Period_Demand_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Item_Period_Demand_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/item_period_demand_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Item_Period_Demand_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Item_Period_Demand_Inbound");
        }
...
/************************************************************************************************
 *     315161 characters generated by Talend Open Studio for Data Integration 
