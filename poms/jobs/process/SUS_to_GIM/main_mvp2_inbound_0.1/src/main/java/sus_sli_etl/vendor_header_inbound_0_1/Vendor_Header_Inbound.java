...
package sus_sli_etl.vendor_header_inbound_0_1;
...
/**
 * Job: Vendor_Header_Inbound Purpose: Migrating data from USVBA2PF and USVBMKRF to VENDOR_HEADER<br>
 * Description: Migrating data from USVBA2PF and USVBMKRF to VENDOR_HEADER <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Vendor_Header_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Vendor_Header_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Vendor_Header_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Vendor_Header_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_q3Wo0AvjEe2eScgMP1UCyw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_q3Wo0AvjEe2eScgMP1UCyw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Vendor_Header_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Vendor_Header_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Vendor_Header_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Vendor_Header_Inbound) {
...
System.out.println("Starting the Migrating Data from USVBA2PF to VENDOR_HEADER...........");
...
public static class VENDOR_HEADERStruct implements routines.system.IPersistableRow<VENDOR_HEADERStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Vendor_Header_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Vendor_Header_Inbound = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final VENDOR_HEADERStruct other = (VENDOR_HEADERStruct) obj;
	...
	public void copyDataTo(VENDOR_HEADERStruct other) {

		other.VENDOR_TYPE = this.VENDOR_TYPE;
	...
	public void copyKeysDataTo(VENDOR_HEADERStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(VENDOR_HEADERStruct other) {
...
VENDOR_HEADERStruct VENDOR_HEADER = new VENDOR_HEADERStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"VENDOR_HEADER");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"VENDOR_HEADER\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("VENDOR_HEADER");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("VENDOR_HEADER");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"VENDOR_TYPE\" = ?,\"VENDOR_NAME\" = ?,\"IS_DELETED\" = ?,\"CREATED_ORIGIN\" = ?,\"CREATED_ORIGIN_TIMESTAMP\" = ?,\"UPDATED_ORIGIN\" = ?,\"UPDATED_ORIGIN_TIMESTAMP\" = ?,\"A2PF_SVOP\" = ?,\"IS_ACTIVE\" = ? WHERE \"VENDOR_NO\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"VENDOR_TYPE\",\"VENDOR_NO\",\"VENDOR_NAME\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"A2PF_SVOP\",\"IS_ACTIVE\") VALUES (?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_VENDOR_HEADER_tMap_1 = 0;
				
VENDOR_HEADERStruct VENDOR_HEADER_tmp = new VENDOR_HEADERStruct();
// ###############################
...
// # Output table : 'VENDOR_HEADER'
count_VENDOR_HEADER_tMap_1++;

VENDOR_HEADER_tmp.VENDOR_TYPE = row1.A2TYEM ;
VENDOR_HEADER_tmp.VENDOR_NO = row1.A2VNBR ;
VENDOR_HEADER_tmp.VENDOR_NAME = row1.A2VNNM ;
VENDOR_HEADER_tmp.IS_DELETED = false;
VENDOR_HEADER_tmp.CREATED_ORIGIN = "SUS";
VENDOR_HEADER_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
VENDOR_HEADER_tmp.UPDATED_ORIGIN = "SUS";
VENDOR_HEADER_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
VENDOR_HEADER_tmp.A2PF_SVOP = context.svop;
VENDOR_HEADER_tmp.IS_ACTIVE = true;
VENDOR_HEADER = VENDOR_HEADER_tmp;
log.debug("tMap_1 - Outputting the record " + count_VENDOR_HEADER_tMap_1 + " of the output table 'VENDOR_HEADER'.");
...
if(VENDOR_HEADER != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("VENDOR_HEADER - " + (VENDOR_HEADER==null? "": VENDOR_HEADER.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(VENDOR_HEADER.VENDOR_TYPE == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, VENDOR_HEADER.VENDOR_TYPE);
}

                    if(VENDOR_HEADER.VENDOR_NAME == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, VENDOR_HEADER.VENDOR_NAME);
}

                    pstmtUpdate_tDBOutput_1.setBoolean(3, VENDOR_HEADER.IS_DELETED);

                    if(VENDOR_HEADER.CREATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, VENDOR_HEADER.CREATED_ORIGIN);
}

                    if(VENDOR_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(VENDOR_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.TIMESTAMP);
}

                    if(VENDOR_HEADER.UPDATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6, VENDOR_HEADER.UPDATED_ORIGIN);
}

                    if(VENDOR_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(VENDOR_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(VENDOR_HEADER.A2PF_SVOP == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8, VENDOR_HEADER.A2PF_SVOP);
}

                    if(VENDOR_HEADER.IS_ACTIVE == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(9, VENDOR_HEADER.IS_ACTIVE);
}


                    if(VENDOR_HEADER.VENDOR_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(10 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10 + count_tDBOutput_1, VENDOR_HEADER.VENDOR_NO);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, VENDOR_HEADER.VENDOR_TYPE);
}

                        if(VENDOR_HEADER.VENDOR_NO == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, VENDOR_HEADER.VENDOR_NO);
}

                        if(VENDOR_HEADER.VENDOR_NAME == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, VENDOR_HEADER.VENDOR_NAME);
}

                        pstmtInsert_tDBOutput_1.setBoolean(4, VENDOR_HEADER.IS_DELETED);

                        if(VENDOR_HEADER.CREATED_ORIGIN == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, VENDOR_HEADER.CREATED_ORIGIN);
}

                        if(VENDOR_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(VENDOR_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(7, VENDOR_HEADER.UPDATED_ORIGIN);
}

                        if(VENDOR_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(VENDOR_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(9, VENDOR_HEADER.A2PF_SVOP);
}

                        if(VENDOR_HEADER.IS_ACTIVE == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_1.setBoolean(10, VENDOR_HEADER.IS_ACTIVE);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'VENDOR_HEADER': " + count_VENDOR_HEADER_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"VENDOR_HEADER");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Vendor_Header_Inbound Vendor_Header_InboundClass = new Vendor_Header_Inbound();

        int exitCode = Vendor_Header_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Vendor_Header_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Vendor_Header_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Vendor_Header_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/vendor_header_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Vendor_Header_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Vendor_Header_Inbound");
        }
...
/************************************************************************************************
 *     313747 characters generated by Talend Open Studio for Data Integration 
