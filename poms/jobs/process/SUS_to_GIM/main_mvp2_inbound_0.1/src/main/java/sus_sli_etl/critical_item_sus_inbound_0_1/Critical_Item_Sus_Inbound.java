...
package sus_sli_etl.critical_item_sus_inbound_0_1;
...
/**
 * Job: Critical_Item_Sus_Inbound Purpose: Migrating data from IMCIG6FF to Critical_Item_Sus Table<br>
 * Description: Migrating data from IMCIG6FF to Critical_Item_Sus Table <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Critical_Item_Sus_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Critical_Item_Sus_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Critical_Item_Sus_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Critical_Item_Sus_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_YH5ocDo4Ee2xGNo11e9t0A", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_YH5ocDo4Ee2xGNo11e9t0A", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Critical_Item_Sus_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Critical_Item_Sus_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Critical_Item_Sus_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Critical_Item_Sus_Inbound) {
...
System.out.println("Starting the Migrating Data from IMCIG6FF to CRITICAL_ITEM_SUS...........");
...
public static class CRITICAL_ITEM_SUSStruct implements routines.system.IPersistableRow<CRITICAL_ITEM_SUSStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Critical_Item_Sus_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public BigDecimal INVENTORY_DAYS_SUPPLY;

				public BigDecimal getINVENTORY_DAYS_SUPPLY () {
					return this.INVENTORY_DAYS_SUPPLY;
				}
			    ...
			    public String CRITICAL_ITEM_SOURCE_CODE;

				public String getCRITICAL_ITEM_SOURCE_CODE () {
					return this.CRITICAL_ITEM_SOURCE_CODE;
				}
				
			    public BigDecimal FILL_IN_QTY;

				public BigDecimal getFILL_IN_QTY () {
					return this.FILL_IN_QTY;
				}
			    ...
			    public String MARK_UNMARK_FLAG;

				public String getMARK_UNMARK_FLAG () {
					return this.MARK_UNMARK_FLAG;
				}
			    ...
			    public String G6FF_SVOP;

				public String getG6FF_SVOP () {
					return this.G6FF_SVOP;
				}
	...
	public boolean equals(Object obj) {
		...
		final CRITICAL_ITEM_SUSStruct other = (CRITICAL_ITEM_SUSStruct) obj;
	...
	public void copyDataTo(CRITICAL_ITEM_SUSStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.ITEM_NO = this.ITEM_NO;
	            other.VENDOR_NO = this.VENDOR_NO;
	            other.VENDOR_SUFFIX = this.VENDOR_SUFFIX;
	            other.INVENTORY_DAYS_SUPPLY = this.INVENTORY_DAYS_SUPPLY;
	            other.PO_FLAG = this.PO_FLAG;
	            other.CRITICAL_ITEM_SOURCE_CODE = this.CRITICAL_ITEM_SOURCE_CODE;
	            other.FILL_IN_QTY = this.FILL_IN_QTY;
	            other.BUYER_NO = this.BUYER_NO;
	            other.MARK_UNMARK_FLAG = this.MARK_UNMARK_FLAG;
	            other.MOVEMENT_TYPE = this.MOVEMENT_TYPE;
	            ...
	            other.G6FF_SVOP = this.G6FF_SVOP;
	            
	}

	public void copyKeysDataTo(CRITICAL_ITEM_SUSStruct other) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.VENDOR_NO = readString(dis);
						...
						this.INVENTORY_DAYS_SUPPLY = (BigDecimal) dis.readObject();
					
					this.PO_FLAG = readString(dis);
					
					this.CRITICAL_ITEM_SOURCE_CODE = readString(dis);
					
						this.FILL_IN_QTY = (BigDecimal) dis.readObject();
					
					this.BUYER_NO = readString(dis);
					
					this.MARK_UNMARK_FLAG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.INVENTORY_DAYS_SUPPLY);
					
					// String
				
						writeString(this.PO_FLAG,dos);
					
					// String
				
						writeString(this.CRITICAL_ITEM_SOURCE_CODE,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FILL_IN_QTY);
					...
					// String
						...
						writeString(this.MARK_UNMARK_FLAG,dos);
					...
					// String
						...
						writeString(this.G6FF_SVOP,dos);
    ...
    public String toString() {
		...
		sb.append(",INVENTORY_DAYS_SUPPLY="+String.valueOf(INVENTORY_DAYS_SUPPLY));
		sb.append(",PO_FLAG="+PO_FLAG);
		sb.append(",CRITICAL_ITEM_SOURCE_CODE="+CRITICAL_ITEM_SOURCE_CODE);
		sb.append(",FILL_IN_QTY="+String.valueOf(FILL_IN_QTY));
		sb.append(",BUYER_NO="+BUYER_NO);
		sb.append(",MARK_UNMARK_FLAG="+MARK_UNMARK_FLAG);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(INVENTORY_DAYS_SUPPLY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(INVENTORY_DAYS_SUPPLY);
            			}
        			...
        			sb.append("|");
        				...
        				if(CRITICAL_ITEM_SOURCE_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CRITICAL_ITEM_SOURCE_CODE);
            			}
        			...
        			sb.append("|");
        				...
        				if(MARK_UNMARK_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MARK_UNMARK_FLAG);
            			}
     ...
     * Compare keys
     */
    public int compareTo(CRITICAL_ITEM_SUSStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Critical_Item_Sus_Inbound = new byte[0];
			    ...
			    public String G6ITEM;

				public String getG6ITEM () {
					return this.G6ITEM;
				}
				
			    public String G6CPVN;

				public String getG6CPVN () {
					return this.G6CPVN;
				}
				
			    public String G6VNBR;

				public String getG6VNBR () {
					return this.G6VNBR;
				}
				
			    public BigDecimal G6ADCD;

				public BigDecimal getG6ADCD () {
					return this.G6ADCD;
				}
				
			    public String G6PACK;

				public String getG6PACK () {
					return this.G6PACK;
				}
				
			    public String G6ITSZ;

				public String getG6ITSZ () {
					return this.G6ITSZ;
				}
				
			    public String G6BRND;

				public String getG6BRND () {
					return this.G6BRND;
				}
				
			    public String G6ITDS;

				public String getG6ITDS () {
					return this.G6ITDS;
				}
				
			    public String G6ITPR;

				public String getG6ITPR () {
					return this.G6ITPR;
				}
				
			    public BigDecimal G6IDSU;

				public BigDecimal getG6IDSU () {
					return this.G6IDSU;
				}
				
			    public String G6POFA;

				public String getG6POFA () {
					return this.G6POFA;
				}
				
			    public String G6CISC;

				public String getG6CISC () {
					return this.G6CISC;
				}
				
			    public BigDecimal G6FIQT;

				public BigDecimal getG6FIQT () {
					return this.G6FIQT;
				}
				
			    public String G6MNPC;

				public String getG6MNPC () {
					return this.G6MNPC;
				}
				
			    public String G6BUYR;

				public String getG6BUYR () {
					return this.G6BUYR;
				}
				
			    public String G6MRKF;

				public String getG6MRKF () {
					return this.G6MRKF;
				}
				
			    public String G6MVTP;

				public String getG6MVTP () {
					return this.G6MVTP;
				}
				
			    public BigDecimal G6EADT;

				public BigDecimal getG6EADT () {
					return this.G6EADT;
				}
				
			    public BigDecimal G6EATM;

				public BigDecimal getG6EATM () {
					return this.G6EATM;
				}
				
			    public String G6EAID;

				public String getG6EAID () {
					return this.G6EAID;
				}
				
			    public BigDecimal G6MODT;

				public BigDecimal getG6MODT () {
					return this.G6MODT;
				}
				
			    public BigDecimal G6MOTM;

				public BigDecimal getG6MOTM () {
					return this.G6MOTM;
				}
				
			    public String G6MOID;

				public String getG6MOID () {
					return this.G6MOID;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Critical_Item_Sus_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.G6ITEM = readString(dis);
					
					this.G6CPVN = readString(dis);
					
					this.G6VNBR = readString(dis);
					
						this.G6ADCD = (BigDecimal) dis.readObject();
					
					this.G6PACK = readString(dis);
					
					this.G6ITSZ = readString(dis);
					
					this.G6BRND = readString(dis);
					
					this.G6ITDS = readString(dis);
					
					this.G6ITPR = readString(dis);
					
						this.G6IDSU = (BigDecimal) dis.readObject();
					
					this.G6POFA = readString(dis);
					
					this.G6CISC = readString(dis);
					
						this.G6FIQT = (BigDecimal) dis.readObject();
					
					this.G6MNPC = readString(dis);
					
					this.G6BUYR = readString(dis);
					
					this.G6MRKF = readString(dis);
					
					this.G6MVTP = readString(dis);
					
						this.G6EADT = (BigDecimal) dis.readObject();
					
						this.G6EATM = (BigDecimal) dis.readObject();
					
					this.G6EAID = readString(dis);
					
						this.G6MODT = (BigDecimal) dis.readObject();
					
						this.G6MOTM = (BigDecimal) dis.readObject();
					
					this.G6MOID = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.G6ITEM,dos);
					
					// String
				
						writeString(this.G6CPVN,dos);
					
					// String
				
						writeString(this.G6VNBR,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.G6ADCD);
					
					// String
				
						writeString(this.G6PACK,dos);
					
					// String
				
						writeString(this.G6ITSZ,dos);
					
					// String
				
						writeString(this.G6BRND,dos);
					
					// String
				
						writeString(this.G6ITDS,dos);
					
					// String
				
						writeString(this.G6ITPR,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.G6IDSU);
					
					// String
				
						writeString(this.G6POFA,dos);
					
					// String
				
						writeString(this.G6CISC,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.G6FIQT);
					
					// String
				
						writeString(this.G6MNPC,dos);
					
					// String
				
						writeString(this.G6BUYR,dos);
					
					// String
				
						writeString(this.G6MRKF,dos);
					
					// String
				
						writeString(this.G6MVTP,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.G6EADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.G6EATM);
					
					// String
				
						writeString(this.G6EAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.G6MODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.G6MOTM);
					
					// String
				
						writeString(this.G6MOID,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("G6ITEM="+G6ITEM);
		sb.append(",G6CPVN="+G6CPVN);
		sb.append(",G6VNBR="+G6VNBR);
		sb.append(",G6ADCD="+String.valueOf(G6ADCD));
		sb.append(",G6PACK="+G6PACK);
		sb.append(",G6ITSZ="+G6ITSZ);
		sb.append(",G6BRND="+G6BRND);
		sb.append(",G6ITDS="+G6ITDS);
		sb.append(",G6ITPR="+G6ITPR);
		sb.append(",G6IDSU="+String.valueOf(G6IDSU));
		sb.append(",G6POFA="+G6POFA);
		sb.append(",G6CISC="+G6CISC);
		sb.append(",G6FIQT="+String.valueOf(G6FIQT));
		sb.append(",G6MNPC="+G6MNPC);
		sb.append(",G6BUYR="+G6BUYR);
		sb.append(",G6MRKF="+G6MRKF);
		sb.append(",G6MVTP="+G6MVTP);
		sb.append(",G6EADT="+String.valueOf(G6EADT));
		sb.append(",G6EATM="+String.valueOf(G6EATM));
		sb.append(",G6EAID="+G6EAID);
		sb.append(",G6MODT="+String.valueOf(G6MODT));
		sb.append(",G6MOTM="+String.valueOf(G6MOTM));
		sb.append(",G6MOID="+G6MOID);
	    sb.append("]");
...
CRITICAL_ITEM_SUSStruct CRITICAL_ITEM_SUS = new CRITICAL_ITEM_SUSStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"CRITICAL_ITEM_SUS");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"CRITICAL_ITEM_SUS\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("CRITICAL_ITEM_SUS");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("CRITICAL_ITEM_SUS");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"VENDOR_NO\",\"VENDOR_SUFFIX\",\"INVENTORY_DAYS_SUPPLY\",\"PO_FLAG\",\"CRITICAL_ITEM_SOURCE_CODE\",\"FILL_IN_QTY\",\"BUYER_NO\",\"MARK_UNMARK_FLAG\",\"MOVEMENT_TYPE\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"G6FF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_CRITICAL_ITEM_SUS_tMap_4 = 0;
				
CRITICAL_ITEM_SUSStruct CRITICAL_ITEM_SUS_tmp = new CRITICAL_ITEM_SUSStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"IMCIG6FF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    IMCIG6FF.G6ITEM,    IMCIG6FF.G6CPVN,    IMCIG6FF.G6VNBR,    IMCIG6FF.G6ADCD,    IMCIG6FF.G6PACK,    IMCIG6FF.G6ITSZ,    IMCIG6FF.G6BRND,    IMCIG6FF.G6ITDS,    IMCIG6FF.G6ITPR,    IMCIG6FF.G6IDSU,    IMCIG6FF.G6POFA,    IMCIG6FF.G6CISC,    IMCIG6FF.G6FIQT,    IMCIG6FF.G6MNPC,    IMCIG6FF.G6BUYR,    IMCIG6FF.G6MRKF,    IMCIG6FF.G6MVTP,    IMCIG6FF.G6EADT,    IMCIG6FF.G6EATM,    IMCIG6FF.G6EAID,    IMCIG6FF.G6MODT,    IMCIG6FF.G6MOTM,    IMCIG6FF.G6MOID FROM IMCIG6FF ORDER BY IMCIG6FF.G6EADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+" ORDER BY IMCIG6FF.G6EADT DESC";
        	...
        	row1.G6ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.G6CPVN = null;
							} else {
	                         		
        	row1.G6CPVN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.G6VNBR = null;
							} else {
	                         		
        	row1.G6VNBR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.G6ADCD = null;
							} else {
		                          
            row1.G6ADCD = rs_tDBInput_1.getBigDecimal(4);
        	...
        	row1.G6PACK = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.G6ITSZ = null;
							} else {
	                         		
        	row1.G6ITSZ = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.G6BRND = null;
							} else {
	                         		
        	row1.G6BRND = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.G6ITDS = null;
							} else {
	                         		
        	row1.G6ITDS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.G6ITPR = null;
							} else {
	                         		
        	row1.G6ITPR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.G6IDSU = null;
							} else {
		                          
            row1.G6IDSU = rs_tDBInput_1.getBigDecimal(10);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.G6POFA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.G6CISC = null;
							} else {
	                         		
        	row1.G6CISC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.G6FIQT = null;
							} else {
		                          
            row1.G6FIQT = rs_tDBInput_1.getBigDecimal(13);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.G6MNPC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.G6BUYR = null;
							} else {
	                         		
        	row1.G6BUYR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.G6MRKF = null;
							} else {
	                         		
        	row1.G6MRKF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row1.G6MVTP = null;
							} else {
	                         		
        	row1.G6MVTP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row1.G6EADT = null;
							} else {
		                          
            row1.G6EADT = rs_tDBInput_1.getBigDecimal(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.G6EATM = rs_tDBInput_1.getBigDecimal(19);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.G6EAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.G6MODT = null;
							} else {
		                          
            row1.G6MODT = rs_tDBInput_1.getBigDecimal(21);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.G6MOTM = rs_tDBInput_1.getBigDecimal(22);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.G6MOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, true);
		                    }
...
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.G6EADT.toString(),row1.G6EATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.G6MODT.toString(),row1.G6MOTM.toString()) ;
Var.G6ITEM = CharSetHandling.convertEBCDICStrToASCII(row1.G6ITEM) ;
Var.G6VNBR = CharSetHandling.convertEBCDICStrToASCII(row1.G6VNBR) ;
Var.G6POFA = CharSetHandling.convertEBCDICStrToASCII(row1.G6POFA) ;
Var.G6CISC = CharSetHandling.convertEBCDICStrToASCII(row1.G6CISC) ;
Var.G6BUYR = CharSetHandling.convertEBCDICStrToASCII(row1.G6BUYR) ;
Var.G6MRKF = CharSetHandling.convertEBCDICStrToASCII(row1.G6MRKF) ;
Var.G6MVTP = CharSetHandling.convertEBCDICStrToASCII(row1.G6MVTP) ;
Var.G6EAID = CharSetHandling.convertEBCDICStrToASCII(row1.G6EAID) ;
Var.G6MOID = CharSetHandling.convertEBCDICStrToASCII(row1.G6MOID) ;// ###############################
        // ###############################
        // # Output tables

CRITICAL_ITEM_SUS = null;


// # Output table : 'CRITICAL_ITEM_SUS'
count_CRITICAL_ITEM_SUS_tMap_4++;

CRITICAL_ITEM_SUS_tmp.SITE_ID = context.opco;
CRITICAL_ITEM_SUS_tmp.ITEM_NO = Var.G6ITEM ;
CRITICAL_ITEM_SUS_tmp.VENDOR_NO = Var.G6VNBR ;
CRITICAL_ITEM_SUS_tmp.VENDOR_SUFFIX = row1.G6ADCD ;
CRITICAL_ITEM_SUS_tmp.INVENTORY_DAYS_SUPPLY = row1.G6IDSU ;
CRITICAL_ITEM_SUS_tmp.PO_FLAG = Var.G6POFA ;
CRITICAL_ITEM_SUS_tmp.CRITICAL_ITEM_SOURCE_CODE = Var.G6CISC;
CRITICAL_ITEM_SUS_tmp.FILL_IN_QTY = row1.G6FIQT ;
CRITICAL_ITEM_SUS_tmp.BUYER_NO = Var.G6BUYR ;
CRITICAL_ITEM_SUS_tmp.MARK_UNMARK_FLAG = Var.G6MRKF ;
CRITICAL_ITEM_SUS_tmp.MOVEMENT_TYPE = Var.G6MVTP ;
CRITICAL_ITEM_SUS_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
CRITICAL_ITEM_SUS_tmp.CREATED_USER_ID = Var.G6EAID;
CRITICAL_ITEM_SUS_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
CRITICAL_ITEM_SUS_tmp.UPDATED_USER_ID = Var.G6MOID ;
CRITICAL_ITEM_SUS_tmp.IS_DELETED = false;
CRITICAL_ITEM_SUS_tmp.CREATED_ORIGIN = "SUS";
CRITICAL_ITEM_SUS_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
CRITICAL_ITEM_SUS_tmp.UPDATED_ORIGIN = "SUS";
CRITICAL_ITEM_SUS_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
CRITICAL_ITEM_SUS_tmp.G6FF_SVOP = context.svop;
CRITICAL_ITEM_SUS = CRITICAL_ITEM_SUS_tmp;
log.debug("tMap_4 - Outputting the record " + count_CRITICAL_ITEM_SUS_tMap_4 + " of the output table 'CRITICAL_ITEM_SUS'.");
 ...
 */
// Start of branch "CRITICAL_ITEM_SUS"
if(CRITICAL_ITEM_SUS != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("CRITICAL_ITEM_SUS - " + (CRITICAL_ITEM_SUS==null? "": CRITICAL_ITEM_SUS.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(CRITICAL_ITEM_SUS.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, CRITICAL_ITEM_SUS.SITE_ID);
}

                    if(CRITICAL_ITEM_SUS.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, CRITICAL_ITEM_SUS.ITEM_NO);
}

                    if(CRITICAL_ITEM_SUS.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, CRITICAL_ITEM_SUS.VENDOR_NO);
}

                    pstmt_tDBOutput_1.setBigDecimal(4, CRITICAL_ITEM_SUS.VENDOR_SUFFIX);

                    pstmt_tDBOutput_1.setBigDecimal(5, CRITICAL_ITEM_SUS.INVENTORY_DAYS_SUPPLY);

                    if(CRITICAL_ITEM_SUS.PO_FLAG == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, CRITICAL_ITEM_SUS.PO_FLAG);
}

                    if(CRITICAL_ITEM_SUS.CRITICAL_ITEM_SOURCE_CODE == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, CRITICAL_ITEM_SUS.CRITICAL_ITEM_SOURCE_CODE);
}

                    pstmt_tDBOutput_1.setBigDecimal(8, CRITICAL_ITEM_SUS.FILL_IN_QTY);

                    if(CRITICAL_ITEM_SUS.BUYER_NO == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, CRITICAL_ITEM_SUS.BUYER_NO);
}

                    if(CRITICAL_ITEM_SUS.MARK_UNMARK_FLAG == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, CRITICAL_ITEM_SUS.MARK_UNMARK_FLAG);
}

                    if(CRITICAL_ITEM_SUS.MOVEMENT_TYPE == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, CRITICAL_ITEM_SUS.MOVEMENT_TYPE);
}

                    if(CRITICAL_ITEM_SUS.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(12, new java.sql.Timestamp(CRITICAL_ITEM_SUS.CREATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.TIMESTAMP);
}

                    if(CRITICAL_ITEM_SUS.CREATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, CRITICAL_ITEM_SUS.CREATED_USER_ID);
}

                    if(CRITICAL_ITEM_SUS.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(14, new java.sql.Timestamp(CRITICAL_ITEM_SUS.UPDATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.TIMESTAMP);
}

                    if(CRITICAL_ITEM_SUS.UPDATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, CRITICAL_ITEM_SUS.UPDATED_USER_ID);
}

                    pstmt_tDBOutput_1.setBoolean(16, CRITICAL_ITEM_SUS.IS_DELETED);

                    if(CRITICAL_ITEM_SUS.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, CRITICAL_ITEM_SUS.CREATED_ORIGIN);
}

                    if(CRITICAL_ITEM_SUS.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(CRITICAL_ITEM_SUS.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.TIMESTAMP);
}

                    if(CRITICAL_ITEM_SUS.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(19, CRITICAL_ITEM_SUS.UPDATED_ORIGIN);
}

                    if(CRITICAL_ITEM_SUS.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(20, new java.sql.Timestamp(CRITICAL_ITEM_SUS.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(20, java.sql.Types.TIMESTAMP);
}

                    if(CRITICAL_ITEM_SUS.G6FF_SVOP == null) {
pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(21, CRITICAL_ITEM_SUS.G6FF_SVOP);
}
...
} // End of branch "CRITICAL_ITEM_SUS"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_4 - Written records count in the table 'CRITICAL_ITEM_SUS': " + count_CRITICAL_ITEM_SUS_tMap_4 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"CRITICAL_ITEM_SUS");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Critical_Item_Sus_Inbound Critical_Item_Sus_InboundClass = new Critical_Item_Sus_Inbound();

        int exitCode = Critical_Item_Sus_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Critical_Item_Sus_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Critical_Item_Sus_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Critical_Item_Sus_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/critical_item_sus_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Critical_Item_Sus_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Critical_Item_Sus_Inbound");
        }
...
/************************************************************************************************
 *     285329 characters generated by Talend Open Studio for Data Integration 
