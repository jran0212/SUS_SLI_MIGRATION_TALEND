...
/**
 * Job: Strategic_Broker_Inbound Purpose: Migrating data from IMVBSERF to Strategic Broker<br>
...
public class Strategic_Broker_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Strategic_Broker_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Strategic_Broker_Inbound.class);
...
public static class STRATEGIC_BROKERStruct implements routines.system.IPersistableRow<STRATEGIC_BROKERStruct> {
    ...
    public String loopKey;
			    ...
			    public String SERF_SVOP;

				public String getSERF_SVOP () {
					return this.SERF_SVOP;
				}
	...
	public void copyDataTo(STRATEGIC_BROKERStruct other) {
		...
		other.SITE_ID = this.SITE_ID;
	            ...
	            other.SERF_SVOP = this.SERF_SVOP;
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.SERF_SVOP,dos);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(CONTACT_TELEPHONE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CONTACT_TELEPHONE_NO);
            			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"STRATEGIC_BROKER\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"BROKER_ID\",\"CONTACT_PERSON_NAME\",\"CONTACT_TITLE\",\"ADDRESS_LINE_1\",\"ADDRESS_LINE_2\",\"ADDRESS_LINE_3\",\"ADDRESS_LINE_4\",\"CONTACT_TELEPHONE_NO\",\"FAX\",\"CITY\",\"STATE\",\"ZIP_CODE\",\"COUNTRY\",\"EMAIL\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"UPDATED_PROGRAM_ID\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"SERF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_STRATEGIC_BROKER_tMap_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"IMVBSERF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    IMVBSERF.SEOPCO,    IMVBSERF.SEBRID,    IMVBSERF.SECONT,    IMVBSERF.SECNTT,    IMVBSERF.SEADR1,    IMVBSERF.SEADR2,    IMVBSERF.SEADR3,    IMVBSERF.SEADR4,    IMVBSERF.\\\"SETEL#\\\",    IMVBSERF.SECFAX,    IMVBSERF.SEMCIT,    IMVBSERF.SESTAE,    IMVBSERF.SEMZIP,    IMVBSERF.SECY20,    IMVBSERF.SEREML,    IMVBSERF.SEFL16,    IMVBSERF.SERDCN,    IMVBSERF.SEEADT,    IMVBSERF.SEEATM,    IMVBSERF.SEEAID,    IMVBSERF.SEMODT,    IMVBSERF.SEMOTM,    IMVBSERF.SEMOID,    IMVBSERF.SEMOPG FROM IMVBSERF ORDER BY IMVBSERF.SEEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.SEEADT.toString(),row1.SEEATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.SEMODT.toString(),row1.SEMOTM.toString()) ;// ###############################
        // ###############################
        // # Output tables
...
count_STRATEGIC_BROKER_tMap_1++;

STRATEGIC_BROKER_tmp.SITE_ID = context.opco;
...
STRATEGIC_BROKER_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
STRATEGIC_BROKER_tmp.CREATED_USER_ID = row1.SEEAID ;
STRATEGIC_BROKER_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
...
STRATEGIC_BROKER_tmp.CREATED_ORIGIN = "SUS";
STRATEGIC_BROKER_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
STRATEGIC_BROKER_tmp.UPDATED_ORIGIN = "SUS";
STRATEGIC_BROKER_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
STRATEGIC_BROKER_tmp.SERF_SVOP = context.svop;
STRATEGIC_BROKER = STRATEGIC_BROKER_tmp;
log.debug("tMap_1 - Outputting the record " + count_STRATEGIC_BROKER_tMap_1 + " of the output table 'STRATEGIC_BROKER'.");
...
if(STRATEGIC_BROKER != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("STRATEGIC_BROKER - " + (STRATEGIC_BROKER==null? "": STRATEGIC_BROKER.toLogString()));
    			}
...
} else {pstmt_tDBOutput_1.setString(1, STRATEGIC_BROKER.SITE_ID);
}

                    if(STRATEGIC_BROKER.BROKER_ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, STRATEGIC_BROKER.BROKER_ID);
}

                    if(STRATEGIC_BROKER.CONTACT_PERSON_NAME == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, STRATEGIC_BROKER.CONTACT_PERSON_NAME);
}

                    if(STRATEGIC_BROKER.CONTACT_TITLE == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, STRATEGIC_BROKER.CONTACT_TITLE);
}

                    if(STRATEGIC_BROKER.ADDRESS_LINE_1 == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, STRATEGIC_BROKER.ADDRESS_LINE_1);
}

                    if(STRATEGIC_BROKER.ADDRESS_LINE_2 == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, STRATEGIC_BROKER.ADDRESS_LINE_2);
}

                    if(STRATEGIC_BROKER.ADDRESS_LINE_3 == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, STRATEGIC_BROKER.ADDRESS_LINE_3);
}

                    if(STRATEGIC_BROKER.ADDRESS_LINE_4 == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, STRATEGIC_BROKER.ADDRESS_LINE_4);
}

                    if(STRATEGIC_BROKER.CONTACT_TELEPHONE_NO == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, STRATEGIC_BROKER.CONTACT_TELEPHONE_NO);
}

                    if(STRATEGIC_BROKER.FAX == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, STRATEGIC_BROKER.FAX);
}

                    if(STRATEGIC_BROKER.CITY == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, STRATEGIC_BROKER.CITY);
}

                    if(STRATEGIC_BROKER.STATE == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, STRATEGIC_BROKER.STATE);
}

                    if(STRATEGIC_BROKER.ZIP_CODE == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, STRATEGIC_BROKER.ZIP_CODE);
}

                    if(STRATEGIC_BROKER.COUNTRY == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, STRATEGIC_BROKER.COUNTRY);
}

                    if(STRATEGIC_BROKER.EMAIL == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, STRATEGIC_BROKER.EMAIL);
}

                    if(STRATEGIC_BROKER.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(16, new java.sql.Timestamp(STRATEGIC_BROKER.CREATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(17, STRATEGIC_BROKER.CREATED_USER_ID);
}

                    if(STRATEGIC_BROKER.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(STRATEGIC_BROKER.UPDATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(19, STRATEGIC_BROKER.UPDATED_USER_ID);
}

                    if(STRATEGIC_BROKER.UPDATED_PROGRAM_ID == null) {
pstmt_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(20, STRATEGIC_BROKER.UPDATED_PROGRAM_ID);
}

                    pstmt_tDBOutput_1.setBoolean(21, STRATEGIC_BROKER.IS_DELETED);

                    if(STRATEGIC_BROKER.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(22, STRATEGIC_BROKER.CREATED_ORIGIN);
}

                    if(STRATEGIC_BROKER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(23, new java.sql.Timestamp(STRATEGIC_BROKER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(23, java.sql.Types.TIMESTAMP);
}

                    if(STRATEGIC_BROKER.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(24, STRATEGIC_BROKER.UPDATED_ORIGIN);
}

                    if(STRATEGIC_BROKER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(25, new java.sql.Timestamp(STRATEGIC_BROKER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(25, java.sql.Types.TIMESTAMP);
}

                    if(STRATEGIC_BROKER.SERF_SVOP == null) {
pstmt_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(26, STRATEGIC_BROKER.SERF_SVOP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'STRATEGIC_BROKER': " + count_STRATEGIC_BROKER_tMap_1 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Strategic_Broker_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Strategic_Broker_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Strategic_Broker_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Strategic_Broker_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/strategic_broker_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Strategic_Broker_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Strategic_Broker_Inbound");
        }
...
/************************************************************************************************
 *     292436 characters generated by Talend Open Studio for Data Integration 
