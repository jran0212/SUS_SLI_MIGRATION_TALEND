...
package sus_sli_etl.ship_via_inbound_0_1;
...
/**
 * Job: Ship_Via_Inbound Purpose: Migrating data from referp to SHIP_VIA<br>
 * Description: Migrating data from referp to SHIP_VIA <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Ship_Via_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Ship_Via_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Ship_Via_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Ship_Via_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_NUk_UAjhEe27itDdtrBWEw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_NUk_UAjhEe27itDdtrBWEw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Ship_Via_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Ship_Via_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Ship_Via_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Ship_Via_Inbound) {
...
System.out.println("Starting the Migrating Data from REFERP to SHIP_VIA...........");
...
public static class SHIP_VIAStruct implements routines.system.IPersistableRow<SHIP_VIAStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Ship_Via_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Ship_Via_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String SHIPPED_VIA_CODE;

				public String getSHIPPED_VIA_CODE () {
					return this.SHIPPED_VIA_CODE;
				}
				
			    public String SHIPPED_VIA_DESC;

				public String getSHIPPED_VIA_DESC () {
					return this.SHIPPED_VIA_DESC;
				}
				
			    public String PRODUCT_CLASS_CODE;

				public String getPRODUCT_CLASS_CODE () {
					return this.PRODUCT_CLASS_CODE;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.SHIPPED_VIA_CODE == null) ? 0 : this.SHIPPED_VIA_CODE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final SHIP_VIAStruct other = (SHIP_VIAStruct) obj;
						...
						if (this.SHIPPED_VIA_CODE == null) {
							if (other.SHIPPED_VIA_CODE != null)
								return false;
						
						} else if (!this.SHIPPED_VIA_CODE.equals(other.SHIPPED_VIA_CODE))
	...
	public void copyDataTo(SHIP_VIAStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.SHIPPED_VIA_CODE = this.SHIPPED_VIA_CODE;
	            other.SHIPPED_VIA_DESC = this.SHIPPED_VIA_DESC;
	            other.PRODUCT_CLASS_CODE = this.PRODUCT_CLASS_CODE;
	...
	public void copyKeysDataTo(SHIP_VIAStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Ship_Via_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.SHIPPED_VIA_CODE = readString(dis);
					
					this.SHIPPED_VIA_DESC = readString(dis);
					
					this.PRODUCT_CLASS_CODE = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.SHIPPED_VIA_CODE,dos);
					
					// String
				
						writeString(this.SHIPPED_VIA_DESC,dos);
					
					// String
				
						writeString(this.PRODUCT_CLASS_CODE,dos);
    ...
    public String toString() {
		...
		sb.append(",SHIPPED_VIA_CODE="+SHIPPED_VIA_CODE);
		sb.append(",SHIPPED_VIA_DESC="+SHIPPED_VIA_DESC);
		sb.append(",PRODUCT_CLASS_CODE="+PRODUCT_CLASS_CODE);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(SHIPPED_VIA_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SHIPPED_VIA_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(SHIPPED_VIA_DESC == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SHIPPED_VIA_DESC);
            			}
     ...
     * Compare keys
     */
    public int compareTo(SHIP_VIAStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.SHIPPED_VIA_CODE, other.SHIPPED_VIA_CODE);
						if(returnValue != 0) {
							return returnValue;
						}
...
SHIP_VIAStruct SHIP_VIA = new SHIP_VIAStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"SHIP_VIA");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"SHIP_VIA\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("SHIP_VIA");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("SHIP_VIA");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"SHIPPED_VIA_CODE\",\"SHIPPED_VIA_DESC\",\"PRODUCT_CLASS_CODE\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"FERP_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_SHIP_VIA_tMap_1 = 0;
				
SHIP_VIAStruct SHIP_VIA_tmp = new SHIP_VIAStruct();
// ###############################
 ...
 */
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"REFERP\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    REFERP.REFCAT,    REFERP.REFKEY,    REFERP.REFDAT FROM REFERP WHERE REFERP.REFCAT='HA'\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PROPERTIES" + " = " + "context.SUS_Additional_Params");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("REFCAT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFKEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFDAT")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
	...
	final String decryptedPassword_tDBInput_1 = context.SUS_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  REFERP.REFCAT, \n  REFERP.REFKEY, \n  REFERP.REFDAT\nFROM REFERP WHERE REFERP.REFCAT='HA'";
...
row2.SHIPPED_VIA_CODE = row1.REFKEY;
row2.SHIPPED_VIA_DESC = row1.REFDAT.substring(0,10);
row2.PRODUCT_CLASS_CODE = row1.REFDAT.substring(10,14);
...
// # Output table : 'SHIP_VIA'
count_SHIP_VIA_tMap_1++;

SHIP_VIA_tmp.SITE_ID = row2.SITE_ID;
SHIP_VIA_tmp.SHIPPED_VIA_CODE = row2.SHIPPED_VIA_CODE.trim();
SHIP_VIA_tmp.SHIPPED_VIA_DESC = row2.SHIPPED_VIA_DESC.trim();
SHIP_VIA_tmp.PRODUCT_CLASS_CODE = row2.PRODUCT_CLASS_CODE.trim();
SHIP_VIA_tmp.IS_DELETED = row2.IS_DELETED;
SHIP_VIA_tmp.CREATED_ORIGIN = "SUS";
SHIP_VIA_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
SHIP_VIA_tmp.UPDATED_ORIGIN = "SUS";
SHIP_VIA_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
SHIP_VIA_tmp.FERP_SVOP = context.svop;
SHIP_VIA = SHIP_VIA_tmp;
log.debug("tMap_1 - Outputting the record " + count_SHIP_VIA_tMap_1 + " of the output table 'SHIP_VIA'.");
...
if(SHIP_VIA != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("SHIP_VIA - " + (SHIP_VIA==null? "": SHIP_VIA.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(SHIP_VIA.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, SHIP_VIA.SITE_ID);
}

                    if(SHIP_VIA.SHIPPED_VIA_CODE == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, SHIP_VIA.SHIPPED_VIA_CODE);
}

                    if(SHIP_VIA.SHIPPED_VIA_DESC == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, SHIP_VIA.SHIPPED_VIA_DESC);
}

                    if(SHIP_VIA.PRODUCT_CLASS_CODE == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, SHIP_VIA.PRODUCT_CLASS_CODE);
}

                    pstmt_tDBOutput_1.setBoolean(5, SHIP_VIA.IS_DELETED);

                    if(SHIP_VIA.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, SHIP_VIA.CREATED_ORIGIN);
}

                    if(SHIP_VIA.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(SHIP_VIA.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(SHIP_VIA.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, SHIP_VIA.UPDATED_ORIGIN);
}

                    if(SHIP_VIA.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(SHIP_VIA.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.TIMESTAMP);
}

                    if(SHIP_VIA.FERP_SVOP == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, SHIP_VIA.FERP_SVOP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'SHIP_VIA': " + count_SHIP_VIA_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"SHIP_VIA");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Ship_Via_Inbound Ship_Via_InboundClass = new Ship_Via_Inbound();

        int exitCode = Ship_Via_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Ship_Via_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Ship_Via_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Ship_Via_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/ship_via_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Ship_Via_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Ship_Via_Inbound");
        }
...
/************************************************************************************************
 *     267853 characters generated by Talend Open Studio for Data Integration 
