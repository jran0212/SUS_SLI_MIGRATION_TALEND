...
package sus_sli_etl.item_note_inbound_0_1;
...
/**
 * Job: Item_Note_Inbound Purpose: Migrating data from USIJC7PF to ITEM_NOTE<br>
 * Description: Migrating data from USIJC7PF to ITEM_NOTE <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Item_Note_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Item_Note_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Item_Note_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Item_Note_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_FOAqYAQLEe2Hm-5Lqgv_5w", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_FOAqYAQLEe2Hm-5Lqgv_5w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Item_Note_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Item_Note_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Note_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Note_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Item_Note_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Item_Note_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Item_Note_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Item_Note_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Item_Note_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Note_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Item_Note_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Note_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Note_Inbound) {
...
System.out.println("Starting the Migrating Data from USIJC7PF to ITEM_NOTE...........");
...
public static class ITEM_NOTEStruct implements routines.system.IPersistableRow<ITEM_NOTEStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Note_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Note_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String NOTE_SEQUENCE_NO;

				public String getNOTE_SEQUENCE_NO () {
					return this.NOTE_SEQUENCE_NO;
				}
			    ...
			    public String C7PF_SVOP;

				public String getC7PF_SVOP () {
					return this.C7PF_SVOP;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.NOTE_TYPE == null) ? 0 : this.NOTE_TYPE.hashCode());
					
						result = prime * result + ((this.NOTE_DATE == null) ? 0 : this.NOTE_DATE.hashCode());
					
						result = prime * result + ((this.NOTE_SEQUENCE_NO == null) ? 0 : this.NOTE_SEQUENCE_NO.hashCode());
					
						result = prime * result + ((this.NOTE_TIME == null) ? 0 : this.NOTE_TIME.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final ITEM_NOTEStruct other = (ITEM_NOTEStruct) obj;
						...
						} else if (!this.NOTE_TYPE.equals(other.NOTE_TYPE))
						...
						} else if (!this.NOTE_DATE.equals(other.NOTE_DATE))
						
							return false;
					
						if (this.NOTE_SEQUENCE_NO == null) {
							if (other.NOTE_SEQUENCE_NO != null)
								return false;
						
						} else if (!this.NOTE_SEQUENCE_NO.equals(other.NOTE_SEQUENCE_NO))
						
							return false;
					
						if (this.NOTE_TIME == null) {
							if (other.NOTE_TIME != null)
								return false;
						
						} else if (!this.NOTE_TIME.equals(other.NOTE_TIME))
	...
	public void copyDataTo(ITEM_NOTEStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.ITEM_NO = this.ITEM_NO;
	            other.NOTE_TYPE = this.NOTE_TYPE;
	            other.NOTE_DATE = this.NOTE_DATE;
	            other.NOTE_USER_ID = this.NOTE_USER_ID;
	            other.NOTE_TEXT = this.NOTE_TEXT;
	            other.NOTE_SEQUENCE_NO = this.NOTE_SEQUENCE_NO;
	            other.NOTE_TIME = this.NOTE_TIME;
	            ...
	            other.C7PF_SVOP = this.C7PF_SVOP;
	            
	}

	public void copyKeysDataTo(ITEM_NOTEStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Note_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.NOTE_DATE = readString(dis);
					
					this.NOTE_USER_ID = readString(dis);
					
					this.NOTE_TEXT = readString(dis);
					
					this.NOTE_SEQUENCE_NO = readString(dis);
					
					this.NOTE_TIME = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.NOTE_DATE,dos);
					
					// String
				
						writeString(this.NOTE_USER_ID,dos);
					
					// String
				
						writeString(this.NOTE_TEXT,dos);
					
					// String
				
						writeString(this.NOTE_SEQUENCE_NO,dos);
					
					// String
				
						writeString(this.NOTE_TIME,dos);
					...
					// String
						...
						writeString(this.C7PF_SVOP,dos);
    ...
    public String toString() {
		...
		sb.append(",NOTE_DATE="+NOTE_DATE);
		sb.append(",NOTE_USER_ID="+NOTE_USER_ID);
		sb.append(",NOTE_TEXT="+NOTE_TEXT);
		sb.append(",NOTE_SEQUENCE_NO="+NOTE_SEQUENCE_NO);
		sb.append(",NOTE_TIME="+NOTE_TIME);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(NOTE_USER_ID == null){
        					sb.append("<null>");
        				}else{
            				sb.append(NOTE_USER_ID);
            			}
        			...
        			sb.append("|");
        				...
        				if(NOTE_SEQUENCE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(NOTE_SEQUENCE_NO);
            			}
     ...
     * Compare keys
     */
    public int compareTo(ITEM_NOTEStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.NOTE_TYPE, other.NOTE_TYPE);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.NOTE_DATE, other.NOTE_DATE);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.NOTE_SEQUENCE_NO, other.NOTE_SEQUENCE_NO);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.NOTE_TIME, other.NOTE_TIME);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Note_Inbound = new byte[0];
			    ...
			    public String C7ITEM;

				public String getC7ITEM () {
					return this.C7ITEM;
				}
				
			    public String C7NOTY;

				public String getC7NOTY () {
					return this.C7NOTY;
				}
				
			    public String C7NODT;

				public String getC7NODT () {
					return this.C7NODT;
				}
				
			    public String C7NOID;

				public String getC7NOID () {
					return this.C7NOID;
				}
				
			    public String C7NOTX;

				public String getC7NOTX () {
					return this.C7NOTX;
				}
				
			    public String C7NOSQ;

				public String getC7NOSQ () {
					return this.C7NOSQ;
				}
				
			    public String C7NOTM;

				public String getC7NOTM () {
					return this.C7NOTM;
				}
				
			    public BigDecimal C7EADT;

				public BigDecimal getC7EADT () {
					return this.C7EADT;
				}
				
			    public BigDecimal C7EATM;

				public BigDecimal getC7EATM () {
					return this.C7EATM;
				}
				
			    public String C7EAID;

				public String getC7EAID () {
					return this.C7EAID;
				}
				
			    public BigDecimal C7MODT;

				public BigDecimal getC7MODT () {
					return this.C7MODT;
				}
				
			    public BigDecimal C7MOTM;

				public BigDecimal getC7MOTM () {
					return this.C7MOTM;
				}
				
			    public String C7MOID;

				public String getC7MOID () {
					return this.C7MOID;
				}
				
			    public String C7MOPG;

				public String getC7MOPG () {
					return this.C7MOPG;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Note_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.C7ITEM = readString(dis);
					
					this.C7NOTY = readString(dis);
					
					this.C7NODT = readString(dis);
					
					this.C7NOID = readString(dis);
					
					this.C7NOTX = readString(dis);
					
					this.C7NOSQ = readString(dis);
					
					this.C7NOTM = readString(dis);
					
						this.C7EADT = (BigDecimal) dis.readObject();
					
						this.C7EATM = (BigDecimal) dis.readObject();
					
					this.C7EAID = readString(dis);
					
						this.C7MODT = (BigDecimal) dis.readObject();
					
						this.C7MOTM = (BigDecimal) dis.readObject();
					
					this.C7MOID = readString(dis);
					
					this.C7MOPG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.C7ITEM,dos);
					
					// String
				
						writeString(this.C7NOTY,dos);
					
					// String
				
						writeString(this.C7NODT,dos);
					
					// String
				
						writeString(this.C7NOID,dos);
					
					// String
				
						writeString(this.C7NOTX,dos);
					
					// String
				
						writeString(this.C7NOSQ,dos);
					
					// String
				
						writeString(this.C7NOTM,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.C7EADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.C7EATM);
					
					// String
				
						writeString(this.C7EAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.C7MODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.C7MOTM);
					
					// String
				
						writeString(this.C7MOID,dos);
					
					// String
				
						writeString(this.C7MOPG,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("C7ITEM="+C7ITEM);
		sb.append(",C7NOTY="+C7NOTY);
		sb.append(",C7NODT="+C7NODT);
		sb.append(",C7NOID="+C7NOID);
		sb.append(",C7NOTX="+C7NOTX);
		sb.append(",C7NOSQ="+C7NOSQ);
		sb.append(",C7NOTM="+C7NOTM);
		sb.append(",C7EADT="+String.valueOf(C7EADT));
		sb.append(",C7EATM="+String.valueOf(C7EATM));
		sb.append(",C7EAID="+C7EAID);
		sb.append(",C7MODT="+String.valueOf(C7MODT));
		sb.append(",C7MOTM="+String.valueOf(C7MOTM));
		sb.append(",C7MOID="+C7MOID);
		sb.append(",C7MOPG="+C7MOPG);
	    sb.append("]");
...
ITEM_NOTEStruct ITEM_NOTE = new ITEM_NOTEStruct();
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ITEM_NOTE");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"ITEM_NOTE\"");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("ITEM_NOTE");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("ITEM_NOTE");
}
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"SITE_ID\",\"ITEM_NO\",\"NOTE_TYPE\",\"NOTE_DATE\",\"NOTE_USER_ID\",\"NOTE_TEXT\",\"NOTE_SEQUENCE_NO\",\"NOTE_TIME\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"UPDATED_PROGRAM_ID\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"C7PF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_ITEM_NOTE_tMap_1 = 0;
				
ITEM_NOTEStruct ITEM_NOTE_tmp = new ITEM_NOTEStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"USIJC7PF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    USIJC7PF.C7ITEM,    USIJC7PF.C7NOTY,    USIJC7PF.C7NODT,    USIJC7PF.C7NOID,    USIJC7PF.C7NOTX,    USIJC7PF.C7NOSQ,    USIJC7PF.C7NOTM,    USIJC7PF.C7EADT,    USIJC7PF.C7EATM,    USIJC7PF.C7EAID,    USIJC7PF.C7MODT,    USIJC7PF.C7MOTM,    USIJC7PF.C7MOID,    USIJC7PF.C7MOPG FROM USIJC7PF ORDER BY USIJC7PF.C7EADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PROPERTIES" + " = " + "context.SUS_Additional_Params");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("true")+", SCHEMA_COLUMN="+("C7ITEM")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7NOTY")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7NODT")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7NOID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("C7NOTX")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7NOSQ")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7NOTM")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7EADT")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7EATM")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7EAID")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7MODT")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7MOTM")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7MOID")+"}, {TRIM="+("true")+", SCHEMA_COLUMN="+("C7MOPG")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"C7NOSQ, \n  USIJC7PF.C7NOTM, \n  USIJC7PF.C7EADT, \n  USIJC7PF.C7EATM, \n  USIJC7PF.C7EAID, \n  USIJC7PF.C7MODT, \n  USIJC7PF."
+"C7MOTM, \n  USIJC7PF.C7MOID, \n  USIJC7PF.C7MOPG\nFROM USIJC7PF ORDER BY USIJC7PF.C7EADT DESC";
        	...
        	row1.C7ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.C7NOTY = null;
							} else {
	                         		
        	row1.C7NOTY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.C7NODT = null;
							} else {
	                         		
        	row1.C7NODT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.C7NOID = null;
							} else {
	                         		
        	row1.C7NOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.C7NOTX = null;
							} else {
	                         		
        	row1.C7NOTX = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.C7NOSQ = null;
							} else {
	                         		
        	row1.C7NOSQ = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.C7NOTM = null;
							} else {
	                         		
        	row1.C7NOTM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.C7EADT = null;
							} else {
		                          
            row1.C7EADT = rs_tDBInput_1.getBigDecimal(8);
            ...
            row1.C7EATM = rs_tDBInput_1.getBigDecimal(9);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.C7EAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.C7MODT = null;
							} else {
		                          
            row1.C7MODT = rs_tDBInput_1.getBigDecimal(11);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.C7MOTM = rs_tDBInput_1.getBigDecimal(12);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.C7MOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.C7MOPG = null;
							} else {
	                         		
        	row1.C7MOPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, true);
		                    }
...
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.C7EADT.toString(), row1.C7EATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.C7MODT.toString(), row1.C7MOTM.toString()) ;// ###############################
        // ###############################
        // # Output tables
...
// # Output table : 'ITEM_NOTE'
count_ITEM_NOTE_tMap_1++;

ITEM_NOTE_tmp.SITE_ID = context.opco;
ITEM_NOTE_tmp.ITEM_NO = row1.C7ITEM;
ITEM_NOTE_tmp.NOTE_TYPE = row1.C7NOTY;
ITEM_NOTE_tmp.NOTE_DATE = row1.C7NODT;
ITEM_NOTE_tmp.NOTE_USER_ID = row1.C7NOID;
ITEM_NOTE_tmp.NOTE_TEXT = row1.C7NOTX ;
ITEM_NOTE_tmp.NOTE_SEQUENCE_NO = row1.C7NOSQ;
ITEM_NOTE_tmp.NOTE_TIME = row1.C7NOTM;
ITEM_NOTE_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
ITEM_NOTE_tmp.CREATED_USER_ID = row1.C7EAID;
ITEM_NOTE_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
ITEM_NOTE_tmp.UPDATED_USER_ID = row1.C7MOID;
ITEM_NOTE_tmp.UPDATED_PROGRAM_ID = row1.C7MOPG;
ITEM_NOTE_tmp.IS_DELETED = false;
ITEM_NOTE_tmp.CREATED_ORIGIN = "SUS";
ITEM_NOTE_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_NOTE_tmp.UPDATED_ORIGIN = "SUS";
ITEM_NOTE_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_NOTE_tmp.C7PF_SVOP = context.svop;
ITEM_NOTE = ITEM_NOTE_tmp;
log.debug("tMap_1 - Outputting the record " + count_ITEM_NOTE_tMap_1 + " of the output table 'ITEM_NOTE'.");
...
if(ITEM_NOTE != null) { 
	...
	currentComponent="tDBOutput_2";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("ITEM_NOTE - " + (ITEM_NOTE==null? "": ITEM_NOTE.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_2 = false;
                    if(ITEM_NOTE.SITE_ID == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, ITEM_NOTE.SITE_ID);
}

                    if(ITEM_NOTE.ITEM_NO == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, ITEM_NOTE.ITEM_NO);
}

                    if(ITEM_NOTE.NOTE_TYPE == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, ITEM_NOTE.NOTE_TYPE);
}

                    if(ITEM_NOTE.NOTE_DATE == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, ITEM_NOTE.NOTE_DATE);
}

                    if(ITEM_NOTE.NOTE_USER_ID == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, ITEM_NOTE.NOTE_USER_ID);
}

                    if(ITEM_NOTE.NOTE_TEXT == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, ITEM_NOTE.NOTE_TEXT);
}

                    if(ITEM_NOTE.NOTE_SEQUENCE_NO == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, ITEM_NOTE.NOTE_SEQUENCE_NO);
}

                    if(ITEM_NOTE.NOTE_TIME == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, ITEM_NOTE.NOTE_TIME);
}

                    if(ITEM_NOTE.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_2.setTimestamp(9, new java.sql.Timestamp(ITEM_NOTE.CREATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_NOTE.CREATED_USER_ID == null) {
pstmt_tDBOutput_2.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(10, ITEM_NOTE.CREATED_USER_ID);
}

                    if(ITEM_NOTE.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_2.setTimestamp(11, new java.sql.Timestamp(ITEM_NOTE.UPDATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_2.setNull(11, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_NOTE.UPDATED_USER_ID == null) {
pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(12, ITEM_NOTE.UPDATED_USER_ID);
}

                    if(ITEM_NOTE.UPDATED_PROGRAM_ID == null) {
pstmt_tDBOutput_2.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(13, ITEM_NOTE.UPDATED_PROGRAM_ID);
}

                    pstmt_tDBOutput_2.setBoolean(14, ITEM_NOTE.IS_DELETED);

                    if(ITEM_NOTE.CREATED_ORIGIN == null) {
pstmt_tDBOutput_2.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(15, ITEM_NOTE.CREATED_ORIGIN);
}

                    if(ITEM_NOTE.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_2.setTimestamp(16, new java.sql.Timestamp(ITEM_NOTE.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_2.setNull(16, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_NOTE.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_2.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(17, ITEM_NOTE.UPDATED_ORIGIN);
}

                    if(ITEM_NOTE.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_2.setTimestamp(18, new java.sql.Timestamp(ITEM_NOTE.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_2.setNull(18, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_NOTE.C7PF_SVOP == null) {
pstmt_tDBOutput_2.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(19, ITEM_NOTE.C7PF_SVOP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'ITEM_NOTE': " + count_ITEM_NOTE_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
            ...
            log.debug("tDBOutput_2 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_2)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ITEM_NOTE");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Item_Note_Inbound Item_Note_InboundClass = new Item_Note_Inbound();

        int exitCode = Item_Note_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Item_Note_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Item_Note_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Item_Note_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/item_note_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Item_Note_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Item_Note_Inbound");
        }
...
/************************************************************************************************
 *     278731 characters generated by Talend Open Studio for Data Integration 
