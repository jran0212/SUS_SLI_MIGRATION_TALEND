...
package sus_sli_etl.entity_inbound_0_1;
...
/**
 * Job: Entity_Inbound Purpose: Migrating data from MSLIY5PF to Entity<br>
 * Description: Migrating data from MSLIY5PF to Entity <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Entity_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Entity_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Entity_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Entity_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_o6fdkANeEe2mdNKMHGUS9Q", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_o6fdkANeEe2mdNKMHGUS9Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Entity_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Entity_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Entity_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Entity_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Entity_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Entity_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Entity_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Entity_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Entity_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Entity_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Entity_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Entity_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Entity_Inbound) {
...
System.out.println("Starting the Migrating Data from MSLIY5PF to ENTITY...........");
...
public static class ENTITYStruct implements routines.system.IPersistableRow<ENTITYStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Entity_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Entity_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String ORGANIZATION_LEVEL_NAME;

				public String getORGANIZATION_LEVEL_NAME () {
					return this.ORGANIZATION_LEVEL_NAME;
				}
				
			    public String ORGANIZATION_LEVEL_PARENT;

				public String getORGANIZATION_LEVEL_PARENT () {
					return this.ORGANIZATION_LEVEL_PARENT;
				}
			    ...
			    public String Y5PF_SVOP;

				public String getY5PF_SVOP () {
					return this.Y5PF_SVOP;
				}
	...
	public boolean equals(Object obj) {
		...
		final ENTITYStruct other = (ENTITYStruct) obj;
	...
	public void copyDataTo(ENTITYStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.ENTITY_ID = this.ENTITY_ID;
	            other.ENTITY_PARENT = this.ENTITY_PARENT;
	            other.ENTITY_DESC = this.ENTITY_DESC;
	            other.ORGANIZATION_LEVEL_NAME = this.ORGANIZATION_LEVEL_NAME;
	            other.ORGANIZATION_LEVEL_PARENT = this.ORGANIZATION_LEVEL_PARENT;
	            other.MODEL_ID = this.MODEL_ID;
	            other.ORGANIZATION_NAME = this.ORGANIZATION_NAME;
	            other.STATUS = this.STATUS;
	            other.CHANGE_FLAG = this.CHANGE_FLAG;
	            ...
	            other.Y5PF_SVOP = this.Y5PF_SVOP;
	            
	}

	public void copyKeysDataTo(ENTITYStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Entity_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ENTITY_PARENT = readString(dis);
					
					this.ENTITY_DESC = readString(dis);
					
					this.ORGANIZATION_LEVEL_NAME = readString(dis);
					
					this.ORGANIZATION_LEVEL_PARENT = readString(dis);
					
					this.MODEL_ID = readString(dis);
					
					this.ORGANIZATION_NAME = readString(dis);
					
					this.STATUS = readString(dis);
					
					this.CHANGE_FLAG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.ENTITY_PARENT,dos);
					...
					// String
						...
						writeString(this.ORGANIZATION_LEVEL_NAME,dos);
					
					// String
				
						writeString(this.ORGANIZATION_LEVEL_PARENT,dos);
					
					// String
				
						writeString(this.MODEL_ID,dos);
					...
					// String
						...
						writeString(this.CHANGE_FLAG,dos);
					...
					// String
						...
						writeString(this.Y5PF_SVOP,dos);
    ...
    public String toString() {
		...
		sb.append(",ENTITY_PARENT="+ENTITY_PARENT);
		sb.append(",ENTITY_DESC="+ENTITY_DESC);
		sb.append(",ORGANIZATION_LEVEL_NAME="+ORGANIZATION_LEVEL_NAME);
		sb.append(",ORGANIZATION_LEVEL_PARENT="+ORGANIZATION_LEVEL_PARENT);
		sb.append(",MODEL_ID="+MODEL_ID);
		sb.append(",ORGANIZATION_NAME="+ORGANIZATION_NAME);
		sb.append(",STATUS="+STATUS);
		sb.append(",CHANGE_FLAG="+CHANGE_FLAG);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(ORGANIZATION_LEVEL_NAME == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORGANIZATION_LEVEL_NAME);
            			}
            		
        			sb.append("|");
        		
        				if(ORGANIZATION_LEVEL_PARENT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORGANIZATION_LEVEL_PARENT);
            			}
     ...
     * Compare keys
     */
    public int compareTo(ENTITYStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Entity_Inbound = new byte[0];
			    ...
			    public String Y5ENID;

				public String getY5ENID () {
					return this.Y5ENID;
				}
				
			    public String Y5ENPR;

				public String getY5ENPR () {
					return this.Y5ENPR;
				}
				
			    public String Y5ENDS;

				public String getY5ENDS () {
					return this.Y5ENDS;
				}
				
			    public String Y5ORLV;

				public String getY5ORLV () {
					return this.Y5ORLV;
				}
				
			    public String Y5ORPR;

				public String getY5ORPR () {
					return this.Y5ORPR;
				}
				
			    public String Y5MIDE;

				public String getY5MIDE () {
					return this.Y5MIDE;
				}
				
			    public String Y5ORNM;

				public String getY5ORNM () {
					return this.Y5ORNM;
				}
				
			    public String Y5STAS;

				public String getY5STAS () {
					return this.Y5STAS;
				}
				
			    public String Y5CHFL;

				public String getY5CHFL () {
					return this.Y5CHFL;
				}
				
			    public String Y5USER;

				public String getY5USER () {
					return this.Y5USER;
				}
				
			    public String Y5EMP;

				public String getY5EMP () {
					return this.Y5EMP;
				}
				
			    public String Y5LTUF;

				public String getY5LTUF () {
					return this.Y5LTUF;
				}
				
			    public String Y5NTRD;

				public String getY5NTRD () {
					return this.Y5NTRD;
				}
				
			    public BigDecimal Y5EADT;

				public BigDecimal getY5EADT () {
					return this.Y5EADT;
				}
				
			    public BigDecimal Y5EATM;

				public BigDecimal getY5EATM () {
					return this.Y5EATM;
				}
				
			    public String Y5EAID;

				public String getY5EAID () {
					return this.Y5EAID;
				}
				
			    public BigDecimal Y5MODT;

				public BigDecimal getY5MODT () {
					return this.Y5MODT;
				}
				
			    public BigDecimal Y5MOTM;

				public BigDecimal getY5MOTM () {
					return this.Y5MOTM;
				}
				
			    public String Y5MOID;

				public String getY5MOID () {
					return this.Y5MOID;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Entity_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Y5ENID = readString(dis);
					
					this.Y5ENPR = readString(dis);
					
					this.Y5ENDS = readString(dis);
					
					this.Y5ORLV = readString(dis);
					
					this.Y5ORPR = readString(dis);
					
					this.Y5MIDE = readString(dis);
					
					this.Y5ORNM = readString(dis);
					
					this.Y5STAS = readString(dis);
					
					this.Y5CHFL = readString(dis);
					
					this.Y5USER = readString(dis);
					
					this.Y5EMP = readString(dis);
					
					this.Y5LTUF = readString(dis);
					
					this.Y5NTRD = readString(dis);
					
						this.Y5EADT = (BigDecimal) dis.readObject();
					
						this.Y5EATM = (BigDecimal) dis.readObject();
					
					this.Y5EAID = readString(dis);
					
						this.Y5MODT = (BigDecimal) dis.readObject();
					
						this.Y5MOTM = (BigDecimal) dis.readObject();
					
					this.Y5MOID = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Y5ENID,dos);
					
					// String
				
						writeString(this.Y5ENPR,dos);
					
					// String
				
						writeString(this.Y5ENDS,dos);
					
					// String
				
						writeString(this.Y5ORLV,dos);
					
					// String
				
						writeString(this.Y5ORPR,dos);
					
					// String
				
						writeString(this.Y5MIDE,dos);
					
					// String
				
						writeString(this.Y5ORNM,dos);
					
					// String
				
						writeString(this.Y5STAS,dos);
					
					// String
				
						writeString(this.Y5CHFL,dos);
					
					// String
				
						writeString(this.Y5USER,dos);
					
					// String
				
						writeString(this.Y5EMP,dos);
					
					// String
				
						writeString(this.Y5LTUF,dos);
					
					// String
				
						writeString(this.Y5NTRD,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.Y5EADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.Y5EATM);
					
					// String
				
						writeString(this.Y5EAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.Y5MODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.Y5MOTM);
					
					// String
				
						writeString(this.Y5MOID,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("Y5ENID="+Y5ENID);
		sb.append(",Y5ENPR="+Y5ENPR);
		sb.append(",Y5ENDS="+Y5ENDS);
		sb.append(",Y5ORLV="+Y5ORLV);
		sb.append(",Y5ORPR="+Y5ORPR);
		sb.append(",Y5MIDE="+Y5MIDE);
		sb.append(",Y5ORNM="+Y5ORNM);
		sb.append(",Y5STAS="+Y5STAS);
		sb.append(",Y5CHFL="+Y5CHFL);
		sb.append(",Y5USER="+Y5USER);
		sb.append(",Y5EMP="+Y5EMP);
		sb.append(",Y5LTUF="+Y5LTUF);
		sb.append(",Y5NTRD="+Y5NTRD);
		sb.append(",Y5EADT="+String.valueOf(Y5EADT));
		sb.append(",Y5EATM="+String.valueOf(Y5EATM));
		sb.append(",Y5EAID="+Y5EAID);
		sb.append(",Y5MODT="+String.valueOf(Y5MODT));
		sb.append(",Y5MOTM="+String.valueOf(Y5MOTM));
		sb.append(",Y5MOID="+Y5MOID);
	    sb.append("]");
...
ENTITYStruct ENTITY = new ENTITYStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ENTITY");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"ENTITY\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ENTITY");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ENTITY");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ENTITY_ID\",\"ENTITY_PARENT\",\"ENTITY_DESC\",\"ORGANIZATION_LEVEL_NAME\",\"ORGANIZATION_LEVEL_PARENT\",\"MODEL_ID\",\"ORGANIZATION_NAME\",\"STATUS\",\"CHANGE_FLAG\",\"EMPLOYEE_NO\",\"LAPTOP_USER_FLAG\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"Y5PF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_ENTITY_tMap_1 = 0;
				
ENTITYStruct ENTITY_tmp = new ENTITYStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"MSLIY5PF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    MSLIY5PF.Y5ENID,    MSLIY5PF.Y5ENPR,    MSLIY5PF.Y5ENDS,    MSLIY5PF.Y5ORLV,    MSLIY5PF.Y5ORPR,    MSLIY5PF.Y5MIDE,    MSLIY5PF.Y5ORNM,    MSLIY5PF.Y5STAS,    MSLIY5PF.Y5CHFL,    MSLIY5PF.Y5USER,    MSLIY5PF.\\\"Y5EMP#\\\",    MSLIY5PF.Y5LTUF,    MSLIY5PF.Y5NTRD,    MSLIY5PF.Y5EADT,    MSLIY5PF.Y5EATM,    MSLIY5PF.Y5EAID,    MSLIY5PF.Y5MODT,    MSLIY5PF.Y5MOTM,    MSLIY5PF.Y5MOID FROM MSLIY5PF ORDER BY MSLIY5PF.Y5EADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"Y5MIDE, \n  MSLIY5PF.Y5ORNM, \n  MSLIY5PF.Y5STAS, \n  MSLIY5PF.Y5CHFL, \n  MSLIY5PF.Y5USER, \n  MSLIY5PF.\"Y5EMP#\", \n  MSLIY"
+"5PF.Y5LTUF, \n  MSLIY5PF.Y5NTRD, \n  MSLIY5PF.Y5EADT, \n  MSLIY5PF.Y5EATM, \n  MSLIY5PF.Y5EAID, \n  MSLIY5PF.Y5MODT, \n  MSLIY"
+"5PF.Y5MOTM, \n  MSLIY5PF.Y5MOID\nFROM MSLIY5PF ORDER BY MSLIY5PF.Y5EADT DESC";
        	...
        	row1.Y5ENID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.Y5ENPR = null;
							} else {
	                         		
        	row1.Y5ENPR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.Y5ENDS = null;
							} else {
	                         		
        	row1.Y5ENDS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.Y5ORLV = null;
							} else {
	                         		
        	row1.Y5ORLV = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.Y5ORPR = null;
							} else {
	                         		
        	row1.Y5ORPR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.Y5MIDE = null;
							} else {
	                         		
        	row1.Y5MIDE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.Y5ORNM = null;
							} else {
	                         		
        	row1.Y5ORNM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.Y5STAS = null;
							} else {
	                         		
        	row1.Y5STAS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.Y5CHFL = null;
							} else {
	                         		
        	row1.Y5CHFL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.Y5USER = null;
							} else {
	                         		
        	row1.Y5USER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.Y5EMP = null;
							} else {
	                         		
        	row1.Y5EMP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.Y5LTUF = null;
							} else {
	                         		
        	row1.Y5LTUF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.Y5NTRD = null;
							} else {
	                         		
        	row1.Y5NTRD = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.Y5EADT = null;
							} else {
		                          
            row1.Y5EADT = rs_tDBInput_1.getBigDecimal(14);
            ...
            row1.Y5EATM = rs_tDBInput_1.getBigDecimal(15);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.Y5EAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row1.Y5MODT = null;
							} else {
		                          
            row1.Y5MODT = rs_tDBInput_1.getBigDecimal(17);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.Y5MOTM = rs_tDBInput_1.getBigDecimal(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.Y5MOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, true);
		                    }
...
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.Y5EADT.toString(),row1.Y5EATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.Y5MODT.toString(),row1.Y5MOTM.toString()) ;// ###############################
        // ###############################
        // # Output tables
...
ENTITY_tmp.SITE_ID = context.opco;
ENTITY_tmp.ENTITY_ID = row1.Y5ENID ;
ENTITY_tmp.ENTITY_PARENT = row1.Y5ENPR ;
ENTITY_tmp.ENTITY_DESC = row1.Y5ENDS ;
ENTITY_tmp.ORGANIZATION_LEVEL_NAME = row1.Y5ORLV ;
ENTITY_tmp.ORGANIZATION_LEVEL_PARENT = row1.Y5ORPR ;
ENTITY_tmp.MODEL_ID = row1.Y5MIDE ;
ENTITY_tmp.ORGANIZATION_NAME = row1.Y5ORNM ;
ENTITY_tmp.STATUS = row1.Y5STAS ;
ENTITY_tmp.CHANGE_FLAG = row1.Y5CHFL ;
ENTITY_tmp.EMPLOYEE_NO = row1.Y5EMP ;
ENTITY_tmp.LAPTOP_USER_FLAG = row1.Y5LTUF ;
ENTITY_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
ENTITY_tmp.CREATED_USER_ID = row1.Y5EAID ;
ENTITY_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
ENTITY_tmp.UPDATED_USER_ID = row1.Y5MOID ;
ENTITY_tmp.IS_DELETED = false;
ENTITY_tmp.CREATED_ORIGIN = "SUS";
ENTITY_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ENTITY_tmp.UPDATED_ORIGIN = "SUS";
ENTITY_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ENTITY_tmp.Y5PF_SVOP = context.svop;
ENTITY = ENTITY_tmp;
log.debug("tMap_1 - Outputting the record " + count_ENTITY_tMap_1 + " of the output table 'ENTITY'.");
...
if(ENTITY != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("ENTITY - " + (ENTITY==null? "": ENTITY.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(ENTITY.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, ENTITY.SITE_ID);
}

                    if(ENTITY.ENTITY_ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ENTITY.ENTITY_ID);
}

                    if(ENTITY.ENTITY_PARENT == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, ENTITY.ENTITY_PARENT);
}

                    if(ENTITY.ENTITY_DESC == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, ENTITY.ENTITY_DESC);
}

                    if(ENTITY.ORGANIZATION_LEVEL_NAME == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, ENTITY.ORGANIZATION_LEVEL_NAME);
}

                    if(ENTITY.ORGANIZATION_LEVEL_PARENT == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, ENTITY.ORGANIZATION_LEVEL_PARENT);
}

                    if(ENTITY.MODEL_ID == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, ENTITY.MODEL_ID);
}

                    if(ENTITY.ORGANIZATION_NAME == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, ENTITY.ORGANIZATION_NAME);
}

                    if(ENTITY.STATUS == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, ENTITY.STATUS);
}

                    if(ENTITY.CHANGE_FLAG == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, ENTITY.CHANGE_FLAG);
}

                    if(ENTITY.EMPLOYEE_NO == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, ENTITY.EMPLOYEE_NO);
}

                    if(ENTITY.LAPTOP_USER_FLAG == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, ENTITY.LAPTOP_USER_FLAG);
}

                    if(ENTITY.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(13, new java.sql.Timestamp(ENTITY.CREATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.TIMESTAMP);
}

                    if(ENTITY.CREATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, ENTITY.CREATED_USER_ID);
}

                    if(ENTITY.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(15, new java.sql.Timestamp(ENTITY.UPDATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.TIMESTAMP);
}

                    if(ENTITY.UPDATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(16, ENTITY.UPDATED_USER_ID);
}

                    pstmt_tDBOutput_1.setBoolean(17, ENTITY.IS_DELETED);

                    if(ENTITY.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(18, ENTITY.CREATED_ORIGIN);
}

                    if(ENTITY.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(19, new java.sql.Timestamp(ENTITY.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(19, java.sql.Types.TIMESTAMP);
}

                    if(ENTITY.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(20, ENTITY.UPDATED_ORIGIN);
}

                    if(ENTITY.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(21, new java.sql.Timestamp(ENTITY.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(21, java.sql.Types.TIMESTAMP);
}

                    if(ENTITY.Y5PF_SVOP == null) {
pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(22, ENTITY.Y5PF_SVOP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'ENTITY': " + count_ENTITY_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ENTITY");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Entity_Inbound Entity_InboundClass = new Entity_Inbound();

        int exitCode = Entity_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Entity_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Entity_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Entity_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/entity_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Entity_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Entity_Inbound");
        }
...
/************************************************************************************************
 *     282375 characters generated by Talend Open Studio for Data Integration 
