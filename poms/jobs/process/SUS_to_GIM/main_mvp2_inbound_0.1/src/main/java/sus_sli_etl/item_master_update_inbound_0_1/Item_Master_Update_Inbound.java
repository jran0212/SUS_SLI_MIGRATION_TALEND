...
public static class ITEM_HEADERStruct implements routines.system.IPersistableRow<ITEM_HEADERStruct> {
    ...
    public String loopKey;
			    ...
			    public BigDecimal SUPC_CATEGORY;

				public BigDecimal getSUPC_CATEGORY () {
					return this.SUPC_CATEGORY;
				}
	...
	public void copyDataTo(ITEM_HEADERStruct other) {
		...
		other.ITEM_NO = this.ITEM_NO;
	            ...
	            other.UPDATED_USER_ID = this.UPDATED_USER_ID;
	            other.IS_ACTIVE = this.IS_ACTIVE;
	            other.SUPC_CATEGORY = this.SUPC_CATEGORY;
        	...
        	try {
        		...
        		int length = 0;
					...
					this.UPDATED_USER_ID = readString(dis);
						...
						this.SUPC_CATEGORY = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.SUPC_CATEGORY);
    ...
    public String toString() {
		...
		sb.append(",UPDATED_USER_ID="+UPDATED_USER_ID);
		sb.append(",IS_ACTIVE="+String.valueOf(IS_ACTIVE));
		sb.append(",SUPC_CATEGORY="+String.valueOf(SUPC_CATEGORY));
	    sb.append("]");
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(SUPC_CATEGORY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SUPC_CATEGORY);
            			}
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"PACK\" = ?,\"BRAND\" = ?,\"ITEM_DESC\" = ?,\"MFG_CODE\" = ?,\"ITEM_SIZE\" = ?,\"IS_DELETED\" = ?,\"CREATED_ORIGIN\" = ?,\"CREATED_ORIGIN_TIMESTAMP\" = ?,\"UPDATED_ORIGIN\" = ?,\"UPDATED_ORIGIN_TIMESTAMP\" = ?,\"JFPF_SVOP\" = ?,\"CREATED_TIMESTAMP\" = ?,\"UPDATED_TIMESTAMP\" = ?,\"UPDATED_USER_ID\" = ?,\"IS_ACTIVE\" = ?,\"SUPC_CATEGORY\" = ? WHERE \"ITEM_NO\" = ?";
	    ...
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"ITEM_NO\",\"PACK\",\"BRAND\",\"ITEM_DESC\",\"MFG_CODE\",\"ITEM_SIZE\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"JFPF_SVOP\",\"CREATED_TIMESTAMP\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"IS_ACTIVE\",\"SUPC_CATEGORY\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
ITEM_HEADER_tmp.SUPC_CATEGORY = row1.JFSUCA ;
...
pstmtUpdate_tDBOutput_2.setNull(15, java.sql.Types.BOOLEAN);
                    ...
                    pstmtUpdate_tDBOutput_2.setBigDecimal(16, ITEM_HEADER.SUPC_CATEGORY);


                    if(ITEM_HEADER.ITEM_NO == null) {
pstmtUpdate_tDBOutput_2.setNull(17 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(17 + count_tDBOutput_2, ITEM_HEADER.ITEM_NO);
}
...
pstmtInsert_tDBOutput_2.setNull(16, java.sql.Types.BOOLEAN);
                        ...
                        pstmtInsert_tDBOutput_2.setBigDecimal(17, ITEM_HEADER.SUPC_CATEGORY);
...
/************************************************************************************************
 *     723859 characters generated by Talend Open Studio for Data Integration 
