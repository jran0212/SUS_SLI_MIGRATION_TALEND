...
package sus_sli_etl.main_mvp2_inbound_0_1;
...
/**
 * Job: Main_MVP2_Inbound Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Main_MVP2_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Main_MVP2_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Main_MVP2_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Main_MVP2_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_NvciMFs6Ee2yKeBEegOJhQ", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_NvciMFs6Ee2yKeBEegOJhQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Main_MVP2_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Main_MVP2_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
                ...
                class BytesLimit65535_tRunJob_2{
                    ...
                    log4jParamters_tRunJob_2.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("PROCESS" + " = " + "Record_Count_Compare_SLI_MVP2");
                        log4jParamters_tRunJob_2.append(" | ");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
	        					...
	        					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(classpath_tRunJob_2_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "sus_sli_etl.record_count_compare_sli_mvp2_0_1.Record_Count_Compare_SLI_MVP2");
...
globalMap.put("tRunJob_2_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_2 = consoleHelper_tRunJob_2.getNormalThread(ps_tRunJob_2);
                log.info("tRunJob_2 - The child job 'Record_Count_Compare_SLI_MVP2' starts on the version '0.1' with the context 'PROD'.");
            normal_tRunJob_2.start();
                log.info("tRunJob_2 - The child job 'Record_Count_Compare_SLI_MVP2' is done.");
                ...
                class BytesLimit65535_tRunJob_3{
                    ...
                    log4jParamters_tRunJob_3.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("PROCESS" + " = " + "MVP2_Inbound");
                        log4jParamters_tRunJob_3.append(" | ");
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-Xmx16384M");
		      				
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-cp");
		      				
              					String classpath_tRunJob_3_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/crypto-utils-0.31.12.jar;mvp2_inbound_0_1.jar;vendor_inventory_inbound_0_1.jar;item_vendor_ship_from_inbound_0_1.jar;item_transaction_history_inbound1_0_1.jar;strategic_broker_inbound_0_1.jar;obligation_detail1_inbound_0_1.jar;obligation_detail_inbound_0_1.jar;item_note_inbound_0_1.jar;rdc_item_pay_to_vendor_update_inbound_0_1.jar;customer_inbound_0_1.jar;demand_history_inbound_0_1.jar;item_transaction_history_inbound_0_1.jar;user_inbound_0_1.jar;customer_ship_to_inbound_0_1.jar;entity_inbound_0_1.jar;item_master_update_inbound_0_1.jar;strategic_broker_item_inbound_0_1.jar;item_transaction_history_inbound2_0_1.jar;hazard_detail_inbound_0_1.jar;item_period_demand_inbound_0_1.jar;obligation_detail2_inbound_0_1.jar;buyer_inbound_0_1.jar;item_pay_to_vendor_inbound_0_1.jar;vendor_ship_from_inbound_0_1.jar;vendor_header_inbound_0_1.jar;vendor_detail_inbound_0_1.jar;critical_item_sus_inbound_0_1.jar;item_warehouse_param_inbound_0_1.jar;ship_via_inbound_0_1.jar;order_process_header_inbound_0_1.jar;order_process_detail_inbound_0_1.jar;broker_ship_from_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(classpath_tRunJob_3_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "sus_sli_etl.mvp2_inbound_0_1.MVP2_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-cp");
		      					...
		      					String classpath_tRunJob_3_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/mvp2_inbound_0_1.jar:$ROOT_PATH/vendor_inventory_inbound_0_1.jar:$ROOT_PATH/item_vendor_ship_from_inbound_0_1.jar:$ROOT_PATH/item_transaction_history_inbound1_0_1.jar:$ROOT_PATH/strategic_broker_inbound_0_1.jar:$ROOT_PATH/obligation_detail1_inbound_0_1.jar:$ROOT_PATH/obligation_detail_inbound_0_1.jar:$ROOT_PATH/item_note_inbound_0_1.jar:$ROOT_PATH/rdc_item_pay_to_vendor_update_inbound_0_1.jar:$ROOT_PATH/customer_inbound_0_1.jar:$ROOT_PATH/demand_history_inbound_0_1.jar:$ROOT_PATH/item_transaction_history_inbound_0_1.jar:$ROOT_PATH/user_inbound_0_1.jar:$ROOT_PATH/customer_ship_to_inbound_0_1.jar:$ROOT_PATH/entity_inbound_0_1.jar:$ROOT_PATH/item_master_update_inbound_0_1.jar:$ROOT_PATH/strategic_broker_item_inbound_0_1.jar:$ROOT_PATH/item_transaction_history_inbound2_0_1.jar:$ROOT_PATH/hazard_detail_inbound_0_1.jar:$ROOT_PATH/item_period_demand_inbound_0_1.jar:$ROOT_PATH/obligation_detail2_inbound_0_1.jar:$ROOT_PATH/buyer_inbound_0_1.jar:$ROOT_PATH/item_pay_to_vendor_inbound_0_1.jar:$ROOT_PATH/vendor_ship_from_inbound_0_1.jar:$ROOT_PATH/vendor_header_inbound_0_1.jar:$ROOT_PATH/vendor_detail_inbound_0_1.jar:$ROOT_PATH/critical_item_sus_inbound_0_1.jar:$ROOT_PATH/item_warehouse_param_inbound_0_1.jar:$ROOT_PATH/ship_via_inbound_0_1.jar:$ROOT_PATH/order_process_header_inbound_0_1.jar:$ROOT_PATH/order_process_detail_inbound_0_1.jar:$ROOT_PATH/broker_ship_from_0_1.jar:";
...
globalMap.put("tRunJob_3_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_3 = consoleHelper_tRunJob_3.getNormalThread(ps_tRunJob_3);
                log.info("tRunJob_3 - The child job 'MVP2_Inbound' starts on the version '0.1' with the context 'PROD'.");
            normal_tRunJob_3.start();
                log.info("tRunJob_3 - The child job 'MVP2_Inbound' is done.");
                ...
                class BytesLimit65535_tRunJob_1{
                    ...
                    log4jParamters_tRunJob_1.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_1.append(" | ");
                            log4jParamters_tRunJob_1.append("PROCESS" + " = " + "Record_Count_Compare_SLI_MVP2");
                        log4jParamters_tRunJob_1.append(" | ");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "sus_sli_etl.record_count_compare_sli_mvp2_0_1.Record_Count_Compare_SLI_MVP2");
...
globalMap.put("tRunJob_1_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_1 = consoleHelper_tRunJob_1.getNormalThread(ps_tRunJob_1);
                log.info("tRunJob_1 - The child job 'Record_Count_Compare_SLI_MVP2' starts on the version '0.1' with the context 'PROD'.");
            normal_tRunJob_1.start();
                log.info("tRunJob_1 - The child job 'Record_Count_Compare_SLI_MVP2' is done.");
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Main_MVP2_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Main_MVP2_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Main_MVP2_Inbound) {
 ...
 */
    ...
    public static void main(String[] args){
        final Main_MVP2_Inbound Main_MVP2_InboundClass = new Main_MVP2_Inbound();

        int exitCode = Main_MVP2_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Main_MVP2_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Main_MVP2_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Main_MVP2_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/main_mvp2_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Main_MVP2_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Main_MVP2_Inbound");
        }
...
/************************************************************************************************
 *     322172 characters generated by Talend Open Studio for Data Integration 
 *     on the November 30, 2022 at 10:08:30 AM IST
 ************************************************************************************************/