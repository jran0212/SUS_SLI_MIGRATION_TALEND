...
package sus_sli_etl.item_vendor_ship_from_inbound_0_1;
...
/**
 * Job: Item_Vendor_Ship_From_Inbound Purpose: Migrating data from USIUFMPF and IMVNFCRF to ITEM_VENDOR_SHIP_FROM<br>
 * Description: Migrating data from USIUFMPF and IMVNFCRF to ITEM_VENDOR_SHIP_FROM <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Item_Vendor_Ship_From_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Item_Vendor_Ship_From_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Item_Vendor_Ship_From_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Item_Vendor_Ship_From_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_pxzn8AvhEe2eScgMP1UCyw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_pxzn8AvhEe2eScgMP1UCyw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Item_Vendor_Ship_From_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Item_Vendor_Ship_From_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound) {
...
System.out.println("Starting the Migrating Data from USIUFMPF to ITEM_VENDOR_SHIP_FROM...........");
...
public static class ITEM_VENDOR_SHIP_FROMStruct implements routines.system.IPersistableRow<ITEM_VENDOR_SHIP_FROMStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String FMPF_SVOP;

				public String getFMPF_SVOP () {
					return this.FMPF_SVOP;
				}
	...
	public boolean equals(Object obj) {
		...
		final ITEM_VENDOR_SHIP_FROMStruct other = (ITEM_VENDOR_SHIP_FROMStruct) obj;
	...
	public void copyDataTo(ITEM_VENDOR_SHIP_FROMStruct other) {
		...
		other.SITE_ID = this.SITE_ID;
	            ...
	            other.FMPF_SVOP = this.FMPF_SVOP;
	            other.IS_ACTIVE = this.IS_ACTIVE;
	            
	}

	public void copyKeysDataTo(ITEM_VENDOR_SHIP_FROMStruct other) {
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.FMPF_SVOP,dos);
     ...
     * Compare keys
     */
    public int compareTo(ITEM_VENDOR_SHIP_FROMStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
			    ...
			    public String FMITEM;

				public String getFMITEM () {
					return this.FMITEM;
				}
				
			    public String FMVNBR;

				public String getFMVNBR () {
					return this.FMVNBR;
				}
				
			    public String FMITUS;

				public String getFMITUS () {
					return this.FMITUS;
				}
				
			    public BigDecimal FMVFRT;

				public BigDecimal getFMVFRT () {
					return this.FMVFRT;
				}
				
			    public String FMFRTP;

				public String getFMFRTP () {
					return this.FMFRTP;
				}
				
			    public BigDecimal FMLEAD;

				public BigDecimal getFMLEAD () {
					return this.FMLEAD;
				}
				
			    public String FMPALT;

				public String getFMPALT () {
					return this.FMPALT;
				}
				
			    public BigDecimal FMADCD;

				public BigDecimal getFMADCD () {
					return this.FMADCD;
				}
				
			    public BigDecimal FMITNW;

				public BigDecimal getFMITNW () {
					return this.FMITNW;
				}
				
			    public BigDecimal FMITTW;

				public BigDecimal getFMITTW () {
					return this.FMITTW;
				}
				
			    public BigDecimal FMITGW;

				public BigDecimal getFMITGW () {
					return this.FMITGW;
				}
				
			    public String FMTERM;

				public String getFMTERM () {
					return this.FMTERM;
				}
				
			    public BigDecimal FMCUBE;

				public BigDecimal getFMCUBE () {
					return this.FMCUBE;
				}
				
			    public BigDecimal FMVPUA;

				public BigDecimal getFMVPUA () {
					return this.FMVPUA;
				}
				
			    public BigDecimal FMMINI;

				public BigDecimal getFMMINI () {
					return this.FMMINI;
				}
				
			    public BigDecimal FMMAXI;

				public BigDecimal getFMMAXI () {
					return this.FMMAXI;
				}
				
			    public String FMMMTP;

				public String getFMMMTP () {
					return this.FMMMTP;
				}
				
			    public BigDecimal FMBMLT;

				public BigDecimal getFMBMLT () {
					return this.FMBMLT;
				}
				
			    public String FMBMTP;

				public String getFMBMTP () {
					return this.FMBMTP;
				}
				
			    public String FMIIMN;

				public String getFMIIMN () {
					return this.FMIIMN;
				}
				
			    public BigDecimal FMTIBU;

				public BigDecimal getFMTIBU () {
					return this.FMTIBU;
				}
				
			    public BigDecimal FMHIBU;

				public BigDecimal getFMHIBU () {
					return this.FMHIBU;
				}
				
			    public BigDecimal FMCPVU;

				public BigDecimal getFMCPVU () {
					return this.FMCPVU;
				}
				
			    public String FMBUYR;

				public String getFMBUYR () {
					return this.FMBUYR;
				}
				
			    public String FMPSFL;

				public String getFMPSFL () {
					return this.FMPSFL;
				}
				
			    public String FMMNPC;

				public String getFMMNPC () {
					return this.FMMNPC;
				}
				
			    public String FMCSCN;

				public String getFMCSCN () {
					return this.FMCSCN;
				}
				
			    public String FMITDS;

				public String getFMITDS () {
					return this.FMITDS;
				}
				
			    public String FMMUPC;

				public String getFMMUPC () {
					return this.FMMUPC;
				}
				
			    public String FMVCAT;

				public String getFMVCAT () {
					return this.FMVCAT;
				}
				
			    public String FMPUOM;

				public String getFMPUOM () {
					return this.FMPUOM;
				}
				
			    public String FMCPVF;

				public String getFMCPVF () {
					return this.FMCPVF;
				}
				
			    public String FMDSVF;

				public String getFMDSVF () {
					return this.FMDSVF;
				}
				
			    public BigDecimal FMIUPC;

				public BigDecimal getFMIUPC () {
					return this.FMIUPC;
				}
				
			    public BigDecimal FMEADT;

				public BigDecimal getFMEADT () {
					return this.FMEADT;
				}
				
			    public BigDecimal FMEATM;

				public BigDecimal getFMEATM () {
					return this.FMEATM;
				}
				
			    public String FMEAID;

				public String getFMEAID () {
					return this.FMEAID;
				}
				
			    public BigDecimal FMMODT;

				public BigDecimal getFMMODT () {
					return this.FMMODT;
				}
				
			    public BigDecimal FMMOTM;

				public BigDecimal getFMMOTM () {
					return this.FMMOTM;
				}
				
			    public String FMMOID;

				public String getFMMOID () {
					return this.FMMOID;
				}
				
			    public String FMMOPG;

				public String getFMMOPG () {
					return this.FMMOPG;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.FMITEM = readString(dis);
					
					this.FMVNBR = readString(dis);
					
					this.FMITUS = readString(dis);
					
						this.FMVFRT = (BigDecimal) dis.readObject();
					
					this.FMFRTP = readString(dis);
					
						this.FMLEAD = (BigDecimal) dis.readObject();
					
					this.FMPALT = readString(dis);
					
						this.FMADCD = (BigDecimal) dis.readObject();
					
						this.FMITNW = (BigDecimal) dis.readObject();
					
						this.FMITTW = (BigDecimal) dis.readObject();
					
						this.FMITGW = (BigDecimal) dis.readObject();
					
					this.FMTERM = readString(dis);
					
						this.FMCUBE = (BigDecimal) dis.readObject();
					
						this.FMVPUA = (BigDecimal) dis.readObject();
					
						this.FMMINI = (BigDecimal) dis.readObject();
					
						this.FMMAXI = (BigDecimal) dis.readObject();
					
					this.FMMMTP = readString(dis);
					
						this.FMBMLT = (BigDecimal) dis.readObject();
					
					this.FMBMTP = readString(dis);
					
					this.FMIIMN = readString(dis);
					
						this.FMTIBU = (BigDecimal) dis.readObject();
					
						this.FMHIBU = (BigDecimal) dis.readObject();
					
						this.FMCPVU = (BigDecimal) dis.readObject();
					
					this.FMBUYR = readString(dis);
					
					this.FMPSFL = readString(dis);
					
					this.FMMNPC = readString(dis);
					
					this.FMCSCN = readString(dis);
					
					this.FMITDS = readString(dis);
					
					this.FMMUPC = readString(dis);
					
					this.FMVCAT = readString(dis);
					
					this.FMPUOM = readString(dis);
					
					this.FMCPVF = readString(dis);
					
					this.FMDSVF = readString(dis);
					
						this.FMIUPC = (BigDecimal) dis.readObject();
					
						this.FMEADT = (BigDecimal) dis.readObject();
					
						this.FMEATM = (BigDecimal) dis.readObject();
					
					this.FMEAID = readString(dis);
					
						this.FMMODT = (BigDecimal) dis.readObject();
					
						this.FMMOTM = (BigDecimal) dis.readObject();
					
					this.FMMOID = readString(dis);
					
					this.FMMOPG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.FMITEM,dos);
					
					// String
				
						writeString(this.FMVNBR,dos);
					
					// String
				
						writeString(this.FMITUS,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMVFRT);
					
					// String
				
						writeString(this.FMFRTP,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMLEAD);
					
					// String
				
						writeString(this.FMPALT,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMADCD);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMITNW);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMITTW);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMITGW);
					
					// String
				
						writeString(this.FMTERM,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMCUBE);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMVPUA);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMMINI);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMMAXI);
					
					// String
				
						writeString(this.FMMMTP,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMBMLT);
					
					// String
				
						writeString(this.FMBMTP,dos);
					
					// String
				
						writeString(this.FMIIMN,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMTIBU);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMHIBU);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMCPVU);
					
					// String
				
						writeString(this.FMBUYR,dos);
					
					// String
				
						writeString(this.FMPSFL,dos);
					
					// String
				
						writeString(this.FMMNPC,dos);
					
					// String
				
						writeString(this.FMCSCN,dos);
					
					// String
				
						writeString(this.FMITDS,dos);
					
					// String
				
						writeString(this.FMMUPC,dos);
					
					// String
				
						writeString(this.FMVCAT,dos);
					
					// String
				
						writeString(this.FMPUOM,dos);
					
					// String
				
						writeString(this.FMCPVF,dos);
					
					// String
				
						writeString(this.FMDSVF,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMIUPC);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMEADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMEATM);
					
					// String
				
						writeString(this.FMEAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMMODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FMMOTM);
					
					// String
				
						writeString(this.FMMOID,dos);
					
					// String
				
						writeString(this.FMMOPG,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("FMITEM="+FMITEM);
		sb.append(",FMVNBR="+FMVNBR);
		sb.append(",FMITUS="+FMITUS);
		sb.append(",FMVFRT="+String.valueOf(FMVFRT));
		sb.append(",FMFRTP="+FMFRTP);
		sb.append(",FMLEAD="+String.valueOf(FMLEAD));
		sb.append(",FMPALT="+FMPALT);
		sb.append(",FMADCD="+String.valueOf(FMADCD));
		sb.append(",FMITNW="+String.valueOf(FMITNW));
		sb.append(",FMITTW="+String.valueOf(FMITTW));
		sb.append(",FMITGW="+String.valueOf(FMITGW));
		sb.append(",FMTERM="+FMTERM);
		sb.append(",FMCUBE="+String.valueOf(FMCUBE));
		sb.append(",FMVPUA="+String.valueOf(FMVPUA));
		sb.append(",FMMINI="+String.valueOf(FMMINI));
		sb.append(",FMMAXI="+String.valueOf(FMMAXI));
		sb.append(",FMMMTP="+FMMMTP);
		sb.append(",FMBMLT="+String.valueOf(FMBMLT));
		sb.append(",FMBMTP="+FMBMTP);
		sb.append(",FMIIMN="+FMIIMN);
		sb.append(",FMTIBU="+String.valueOf(FMTIBU));
		sb.append(",FMHIBU="+String.valueOf(FMHIBU));
		sb.append(",FMCPVU="+String.valueOf(FMCPVU));
		sb.append(",FMBUYR="+FMBUYR);
		sb.append(",FMPSFL="+FMPSFL);
		sb.append(",FMMNPC="+FMMNPC);
		sb.append(",FMCSCN="+FMCSCN);
		sb.append(",FMITDS="+FMITDS);
		sb.append(",FMMUPC="+FMMUPC);
		sb.append(",FMVCAT="+FMVCAT);
		sb.append(",FMPUOM="+FMPUOM);
		sb.append(",FMCPVF="+FMCPVF);
		sb.append(",FMDSVF="+FMDSVF);
		sb.append(",FMIUPC="+String.valueOf(FMIUPC));
		sb.append(",FMEADT="+String.valueOf(FMEADT));
		sb.append(",FMEATM="+String.valueOf(FMEATM));
		sb.append(",FMEAID="+FMEAID);
		sb.append(",FMMODT="+String.valueOf(FMMODT));
		sb.append(",FMMOTM="+String.valueOf(FMMOTM));
		sb.append(",FMMOID="+FMMOID);
		sb.append(",FMMOPG="+FMMOPG);
	    sb.append("]");
...
ITEM_VENDOR_SHIP_FROMStruct ITEM_VENDOR_SHIP_FROM = new ITEM_VENDOR_SHIP_FROMStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ITEM_VENDOR_SHIP_FROM");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"ITEM_VENDOR_SHIP_FROM\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ITEM_VENDOR_SHIP_FROM");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ITEM_VENDOR_SHIP_FROM");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"VENDOR_NO\",\"VENDOR_FREIGHT_RATE\",\"FREIGHT_RATE_TYPE_BASIS\",\"PICKUP_ALLOW_TYPE\",\"VENDOR_SUFFIX\",\"ITEM_GROSS_WEIGHT\",\"CUBE\",\"VENDOR_PICKUP_ALLOWANCE\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"FMPF_SVOP\",\"IS_ACTIVE\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_ITEM_VENDOR_SHIP_FROM_tMap_1 = 0;
				
ITEM_VENDOR_SHIP_FROMStruct ITEM_VENDOR_SHIP_FROM_tmp = new ITEM_VENDOR_SHIP_FROMStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"USIUFMPF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    USIUFMPF.FMITEM,    USIUFMPF.FMVNBR,    USIUFMPF.FMITUS,    USIUFMPF.FMVFRT,    USIUFMPF.FMFRTP,    USIUFMPF.FMLEAD,    USIUFMPF.FMPALT,    USIUFMPF.FMADCD,    USIUFMPF.FMITNW,    USIUFMPF.FMITTW,    USIUFMPF.FMITGW,    USIUFMPF.FMTERM,    USIUFMPF.FMCUBE,    USIUFMPF.FMVPUA,    USIUFMPF.FMMINI,    USIUFMPF.FMMAXI,    USIUFMPF.FMMMTP,    USIUFMPF.FMBMLT,    USIUFMPF.FMBMTP,    USIUFMPF.FMIIMN,    USIUFMPF.FMTIBU,    USIUFMPF.FMHIBU,    USIUFMPF.FMCPVU,    USIUFMPF.FMBUYR,    USIUFMPF.FMPSFL,    USIUFMPF.FMMNPC,    USIUFMPF.FMCSCN,    USIUFMPF.FMITDS,    USIUFMPF.FMMUPC,    USIUFMPF.FMVCAT,    USIUFMPF.FMPUOM,    USIUFMPF.FMCPVF,    USIUFMPF.FMDSVF,    USIUFMPF.FMIUPC,    USIUFMPF.FMEADT,    USIUFMPF.FMEATM,    USIUFMPF.FMEAID,    USIUFMPF.FMMODT,    USIUFMPF.FMMOTM,    USIUFMPF.FMMOID,    USIUFMPF.FMMOPG FROM USIUFMPF ORDER BY USIUFMPF.FMEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+" ORDER BY USIUFMPF.FMEADT DESC";
        	...
        	row1.FMITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.FMVNBR = null;
							} else {
	                         		
        	row1.FMVNBR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.FMITUS = null;
							} else {
	                         		
        	row1.FMITUS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.FMVFRT = null;
							} else {
		                          
            row1.FMVFRT = rs_tDBInput_1.getBigDecimal(4);
        	...
        	row1.FMFRTP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.FMLEAD = null;
							} else {
		                          
            row1.FMLEAD = rs_tDBInput_1.getBigDecimal(6);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.FMPALT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.FMADCD = null;
							} else {
		                          
            row1.FMADCD = rs_tDBInput_1.getBigDecimal(8);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMITNW = rs_tDBInput_1.getBigDecimal(9);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMITTW = rs_tDBInput_1.getBigDecimal(10);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMITGW = rs_tDBInput_1.getBigDecimal(11);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.FMTERM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.FMCUBE = null;
							} else {
		                          
            row1.FMCUBE = rs_tDBInput_1.getBigDecimal(13);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMVPUA = rs_tDBInput_1.getBigDecimal(14);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMMINI = rs_tDBInput_1.getBigDecimal(15);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMMAXI = rs_tDBInput_1.getBigDecimal(16);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.FMMMTP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row1.FMBMLT = null;
							} else {
		                          
            row1.FMBMLT = rs_tDBInput_1.getBigDecimal(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.FMBMTP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row1.FMIIMN = null;
							} else {
	                         		
        	row1.FMIIMN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.FMTIBU = null;
							} else {
		                          
            row1.FMTIBU = rs_tDBInput_1.getBigDecimal(21);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMHIBU = rs_tDBInput_1.getBigDecimal(22);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMCPVU = rs_tDBInput_1.getBigDecimal(23);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.FMBUYR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 25) {
								row1.FMPSFL = null;
							} else {
	                         		
        	row1.FMPSFL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 26) {
								row1.FMMNPC = null;
							} else {
	                         		
        	row1.FMMNPC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 26, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 27) {
								row1.FMCSCN = null;
							} else {
	                         		
        	row1.FMCSCN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 27, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 28) {
								row1.FMITDS = null;
							} else {
	                         		
        	row1.FMITDS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 28, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 29) {
								row1.FMMUPC = null;
							} else {
	                         		
        	row1.FMMUPC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 29, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 30) {
								row1.FMVCAT = null;
							} else {
	                         		
        	row1.FMVCAT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 30, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 31) {
								row1.FMPUOM = null;
							} else {
	                         		
        	row1.FMPUOM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 32) {
								row1.FMCPVF = null;
							} else {
	                         		
        	row1.FMCPVF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 32, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 33) {
								row1.FMDSVF = null;
							} else {
	                         		
        	row1.FMDSVF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 33, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 34) {
								row1.FMIUPC = null;
							} else {
		                          
            row1.FMIUPC = rs_tDBInput_1.getBigDecimal(34);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMEADT = rs_tDBInput_1.getBigDecimal(35);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMEATM = rs_tDBInput_1.getBigDecimal(36);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.FMEAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 37, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 38) {
								row1.FMMODT = null;
							} else {
		                          
            row1.FMMODT = rs_tDBInput_1.getBigDecimal(38);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.FMMOTM = rs_tDBInput_1.getBigDecimal(39);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.FMMOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 40, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 41) {
								row1.FMMOPG = null;
							} else {
	                         		
        	row1.FMMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 41, true);
		                    }
...
Var.FMITEM = CharSetHandling.convertEBCDICStrToASCII(row1.FMITEM) ;
Var.FMVNBR = CharSetHandling.convertEBCDICStrToASCII(row1.FMVNBR) ;
Var.FMFRTP = CharSetHandling.convertEBCDICStrToASCII(row1.FMFRTP) ;
Var.FMPALT = CharSetHandling.convertEBCDICStrToASCII(row1.FMPALT) ;// ###############################
        // ###############################
        // # Output tables

ITEM_VENDOR_SHIP_FROM = null;


// # Output table : 'ITEM_VENDOR_SHIP_FROM'
count_ITEM_VENDOR_SHIP_FROM_tMap_1++;

ITEM_VENDOR_SHIP_FROM_tmp.SITE_ID = context.opco;
ITEM_VENDOR_SHIP_FROM_tmp.ITEM_NO = Var.FMITEM;
ITEM_VENDOR_SHIP_FROM_tmp.VENDOR_NO = Var.FMVNBR ;
ITEM_VENDOR_SHIP_FROM_tmp.VENDOR_FREIGHT_RATE = row1.FMVFRT ;
ITEM_VENDOR_SHIP_FROM_tmp.FREIGHT_RATE_TYPE_BASIS = Var.FMFRTP;
ITEM_VENDOR_SHIP_FROM_tmp.PICKUP_ALLOW_TYPE = Var.FMPALT;
ITEM_VENDOR_SHIP_FROM_tmp.VENDOR_SUFFIX = row1.FMADCD;
ITEM_VENDOR_SHIP_FROM_tmp.ITEM_GROSS_WEIGHT = row1.FMITGW;
ITEM_VENDOR_SHIP_FROM_tmp.CUBE = row1.FMCUBE;
ITEM_VENDOR_SHIP_FROM_tmp.VENDOR_PICKUP_ALLOWANCE = row1.FMVPUA;
ITEM_VENDOR_SHIP_FROM_tmp.IS_DELETED = false;
ITEM_VENDOR_SHIP_FROM_tmp.CREATED_ORIGIN = "SUS";
ITEM_VENDOR_SHIP_FROM_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_VENDOR_SHIP_FROM_tmp.UPDATED_ORIGIN = "SUS";
ITEM_VENDOR_SHIP_FROM_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_VENDOR_SHIP_FROM_tmp.FMPF_SVOP = context.svop;
ITEM_VENDOR_SHIP_FROM_tmp.IS_ACTIVE = true;
ITEM_VENDOR_SHIP_FROM = ITEM_VENDOR_SHIP_FROM_tmp;
log.debug("tMap_1 - Outputting the record " + count_ITEM_VENDOR_SHIP_FROM_tMap_1 + " of the output table 'ITEM_VENDOR_SHIP_FROM'.");
 ...
 */
// Start of branch "ITEM_VENDOR_SHIP_FROM"
if(ITEM_VENDOR_SHIP_FROM != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1
							...
							,"ITEM_VENDOR_SHIP_FROM"
						
						);
					}
					
    			if(log.isTraceEnabled()){
    				log.trace("ITEM_VENDOR_SHIP_FROM - " + (ITEM_VENDOR_SHIP_FROM==null? "": ITEM_VENDOR_SHIP_FROM.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(ITEM_VENDOR_SHIP_FROM.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, ITEM_VENDOR_SHIP_FROM.SITE_ID);
}

                    if(ITEM_VENDOR_SHIP_FROM.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ITEM_VENDOR_SHIP_FROM.ITEM_NO);
}

                    if(ITEM_VENDOR_SHIP_FROM.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, ITEM_VENDOR_SHIP_FROM.VENDOR_NO);
}

                    pstmt_tDBOutput_1.setBigDecimal(4, ITEM_VENDOR_SHIP_FROM.VENDOR_FREIGHT_RATE);

                    if(ITEM_VENDOR_SHIP_FROM.FREIGHT_RATE_TYPE_BASIS == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, ITEM_VENDOR_SHIP_FROM.FREIGHT_RATE_TYPE_BASIS);
}

                    if(ITEM_VENDOR_SHIP_FROM.PICKUP_ALLOW_TYPE == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, ITEM_VENDOR_SHIP_FROM.PICKUP_ALLOW_TYPE);
}

                    pstmt_tDBOutput_1.setBigDecimal(7, ITEM_VENDOR_SHIP_FROM.VENDOR_SUFFIX);

                    pstmt_tDBOutput_1.setBigDecimal(8, ITEM_VENDOR_SHIP_FROM.ITEM_GROSS_WEIGHT);

                    pstmt_tDBOutput_1.setBigDecimal(9, ITEM_VENDOR_SHIP_FROM.CUBE);

                    pstmt_tDBOutput_1.setBigDecimal(10, ITEM_VENDOR_SHIP_FROM.VENDOR_PICKUP_ALLOWANCE);

                    pstmt_tDBOutput_1.setBoolean(11, ITEM_VENDOR_SHIP_FROM.IS_DELETED);

                    if(ITEM_VENDOR_SHIP_FROM.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, ITEM_VENDOR_SHIP_FROM.CREATED_ORIGIN);
}

                    if(ITEM_VENDOR_SHIP_FROM.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(13, new java.sql.Timestamp(ITEM_VENDOR_SHIP_FROM.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_VENDOR_SHIP_FROM.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, ITEM_VENDOR_SHIP_FROM.UPDATED_ORIGIN);
}

                    if(ITEM_VENDOR_SHIP_FROM.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(15, new java.sql.Timestamp(ITEM_VENDOR_SHIP_FROM.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_VENDOR_SHIP_FROM.FMPF_SVOP == null) {
pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(16, ITEM_VENDOR_SHIP_FROM.FMPF_SVOP);
}

                    if(ITEM_VENDOR_SHIP_FROM.IS_ACTIVE == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_1.setBoolean(17, ITEM_VENDOR_SHIP_FROM.IS_ACTIVE);
}
...
} // End of branch "ITEM_VENDOR_SHIP_FROM"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'ITEM_VENDOR_SHIP_FROM': " + count_ITEM_VENDOR_SHIP_FROM_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ITEM_VENDOR_SHIP_FROM");
			  	}
...
System.out.println("Starting the Updating Data from IMVNFCRF to ITEM_VENDOR_SHIP_FROM...........");
System.out.println("Target OpCO No    : " + context.opco);
System.out.println("Source OpCO No    : " + context.sopco);
System.out.println("Migration SVOP    : " + context.svop);
System.out.println("DateTime          : " + java.time.LocalDate.now());  
...
public static class ITEM_VENDOR_SHIP_FROM_UPDATEStruct implements routines.system.IPersistableRow<ITEM_VENDOR_SHIP_FROM_UPDATEStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
    ...
    public String loopKey;
			    ...
			    public String FCRF_SVOP;

				public String getFCRF_SVOP () {
					return this.FCRF_SVOP;
				}
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ITEM_VENDOR_SHIP_FROM_UPDATEStruct other = (ITEM_VENDOR_SHIP_FROM_UPDATEStruct) obj;
	...
	public void copyDataTo(ITEM_VENDOR_SHIP_FROM_UPDATEStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.ITEM_NO = this.ITEM_NO;
	            other.VENDOR_NO = this.VENDOR_NO;
	            other.VENDOR_SUFFIX = this.VENDOR_SUFFIX;
	            other.DETAIL_FLAG = this.DETAIL_FLAG;
	            other.FCRF_SVOP = this.FCRF_SVOP;
	            
	}

	public void copyKeysDataTo(ITEM_VENDOR_SHIP_FROM_UPDATEStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DETAIL_FLAG = readString(dis);
					
					this.FCRF_SVOP = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DETAIL_FLAG,dos);
					
					// String
				
						writeString(this.FCRF_SVOP,dos);
    ...
    public String toString() {
		...
		sb.append(",VENDOR_NO="+VENDOR_NO);
		sb.append(",VENDOR_SUFFIX="+String.valueOf(VENDOR_SUFFIX));
		sb.append(",DETAIL_FLAG="+DETAIL_FLAG);
		sb.append(",FCRF_SVOP="+FCRF_SVOP);
	    sb.append("]");
     ...
     * Compare keys
     */
    public int compareTo(ITEM_VENDOR_SHIP_FROM_UPDATEStruct other) {
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
			    ...
			    public String FCPVND;

				public String getFCPVND () {
					return this.FCPVND;
				}
				
			    public BigDecimal FCADCD;

				public BigDecimal getFCADCD () {
					return this.FCADCD;
				}
				
			    public String FCISDF;

				public String getFCISDF () {
					return this.FCISDF;
				}
				
			    public String FCITEM;

				public String getFCITEM () {
					return this.FCITEM;
				}
				
			    public String FCFU01;

				public String getFCFU01 () {
					return this.FCFU01;
				}
				
			    public String FCFU02;

				public String getFCFU02 () {
					return this.FCFU02;
				}
				
			    public String FCFU03;

				public String getFCFU03 () {
					return this.FCFU03;
				}
				
			    public String FCFU04;

				public String getFCFU04 () {
					return this.FCFU04;
				}
				
			    public BigDecimal FCFUN1;

				public BigDecimal getFCFUN1 () {
					return this.FCFUN1;
				}
				
			    public BigDecimal FCFUN2;

				public BigDecimal getFCFUN2 () {
					return this.FCFUN2;
				}
				
			    public BigDecimal FCFUN3;

				public BigDecimal getFCFUN3 () {
					return this.FCFUN3;
				}
				
			    public BigDecimal FCABP1;

				public BigDecimal getFCABP1 () {
					return this.FCABP1;
				}
				
			    public BigDecimal FCABP2;

				public BigDecimal getFCABP2 () {
					return this.FCABP2;
				}
				
			    public String FCFUF1;

				public String getFCFUF1 () {
					return this.FCFUF1;
				}
				
			    public String FCFUF2;

				public String getFCFUF2 () {
					return this.FCFUF2;
				}
				
			    public String FCFUF3;

				public String getFCFUF3 () {
					return this.FCFUF3;
				}
				
			    public BigDecimal FCEADT;

				public BigDecimal getFCEADT () {
					return this.FCEADT;
				}
				
			    public BigDecimal FCEATM;

				public BigDecimal getFCEATM () {
					return this.FCEATM;
				}
				
			    public String FCEAID;

				public String getFCEAID () {
					return this.FCEAID;
				}
				
			    public String FCEAPG;

				public String getFCEAPG () {
					return this.FCEAPG;
				}
				
			    public BigDecimal FCMODT;

				public BigDecimal getFCMODT () {
					return this.FCMODT;
				}
				
			    public BigDecimal FCMOTM;

				public BigDecimal getFCMOTM () {
					return this.FCMOTM;
				}
				
			    public String FCMOID;

				public String getFCMOID () {
					return this.FCMOID;
				}
				
			    public String FCMOPG;

				public String getFCMOPG () {
					return this.FCMOPG;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.FCPVND = readString(dis);
					
						this.FCADCD = (BigDecimal) dis.readObject();
					
					this.FCISDF = readString(dis);
					
					this.FCITEM = readString(dis);
					
					this.FCFU01 = readString(dis);
					
					this.FCFU02 = readString(dis);
					
					this.FCFU03 = readString(dis);
					
					this.FCFU04 = readString(dis);
					
						this.FCFUN1 = (BigDecimal) dis.readObject();
					
						this.FCFUN2 = (BigDecimal) dis.readObject();
					
						this.FCFUN3 = (BigDecimal) dis.readObject();
					
						this.FCABP1 = (BigDecimal) dis.readObject();
					
						this.FCABP2 = (BigDecimal) dis.readObject();
					
					this.FCFUF1 = readString(dis);
					
					this.FCFUF2 = readString(dis);
					
					this.FCFUF3 = readString(dis);
					
						this.FCEADT = (BigDecimal) dis.readObject();
					
						this.FCEATM = (BigDecimal) dis.readObject();
					
					this.FCEAID = readString(dis);
					
					this.FCEAPG = readString(dis);
					
						this.FCMODT = (BigDecimal) dis.readObject();
					
						this.FCMOTM = (BigDecimal) dis.readObject();
					
					this.FCMOID = readString(dis);
					
					this.FCMOPG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.FCPVND,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCADCD);
					
					// String
				
						writeString(this.FCISDF,dos);
					
					// String
				
						writeString(this.FCITEM,dos);
					
					// String
				
						writeString(this.FCFU01,dos);
					
					// String
				
						writeString(this.FCFU02,dos);
					
					// String
				
						writeString(this.FCFU03,dos);
					
					// String
				
						writeString(this.FCFU04,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCFUN1);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCFUN2);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCFUN3);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCABP1);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCABP2);
					
					// String
				
						writeString(this.FCFUF1,dos);
					
					// String
				
						writeString(this.FCFUF2,dos);
					
					// String
				
						writeString(this.FCFUF3,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCEADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCEATM);
					
					// String
				
						writeString(this.FCEAID,dos);
					
					// String
				
						writeString(this.FCEAPG,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCMODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.FCMOTM);
					
					// String
				
						writeString(this.FCMOID,dos);
					
					// String
				
						writeString(this.FCMOPG,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("FCPVND="+FCPVND);
		sb.append(",FCADCD="+String.valueOf(FCADCD));
		sb.append(",FCISDF="+FCISDF);
		sb.append(",FCITEM="+FCITEM);
		sb.append(",FCFU01="+FCFU01);
		sb.append(",FCFU02="+FCFU02);
		sb.append(",FCFU03="+FCFU03);
		sb.append(",FCFU04="+FCFU04);
		sb.append(",FCFUN1="+String.valueOf(FCFUN1));
		sb.append(",FCFUN2="+String.valueOf(FCFUN2));
		sb.append(",FCFUN3="+String.valueOf(FCFUN3));
		sb.append(",FCABP1="+String.valueOf(FCABP1));
		sb.append(",FCABP2="+String.valueOf(FCABP2));
		sb.append(",FCFUF1="+FCFUF1);
		sb.append(",FCFUF2="+FCFUF2);
		sb.append(",FCFUF3="+FCFUF3);
		sb.append(",FCEADT="+String.valueOf(FCEADT));
		sb.append(",FCEATM="+String.valueOf(FCEATM));
		sb.append(",FCEAID="+FCEAID);
		sb.append(",FCEAPG="+FCEAPG);
		sb.append(",FCMODT="+String.valueOf(FCMODT));
		sb.append(",FCMOTM="+String.valueOf(FCMOTM));
		sb.append(",FCMOID="+FCMOID);
		sb.append(",FCMOPG="+FCMOPG);
	    sb.append("]");
...
ITEM_VENDOR_SHIP_FROM_UPDATEStruct ITEM_VENDOR_SHIP_FROM_UPDATE = new ITEM_VENDOR_SHIP_FROM_UPDATEStruct();
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ITEM_VENDOR_SHIP_FROM_UPDATE");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"ITEM_VENDOR_SHIP_FROM\"");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("ITEM_VENDOR_SHIP_FROM");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("ITEM_VENDOR_SHIP_FROM");
}
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"DETAIL_FLAG\" = ?,\"FCRF_SVOP\" = ? WHERE \"SITE_ID\" = ? AND \"ITEM_NO\" = ? AND \"VENDOR_NO\" = ? AND \"VENDOR_SUFFIX\" = ?";
...
// ###############################
// # Outputs initialization
				int count_ITEM_VENDOR_SHIP_FROM_UPDATE_tMap_5 = 0;
				
ITEM_VENDOR_SHIP_FROM_UPDATEStruct ITEM_VENDOR_SHIP_FROM_UPDATE_tmp = new ITEM_VENDOR_SHIP_FROM_UPDATEStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"IMVNFCRF\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    IMVNFCRF.FCPVND,    IMVNFCRF.FCADCD,    IMVNFCRF.FCISDF,    IMVNFCRF.FCITEM,    IMVNFCRF.FCFU01,    IMVNFCRF.FCFU02,    IMVNFCRF.FCFU03,    IMVNFCRF.FCFU04,    IMVNFCRF.FCFUN1,    IMVNFCRF.FCFUN2,    IMVNFCRF.FCFUN3,    IMVNFCRF.FCABP1,    IMVNFCRF.FCABP2,    IMVNFCRF.FCFUF1,    IMVNFCRF.FCFUF2,    IMVNFCRF.FCFUF3,    IMVNFCRF.FCEADT,    IMVNFCRF.FCEATM,    IMVNFCRF.FCEAID,    IMVNFCRF.FCEAPG,    IMVNFCRF.FCMODT,    IMVNFCRF.FCMOTM,    IMVNFCRF.FCMOID,    IMVNFCRF.FCMOPG FROM IMVNFCRF ORDER BY IMVNFCRF.FCEADT DESC\"");
                        log4jParamters_tDBInput_2.append(" | ");
...
+"FCABP1, \n  IMVNFCRF.FCABP2, \n  IMVNFCRF.FCFUF1, \n  IMVNFCRF.FCFUF2, \n  IMVNFCRF.FCFUF3, \n  IMVNFCRF.FCEADT, \n  IMVNFCRF."
+"FCEATM, \n  IMVNFCRF.FCEAID, \n  IMVNFCRF.FCEAPG, \n  IMVNFCRF.FCMODT, \n  IMVNFCRF.FCMOTM, \n  IMVNFCRF.FCMOID, \n  IMVNFCRF."
+"FCMOPG\nFROM IMVNFCRF ORDER BY IMVNFCRF.FCEADT DESC";
        	...
        	row2.FCPVND = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row2.FCADCD = null;
							} else {
		                          
            row2.FCADCD = rs_tDBInput_2.getBigDecimal(2);
        	...
        	row2.FCISDF = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row2.FCITEM = null;
							} else {
	                         		
        	row2.FCITEM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row2.FCFU01 = null;
							} else {
	                         		
        	row2.FCFU01 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row2.FCFU02 = null;
							} else {
	                         		
        	row2.FCFU02 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 7) {
								row2.FCFU03 = null;
							} else {
	                         		
        	row2.FCFU03 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 8) {
								row2.FCFU04 = null;
							} else {
	                         		
        	row2.FCFU04 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 8, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 9) {
								row2.FCFUN1 = null;
							} else {
		                          
            row2.FCFUN1 = rs_tDBInput_2.getBigDecimal(9);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.FCFUN2 = rs_tDBInput_2.getBigDecimal(10);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.FCFUN3 = rs_tDBInput_2.getBigDecimal(11);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.FCABP1 = rs_tDBInput_2.getBigDecimal(12);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.FCABP2 = rs_tDBInput_2.getBigDecimal(13);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.FCFUF1 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 14, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 15) {
								row2.FCFUF2 = null;
							} else {
	                         		
        	row2.FCFUF2 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 15, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 16) {
								row2.FCFUF3 = null;
							} else {
	                         		
        	row2.FCFUF3 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 16, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 17) {
								row2.FCEADT = null;
							} else {
		                          
            row2.FCEADT = rs_tDBInput_2.getBigDecimal(17);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.FCEATM = rs_tDBInput_2.getBigDecimal(18);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.FCEAID = routines.system.JDBCUtil.getString(rs_tDBInput_2, 19, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 20) {
								row2.FCEAPG = null;
							} else {
	                         		
        	row2.FCEAPG = routines.system.JDBCUtil.getString(rs_tDBInput_2, 20, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 21) {
								row2.FCMODT = null;
							} else {
		                          
            row2.FCMODT = rs_tDBInput_2.getBigDecimal(21);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row2.FCMOTM = rs_tDBInput_2.getBigDecimal(22);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row2.FCMOID = routines.system.JDBCUtil.getString(rs_tDBInput_2, 23, true);
		                    }
							if(colQtyInRs_tDBInput_2 < 24) {
								row2.FCMOPG = null;
							} else {
	                         		
        	row2.FCMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_2, 24, true);
		                    }
...
ITEM_VENDOR_SHIP_FROM_UPDATE = null;


// # Output table : 'ITEM_VENDOR_SHIP_FROM_UPDATE'
count_ITEM_VENDOR_SHIP_FROM_UPDATE_tMap_5++;

ITEM_VENDOR_SHIP_FROM_UPDATE_tmp.SITE_ID = context.opco;
ITEM_VENDOR_SHIP_FROM_UPDATE_tmp.ITEM_NO = row2.FCITEM ;
ITEM_VENDOR_SHIP_FROM_UPDATE_tmp.VENDOR_NO = row2.FCPVND;
ITEM_VENDOR_SHIP_FROM_UPDATE_tmp.VENDOR_SUFFIX = row2.FCADCD;
ITEM_VENDOR_SHIP_FROM_UPDATE_tmp.DETAIL_FLAG = row2.FCISDF;
ITEM_VENDOR_SHIP_FROM_UPDATE_tmp.FCRF_SVOP = context.svop;
ITEM_VENDOR_SHIP_FROM_UPDATE = ITEM_VENDOR_SHIP_FROM_UPDATE_tmp;
log.debug("tMap_5 - Outputting the record " + count_ITEM_VENDOR_SHIP_FROM_UPDATE_tMap_5 + " of the output table 'ITEM_VENDOR_SHIP_FROM_UPDATE'.");
 ...
 */
// Start of branch "ITEM_VENDOR_SHIP_FROM_UPDATE"
if(ITEM_VENDOR_SHIP_FROM_UPDATE != null) { 
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1
							...
							,"ITEM_VENDOR_SHIP_FROM_UPDATE"
						
						);
					}
					
    			if(log.isTraceEnabled()){
    				log.trace("ITEM_VENDOR_SHIP_FROM_UPDATE - " + (ITEM_VENDOR_SHIP_FROM_UPDATE==null? "": ITEM_VENDOR_SHIP_FROM_UPDATE.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_2 = false;
                    if(ITEM_VENDOR_SHIP_FROM_UPDATE.DETAIL_FLAG == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, ITEM_VENDOR_SHIP_FROM_UPDATE.DETAIL_FLAG);
}

                    if(ITEM_VENDOR_SHIP_FROM_UPDATE.FCRF_SVOP == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, ITEM_VENDOR_SHIP_FROM_UPDATE.FCRF_SVOP);
}

                    if(ITEM_VENDOR_SHIP_FROM_UPDATE.SITE_ID == null) {
pstmt_tDBOutput_2.setNull(3 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3 + count_tDBOutput_2, ITEM_VENDOR_SHIP_FROM_UPDATE.SITE_ID);
}


                    if(ITEM_VENDOR_SHIP_FROM_UPDATE.ITEM_NO == null) {
pstmt_tDBOutput_2.setNull(4 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4 + count_tDBOutput_2, ITEM_VENDOR_SHIP_FROM_UPDATE.ITEM_NO);
}


                    if(ITEM_VENDOR_SHIP_FROM_UPDATE.VENDOR_NO == null) {
pstmt_tDBOutput_2.setNull(5 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5 + count_tDBOutput_2, ITEM_VENDOR_SHIP_FROM_UPDATE.VENDOR_NO);
}


                    pstmt_tDBOutput_2.setBigDecimal(6 + count_tDBOutput_2, ITEM_VENDOR_SHIP_FROM_UPDATE.VENDOR_SUFFIX);
...
} // End of branch "ITEM_VENDOR_SHIP_FROM_UPDATE"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_5 - Written records count in the table 'ITEM_VENDOR_SHIP_FROM_UPDATE': " + count_ITEM_VENDOR_SHIP_FROM_UPDATE_tMap_5 + ".");
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
            ...
            log.debug("tDBOutput_2 - "  + ("Has ")  + ("updated")  + (" ")  + (nb_line_update_tDBOutput_2)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ITEM_VENDOR_SHIP_FROM_UPDATE");
			  	}
...
System.out.println("Starting the Migrating Data from IMVNFCRF to ITEM_VENDOR_SHIP_FROM...........");
System.out.println("Target OpCO No    : " + context.opco);
System.out.println("Source OpCO No    : " + context.sopco);
System.out.println("Migration SVOP    : " + context.svop);
System.out.println("DateTime          : " + java.time.LocalDate.now());  
...
public static class ITEM_VENDOR_SHIP_FROM_FCRFStruct implements routines.system.IPersistableRow<ITEM_VENDOR_SHIP_FROM_FCRFStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Vendor_Ship_From_Inbound = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ITEM_VENDOR_SHIP_FROM_FCRFStruct other = (ITEM_VENDOR_SHIP_FROM_FCRFStruct) obj;
	...
	public void copyDataTo(ITEM_VENDOR_SHIP_FROM_FCRFStruct other) {
	...
	public void copyKeysDataTo(ITEM_VENDOR_SHIP_FROM_FCRFStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(ITEM_VENDOR_SHIP_FROM_FCRFStruct other) {
...
ITEM_VENDOR_SHIP_FROM_FCRFStruct ITEM_VENDOR_SHIP_FROM_FCRF = new ITEM_VENDOR_SHIP_FROM_FCRFStruct();
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ITEM_VENDOR_SHIP_FROM_FCRF");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_3{
                    ...
                    log4jParamters_tDBOutput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("TABLE" + " = " + "\"ITEM_VENDOR_SHIP_FROM\"");
                        log4jParamters_tDBOutput_3.append(" | ");
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("ITEM_VENDOR_SHIP_FROM");
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("ITEM_VENDOR_SHIP_FROM");
}
...
int count_tDBOutput_3=0;
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"SITE_ID\",\"ITEM_NO\",\"VENDOR_NO\",\"VENDOR_SUFFIX\",\"DETAIL_FLAG\",\"IS_ACTIVE\",\"FCRF_SVOP\") VALUES (?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_ITEM_VENDOR_SHIP_FROM_FCRF_tMap_6 = 0;
				
ITEM_VENDOR_SHIP_FROM_FCRFStruct ITEM_VENDOR_SHIP_FROM_FCRF_tmp = new ITEM_VENDOR_SHIP_FROM_FCRFStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TABLE" + " = " + "\"IMVNFCRF\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT    IMVNFCRF.FCPVND,    IMVNFCRF.FCADCD,    IMVNFCRF.FCISDF,    IMVNFCRF.FCITEM,    IMVNFCRF.FCFU01,    IMVNFCRF.FCFU02,    IMVNFCRF.FCFU03,    IMVNFCRF.FCFU04,    IMVNFCRF.FCFUN1,    IMVNFCRF.FCFUN2,    IMVNFCRF.FCFUN3,    IMVNFCRF.FCABP1,    IMVNFCRF.FCABP2,    IMVNFCRF.FCFUF1,    IMVNFCRF.FCFUF2,    IMVNFCRF.FCFUF3,    IMVNFCRF.FCEADT,    IMVNFCRF.FCEATM,    IMVNFCRF.FCEAID,    IMVNFCRF.FCEAPG,    IMVNFCRF.FCMODT,    IMVNFCRF.FCMOTM,    IMVNFCRF.FCMOID,    IMVNFCRF.FCMOPG FROM IMVNFCRF ORDER BY IMVNFCRF.FCEADT DESC\"");
                        log4jParamters_tDBInput_3.append(" | ");
...
+"FCMOPG\nFROM IMVNFCRF ORDER BY IMVNFCRF.FCEADT DESC";
        	...
        	row3.FCPVND = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row3.FCADCD = null;
							} else {
		                          
            row3.FCADCD = rs_tDBInput_3.getBigDecimal(2);
        	...
        	row3.FCISDF = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row3.FCITEM = null;
							} else {
	                         		
        	row3.FCITEM = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row3.FCFU01 = null;
							} else {
	                         		
        	row3.FCFU01 = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								row3.FCFU02 = null;
							} else {
	                         		
        	row3.FCFU02 = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row3.FCFU03 = null;
							} else {
	                         		
        	row3.FCFU03 = routines.system.JDBCUtil.getString(rs_tDBInput_3, 7, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 8) {
								row3.FCFU04 = null;
							} else {
	                         		
        	row3.FCFU04 = routines.system.JDBCUtil.getString(rs_tDBInput_3, 8, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 9) {
								row3.FCFUN1 = null;
							} else {
		                          
            row3.FCFUN1 = rs_tDBInput_3.getBigDecimal(9);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.FCFUN2 = rs_tDBInput_3.getBigDecimal(10);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.FCFUN3 = rs_tDBInput_3.getBigDecimal(11);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.FCABP1 = rs_tDBInput_3.getBigDecimal(12);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.FCABP2 = rs_tDBInput_3.getBigDecimal(13);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row3.FCFUF1 = routines.system.JDBCUtil.getString(rs_tDBInput_3, 14, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 15) {
								row3.FCFUF2 = null;
							} else {
	                         		
        	row3.FCFUF2 = routines.system.JDBCUtil.getString(rs_tDBInput_3, 15, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 16) {
								row3.FCFUF3 = null;
							} else {
	                         		
        	row3.FCFUF3 = routines.system.JDBCUtil.getString(rs_tDBInput_3, 16, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 17) {
								row3.FCEADT = null;
							} else {
		                          
            row3.FCEADT = rs_tDBInput_3.getBigDecimal(17);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.FCEATM = rs_tDBInput_3.getBigDecimal(18);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row3.FCEAID = routines.system.JDBCUtil.getString(rs_tDBInput_3, 19, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 20) {
								row3.FCEAPG = null;
							} else {
	                         		
        	row3.FCEAPG = routines.system.JDBCUtil.getString(rs_tDBInput_3, 20, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 21) {
								row3.FCMODT = null;
							} else {
		                          
            row3.FCMODT = rs_tDBInput_3.getBigDecimal(21);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row3.FCMOTM = rs_tDBInput_3.getBigDecimal(22);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row3.FCMOID = routines.system.JDBCUtil.getString(rs_tDBInput_3, 23, true);
		                    }
							if(colQtyInRs_tDBInput_3 < 24) {
								row3.FCMOPG = null;
							} else {
	                         		
        	row3.FCMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_3, 24, true);
		                    }
...
ITEM_VENDOR_SHIP_FROM_FCRF = null;


// # Output table : 'ITEM_VENDOR_SHIP_FROM_FCRF'
count_ITEM_VENDOR_SHIP_FROM_FCRF_tMap_6++;

ITEM_VENDOR_SHIP_FROM_FCRF_tmp.SITE_ID = context.opco;
ITEM_VENDOR_SHIP_FROM_FCRF_tmp.ITEM_NO = row3.FCITEM ;
ITEM_VENDOR_SHIP_FROM_FCRF_tmp.VENDOR_NO = row3.FCPVND;
ITEM_VENDOR_SHIP_FROM_FCRF_tmp.VENDOR_SUFFIX = row3.FCADCD;
ITEM_VENDOR_SHIP_FROM_FCRF_tmp.DETAIL_FLAG = row3.FCISDF;
ITEM_VENDOR_SHIP_FROM_FCRF_tmp.IS_ACTIVE = false;
ITEM_VENDOR_SHIP_FROM_FCRF_tmp.FCRF_SVOP = context.svop;
ITEM_VENDOR_SHIP_FROM_FCRF = ITEM_VENDOR_SHIP_FROM_FCRF_tmp;
log.debug("tMap_6 - Outputting the record " + count_ITEM_VENDOR_SHIP_FROM_FCRF_tMap_6 + " of the output table 'ITEM_VENDOR_SHIP_FROM_FCRF'.");
 ...
 */
// Start of branch "ITEM_VENDOR_SHIP_FROM_FCRF"
if(ITEM_VENDOR_SHIP_FROM_FCRF != null) { 
	...
	currentComponent="tDBOutput_3";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1
							...
							,"ITEM_VENDOR_SHIP_FROM_FCRF"
						
						);
					}
					
    			if(log.isTraceEnabled()){
    				log.trace("ITEM_VENDOR_SHIP_FROM_FCRF - " + (ITEM_VENDOR_SHIP_FROM_FCRF==null? "": ITEM_VENDOR_SHIP_FROM_FCRF.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_3 = false;
                    if(ITEM_VENDOR_SHIP_FROM_FCRF.SITE_ID == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, ITEM_VENDOR_SHIP_FROM_FCRF.SITE_ID);
}

                    if(ITEM_VENDOR_SHIP_FROM_FCRF.ITEM_NO == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, ITEM_VENDOR_SHIP_FROM_FCRF.ITEM_NO);
}

                    if(ITEM_VENDOR_SHIP_FROM_FCRF.VENDOR_NO == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, ITEM_VENDOR_SHIP_FROM_FCRF.VENDOR_NO);
}

                    pstmt_tDBOutput_3.setBigDecimal(4, ITEM_VENDOR_SHIP_FROM_FCRF.VENDOR_SUFFIX);

                    if(ITEM_VENDOR_SHIP_FROM_FCRF.DETAIL_FLAG == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, ITEM_VENDOR_SHIP_FROM_FCRF.DETAIL_FLAG);
}

                    if(ITEM_VENDOR_SHIP_FROM_FCRF.IS_ACTIVE == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_3.setBoolean(6, ITEM_VENDOR_SHIP_FROM_FCRF.IS_ACTIVE);
}

                    if(ITEM_VENDOR_SHIP_FROM_FCRF.FCRF_SVOP == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, ITEM_VENDOR_SHIP_FROM_FCRF.FCRF_SVOP);
}
...
} // End of branch "ITEM_VENDOR_SHIP_FROM_FCRF"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_6 - Written records count in the table 'ITEM_VENDOR_SHIP_FROM_FCRF': " + count_ITEM_VENDOR_SHIP_FROM_FCRF_tMap_6 + ".");
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
            ...
            log.debug("tDBOutput_3 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_3)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ITEM_VENDOR_SHIP_FROM_FCRF");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Item_Vendor_Ship_From_Inbound Item_Vendor_Ship_From_InboundClass = new Item_Vendor_Ship_From_Inbound();

        int exitCode = Item_Vendor_Ship_From_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Item_Vendor_Ship_From_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Item_Vendor_Ship_From_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Item_Vendor_Ship_From_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/item_vendor_ship_from_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Item_Vendor_Ship_From_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Item_Vendor_Ship_From_Inbound");
        }
...
/************************************************************************************************
 *     468349 characters generated by Talend Open Studio for Data Integration 
