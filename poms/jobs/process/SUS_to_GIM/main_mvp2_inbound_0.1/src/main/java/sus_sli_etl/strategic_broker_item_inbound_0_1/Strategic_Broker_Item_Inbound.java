...
package sus_sli_etl.strategic_broker_item_inbound_0_1;
...
/**
 * Job: Strategic_Broker_Item_Inbound Purpose: Migrating data from USDVVBRF to STRATEGIC_BROKER_ITEM<br>
 * Description: Migrating data from USDVVBRF to STRATEGIC_BROKER_ITEM <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Strategic_Broker_Item_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Strategic_Broker_Item_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Strategic_Broker_Item_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Strategic_Broker_Item_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_U2cT4ANzEe2mdNKMHGUS9Q", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_U2cT4ANzEe2mdNKMHGUS9Q", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Strategic_Broker_Item_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Strategic_Broker_Item_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Item_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Item_Inbound) {
...
System.out.println("Starting the Migrating Data from USDVVBRF to STRATEGIC_BROKER_ITEM...........");
...
public static class STRATEGIC_BROKER_ITEMStruct implements routines.system.IPersistableRow<STRATEGIC_BROKER_ITEMStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Item_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String VBRF_SVOP;

				public String getVBRF_SVOP () {
					return this.VBRF_SVOP;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.RECORD_TYPE == null) ? 0 : this.RECORD_TYPE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final STRATEGIC_BROKER_ITEMStruct other = (STRATEGIC_BROKER_ITEMStruct) obj;
						...
						} else if (!this.RECORD_TYPE.equals(other.RECORD_TYPE))
	...
	public void copyDataTo(STRATEGIC_BROKER_ITEMStruct other) {
		...
		other.SITE_ID = this.SITE_ID;
	            ...
	            other.CONTACT_TEL_NO = this.CONTACT_TEL_NO;
	            ...
	            other.VBRF_SVOP = this.VBRF_SVOP;
	            
	}

	public void copyKeysDataTo(STRATEGIC_BROKER_ITEMStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Item_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CONTACT_TEL_NO = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CONTACT_TEL_NO,dos);
					...
					// String
						...
						writeString(this.VBRF_SVOP,dos);
    ...
    public String toString() {
		...
		sb.append(",CONTACT_TEL_NO="+CONTACT_TEL_NO);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(CONTACT_TEL_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CONTACT_TEL_NO);
            			}
     ...
     * Compare keys
     */
    public int compareTo(STRATEGIC_BROKER_ITEMStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.RECORD_TYPE, other.RECORD_TYPE);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Strategic_Broker_Item_Inbound = new byte[0];
			    ...
			    public String VBOPCO;

				public String getVBOPCO () {
					return this.VBOPCO;
				}
				
			    public String VBITEM;

				public String getVBITEM () {
					return this.VBITEM;
				}
				
			    public String VBVNBR;

				public String getVBVNBR () {
					return this.VBVNBR;
				}
				
			    public String VBBRID;

				public String getVBBRID () {
					return this.VBBRID;
				}
				
			    public String VBCONT;
				...
				public String getVBTEL () {
					return this.VBTEL;
				}
				
			    public BigDecimal VBDFDT;

				public BigDecimal getVBDFDT () {
					return this.VBDFDT;
				}
				
			    public BigDecimal VBENDT;

				public BigDecimal getVBENDT () {
					return this.VBENDT;
				}
				
			    public String VBRECT;

				public String getVBRECT () {
					return this.VBRECT;
				}
				
			    public String VBEAID;

				public String getVBEAID () {
					return this.VBEAID;
				}
				
			    public BigDecimal VBEADT;

				public BigDecimal getVBEADT () {
					return this.VBEADT;
				}
				
			    public BigDecimal VBEATM;

				public BigDecimal getVBEATM () {
					return this.VBEATM;
				}
				
			    public String VBMOID;

				public String getVBMOID () {
					return this.VBMOID;
				}
				
			    public BigDecimal VBMODT;

				public BigDecimal getVBMODT () {
					return this.VBMODT;
				}
				
			    public BigDecimal VBMOTM;

				public BigDecimal getVBMOTM () {
					return this.VBMOTM;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Item_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.VBOPCO = readString(dis);
					
					this.VBITEM = readString(dis);
					
					this.VBVNBR = readString(dis);
					
					this.VBBRID = readString(dis);
					
					this.VBCONT = readString(dis);
					
					this.VBTEL = readString(dis);
					
						this.VBDFDT = (BigDecimal) dis.readObject();
					
						this.VBENDT = (BigDecimal) dis.readObject();
					
					this.VBRECT = readString(dis);
					
					this.VBEAID = readString(dis);
					
						this.VBEADT = (BigDecimal) dis.readObject();
					
						this.VBEATM = (BigDecimal) dis.readObject();
					
					this.VBMOID = readString(dis);
					
						this.VBMODT = (BigDecimal) dis.readObject();
					
						this.VBMOTM = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.VBOPCO,dos);
					
					// String
				
						writeString(this.VBITEM,dos);
					
					// String
				
						writeString(this.VBVNBR,dos);
					
					// String
				
						writeString(this.VBBRID,dos);
					
					// String
				
						writeString(this.VBCONT,dos);
					
					// String
				
						writeString(this.VBTEL,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VBDFDT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VBENDT);
					
					// String
				
						writeString(this.VBRECT,dos);
					
					// String
				
						writeString(this.VBEAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VBEADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VBEATM);
					
					// String
				
						writeString(this.VBMOID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VBMODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VBMOTM);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("VBOPCO="+VBOPCO);
		sb.append(",VBITEM="+VBITEM);
		sb.append(",VBVNBR="+VBVNBR);
		sb.append(",VBBRID="+VBBRID);
		sb.append(",VBCONT="+VBCONT);
		sb.append(",VBTEL="+VBTEL);
		sb.append(",VBDFDT="+String.valueOf(VBDFDT));
		sb.append(",VBENDT="+String.valueOf(VBENDT));
		sb.append(",VBRECT="+VBRECT);
		sb.append(",VBEAID="+VBEAID);
		sb.append(",VBEADT="+String.valueOf(VBEADT));
		sb.append(",VBEATM="+String.valueOf(VBEATM));
		sb.append(",VBMOID="+VBMOID);
		sb.append(",VBMODT="+String.valueOf(VBMODT));
		sb.append(",VBMOTM="+String.valueOf(VBMOTM));
	    sb.append("]");
...
STRATEGIC_BROKER_ITEMStruct STRATEGIC_BROKER_ITEM = new STRATEGIC_BROKER_ITEMStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"STRATEGIC_BROKER_ITEM");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"STRATEGIC_BROKER_ITEM\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("STRATEGIC_BROKER_ITEM");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("STRATEGIC_BROKER_ITEM");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"VENDOR_NO\",\"BROKER_ID\",\"CONTACT_PERSON_NAME\",\"CONTACT_TEL_NO\",\"START_DATE\",\"END_DATE\",\"RECORD_TYPE\",\"CREATED_USER_ID\",\"CREATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"VBRF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_STRATEGIC_BROKER_ITEM_tMap_1 = 0;
				
STRATEGIC_BROKER_ITEMStruct STRATEGIC_BROKER_ITEM_tmp = new STRATEGIC_BROKER_ITEMStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"USDVVBRF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    USDVVBRF.VBOPCO,    USDVVBRF.VBITEM,    USDVVBRF.VBVNBR,    USDVVBRF.VBBRID,    USDVVBRF.VBCONT,    USDVVBRF.\\\"VBTEL#\\\",    USDVVBRF.VBDFDT,    USDVVBRF.VBENDT,    USDVVBRF.VBRECT,    USDVVBRF.VBEAID,    USDVVBRF.VBEADT,    USDVVBRF.VBEATM,    USDVVBRF.VBMOID,    USDVVBRF.VBMODT,    USDVVBRF.VBMOTM FROM USDVVBRF ORDER BY USDVVBRF.VBEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"\"VBTEL#\", \n  USDVVBRF.VBDFDT, \n  USDVVBRF.VBENDT, \n  USDVVBRF.VBRECT, \n  USDVVBRF.VBEAID, \n  USDVVBRF.VBEADT, \n  USDVV"
+"BRF.VBEATM, \n  USDVVBRF.VBMOID, \n  USDVVBRF.VBMODT, \n  USDVVBRF.VBMOTM\nFROM USDVVBRF ORDER BY USDVVBRF.VBEADT DESC";
        	...
        	row1.VBOPCO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.VBITEM = null;
							} else {
	                         		
        	row1.VBITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.VBVNBR = null;
							} else {
	                         		
        	row1.VBVNBR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.VBBRID = null;
							} else {
	                         		
        	row1.VBBRID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.VBCONT = null;
							} else {
	                         		
        	row1.VBCONT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.VBTEL = null;
							} else {
	                         		
        	row1.VBTEL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.VBDFDT = null;
							} else {
		                          
            row1.VBDFDT = rs_tDBInput_1.getBigDecimal(7);
            ...
            row1.VBENDT = rs_tDBInput_1.getBigDecimal(8);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.VBRECT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.VBEAID = null;
							} else {
	                         		
        	row1.VBEAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.VBEADT = null;
							} else {
		                          
            row1.VBEADT = rs_tDBInput_1.getBigDecimal(11);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.VBEATM = rs_tDBInput_1.getBigDecimal(12);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.VBMOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.VBMODT = null;
							} else {
		                          
            row1.VBMODT = rs_tDBInput_1.getBigDecimal(14);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.VBMOTM = rs_tDBInput_1.getBigDecimal(15);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
Var.START_DATE = TimeStampConverting.convertToDate(row1.VBDFDT.toString()) ;
Var.END_DATE = TimeStampConverting.convertToDate(row1.VBENDT.toString()) ;
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.VBEADT.toString(), row1.VBEATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.VBMODT.toString(), row1.VBMOTM.toString()) ;// ###############################
        // ###############################
        // # Output tables

STRATEGIC_BROKER_ITEM = null;


// # Output table : 'STRATEGIC_BROKER_ITEM'
count_STRATEGIC_BROKER_ITEM_tMap_1++;

STRATEGIC_BROKER_ITEM_tmp.SITE_ID = context.opco;
STRATEGIC_BROKER_ITEM_tmp.ITEM_NO = row1.VBITEM ;
STRATEGIC_BROKER_ITEM_tmp.VENDOR_NO = row1.VBVNBR ;
STRATEGIC_BROKER_ITEM_tmp.BROKER_ID = row1.VBBRID ;
STRATEGIC_BROKER_ITEM_tmp.CONTACT_PERSON_NAME = row1.VBCONT ;
STRATEGIC_BROKER_ITEM_tmp.CONTACT_TEL_NO = row1.VBTEL ;
STRATEGIC_BROKER_ITEM_tmp.START_DATE = Var.START_DATE!=""? TalendDate.parseDate("dd-MM-yyyy",Var.START_DATE):null ;
STRATEGIC_BROKER_ITEM_tmp.END_DATE = Var.END_DATE!=""? TalendDate.parseDate("dd-MM-yyyy",Var.END_DATE):null ;
STRATEGIC_BROKER_ITEM_tmp.RECORD_TYPE = row1.VBRECT ;
STRATEGIC_BROKER_ITEM_tmp.CREATED_USER_ID = row1.VBEAID ;
STRATEGIC_BROKER_ITEM_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
STRATEGIC_BROKER_ITEM_tmp.UPDATED_USER_ID = row1.VBMOID ;
STRATEGIC_BROKER_ITEM_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
STRATEGIC_BROKER_ITEM_tmp.IS_DELETED = false;
STRATEGIC_BROKER_ITEM_tmp.CREATED_ORIGIN = "SUS";
STRATEGIC_BROKER_ITEM_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
STRATEGIC_BROKER_ITEM_tmp.UPDATED_ORIGIN = "SUS";
STRATEGIC_BROKER_ITEM_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
STRATEGIC_BROKER_ITEM_tmp.VBRF_SVOP = context.svop;
STRATEGIC_BROKER_ITEM = STRATEGIC_BROKER_ITEM_tmp;
log.debug("tMap_1 - Outputting the record " + count_STRATEGIC_BROKER_ITEM_tMap_1 + " of the output table 'STRATEGIC_BROKER_ITEM'.");
 ...
 */
// Start of branch "STRATEGIC_BROKER_ITEM"
if(STRATEGIC_BROKER_ITEM != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1
							...
							,"STRATEGIC_BROKER_ITEM"
						
						);
					}
					
    			if(log.isTraceEnabled()){
    				log.trace("STRATEGIC_BROKER_ITEM - " + (STRATEGIC_BROKER_ITEM==null? "": STRATEGIC_BROKER_ITEM.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(STRATEGIC_BROKER_ITEM.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, STRATEGIC_BROKER_ITEM.SITE_ID);
}

                    if(STRATEGIC_BROKER_ITEM.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, STRATEGIC_BROKER_ITEM.ITEM_NO);
}

                    if(STRATEGIC_BROKER_ITEM.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, STRATEGIC_BROKER_ITEM.VENDOR_NO);
}

                    if(STRATEGIC_BROKER_ITEM.BROKER_ID == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, STRATEGIC_BROKER_ITEM.BROKER_ID);
}

                    if(STRATEGIC_BROKER_ITEM.CONTACT_PERSON_NAME == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, STRATEGIC_BROKER_ITEM.CONTACT_PERSON_NAME);
}

                    if(STRATEGIC_BROKER_ITEM.CONTACT_TEL_NO == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, STRATEGIC_BROKER_ITEM.CONTACT_TEL_NO);
}

                    if(STRATEGIC_BROKER_ITEM.START_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(STRATEGIC_BROKER_ITEM.START_DATE.getTime()));
} else {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(STRATEGIC_BROKER_ITEM.END_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(STRATEGIC_BROKER_ITEM.END_DATE.getTime()));
} else {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.TIMESTAMP);
}

                    if(STRATEGIC_BROKER_ITEM.RECORD_TYPE == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, STRATEGIC_BROKER_ITEM.RECORD_TYPE);
}

                    if(STRATEGIC_BROKER_ITEM.CREATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, STRATEGIC_BROKER_ITEM.CREATED_USER_ID);
}

                    if(STRATEGIC_BROKER_ITEM.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(11, new java.sql.Timestamp(STRATEGIC_BROKER_ITEM.CREATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.TIMESTAMP);
}

                    if(STRATEGIC_BROKER_ITEM.UPDATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, STRATEGIC_BROKER_ITEM.UPDATED_USER_ID);
}

                    if(STRATEGIC_BROKER_ITEM.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(13, new java.sql.Timestamp(STRATEGIC_BROKER_ITEM.UPDATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setBoolean(14, STRATEGIC_BROKER_ITEM.IS_DELETED);

                    if(STRATEGIC_BROKER_ITEM.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, STRATEGIC_BROKER_ITEM.CREATED_ORIGIN);
}

                    if(STRATEGIC_BROKER_ITEM.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(16, new java.sql.Timestamp(STRATEGIC_BROKER_ITEM.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(16, java.sql.Types.TIMESTAMP);
}

                    if(STRATEGIC_BROKER_ITEM.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, STRATEGIC_BROKER_ITEM.UPDATED_ORIGIN);
}

                    if(STRATEGIC_BROKER_ITEM.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(STRATEGIC_BROKER_ITEM.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.TIMESTAMP);
}

                    if(STRATEGIC_BROKER_ITEM.VBRF_SVOP == null) {
pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(19, STRATEGIC_BROKER_ITEM.VBRF_SVOP);
}
...
} // End of branch "STRATEGIC_BROKER_ITEM"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'STRATEGIC_BROKER_ITEM': " + count_STRATEGIC_BROKER_ITEM_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"STRATEGIC_BROKER_ITEM");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Strategic_Broker_Item_Inbound Strategic_Broker_Item_InboundClass = new Strategic_Broker_Item_Inbound();

        int exitCode = Strategic_Broker_Item_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Strategic_Broker_Item_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Strategic_Broker_Item_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Strategic_Broker_Item_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/strategic_broker_item_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Strategic_Broker_Item_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Strategic_Broker_Item_Inbound");
        }
...
/************************************************************************************************
 *     281352 characters generated by Talend Open Studio for Data Integration 
