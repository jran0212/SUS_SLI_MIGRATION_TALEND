...
package sus_sli_etl.rdc_item_pay_to_vendor_update_inbound_0_1;
...
/**
 * Job: Rdc_Item_Pay_To_Vendor_Update_Inbound Purpose: Migrating data from USIBMIRF to RDC_ITEM_PAY_TO_VENDOR<br>
 * Description: Migrating data from USIBMIRF to RDC_ITEM_PAY_TO_VENDOR <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Rdc_Item_Pay_To_Vendor_Update_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Rdc_Item_Pay_To_Vendor_Update_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Rdc_Item_Pay_To_Vendor_Update_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Rdc_Item_Pay_To_Vendor_Update_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_1bRvQAP7Ee2Hm-5Lqgv_5w", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_1bRvQAP7Ee2Hm-5Lqgv_5w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Rdc_Item_Pay_To_Vendor_Update_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Rdc_Item_Pay_To_Vendor_Update_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound) {
...
System.out.println("Starting the Migrating Data from USIBMIRF to RDC_ITEM_PAY_TO_VENDOR...........");
...
public static class RDC_ITEM_PAY_TO_VENDORStruct implements routines.system.IPersistableRow<RDC_ITEM_PAY_TO_VENDORStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String PRODUCT_SPECIALIST;

				public String getPRODUCT_SPECIALIST () {
					return this.PRODUCT_SPECIALIST;
				}
			    ...
			    public String MIRF_SVOP;

				public String getMIRF_SVOP () {
					return this.MIRF_SVOP;
				}
				
			    public String VENDOR_STORAGE;

				public String getVENDOR_STORAGE () {
					return this.VENDOR_STORAGE;
				}
			    ...
			    public String LONG_LEAD_TIME;

				public String getLONG_LEAD_TIME () {
					return this.LONG_LEAD_TIME;
				}
				
			    public String VEGETARIAN_FLAG;

				public String getVEGETARIAN_FLAG () {
					return this.VEGETARIAN_FLAG;
				}
				
			    public String ZERO_TRANSFAT_FLAG;

				public String getZERO_TRANSFAT_FLAG () {
					return this.ZERO_TRANSFAT_FLAG;
				}
				
			    public String HALAL_FLAG;

				public String getHALAL_FLAG () {
					return this.HALAL_FLAG;
				}
	...
	public boolean equals(Object obj) {
		...
		final RDC_ITEM_PAY_TO_VENDORStruct other = (RDC_ITEM_PAY_TO_VENDORStruct) obj;
	...
	public void copyDataTo(RDC_ITEM_PAY_TO_VENDORStruct other) {
		...
		other.SITE_ID = this.SITE_ID;
	            ...
	            other.MIRF_SVOP = this.MIRF_SVOP;
	            other.VENDOR_STORAGE = this.VENDOR_STORAGE;
	            other.STOCK_TYPE = this.STOCK_TYPE;
	            other.LONG_LEAD_TIME = this.LONG_LEAD_TIME;
	            other.VEGETARIAN_FLAG = this.VEGETARIAN_FLAG;
	            other.ZERO_TRANSFAT_FLAG = this.ZERO_TRANSFAT_FLAG;
	            other.HALAL_FLAG = this.HALAL_FLAG;
	            
	}

	public void copyKeysDataTo(RDC_ITEM_PAY_TO_VENDORStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.PRODUCT_SPECIALIST = readString(dis);
					...
					this.MIRF_SVOP = readString(dis);
					
					this.VENDOR_STORAGE = readString(dis);
					
					this.STOCK_TYPE = readString(dis);
					
					this.LONG_LEAD_TIME = readString(dis);
					
					this.VEGETARIAN_FLAG = readString(dis);
					
					this.ZERO_TRANSFAT_FLAG = readString(dis);
					
					this.HALAL_FLAG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.PRODUCT_SPECIALIST,dos);
					...
					// String
						...
						writeString(this.MIRF_SVOP,dos);
					
					// String
				
						writeString(this.VENDOR_STORAGE,dos);
					...
					// String
						...
						writeString(this.LONG_LEAD_TIME,dos);
					
					// String
				
						writeString(this.VEGETARIAN_FLAG,dos);
					
					// String
				
						writeString(this.ZERO_TRANSFAT_FLAG,dos);
					
					// String
				
						writeString(this.HALAL_FLAG,dos);
    ...
    public String toString() {
		...
		sb.append(",PRODUCT_SPECIALIST="+PRODUCT_SPECIALIST);
		...
		sb.append(",MIRF_SVOP="+MIRF_SVOP);
		sb.append(",VENDOR_STORAGE="+VENDOR_STORAGE);
		sb.append(",STOCK_TYPE="+STOCK_TYPE);
		sb.append(",LONG_LEAD_TIME="+LONG_LEAD_TIME);
		sb.append(",VEGETARIAN_FLAG="+VEGETARIAN_FLAG);
		sb.append(",ZERO_TRANSFAT_FLAG="+ZERO_TRANSFAT_FLAG);
		sb.append(",HALAL_FLAG="+HALAL_FLAG);
	    sb.append("]");
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(PRODUCT_SPECIALIST == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PRODUCT_SPECIALIST);
            			}
        			...
        			sb.append("|");
        				...
        				if(VENDOR_STORAGE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(VENDOR_STORAGE);
            			}
        			...
        			sb.append("|");
        				...
        				if(LONG_LEAD_TIME == null){
        					sb.append("<null>");
        				}else{
            				sb.append(LONG_LEAD_TIME);
            			}
            		
        			sb.append("|");
        		
        				if(VEGETARIAN_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(VEGETARIAN_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(ZERO_TRANSFAT_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ZERO_TRANSFAT_FLAG);
            			}
     ...
     * Compare keys
     */
    public int compareTo(RDC_ITEM_PAY_TO_VENDORStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound = new byte[0];
			    ...
			    public String MICOCO;

				public String getMICOCO () {
					return this.MICOCO;
				}
			    ...
			    public String MIVNBR;

				public String getMIVNBR () {
					return this.MIVNBR;
				}
				
			    public String MIBUYR;

				public String getMIBUYR () {
					return this.MIBUYR;
				}
				
			    public String MIBYRP;

				public String getMIBYRP () {
					return this.MIBYRP;
				}
				
			    public String MIDMST;

				public String getMIDMST () {
					return this.MIDMST;
				}
				
			    public String MISKST;

				public String getMISKST () {
					return this.MISKST;
				}
				
			    public String MIVSGT;

				public String getMIVSGT () {
					return this.MIVSGT;
				}
				
			    public String MISTKT;

				public String getMISTKT () {
					return this.MISTKT;
				}
				
			    public String MICORG;

				public String getMICORG () {
					return this.MICORG;
				}
				
			    public BigDecimal MISHLF;

				public BigDecimal getMISHLF () {
					return this.MISHLF;
				}
				
			    public String MIDSIF;

				public String getMIDSIF () {
					return this.MIDSIF;
				}
				
			    public BigDecimal MILENC;

				public BigDecimal getMILENC () {
					return this.MILENC;
				}
				
			    public BigDecimal MIWIDC;

				public BigDecimal getMIWIDC () {
					return this.MIWIDC;
				}
				
			    public BigDecimal MIHGTC;

				public BigDecimal getMIHGTC () {
					return this.MIHGTC;
				}
				
			    public String MIPVST;

				public String getMIPVST () {
					return this.MIPVST;
				}
				
			    public BigDecimal MISEDT;

				public BigDecimal getMISEDT () {
					return this.MISEDT;
				}
				
			    public BigDecimal MIEUPC;

				public BigDecimal getMIEUPC () {
					return this.MIEUPC;
				}
				
			    public String MILLTM;

				public String getMILLTM () {
					return this.MILLTM;
				}
				
			    public String MIFUA1;

				public String getMIFUA1 () {
					return this.MIFUA1;
				}
				
			    public String MIFUA2;

				public String getMIFUA2 () {
					return this.MIFUA2;
				}
				
			    public String MIFUA3;

				public String getMIFUA3 () {
					return this.MIFUA3;
				}
				
			    public String MIFUF1;

				public String getMIFUF1 () {
					return this.MIFUF1;
				}
				
			    public String MIFUF2;

				public String getMIFUF2 () {
					return this.MIFUF2;
				}
				
			    public String MIFUF3;

				public String getMIFUF3 () {
					return this.MIFUF3;
				}
				
			    public BigDecimal MIFUN1;

				public BigDecimal getMIFUN1 () {
					return this.MIFUN1;
				}
				
			    public BigDecimal MIFUN2;

				public BigDecimal getMIFUN2 () {
					return this.MIFUN2;
				}
				
			    public BigDecimal MIFUN3;

				public BigDecimal getMIFUN3 () {
					return this.MIFUN3;
				}
				
			    public String MIOROR;

				public String getMIOROR () {
					return this.MIOROR;
				}
				
			    public String MIVATY;

				public String getMIVATY () {
					return this.MIVATY;
				}
				
			    public String MIVATF;

				public String getMIVATF () {
					return this.MIVATF;
				}
				
			    public String MITRT1;

				public String getMITRT1 () {
					return this.MITRT1;
				}
				
			    public String MISRCC;

				public String getMISRCC () {
					return this.MISRCC;
				}
				
			    public String MIHHAA;

				public String getMIHHAA () {
					return this.MIHHAA;
				}
				
			    public BigDecimal MIEADT;

				public BigDecimal getMIEADT () {
					return this.MIEADT;
				}
				
			    public BigDecimal MIEATM;

				public BigDecimal getMIEATM () {
					return this.MIEATM;
				}
				
			    public String MIEAID;

				public String getMIEAID () {
					return this.MIEAID;
				}
				
			    public String MIEAPG;

				public String getMIEAPG () {
					return this.MIEAPG;
				}
				
			    public BigDecimal MIMODT;

				public BigDecimal getMIMODT () {
					return this.MIMODT;
				}
				
			    public BigDecimal MIMOTM;

				public BigDecimal getMIMOTM () {
					return this.MIMOTM;
				}
				
			    public String MIMOID;

				public String getMIMOID () {
					return this.MIMOID;
				}
				
			    public String MIMOPG;

				public String getMIMOPG () {
					return this.MIMOPG;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Update_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.MICOCO = readString(dis);
					
					this.MIITEM = readString(dis);
					
					this.MIVNBR = readString(dis);
					
					this.MIBUYR = readString(dis);
					
					this.MIBYRP = readString(dis);
					
					this.MIDMST = readString(dis);
					
					this.MISKST = readString(dis);
					
					this.MIVSGT = readString(dis);
					
					this.MISTKT = readString(dis);
					
					this.MICORG = readString(dis);
					
						this.MISHLF = (BigDecimal) dis.readObject();
					
					this.MIDSIF = readString(dis);
					
						this.MILENC = (BigDecimal) dis.readObject();
					
						this.MIWIDC = (BigDecimal) dis.readObject();
					
						this.MIHGTC = (BigDecimal) dis.readObject();
					
					this.MIPVST = readString(dis);
					
						this.MISEDT = (BigDecimal) dis.readObject();
					
						this.MIEUPC = (BigDecimal) dis.readObject();
					
					this.MILLTM = readString(dis);
					
					this.MIFUA1 = readString(dis);
					
					this.MIFUA2 = readString(dis);
					
					this.MIFUA3 = readString(dis);
					
					this.MIFUF1 = readString(dis);
					
					this.MIFUF2 = readString(dis);
					
					this.MIFUF3 = readString(dis);
					
						this.MIFUN1 = (BigDecimal) dis.readObject();
					
						this.MIFUN2 = (BigDecimal) dis.readObject();
					
						this.MIFUN3 = (BigDecimal) dis.readObject();
					
					this.MIOROR = readString(dis);
					
					this.MIVATY = readString(dis);
					
					this.MIVATF = readString(dis);
					
					this.MITRT1 = readString(dis);
					
					this.MISRCC = readString(dis);
					
					this.MIHHAA = readString(dis);
					
						this.MIEADT = (BigDecimal) dis.readObject();
					
						this.MIEATM = (BigDecimal) dis.readObject();
					
					this.MIEAID = readString(dis);
					
					this.MIEAPG = readString(dis);
					
						this.MIMODT = (BigDecimal) dis.readObject();
					
						this.MIMOTM = (BigDecimal) dis.readObject();
					
					this.MIMOID = readString(dis);
					
					this.MIMOPG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.MICOCO,dos);
					
					// String
				
						writeString(this.MIITEM,dos);
					
					// String
				
						writeString(this.MIVNBR,dos);
					
					// String
				
						writeString(this.MIBUYR,dos);
					
					// String
				
						writeString(this.MIBYRP,dos);
					
					// String
				
						writeString(this.MIDMST,dos);
					
					// String
				
						writeString(this.MISKST,dos);
					
					// String
				
						writeString(this.MIVSGT,dos);
					
					// String
				
						writeString(this.MISTKT,dos);
					
					// String
				
						writeString(this.MICORG,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MISHLF);
					
					// String
				
						writeString(this.MIDSIF,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MILENC);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIWIDC);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIHGTC);
					
					// String
				
						writeString(this.MIPVST,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MISEDT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIEUPC);
					
					// String
				
						writeString(this.MILLTM,dos);
					
					// String
				
						writeString(this.MIFUA1,dos);
					
					// String
				
						writeString(this.MIFUA2,dos);
					
					// String
				
						writeString(this.MIFUA3,dos);
					
					// String
				
						writeString(this.MIFUF1,dos);
					
					// String
				
						writeString(this.MIFUF2,dos);
					
					// String
				
						writeString(this.MIFUF3,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIFUN1);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIFUN2);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIFUN3);
					
					// String
				
						writeString(this.MIOROR,dos);
					
					// String
				
						writeString(this.MIVATY,dos);
					
					// String
				
						writeString(this.MIVATF,dos);
					
					// String
				
						writeString(this.MITRT1,dos);
					
					// String
				
						writeString(this.MISRCC,dos);
					
					// String
				
						writeString(this.MIHHAA,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIEADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIEATM);
					
					// String
				
						writeString(this.MIEAID,dos);
					
					// String
				
						writeString(this.MIEAPG,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIMODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.MIMOTM);
					
					// String
				
						writeString(this.MIMOID,dos);
					
					// String
				
						writeString(this.MIMOPG,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("MICOCO="+MICOCO);
		sb.append(",MIITEM="+MIITEM);
		sb.append(",MIVNBR="+MIVNBR);
		sb.append(",MIBUYR="+MIBUYR);
		sb.append(",MIBYRP="+MIBYRP);
		sb.append(",MIDMST="+MIDMST);
		sb.append(",MISKST="+MISKST);
		sb.append(",MIVSGT="+MIVSGT);
		sb.append(",MISTKT="+MISTKT);
		sb.append(",MICORG="+MICORG);
		sb.append(",MISHLF="+String.valueOf(MISHLF));
		sb.append(",MIDSIF="+MIDSIF);
		sb.append(",MILENC="+String.valueOf(MILENC));
		sb.append(",MIWIDC="+String.valueOf(MIWIDC));
		sb.append(",MIHGTC="+String.valueOf(MIHGTC));
		sb.append(",MIPVST="+MIPVST);
		sb.append(",MISEDT="+String.valueOf(MISEDT));
		sb.append(",MIEUPC="+String.valueOf(MIEUPC));
		sb.append(",MILLTM="+MILLTM);
		sb.append(",MIFUA1="+MIFUA1);
		sb.append(",MIFUA2="+MIFUA2);
		sb.append(",MIFUA3="+MIFUA3);
		sb.append(",MIFUF1="+MIFUF1);
		sb.append(",MIFUF2="+MIFUF2);
		sb.append(",MIFUF3="+MIFUF3);
		sb.append(",MIFUN1="+String.valueOf(MIFUN1));
		sb.append(",MIFUN2="+String.valueOf(MIFUN2));
		sb.append(",MIFUN3="+String.valueOf(MIFUN3));
		sb.append(",MIOROR="+MIOROR);
		sb.append(",MIVATY="+MIVATY);
		sb.append(",MIVATF="+MIVATF);
		sb.append(",MITRT1="+MITRT1);
		sb.append(",MISRCC="+MISRCC);
		sb.append(",MIHHAA="+MIHHAA);
		sb.append(",MIEADT="+String.valueOf(MIEADT));
		sb.append(",MIEATM="+String.valueOf(MIEATM));
		sb.append(",MIEAID="+MIEAID);
		sb.append(",MIEAPG="+MIEAPG);
		sb.append(",MIMODT="+String.valueOf(MIMODT));
		sb.append(",MIMOTM="+String.valueOf(MIMOTM));
		sb.append(",MIMOID="+MIMOID);
		sb.append(",MIMOPG="+MIMOPG);
	    sb.append("]");
...
RDC_ITEM_PAY_TO_VENDORStruct RDC_ITEM_PAY_TO_VENDOR = new RDC_ITEM_PAY_TO_VENDORStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"RDC_ITEM_PAY_TO_VENDOR");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"RDC_ITEM_PAY_TO_VENDOR\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("RDC_ITEM_PAY_TO_VENDOR");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("RDC_ITEM_PAY_TO_VENDOR");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"VENDOR_NO\",\"BUYER_NO\",\"PRODUCT_SPECIALIST\",\"DEMAND_STATUS\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"MIRF_SVOP\",\"VENDOR_STORAGE\",\"STOCK_TYPE\",\"LONG_LEAD_TIME\",\"VEGETARIAN_FLAG\",\"ZERO_TRANSFAT_FLAG\",\"HALAL_FLAG\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_RDC_ITEM_PAY_TO_VENDOR_tMap_1 = 0;
				
RDC_ITEM_PAY_TO_VENDORStruct RDC_ITEM_PAY_TO_VENDOR_tmp = new RDC_ITEM_PAY_TO_VENDORStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"USIBMIRF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    USIBMIRF.MICOCO,    USIBMIRF.MIITEM,    USIBMIRF.MIVNBR,    USIBMIRF.MIBUYR,    USIBMIRF.MIBYRP,    USIBMIRF.MIDMST,    USIBMIRF.MISKST,    USIBMIRF.MIVSGT,    USIBMIRF.MISTKT,    USIBMIRF.MICORG,    USIBMIRF.MISHLF,    USIBMIRF.MIDSIF,    USIBMIRF.MILENC,    USIBMIRF.MIWIDC,    USIBMIRF.MIHGTC,    USIBMIRF.MIPVST,    USIBMIRF.MISEDT,    USIBMIRF.MIEUPC,    USIBMIRF.MILLTM,    USIBMIRF.MIFUA1,    USIBMIRF.MIFUA2,    USIBMIRF.MIFUA3,    USIBMIRF.MIFUF1,    USIBMIRF.MIFUF2,    USIBMIRF.MIFUF3,    USIBMIRF.MIFUN1,    USIBMIRF.MIFUN2,    USIBMIRF.MIFUN3,    USIBMIRF.MIOROR,    USIBMIRF.MIVATY,    USIBMIRF.MIVATF,    USIBMIRF.MITRT1,    USIBMIRF.MISRCC,    USIBMIRF.MIHHAA,    USIBMIRF.MIEADT,    USIBMIRF.MIEATM,    USIBMIRF.MIEAID,    USIBMIRF.MIEAPG,    USIBMIRF.MIMODT,    USIBMIRF.MIMOTM,    USIBMIRF.MIMOID,    USIBMIRF.MIMOPG FROM USIBMIRF ORDER BY USIBMIRF.MIEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"MIVATY, \n  USIBMIRF.MIVATF, \n  USIBMIRF.MITRT1, \n  USIBMIRF.MISRCC, \n  USIBMIRF.MIHHAA, \n  USIBMIRF.MIEADT, \n  USIBMIRF."
+"MIEATM, \n  USIBMIRF.MIEAID, \n  USIBMIRF.MIEAPG, \n  USIBMIRF.MIMODT, \n  USIBMIRF.MIMOTM, \n  USIBMIRF.MIMOID, \n  USIBMIRF."
+"MIMOPG\nFROM USIBMIRF ORDER BY USIBMIRF.MIEADT DESC";
        	...
        	row1.MICOCO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.MIITEM = null;
							} else {
	                         		
        	row1.MIITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.MIVNBR = null;
							} else {
	                         		
        	row1.MIVNBR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.MIBUYR = null;
							} else {
	                         		
        	row1.MIBUYR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.MIBYRP = null;
							} else {
	                         		
        	row1.MIBYRP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.MIDMST = null;
							} else {
	                         		
        	row1.MIDMST = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.MISKST = null;
							} else {
	                         		
        	row1.MISKST = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.MIVSGT = null;
							} else {
	                         		
        	row1.MIVSGT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.MISTKT = null;
							} else {
	                         		
        	row1.MISTKT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.MICORG = null;
							} else {
	                         		
        	row1.MICORG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.MISHLF = null;
							} else {
		                          
            row1.MISHLF = rs_tDBInput_1.getBigDecimal(11);
        	...
        	row1.MIDSIF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.MILENC = null;
							} else {
		                          
            row1.MILENC = rs_tDBInput_1.getBigDecimal(13);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MIWIDC = rs_tDBInput_1.getBigDecimal(14);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MIHGTC = rs_tDBInput_1.getBigDecimal(15);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.MIPVST = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row1.MISEDT = null;
							} else {
		                          
            row1.MISEDT = rs_tDBInput_1.getBigDecimal(17);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MIEUPC = rs_tDBInput_1.getBigDecimal(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.MILLTM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row1.MIFUA1 = null;
							} else {
	                         		
        	row1.MIFUA1 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.MIFUA2 = null;
							} else {
	                         		
        	row1.MIFUA2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.MIFUA3 = null;
							} else {
	                         		
        	row1.MIFUA3 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 23) {
								row1.MIFUF1 = null;
							} else {
	                         		
        	row1.MIFUF1 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 24) {
								row1.MIFUF2 = null;
							} else {
	                         		
        	row1.MIFUF2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 25) {
								row1.MIFUF3 = null;
							} else {
	                         		
        	row1.MIFUF3 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 26) {
								row1.MIFUN1 = null;
							} else {
		                          
            row1.MIFUN1 = rs_tDBInput_1.getBigDecimal(26);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MIFUN2 = rs_tDBInput_1.getBigDecimal(27);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MIFUN3 = rs_tDBInput_1.getBigDecimal(28);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.MIOROR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 29, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 30) {
								row1.MIVATY = null;
							} else {
	                         		
        	row1.MIVATY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 30, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 31) {
								row1.MIVATF = null;
							} else {
	                         		
        	row1.MIVATF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 32) {
								row1.MITRT1 = null;
							} else {
	                         		
        	row1.MITRT1 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 32, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 33) {
								row1.MISRCC = null;
							} else {
	                         		
        	row1.MISRCC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 33, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 34) {
								row1.MIHHAA = null;
							} else {
	                         		
        	row1.MIHHAA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 34, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 35) {
								row1.MIEADT = null;
							} else {
		                          
            row1.MIEADT = rs_tDBInput_1.getBigDecimal(35);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MIEATM = rs_tDBInput_1.getBigDecimal(36);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.MIEAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 37, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 38) {
								row1.MIEAPG = null;
							} else {
	                         		
        	row1.MIEAPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 38, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 39) {
								row1.MIMODT = null;
							} else {
		                          
            row1.MIMODT = rs_tDBInput_1.getBigDecimal(39);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.MIMOTM = rs_tDBInput_1.getBigDecimal(40);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.MIMOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 41, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 42) {
								row1.MIMOPG = null;
							} else {
	                         		
        	row1.MIMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 42, true);
		                    }
...
RDC_ITEM_PAY_TO_VENDOR = null;


// # Output table : 'RDC_ITEM_PAY_TO_VENDOR'
count_RDC_ITEM_PAY_TO_VENDOR_tMap_1++;

RDC_ITEM_PAY_TO_VENDOR_tmp.SITE_ID = context.opco;
RDC_ITEM_PAY_TO_VENDOR_tmp.ITEM_NO = row1.MIITEM ;
RDC_ITEM_PAY_TO_VENDOR_tmp.VENDOR_NO = row1.MIVNBR ;
RDC_ITEM_PAY_TO_VENDOR_tmp.BUYER_NO = row1.MIBUYR ;
RDC_ITEM_PAY_TO_VENDOR_tmp.PRODUCT_SPECIALIST = row1.MIBYRP ;
RDC_ITEM_PAY_TO_VENDOR_tmp.DEMAND_STATUS = row1.MIDMST ;
RDC_ITEM_PAY_TO_VENDOR_tmp.IS_DELETED = false;
RDC_ITEM_PAY_TO_VENDOR_tmp.CREATED_ORIGIN = "SUS";
RDC_ITEM_PAY_TO_VENDOR_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
RDC_ITEM_PAY_TO_VENDOR_tmp.UPDATED_ORIGIN = "SUS";
RDC_ITEM_PAY_TO_VENDOR_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
RDC_ITEM_PAY_TO_VENDOR_tmp.MIRF_SVOP = context.svop;
RDC_ITEM_PAY_TO_VENDOR_tmp.VENDOR_STORAGE = row1.MIVSGT ;
RDC_ITEM_PAY_TO_VENDOR_tmp.STOCK_TYPE = row1.MISTKT ;
RDC_ITEM_PAY_TO_VENDOR_tmp.LONG_LEAD_TIME = row1.MILLTM ;
RDC_ITEM_PAY_TO_VENDOR_tmp.VEGETARIAN_FLAG = row1.MIVATF ;
RDC_ITEM_PAY_TO_VENDOR_tmp.ZERO_TRANSFAT_FLAG = row1.MITRT1 ;
RDC_ITEM_PAY_TO_VENDOR_tmp.HALAL_FLAG = row1.MIHHAA ;
RDC_ITEM_PAY_TO_VENDOR = RDC_ITEM_PAY_TO_VENDOR_tmp;
log.debug("tMap_1 - Outputting the record " + count_RDC_ITEM_PAY_TO_VENDOR_tMap_1 + " of the output table 'RDC_ITEM_PAY_TO_VENDOR'.");
 ...
 */
// Start of branch "RDC_ITEM_PAY_TO_VENDOR"
if(RDC_ITEM_PAY_TO_VENDOR != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1
							...
							,"RDC_ITEM_PAY_TO_VENDOR"
						
						);
					}
					
    			if(log.isTraceEnabled()){
    				log.trace("RDC_ITEM_PAY_TO_VENDOR - " + (RDC_ITEM_PAY_TO_VENDOR==null? "": RDC_ITEM_PAY_TO_VENDOR.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(RDC_ITEM_PAY_TO_VENDOR.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, RDC_ITEM_PAY_TO_VENDOR.SITE_ID);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, RDC_ITEM_PAY_TO_VENDOR.ITEM_NO);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, RDC_ITEM_PAY_TO_VENDOR.VENDOR_NO);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.BUYER_NO == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, RDC_ITEM_PAY_TO_VENDOR.BUYER_NO);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.PRODUCT_SPECIALIST == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, RDC_ITEM_PAY_TO_VENDOR.PRODUCT_SPECIALIST);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.DEMAND_STATUS == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, RDC_ITEM_PAY_TO_VENDOR.DEMAND_STATUS);
}

                    pstmt_tDBOutput_1.setBoolean(7, RDC_ITEM_PAY_TO_VENDOR.IS_DELETED);

                    if(RDC_ITEM_PAY_TO_VENDOR.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, RDC_ITEM_PAY_TO_VENDOR.CREATED_ORIGIN);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(RDC_ITEM_PAY_TO_VENDOR.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.TIMESTAMP);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, RDC_ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(11, new java.sql.Timestamp(RDC_ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.TIMESTAMP);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.MIRF_SVOP == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, RDC_ITEM_PAY_TO_VENDOR.MIRF_SVOP);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.VENDOR_STORAGE == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, RDC_ITEM_PAY_TO_VENDOR.VENDOR_STORAGE);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.STOCK_TYPE == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, RDC_ITEM_PAY_TO_VENDOR.STOCK_TYPE);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.LONG_LEAD_TIME == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, RDC_ITEM_PAY_TO_VENDOR.LONG_LEAD_TIME);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.VEGETARIAN_FLAG == null) {
pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(16, RDC_ITEM_PAY_TO_VENDOR.VEGETARIAN_FLAG);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.ZERO_TRANSFAT_FLAG == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, RDC_ITEM_PAY_TO_VENDOR.ZERO_TRANSFAT_FLAG);
}

                    if(RDC_ITEM_PAY_TO_VENDOR.HALAL_FLAG == null) {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(18, RDC_ITEM_PAY_TO_VENDOR.HALAL_FLAG);
}
...
} // End of branch "RDC_ITEM_PAY_TO_VENDOR"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'RDC_ITEM_PAY_TO_VENDOR': " + count_RDC_ITEM_PAY_TO_VENDOR_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"RDC_ITEM_PAY_TO_VENDOR");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Rdc_Item_Pay_To_Vendor_Update_Inbound Rdc_Item_Pay_To_Vendor_Update_InboundClass = new Rdc_Item_Pay_To_Vendor_Update_Inbound();

        int exitCode = Rdc_Item_Pay_To_Vendor_Update_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Rdc_Item_Pay_To_Vendor_Update_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Rdc_Item_Pay_To_Vendor_Update_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Rdc_Item_Pay_To_Vendor_Update_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/rdc_item_pay_to_vendor_update_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Rdc_Item_Pay_To_Vendor_Update_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Rdc_Item_Pay_To_Vendor_Update_Inbound");
        }
...
/************************************************************************************************
 *     303606 characters generated by Talend Open Studio for Data Integration 
 *     on the November 30, 2022 at 10:08:28 AM IST
 ************************************************************************************************/