...
package sus_sli_etl.item_pay_to_vendor_inbound_0_1;
...
/**
 * Job: Item_Pay_To_Vendor_Inbound Purpose: Migrating data from USIBJGPF to ITEM_PAY_TO_VENDOR<br>
 * Description: Migrating data from USIBJGPF to ITEM_PAY_TO_VENDOR <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Item_Pay_To_Vendor_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Item_Pay_To_Vendor_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Item_Pay_To_Vendor_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Item_Pay_To_Vendor_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_BWSnYAQKEe2Hm-5Lqgv_5w", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_BWSnYAQKEe2Hm-5Lqgv_5w", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Item_Pay_To_Vendor_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Item_Pay_To_Vendor_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound) {
...
System.out.println("Starting the Migrating Data from USIBJGPF to ITEM_PAY_TO_VENDOR...........");
...
public static class ITEM_PAY_TO_VENDORStruct implements routines.system.IPersistableRow<ITEM_PAY_TO_VENDORStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String KOSHER_ITEM;

				public String getKOSHER_ITEM () {
					return this.KOSHER_ITEM;
				}
				
			    public String CHILD_NUTRITION_ITEM;

				public String getCHILD_NUTRITION_ITEM () {
					return this.CHILD_NUTRITION_ITEM;
				}
				
			    public String CONSIGNMENT_ITEM;

				public String getCONSIGNMENT_ITEM () {
					return this.CONSIGNMENT_ITEM;
				}
				
			    public String DROP_SHIP_VENDOR_FLAG;

				public String getDROP_SHIP_VENDOR_FLAG () {
					return this.DROP_SHIP_VENDOR_FLAG;
				}
			    ...
			    public String JGPF_SVOP;

				public String getJGPF_SVOP () {
					return this.JGPF_SVOP;
				}
	...
	public boolean equals(Object obj) {
		...
		final ITEM_PAY_TO_VENDORStruct other = (ITEM_PAY_TO_VENDORStruct) obj;
	...
	public void copyDataTo(ITEM_PAY_TO_VENDORStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.ITEM_NO = this.ITEM_NO;
	            other.VENDOR_NO = this.VENDOR_NO;
	            other.KOSHER_ITEM = this.KOSHER_ITEM;
	            other.CHILD_NUTRITION_ITEM = this.CHILD_NUTRITION_ITEM;
	            other.CONSIGNMENT_ITEM = this.CONSIGNMENT_ITEM;
	            other.DROP_SHIP_VENDOR_FLAG = this.DROP_SHIP_VENDOR_FLAG;
	            ...
	            other.JGPF_SVOP = this.JGPF_SVOP;
	            
	}

	public void copyKeysDataTo(ITEM_PAY_TO_VENDORStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.KOSHER_ITEM = readString(dis);
					
					this.CHILD_NUTRITION_ITEM = readString(dis);
					
					this.CONSIGNMENT_ITEM = readString(dis);
					
					this.DROP_SHIP_VENDOR_FLAG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.KOSHER_ITEM,dos);
					
					// String
				
						writeString(this.CHILD_NUTRITION_ITEM,dos);
					
					// String
				
						writeString(this.CONSIGNMENT_ITEM,dos);
					
					// String
				
						writeString(this.DROP_SHIP_VENDOR_FLAG,dos);
					...
					// String
						...
						writeString(this.JGPF_SVOP,dos);
    ...
    public String toString() {
		...
		sb.append(",KOSHER_ITEM="+KOSHER_ITEM);
		sb.append(",CHILD_NUTRITION_ITEM="+CHILD_NUTRITION_ITEM);
		sb.append(",CONSIGNMENT_ITEM="+CONSIGNMENT_ITEM);
		sb.append(",DROP_SHIP_VENDOR_FLAG="+DROP_SHIP_VENDOR_FLAG);
        	...
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(KOSHER_ITEM == null){
            				...
            				sb.append(KOSHER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(CHILD_NUTRITION_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CHILD_NUTRITION_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(CONSIGNMENT_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CONSIGNMENT_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(DROP_SHIP_VENDOR_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DROP_SHIP_VENDOR_FLAG);
            			}
     ...
     * Compare keys
     */
    public int compareTo(ITEM_PAY_TO_VENDORStruct other) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound = new byte[0];
			    ...
			    public String JGITEM;

				public String getJGITEM () {
					return this.JGITEM;
				}
				
			    public String JGVNBR;

				public String getJGVNBR () {
					return this.JGVNBR;
				}
				
			    public String JGITUS;

				public String getJGITUS () {
					return this.JGITUS;
				}
				
			    public String JGVCAT;

				public String getJGVCAT () {
					return this.JGVCAT;
				}
				
			    public BigDecimal JGITNW;

				public BigDecimal getJGITNW () {
					return this.JGITNW;
				}
				
			    public BigDecimal JGITTW;

				public BigDecimal getJGITTW () {
					return this.JGITTW;
				}
				
			    public BigDecimal JGITGW;

				public BigDecimal getJGITGW () {
					return this.JGITGW;
				}
				
			    public String JGMUPC;

				public String getJGMUPC () {
					return this.JGMUPC;
				}
				
			    public String JGMNPC;

				public String getJGMNPC () {
					return this.JGMNPC;
				}
				
			    public String JGITKO;

				public String getJGITKO () {
					return this.JGITKO;
				}
				
			    public String JGITKD;

				public String getJGITKD () {
					return this.JGITKD;
				}
				
			    public BigDecimal JGCUBE;

				public BigDecimal getJGCUBE () {
					return this.JGCUBE;
				}
				
			    public String JGCHNU;

				public String getJGCHNU () {
					return this.JGCHNU;
				}
				
			    public String JGITCG;

				public String getJGITCG () {
					return this.JGITCG;
				}
				
			    public String JGVPRF;

				public String getJGVPRF () {
					return this.JGVPRF;
				}
				
			    public BigDecimal JGMINI;

				public BigDecimal getJGMINI () {
					return this.JGMINI;
				}
				
			    public BigDecimal JGMAXI;

				public BigDecimal getJGMAXI () {
					return this.JGMAXI;
				}
				
			    public String JGMMTP;

				public String getJGMMTP () {
					return this.JGMMTP;
				}
				
			    public BigDecimal JGBMLT;

				public BigDecimal getJGBMLT () {
					return this.JGBMLT;
				}
				
			    public String JGBMTP;

				public String getJGBMTP () {
					return this.JGBMTP;
				}
				
			    public String JGIIMN;

				public String getJGIIMN () {
					return this.JGIIMN;
				}
				
			    public BigDecimal JGTIBU;

				public BigDecimal getJGTIBU () {
					return this.JGTIBU;
				}
				
			    public BigDecimal JGHIBU;

				public BigDecimal getJGHIBU () {
					return this.JGHIBU;
				}
				
			    public BigDecimal JGCPVU;

				public BigDecimal getJGCPVU () {
					return this.JGCPVU;
				}
				
			    public String JGININ;

				public String getJGININ () {
					return this.JGININ;
				}
				
			    public String JGCSCN;

				public String getJGCSCN () {
					return this.JGCSCN;
				}
				
			    public String JGDSVF;

				public String getJGDSVF () {
					return this.JGDSVF;
				}
				
			    public BigDecimal JGIUPC;

				public BigDecimal getJGIUPC () {
					return this.JGIUPC;
				}
				
			    public BigDecimal JGEADT;

				public BigDecimal getJGEADT () {
					return this.JGEADT;
				}
				
			    public BigDecimal JGEATM;

				public BigDecimal getJGEATM () {
					return this.JGEATM;
				}
				
			    public String JGEAID;

				public String getJGEAID () {
					return this.JGEAID;
				}
				
			    public BigDecimal JGMODT;

				public BigDecimal getJGMODT () {
					return this.JGMODT;
				}
				
			    public BigDecimal JGMOTM;

				public BigDecimal getJGMOTM () {
					return this.JGMOTM;
				}
				
			    public String JGMOID;

				public String getJGMOID () {
					return this.JGMOID;
				}
				
			    public String JGMOPG;

				public String getJGMOPG () {
					return this.JGMOPG;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Pay_To_Vendor_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.JGITEM = readString(dis);
					
					this.JGVNBR = readString(dis);
					
					this.JGITUS = readString(dis);
					
					this.JGVCAT = readString(dis);
					
						this.JGITNW = (BigDecimal) dis.readObject();
					
						this.JGITTW = (BigDecimal) dis.readObject();
					
						this.JGITGW = (BigDecimal) dis.readObject();
					
					this.JGMUPC = readString(dis);
					
					this.JGMNPC = readString(dis);
					
					this.JGITKO = readString(dis);
					
					this.JGITKD = readString(dis);
					
						this.JGCUBE = (BigDecimal) dis.readObject();
					
					this.JGCHNU = readString(dis);
					
					this.JGITCG = readString(dis);
					
					this.JGVPRF = readString(dis);
					
						this.JGMINI = (BigDecimal) dis.readObject();
					
						this.JGMAXI = (BigDecimal) dis.readObject();
					
					this.JGMMTP = readString(dis);
					
						this.JGBMLT = (BigDecimal) dis.readObject();
					
					this.JGBMTP = readString(dis);
					
					this.JGIIMN = readString(dis);
					
						this.JGTIBU = (BigDecimal) dis.readObject();
					
						this.JGHIBU = (BigDecimal) dis.readObject();
					
						this.JGCPVU = (BigDecimal) dis.readObject();
					
					this.JGININ = readString(dis);
					
					this.JGCSCN = readString(dis);
					
					this.JGDSVF = readString(dis);
					
						this.JGIUPC = (BigDecimal) dis.readObject();
					
						this.JGEADT = (BigDecimal) dis.readObject();
					
						this.JGEATM = (BigDecimal) dis.readObject();
					
					this.JGEAID = readString(dis);
					
						this.JGMODT = (BigDecimal) dis.readObject();
					
						this.JGMOTM = (BigDecimal) dis.readObject();
					
					this.JGMOID = readString(dis);
					
					this.JGMOPG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.JGITEM,dos);
					
					// String
				
						writeString(this.JGVNBR,dos);
					
					// String
				
						writeString(this.JGITUS,dos);
					
					// String
				
						writeString(this.JGVCAT,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGITNW);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGITTW);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGITGW);
					
					// String
				
						writeString(this.JGMUPC,dos);
					
					// String
				
						writeString(this.JGMNPC,dos);
					
					// String
				
						writeString(this.JGITKO,dos);
					
					// String
				
						writeString(this.JGITKD,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGCUBE);
					
					// String
				
						writeString(this.JGCHNU,dos);
					
					// String
				
						writeString(this.JGITCG,dos);
					
					// String
				
						writeString(this.JGVPRF,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGMINI);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGMAXI);
					
					// String
				
						writeString(this.JGMMTP,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGBMLT);
					
					// String
				
						writeString(this.JGBMTP,dos);
					
					// String
				
						writeString(this.JGIIMN,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGTIBU);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGHIBU);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGCPVU);
					
					// String
				
						writeString(this.JGININ,dos);
					
					// String
				
						writeString(this.JGCSCN,dos);
					
					// String
				
						writeString(this.JGDSVF,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGIUPC);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGEADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGEATM);
					
					// String
				
						writeString(this.JGEAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGMODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.JGMOTM);
					
					// String
				
						writeString(this.JGMOID,dos);
					
					// String
				
						writeString(this.JGMOPG,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("JGITEM="+JGITEM);
		sb.append(",JGVNBR="+JGVNBR);
		sb.append(",JGITUS="+JGITUS);
		sb.append(",JGVCAT="+JGVCAT);
		sb.append(",JGITNW="+String.valueOf(JGITNW));
		sb.append(",JGITTW="+String.valueOf(JGITTW));
		sb.append(",JGITGW="+String.valueOf(JGITGW));
		sb.append(",JGMUPC="+JGMUPC);
		sb.append(",JGMNPC="+JGMNPC);
		sb.append(",JGITKO="+JGITKO);
		sb.append(",JGITKD="+JGITKD);
		sb.append(",JGCUBE="+String.valueOf(JGCUBE));
		sb.append(",JGCHNU="+JGCHNU);
		sb.append(",JGITCG="+JGITCG);
		sb.append(",JGVPRF="+JGVPRF);
		sb.append(",JGMINI="+String.valueOf(JGMINI));
		sb.append(",JGMAXI="+String.valueOf(JGMAXI));
		sb.append(",JGMMTP="+JGMMTP);
		sb.append(",JGBMLT="+String.valueOf(JGBMLT));
		sb.append(",JGBMTP="+JGBMTP);
		sb.append(",JGIIMN="+JGIIMN);
		sb.append(",JGTIBU="+String.valueOf(JGTIBU));
		sb.append(",JGHIBU="+String.valueOf(JGHIBU));
		sb.append(",JGCPVU="+String.valueOf(JGCPVU));
		sb.append(",JGININ="+JGININ);
		sb.append(",JGCSCN="+JGCSCN);
		sb.append(",JGDSVF="+JGDSVF);
		sb.append(",JGIUPC="+String.valueOf(JGIUPC));
		sb.append(",JGEADT="+String.valueOf(JGEADT));
		sb.append(",JGEATM="+String.valueOf(JGEATM));
		sb.append(",JGEAID="+JGEAID);
		sb.append(",JGMODT="+String.valueOf(JGMODT));
		sb.append(",JGMOTM="+String.valueOf(JGMOTM));
		sb.append(",JGMOID="+JGMOID);
		sb.append(",JGMOPG="+JGMOPG);
	    sb.append("]");
...
ITEM_PAY_TO_VENDORStruct ITEM_PAY_TO_VENDOR = new ITEM_PAY_TO_VENDORStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ITEM_PAY_TO_VENDOR");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"ITEM_PAY_TO_VENDOR\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ITEM_PAY_TO_VENDOR");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ITEM_PAY_TO_VENDOR");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"VENDOR_NO\",\"KOSHER_ITEM\",\"CHILD_NUTRITION_ITEM\",\"CONSIGNMENT_ITEM\",\"DROP_SHIP_VENDOR_FLAG\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"JGPF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_ITEM_PAY_TO_VENDOR_tMap_1 = 0;
				
ITEM_PAY_TO_VENDORStruct ITEM_PAY_TO_VENDOR_tmp = new ITEM_PAY_TO_VENDORStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"USIBJGPF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    USIBJGPF.JGITEM,    USIBJGPF.JGVNBR,    USIBJGPF.JGITUS,    USIBJGPF.JGVCAT,    USIBJGPF.JGITNW,    USIBJGPF.JGITTW,    USIBJGPF.JGITGW,    USIBJGPF.JGMUPC,    USIBJGPF.JGMNPC,    USIBJGPF.JGITKO,    USIBJGPF.JGITKD,    USIBJGPF.JGCUBE,    USIBJGPF.JGCHNU,    USIBJGPF.JGITCG,    USIBJGPF.JGVPRF,    USIBJGPF.JGMINI,    USIBJGPF.JGMAXI,    USIBJGPF.JGMMTP,    USIBJGPF.JGBMLT,    USIBJGPF.JGBMTP,    USIBJGPF.JGIIMN,    USIBJGPF.JGTIBU,    USIBJGPF.JGHIBU,    USIBJGPF.JGCPVU,    USIBJGPF.JGININ,    USIBJGPF.JGCSCN,    USIBJGPF.JGDSVF,    USIBJGPF.JGIUPC,    USIBJGPF.JGEADT,    USIBJGPF.JGEATM,    USIBJGPF.JGEAID,    USIBJGPF.JGMODT,    USIBJGPF.JGMOTM,    USIBJGPF.JGMOID,    USIBJGPF.JGMOPG FROM USIBJGPF ORDER BY USIBJGPF.JGEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+" ORDER BY USIBJGPF.JGEADT DESC";
        	...
        	row1.JGITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.JGVNBR = null;
							} else {
	                         		
        	row1.JGVNBR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.JGITUS = null;
							} else {
	                         		
        	row1.JGITUS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.JGVCAT = null;
							} else {
	                         		
        	row1.JGVCAT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.JGITNW = null;
							} else {
		                          
            row1.JGITNW = rs_tDBInput_1.getBigDecimal(5);
            ...
            row1.JGITTW = rs_tDBInput_1.getBigDecimal(6);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.JGITGW = rs_tDBInput_1.getBigDecimal(7);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.JGMUPC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.JGMNPC = null;
							} else {
	                         		
        	row1.JGMNPC = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.JGITKO = null;
							} else {
	                         		
        	row1.JGITKO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.JGITKD = null;
							} else {
	                         		
        	row1.JGITKD = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.JGCUBE = null;
							} else {
		                          
            row1.JGCUBE = rs_tDBInput_1.getBigDecimal(12);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.JGCHNU = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.JGITCG = null;
							} else {
	                         		
        	row1.JGITCG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.JGVPRF = null;
							} else {
	                         		
        	row1.JGVPRF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.JGMINI = null;
							} else {
		                          
            row1.JGMINI = rs_tDBInput_1.getBigDecimal(16);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.JGMAXI = rs_tDBInput_1.getBigDecimal(17);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.JGMMTP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 18, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 19) {
								row1.JGBMLT = null;
							} else {
		                          
            row1.JGBMLT = rs_tDBInput_1.getBigDecimal(19);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.JGBMTP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.JGIIMN = null;
							} else {
	                         		
        	row1.JGIIMN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.JGTIBU = null;
							} else {
		                          
            row1.JGTIBU = rs_tDBInput_1.getBigDecimal(22);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.JGHIBU = rs_tDBInput_1.getBigDecimal(23);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.JGCPVU = rs_tDBInput_1.getBigDecimal(24);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.JGININ = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 26) {
								row1.JGCSCN = null;
							} else {
	                         		
        	row1.JGCSCN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 26, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 27) {
								row1.JGDSVF = null;
							} else {
	                         		
        	row1.JGDSVF = routines.system.JDBCUtil.getString(rs_tDBInput_1, 27, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 28) {
								row1.JGIUPC = null;
							} else {
		                          
            row1.JGIUPC = rs_tDBInput_1.getBigDecimal(28);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.JGEADT = rs_tDBInput_1.getBigDecimal(29);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.JGEATM = rs_tDBInput_1.getBigDecimal(30);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.JGEAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 32) {
								row1.JGMODT = null;
							} else {
		                          
            row1.JGMODT = rs_tDBInput_1.getBigDecimal(32);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.JGMOTM = rs_tDBInput_1.getBigDecimal(33);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.JGMOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 34, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 35) {
								row1.JGMOPG = null;
							} else {
	                         		
        	row1.JGMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 35, true);
		                    }
...
Var.JGITEM = CharSetHandling.convertEBCDICStrToASCII(row1.JGITEM) ;
Var.JGVNBR = CharSetHandling.convertEBCDICStrToASCII(row1.JGVNBR) ;
Var.JGITKO = CharSetHandling.convertEBCDICStrToASCII(row1.JGITKO) ;
Var.JGCHNU = CharSetHandling.convertEBCDICStrToASCII(row1.JGCHNU) ;
Var.JGITCG = CharSetHandling.convertEBCDICStrToASCII(row1.JGITCG) ;
Var.JGDSVF = CharSetHandling.convertEBCDICStrToASCII(row1.JGDSVF) ;// ###############################
        // ###############################
        // # Output tables

ITEM_PAY_TO_VENDOR = null;


// # Output table : 'ITEM_PAY_TO_VENDOR'
count_ITEM_PAY_TO_VENDOR_tMap_1++;

ITEM_PAY_TO_VENDOR_tmp.SITE_ID = context.opco;
ITEM_PAY_TO_VENDOR_tmp.ITEM_NO = Var.JGITEM;
ITEM_PAY_TO_VENDOR_tmp.VENDOR_NO = Var.JGVNBR;
ITEM_PAY_TO_VENDOR_tmp.KOSHER_ITEM = Var.JGITKO ;
ITEM_PAY_TO_VENDOR_tmp.CHILD_NUTRITION_ITEM = Var.JGCHNU;
ITEM_PAY_TO_VENDOR_tmp.CONSIGNMENT_ITEM = Var.JGITCG;
ITEM_PAY_TO_VENDOR_tmp.DROP_SHIP_VENDOR_FLAG = Var.JGDSVF;
ITEM_PAY_TO_VENDOR_tmp.IS_DELETED = false;
ITEM_PAY_TO_VENDOR_tmp.CREATED_ORIGIN = "SUS";
ITEM_PAY_TO_VENDOR_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_PAY_TO_VENDOR_tmp.UPDATED_ORIGIN = "SUS";
ITEM_PAY_TO_VENDOR_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_PAY_TO_VENDOR_tmp.JGPF_SVOP = context.svop;
ITEM_PAY_TO_VENDOR = ITEM_PAY_TO_VENDOR_tmp;
log.debug("tMap_1 - Outputting the record " + count_ITEM_PAY_TO_VENDOR_tMap_1 + " of the output table 'ITEM_PAY_TO_VENDOR'.");
 ...
 */
// Start of branch "ITEM_PAY_TO_VENDOR"
if(ITEM_PAY_TO_VENDOR != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("ITEM_PAY_TO_VENDOR - " + (ITEM_PAY_TO_VENDOR==null? "": ITEM_PAY_TO_VENDOR.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(ITEM_PAY_TO_VENDOR.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, ITEM_PAY_TO_VENDOR.SITE_ID);
}

                    if(ITEM_PAY_TO_VENDOR.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ITEM_PAY_TO_VENDOR.ITEM_NO);
}

                    if(ITEM_PAY_TO_VENDOR.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, ITEM_PAY_TO_VENDOR.VENDOR_NO);
}

                    if(ITEM_PAY_TO_VENDOR.KOSHER_ITEM == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, ITEM_PAY_TO_VENDOR.KOSHER_ITEM);
}

                    if(ITEM_PAY_TO_VENDOR.CHILD_NUTRITION_ITEM == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, ITEM_PAY_TO_VENDOR.CHILD_NUTRITION_ITEM);
}

                    if(ITEM_PAY_TO_VENDOR.CONSIGNMENT_ITEM == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, ITEM_PAY_TO_VENDOR.CONSIGNMENT_ITEM);
}

                    if(ITEM_PAY_TO_VENDOR.DROP_SHIP_VENDOR_FLAG == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, ITEM_PAY_TO_VENDOR.DROP_SHIP_VENDOR_FLAG);
}

                    pstmt_tDBOutput_1.setBoolean(8, ITEM_PAY_TO_VENDOR.IS_DELETED);

                    if(ITEM_PAY_TO_VENDOR.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, ITEM_PAY_TO_VENDOR.CREATED_ORIGIN);
}

                    if(ITEM_PAY_TO_VENDOR.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(10, new java.sql.Timestamp(ITEM_PAY_TO_VENDOR.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN);
}

                    if(ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(12, new java.sql.Timestamp(ITEM_PAY_TO_VENDOR.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_PAY_TO_VENDOR.JGPF_SVOP == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, ITEM_PAY_TO_VENDOR.JGPF_SVOP);
}
...
} // End of branch "ITEM_PAY_TO_VENDOR"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'ITEM_PAY_TO_VENDOR': " + count_ITEM_PAY_TO_VENDOR_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ITEM_PAY_TO_VENDOR");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Item_Pay_To_Vendor_Inbound Item_Pay_To_Vendor_InboundClass = new Item_Pay_To_Vendor_Inbound();

        int exitCode = Item_Pay_To_Vendor_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Item_Pay_To_Vendor_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Item_Pay_To_Vendor_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Item_Pay_To_Vendor_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/item_pay_to_vendor_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Item_Pay_To_Vendor_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Item_Pay_To_Vendor_Inbound");
        }
...
/************************************************************************************************
 *     292179 characters generated by Talend Open Studio for Data Integration 
