...
public class Buyer_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Buyer_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Buyer_Inbound.class);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(INVENTORY_HELD == null){
        					sb.append("<null>");
        				}else{
            				sb.append(INVENTORY_HELD);
            			}
            		
        			sb.append("|");
        		
        				if(BUYER_DESCRIPTION == null){
        					sb.append("<null>");
        				}else{
            				sb.append(BUYER_DESCRIPTION);
            			}
        			...
        			sb.append("|");
        				...
        				if(CONFIRM_TAX == null){
            				...
            				sb.append(CONFIRM_TAX);
            			}
            		
        			sb.append("|");
        		
        				if(CONFIRM_PHONE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CONFIRM_PHONE);
            			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"BUYER\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"BUYER_NO\",\"BUYER_NAME\",\"USER_ID\",\"INVENTORY_HELD\",\"BUYER_DESCRIPTION\",\"CONFIRM_TAX\",\"CONFIRM_PHONE\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"FERP_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"REFERP\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    REFERP.REFCAT,    REFERP.REFKEY,    REFERP.REFDAT FROM REFERP WHERE REFERP.REFCAT='JB'\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("PROPERTIES" + " = " + "context.SUS_Additional_Params");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("REFCAT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFKEY")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("REFDAT")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
...
BUYER_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
BUYER_tmp.UPDATED_ORIGIN = "SUS";
BUYER_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
BUYER_tmp.FERP_SVOP = context.svop;
BUYER = BUYER_tmp;
log.debug("tMap_1 - Outputting the record " + count_BUYER_tMap_1 + " of the output table 'BUYER'.");
...
if(BUYER != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("BUYER - " + (BUYER==null? "": BUYER.toLogString()));
    			}
...
} else {pstmt_tDBOutput_1.setString(1, BUYER.SITE_ID);
}

                    if(BUYER.BUYER_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, BUYER.BUYER_NO);
}

                    if(BUYER.BUYER_NAME == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, BUYER.BUYER_NAME);
}

                    if(BUYER.USER_ID == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, BUYER.USER_ID);
}

                    if(BUYER.INVENTORY_HELD == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, BUYER.INVENTORY_HELD);
}

                    if(BUYER.BUYER_DESCRIPTION == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, BUYER.BUYER_DESCRIPTION);
}

                    if(BUYER.CONFIRM_TAX == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, BUYER.CONFIRM_TAX);
}

                    if(BUYER.CONFIRM_PHONE == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, BUYER.CONFIRM_PHONE);
}
...
} else {pstmt_tDBOutput_1.setString(10, BUYER.CREATED_ORIGIN);
}

                    if(BUYER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(11, new java.sql.Timestamp(BUYER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(12, BUYER.UPDATED_ORIGIN);
}

                    if(BUYER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(13, new java.sql.Timestamp(BUYER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(14, BUYER.FERP_SVOP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'BUYER': " + count_BUYER_tMap_1 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Buyer_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Buyer_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Buyer_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Buyer_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/buyer_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Buyer_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Buyer_Inbound");
        }
...
/************************************************************************************************
 *     272932 characters generated by Talend Open Studio for Data Integration 
