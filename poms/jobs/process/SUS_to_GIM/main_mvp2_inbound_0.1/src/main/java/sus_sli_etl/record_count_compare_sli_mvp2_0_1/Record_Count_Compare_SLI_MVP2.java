...
package sus_sli_etl.record_count_compare_sli_mvp2_0_1;
...
/**
 * Job: Record_Count_Compare_SLI_MVP2 Purpose: Verification of migrated data from SUS to SLI<br>
 * Description: Verification of migrated data from SUS to SLI <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Record_Count_Compare_SLI_MVP2 implements TalendJob {
	static {System.setProperty("TalendJob.log", "Record_Count_Compare_SLI_MVP2.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Record_Count_Compare_SLI_MVP2.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Record_Count_Compare_SLI_MVP2";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Record_Count_Compare_SLI_MVP2.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Record_Count_Compare_SLI_MVP2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2 = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2 = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP2) {
 ...
 */
    ...
    public static void main(String[] args){
        final Record_Count_Compare_SLI_MVP2 Record_Count_Compare_SLI_MVP2Class = new Record_Count_Compare_SLI_MVP2();

        int exitCode = Record_Count_Compare_SLI_MVP2Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Record_Count_Compare_SLI_MVP2' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Record_Count_Compare_SLI_MVP2' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Record_Count_Compare_SLI_MVP2.class.getClassLoader().getResourceAsStream("sus_sli_etl/record_count_compare_sli_mvp2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Record_Count_Compare_SLI_MVP2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Record_Count_Compare_SLI_MVP2");
        }
...
/************************************************************************************************
 *     275572 characters generated by Talend Open Studio for Data Integration 
 *     on the November 30, 2022 at 10:08:06 AM IST
 ************************************************************************************************/