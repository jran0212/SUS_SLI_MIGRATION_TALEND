...
package sus_sli_etl.strategic_broker_inbound_0_1;
...
/**
 * Job: Strategic_Broker_Inbound Purpose: Migrating data from IMVBSERF to
 * Strategic Broker<br>
 * Description: Migrating data from IMVBSERF to Strategic Broker <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Strategic_Broker_Inbound implements TalendJob {
	...
	private final String jobName = "Strategic_Broker_Inbound";
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_Xc9pAANZEe2mdNKMHGUS9Q", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_Xc9pAANZEe2mdNKMHGUS9Q", "0.1");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Strategic_Broker_Inbound.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Strategic_Broker_Inbound.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class Main_Flow_MeterStruct implements routines.system.IPersistableRow<Main_Flow_MeterStruct> {
		final static byte[] commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Inbound = new byte[0];
		static byte[] commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound.length) {
					if (length < 1024 && commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound.length == 0) {
						commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound = new byte[1024];
					} else {
						commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound, 0, length);
				strReturn = new String(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound, 0, length);
				strReturn = new String(commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Inbound) {
...
///////////////////////    			
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("Starting the Migrating Data from IMVBSERF to STRATEGIC_BROKER...........");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		public String getCONTACT_TELEPHONE_NO() {
			return this.CONTACT_TELEPHONE_NO;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.BROKER_ID == null) ? 0 : this.BROKER_ID.hashCode());
		...
		public boolean equals(Object obj) {
			...
			} else if (!this.BROKER_ID.equals(other.BROKER_ID))
		...
		public void copyDataTo(row2Struct other) {
			...
			other.CONTACT_TELEPHONE_NO = this.CONTACT_TELEPHONE_NO;
			other.FAX = this.FAX;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Inbound) {
				...
				try {
					...
					this.CONTACT_TELEPHONE_NO = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.CONTACT_TELEPHONE_NO, dos);
		...
		public String toString() {
			...
			sb.append(",CONTACT_TELEPHONE_NO=" + CONTACT_TELEPHONE_NO);
			sb.append(",FAX=" + FAX);
			sb.append(",CITY=" + CITY);
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.BROKER_ID, other.BROKER_ID);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class STRATEGIC_BROKERStruct implements routines.system.IPersistableRow<STRATEGIC_BROKERStruct> {
		final static byte[] commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Inbound = new byte[0];
		static byte[] commonByteArray_SUS_SLI_ETL_Strategic_Broker_Inbound = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final STRATEGIC_BROKERStruct other = (STRATEGIC_BROKERStruct) obj;
		...
		public void copyDataTo(STRATEGIC_BROKERStruct other) {
		...
		public void copyKeysDataTo(STRATEGIC_BROKERStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(STRATEGIC_BROKERStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public String SEOPCO;

		public String getSEOPCO() {
			return this.SEOPCO;
		}

		public String SEBRID;

		public String getSEBRID() {
			return this.SEBRID;
		}
		...
		public String SECNTT;

		public String getSECNTT() {
			return this.SECNTT;
		}

		public String SEADR1;

		public String getSEADR1() {
			return this.SEADR1;
		}

		public String SEADR2;

		public String getSEADR2() {
			return this.SEADR2;
		}

		public String SEADR3;

		public String getSEADR3() {
			return this.SEADR3;
		}

		public String SEADR4;

		public String getSEADR4() {
			return this.SEADR4;
		}
		...
		public String SECFAX;

		public String getSECFAX() {
			return this.SECFAX;
		}

		public String SEMCIT;

		public String getSEMCIT() {
			return this.SEMCIT;
		}

		public String SESTAE;

		public String getSESTAE() {
			return this.SESTAE;
		}

		public String SEMZIP;

		public String getSEMZIP() {
			return this.SEMZIP;
		}

		public String SECY20;

		public String getSECY20() {
			return this.SECY20;
		}

		public String SEREML;

		public String getSEREML() {
			return this.SEREML;
		}

		public String SEFL16;

		public String getSEFL16() {
			return this.SEFL16;
		}

		public BigDecimal SERDCN;

		public BigDecimal getSERDCN() {
			return this.SERDCN;
		}

		public BigDecimal SEEADT;

		public BigDecimal getSEEADT() {
			return this.SEEADT;
		}

		public BigDecimal SEEATM;

		public BigDecimal getSEEATM() {
			return this.SEEATM;
		}

		public String SEEAID;

		public String getSEEAID() {
			return this.SEEAID;
		}

		public BigDecimal SEMODT;

		public BigDecimal getSEMODT() {
			return this.SEMODT;
		}

		public BigDecimal SEMOTM;

		public BigDecimal getSEMOTM() {
			return this.SEMOTM;
		}

		public String SEMOID;

		public String getSEMOID() {
			return this.SEMOID;
		}

		public String SEMOPG;

		public String getSEMOPG() {
			return this.SEMOPG;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SUS_SLI_ETL_Strategic_Broker_Inbound) {
				...
				try {
					...
					this.SEOPCO = readString(dis);

					this.SEBRID = readString(dis);

					this.SECONT = readString(dis);

					this.SECNTT = readString(dis);

					this.SEADR1 = readString(dis);

					this.SEADR2 = readString(dis);

					this.SEADR3 = readString(dis);

					this.SEADR4 = readString(dis);

					this.SETEL = readString(dis);

					this.SECFAX = readString(dis);

					this.SEMCIT = readString(dis);

					this.SESTAE = readString(dis);

					this.SEMZIP = readString(dis);

					this.SECY20 = readString(dis);

					this.SEREML = readString(dis);

					this.SEFL16 = readString(dis);

					this.SERDCN = (BigDecimal) dis.readObject();

					this.SEEADT = (BigDecimal) dis.readObject();

					this.SEEATM = (BigDecimal) dis.readObject();

					this.SEEAID = readString(dis);

					this.SEMODT = (BigDecimal) dis.readObject();

					this.SEMOTM = (BigDecimal) dis.readObject();

					this.SEMOID = readString(dis);

					this.SEMOPG = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.SEOPCO, dos);

				// String

				writeString(this.SEBRID, dos);

				// String

				writeString(this.SECONT, dos);

				// String

				writeString(this.SECNTT, dos);

				// String

				writeString(this.SEADR1, dos);

				// String

				writeString(this.SEADR2, dos);

				// String

				writeString(this.SEADR3, dos);

				// String

				writeString(this.SEADR4, dos);

				// String

				writeString(this.SETEL, dos);

				// String

				writeString(this.SECFAX, dos);

				// String

				writeString(this.SEMCIT, dos);

				// String

				writeString(this.SESTAE, dos);

				// String

				writeString(this.SEMZIP, dos);

				// String

				writeString(this.SECY20, dos);

				// String

				writeString(this.SEREML, dos);

				// String

				writeString(this.SEFL16, dos);

				// BigDecimal

				dos.writeObject(this.SERDCN);

				// BigDecimal

				dos.writeObject(this.SEEADT);

				// BigDecimal

				dos.writeObject(this.SEEATM);

				// String

				writeString(this.SEEAID, dos);

				// BigDecimal

				dos.writeObject(this.SEMODT);

				// BigDecimal

				dos.writeObject(this.SEMOTM);

				// String

				writeString(this.SEMOID, dos);

				// String

				writeString(this.SEMOPG, dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("SEOPCO=" + SEOPCO);
			sb.append(",SEBRID=" + SEBRID);
			sb.append(",SECONT=" + SECONT);
			sb.append(",SECNTT=" + SECNTT);
			sb.append(",SEADR1=" + SEADR1);
			sb.append(",SEADR2=" + SEADR2);
			sb.append(",SEADR3=" + SEADR3);
			sb.append(",SEADR4=" + SEADR4);
			sb.append(",SETEL=" + SETEL);
			sb.append(",SECFAX=" + SECFAX);
			sb.append(",SEMCIT=" + SEMCIT);
			sb.append(",SESTAE=" + SESTAE);
			sb.append(",SEMZIP=" + SEMZIP);
			sb.append(",SECY20=" + SECY20);
			sb.append(",SEREML=" + SEREML);
			sb.append(",SEFL16=" + SEFL16);
			sb.append(",SERDCN=" + String.valueOf(SERDCN));
			sb.append(",SEEADT=" + String.valueOf(SEEADT));
			sb.append(",SEEATM=" + String.valueOf(SEEATM));
			sb.append(",SEEAID=" + SEEAID);
			sb.append(",SEMODT=" + String.valueOf(SEMODT));
			sb.append(",SEMOTM=" + String.valueOf(SEMOTM));
			sb.append(",SEMOID=" + SEMOID);
			sb.append(",SEMOPG=" + SEMOPG);
			sb.append("]");
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				STRATEGIC_BROKERStruct STRATEGIC_BROKER = new STRATEGIC_BROKERStruct();
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "STRATEGIC_BROKER");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("STRATEGIC_BROKER");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("STRATEGIC_BROKER");
				}
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1
								+ "\" WHERE \"SITE_ID\" = ? AND \"BROKER_ID\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"SITE_ID\",\"BROKER_ID\",\"CONTACT_PERSON_NAME\",\"CONTACT_TITLE\",\"ADDRESS_LINE_1\",\"ADDRESS_LINE_2\",\"ADDRESS_LINE_3\",\"ADDRESS_LINE_4\",\"CONTACT_TELEPHONE_NO\",\"FAX\",\"CITY\",\"STATE\",\"ZIP_CODE\",\"COUNTRY\",\"EMAIL\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"UPDATED_PROGRAM_ID\",\"IS_DELETED\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"CONTACT_PERSON_NAME\" = ?,\"CONTACT_TITLE\" = ?,\"ADDRESS_LINE_1\" = ?,\"ADDRESS_LINE_2\" = ?,\"ADDRESS_LINE_3\" = ?,\"ADDRESS_LINE_4\" = ?,\"CONTACT_TELEPHONE_NO\" = ?,\"FAX\" = ?,\"CITY\" = ?,\"STATE\" = ?,\"ZIP_CODE\" = ?,\"COUNTRY\" = ?,\"EMAIL\" = ?,\"CREATED_TIMESTAMP\" = ?,\"CREATED_USER_ID\" = ?,\"UPDATED_TIMESTAMP\" = ?,\"UPDATED_USER_ID\" = ?,\"UPDATED_PROGRAM_ID\" = ?,\"IS_DELETED\" = ? WHERE \"SITE_ID\" = ? AND \"BROKER_ID\" = ?";
...
// ###############################
// # Outputs initialization
				STRATEGIC_BROKERStruct STRATEGIC_BROKER_tmp = new STRATEGIC_BROKERStruct();
// ###############################
				...
				String dbquery_tDBInput_1 = "SELECT \n  IMVBSERF.SEOPCO, \n  IMVBSERF.SEBRID, \n  IMVBSERF.SECONT, \n  IMVBSERF.SECNTT, \n  IMVBSERF.SEADR1, \n  IMVBSERF."
						...
						+ "ERF.SESTAE, \n  IMVBSERF.SEMZIP, \n  IMVBSERF.SECY20, \n  IMVBSERF.SEREML, \n  IMVBSERF.SEFL16, \n  IMVBSERF.SERDCN, \n  IMVBS"
						+ "ERF.SEEADT, \n  IMVBSERF.SEEATM, \n  IMVBSERF.SEEAID, \n  IMVBSERF.SEMODT, \n  IMVBSERF.SEMOTM, \n  IMVBSERF.SEMOID, \n  IMVBS"
						+ "ERF.SEMOPG\nFROM IMVBSERF ORDER BY IMVBSERF.SEEADT DESC";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row1.SEOPCO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
						}
						if (colQtyInRs_tDBInput_1 < 2) {
							row1.SEBRID = null;
						} else {

							row1.SEBRID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row1.SECONT = null;
						} else {

							row1.SECONT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.SECNTT = null;
						} else {

							row1.SECNTT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row1.SEADR1 = null;
						} else {

							row1.SEADR1 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, true);
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							row1.SEADR2 = null;
						} else {

							row1.SEADR2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							row1.SEADR3 = null;
						} else {

							row1.SEADR3 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, true);
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							row1.SEADR4 = null;
						} else {

							row1.SEADR4 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, true);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							row1.SETEL = null;
						} else {

							row1.SETEL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, true);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row1.SECFAX = null;
						} else {

							row1.SECFAX = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, true);
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							row1.SEMCIT = null;
						} else {

							row1.SEMCIT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, true);
						}
						if (colQtyInRs_tDBInput_1 < 12) {
							row1.SESTAE = null;
						} else {

							row1.SESTAE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, true);
						}
						if (colQtyInRs_tDBInput_1 < 13) {
							row1.SEMZIP = null;
						} else {

							row1.SEMZIP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, true);
						}
						if (colQtyInRs_tDBInput_1 < 14) {
							row1.SECY20 = null;
						} else {

							row1.SECY20 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, true);
						}
						if (colQtyInRs_tDBInput_1 < 15) {
							row1.SEREML = null;
						} else {

							row1.SEREML = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, true);
						}
						if (colQtyInRs_tDBInput_1 < 16) {
							row1.SEFL16 = null;
						} else {

							row1.SEFL16 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, true);
						}
						if (colQtyInRs_tDBInput_1 < 17) {
							row1.SERDCN = null;
						} else {

							row1.SERDCN = rs_tDBInput_1.getBigDecimal(17);
						...
						if (colQtyInRs_tDBInput_1 < 18) {
							...
							row1.SEEADT = rs_tDBInput_1.getBigDecimal(18);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 19) {
							...
							row1.SEEATM = rs_tDBInput_1.getBigDecimal(19);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 20) {
							...
							row1.SEEAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, true);
						}
						if (colQtyInRs_tDBInput_1 < 21) {
							row1.SEMODT = null;
						} else {

							row1.SEMODT = rs_tDBInput_1.getBigDecimal(21);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 22) {
							...
							row1.SEMOTM = rs_tDBInput_1.getBigDecimal(22);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 23) {
							...
							row1.SEMOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, true);
						}
						if (colQtyInRs_tDBInput_1 < 24) {
							row1.SEMOPG = null;
						} else {

							row1.SEMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, true);
						}
						...
						{ // start of Var scope
							...
							Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.SEEADT.toString(),
									row1.SEEATM.toString());
							Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.SEMODT.toString(),
									row1.SEMOTM.toString());// ###############################
							// ###############################
							// # Output tables

							STRATEGIC_BROKER = null;

// # Output table : 'STRATEGIC_BROKER'
							STRATEGIC_BROKER_tmp.SITE_ID = row1.SEOPCO;
							STRATEGIC_BROKER_tmp.BROKER_ID = row1.SEBRID;
							STRATEGIC_BROKER_tmp.CONTACT_PERSON_NAME = row1.SECONT;
							STRATEGIC_BROKER_tmp.CONTACT_TITLE = row1.SECNTT;
							STRATEGIC_BROKER_tmp.ADDRESS_LINE_1 = row1.SEADR1;
							STRATEGIC_BROKER_tmp.ADDRESS_LINE_2 = row1.SEADR2;
							STRATEGIC_BROKER_tmp.ADDRESS_LINE_3 = row1.SEADR3;
							STRATEGIC_BROKER_tmp.ADDRESS_LINE_4 = row1.SEADR4;
							STRATEGIC_BROKER_tmp.CONTACT_TELEPHONE_NO = row1.SETEL;
							STRATEGIC_BROKER_tmp.FAX = row1.SECFAX;
							STRATEGIC_BROKER_tmp.CITY = row1.SEMCIT;
							STRATEGIC_BROKER_tmp.STATE = row1.SESTAE;
							STRATEGIC_BROKER_tmp.ZIP_CODE = row1.SEMZIP;
							STRATEGIC_BROKER_tmp.COUNTRY = row1.SECY20;
							STRATEGIC_BROKER_tmp.EMAIL = row1.SEREML;
							STRATEGIC_BROKER_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP != ""
									? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", Var.CREATED_TIMESTAMP)
									: null;
							STRATEGIC_BROKER_tmp.CREATED_USER_ID = row1.SEEAID;
							STRATEGIC_BROKER_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP != ""
									? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", Var.UPDATED_TIMESTAMP)
									: null;
							STRATEGIC_BROKER_tmp.UPDATED_USER_ID = row1.SEMOID;
							STRATEGIC_BROKER_tmp.UPDATED_PROGRAM_ID = row1.SEMOPG;
							STRATEGIC_BROKER_tmp.IS_DELETED = false;
							STRATEGIC_BROKER = STRATEGIC_BROKER_tmp;
// ###############################
						 ...
						 */
// Start of branch "STRATEGIC_BROKER"
						if (STRATEGIC_BROKER != null) {
							row2 = null;
							...
							if (STRATEGIC_BROKER.SITE_ID == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(1, STRATEGIC_BROKER.SITE_ID);
							}

							if (STRATEGIC_BROKER.BROKER_ID == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, STRATEGIC_BROKER.BROKER_ID);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (STRATEGIC_BROKER.CONTACT_PERSON_NAME == null) {
									pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(1, STRATEGIC_BROKER.CONTACT_PERSON_NAME);
								}

								if (STRATEGIC_BROKER.CONTACT_TITLE == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(2, STRATEGIC_BROKER.CONTACT_TITLE);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_1 == null) {
									pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3, STRATEGIC_BROKER.ADDRESS_LINE_1);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_2 == null) {
									pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(4, STRATEGIC_BROKER.ADDRESS_LINE_2);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_3 == null) {
									pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(5, STRATEGIC_BROKER.ADDRESS_LINE_3);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_4 == null) {
									pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(6, STRATEGIC_BROKER.ADDRESS_LINE_4);
								}

								if (STRATEGIC_BROKER.CONTACT_TELEPHONE_NO == null) {
									pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(7, STRATEGIC_BROKER.CONTACT_TELEPHONE_NO);
								}

								if (STRATEGIC_BROKER.FAX == null) {
									pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(8, STRATEGIC_BROKER.FAX);
								}

								if (STRATEGIC_BROKER.CITY == null) {
									pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(9, STRATEGIC_BROKER.CITY);
								}

								if (STRATEGIC_BROKER.STATE == null) {
									pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(10, STRATEGIC_BROKER.STATE);
								}

								if (STRATEGIC_BROKER.ZIP_CODE == null) {
									pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(11, STRATEGIC_BROKER.ZIP_CODE);
								}

								if (STRATEGIC_BROKER.COUNTRY == null) {
									pstmtUpdate_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(12, STRATEGIC_BROKER.COUNTRY);
								}

								if (STRATEGIC_BROKER.EMAIL == null) {
									pstmtUpdate_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(13, STRATEGIC_BROKER.EMAIL);
								}

								if (STRATEGIC_BROKER.CREATED_TIMESTAMP != null) {
									pstmtUpdate_tDBOutput_1.setTimestamp(14,
											new java.sql.Timestamp(STRATEGIC_BROKER.CREATED_TIMESTAMP.getTime()));
								} else {
									pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.TIMESTAMP);
								}

								if (STRATEGIC_BROKER.CREATED_USER_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(15, STRATEGIC_BROKER.CREATED_USER_ID);
								}

								if (STRATEGIC_BROKER.UPDATED_TIMESTAMP != null) {
									pstmtUpdate_tDBOutput_1.setTimestamp(16,
											new java.sql.Timestamp(STRATEGIC_BROKER.UPDATED_TIMESTAMP.getTime()));
								} else {
									pstmtUpdate_tDBOutput_1.setNull(16, java.sql.Types.TIMESTAMP);
								}

								if (STRATEGIC_BROKER.UPDATED_USER_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(17, STRATEGIC_BROKER.UPDATED_USER_ID);
								}

								if (STRATEGIC_BROKER.UPDATED_PROGRAM_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(18, STRATEGIC_BROKER.UPDATED_PROGRAM_ID);
								}

								if (STRATEGIC_BROKER.IS_DELETED == null) {
									pstmtUpdate_tDBOutput_1.setNull(19, java.sql.Types.BOOLEAN);
								} else {
									pstmtUpdate_tDBOutput_1.setBoolean(19, STRATEGIC_BROKER.IS_DELETED);
								}

								if (STRATEGIC_BROKER.SITE_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(20 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(20 + count_tDBOutput_1, STRATEGIC_BROKER.SITE_ID);
								}

								if (STRATEGIC_BROKER.BROKER_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(21 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(21 + count_tDBOutput_1,
											STRATEGIC_BROKER.BROKER_ID);
								}
								...
								try {
									...
									nb_line_tDBOutput_1++;
									row2 = new row2Struct();
									row2.SITE_ID = STRATEGIC_BROKER.SITE_ID;
									row2.BROKER_ID = STRATEGIC_BROKER.BROKER_ID;
									row2.CONTACT_PERSON_NAME = STRATEGIC_BROKER.CONTACT_PERSON_NAME;
									row2.CONTACT_TITLE = STRATEGIC_BROKER.CONTACT_TITLE;
									row2.ADDRESS_LINE_1 = STRATEGIC_BROKER.ADDRESS_LINE_1;
									row2.ADDRESS_LINE_2 = STRATEGIC_BROKER.ADDRESS_LINE_2;
									row2.ADDRESS_LINE_3 = STRATEGIC_BROKER.ADDRESS_LINE_3;
									row2.ADDRESS_LINE_4 = STRATEGIC_BROKER.ADDRESS_LINE_4;
									row2.CONTACT_TELEPHONE_NO = STRATEGIC_BROKER.CONTACT_TELEPHONE_NO;
									row2.FAX = STRATEGIC_BROKER.FAX;
									row2.CITY = STRATEGIC_BROKER.CITY;
									row2.STATE = STRATEGIC_BROKER.STATE;
									row2.ZIP_CODE = STRATEGIC_BROKER.ZIP_CODE;
									row2.COUNTRY = STRATEGIC_BROKER.COUNTRY;
									row2.EMAIL = STRATEGIC_BROKER.EMAIL;
									row2.CREATED_TIMESTAMP = STRATEGIC_BROKER.CREATED_TIMESTAMP;
									row2.CREATED_USER_ID = STRATEGIC_BROKER.CREATED_USER_ID;
									row2.UPDATED_TIMESTAMP = STRATEGIC_BROKER.UPDATED_TIMESTAMP;
									row2.UPDATED_USER_ID = STRATEGIC_BROKER.UPDATED_USER_ID;
									row2.UPDATED_PROGRAM_ID = STRATEGIC_BROKER.UPDATED_PROGRAM_ID;
									row2.IS_DELETED = STRATEGIC_BROKER.IS_DELETED;
								...
								if (STRATEGIC_BROKER.SITE_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, STRATEGIC_BROKER.SITE_ID);
								}

								if (STRATEGIC_BROKER.BROKER_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, STRATEGIC_BROKER.BROKER_ID);
								}

								if (STRATEGIC_BROKER.CONTACT_PERSON_NAME == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, STRATEGIC_BROKER.CONTACT_PERSON_NAME);
								}

								if (STRATEGIC_BROKER.CONTACT_TITLE == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(4, STRATEGIC_BROKER.CONTACT_TITLE);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_1 == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(5, STRATEGIC_BROKER.ADDRESS_LINE_1);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_2 == null) {
									pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(6, STRATEGIC_BROKER.ADDRESS_LINE_2);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_3 == null) {
									pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(7, STRATEGIC_BROKER.ADDRESS_LINE_3);
								}

								if (STRATEGIC_BROKER.ADDRESS_LINE_4 == null) {
									pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(8, STRATEGIC_BROKER.ADDRESS_LINE_4);
								}

								if (STRATEGIC_BROKER.CONTACT_TELEPHONE_NO == null) {
									pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(9, STRATEGIC_BROKER.CONTACT_TELEPHONE_NO);
								}

								if (STRATEGIC_BROKER.FAX == null) {
									pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(10, STRATEGIC_BROKER.FAX);
								}

								if (STRATEGIC_BROKER.CITY == null) {
									pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(11, STRATEGIC_BROKER.CITY);
								}

								if (STRATEGIC_BROKER.STATE == null) {
									pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(12, STRATEGIC_BROKER.STATE);
								}

								if (STRATEGIC_BROKER.ZIP_CODE == null) {
									pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(13, STRATEGIC_BROKER.ZIP_CODE);
								}

								if (STRATEGIC_BROKER.COUNTRY == null) {
									pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(14, STRATEGIC_BROKER.COUNTRY);
								}

								if (STRATEGIC_BROKER.EMAIL == null) {
									pstmtInsert_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(15, STRATEGIC_BROKER.EMAIL);
								}
								...
								if (STRATEGIC_BROKER.CREATED_USER_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(17, STRATEGIC_BROKER.CREATED_USER_ID);
								}
								...
								if (STRATEGIC_BROKER.UPDATED_USER_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(19, STRATEGIC_BROKER.UPDATED_USER_ID);
								}

								if (STRATEGIC_BROKER.UPDATED_PROGRAM_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(20, STRATEGIC_BROKER.UPDATED_PROGRAM_ID);
								}

								if (STRATEGIC_BROKER.IS_DELETED == null) {
									pstmtInsert_tDBOutput_1.setNull(21, java.sql.Types.BOOLEAN);
								} else {
									pstmtInsert_tDBOutput_1.setBoolean(21, STRATEGIC_BROKER.IS_DELETED);
								}
...
///////////////////////		
								...
								if (row2.SITE_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.SITE_ID));
								...
								if (row2.BROKER_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.BROKER_ID));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row2.CONTACT_PERSON_NAME != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row2.CONTACT_PERSON_NAME));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row2.CONTACT_TITLE != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row2.CONTACT_TITLE));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row2.ADDRESS_LINE_1 != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row2.ADDRESS_LINE_1));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row2.ADDRESS_LINE_2 != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row2.ADDRESS_LINE_2));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row2.ADDRESS_LINE_3 != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row2.ADDRESS_LINE_3));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row2.ADDRESS_LINE_4 != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row2.ADDRESS_LINE_4));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row2.CONTACT_TELEPHONE_NO != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row2.CONTACT_TELEPHONE_NO));
								...
								if (row2.FAX != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.FAX));
								...
								if (row2.ZIP_CODE != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.ZIP_CODE));
								...
								if (row2.CREATED_TIMESTAMP != null) { //
									...
									strBuffer_tLogRow_1
											.append(FormatterUtils.format_Date(row2.CREATED_TIMESTAMP, "dd-MM-yyyy"));
								...
								if (row2.CREATED_USER_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.CREATED_USER_ID));
								...
								if (row2.UPDATED_TIMESTAMP != null) { //
									...
									strBuffer_tLogRow_1
											.append(FormatterUtils.format_Date(row2.UPDATED_TIMESTAMP, "dd-MM-yyyy"));
								...
								if (row2.UPDATED_USER_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.UPDATED_USER_ID));
								...
								if (row2.UPDATED_PROGRAM_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.UPDATED_PROGRAM_ID));
								...
								if (row2.IS_DELETED != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row2.IS_DELETED));
...
///////////////////////    			
						...
						} // End of branch "STRATEGIC_BROKER"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "STRATEGIC_BROKER");
				}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Strategic_Broker_Inbound Strategic_Broker_InboundClass = new Strategic_Broker_Inbound();

		int exitCode = Strategic_Broker_InboundClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Strategic_Broker_Inbound.class.getClassLoader().getResourceAsStream(
					"sus_sli_etl/strategic_broker_inbound_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Strategic_Broker_Inbound.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Strategic_Broker_Inbound");
		}
...
/************************************************************************************************
 * 262837 characters generated by Talend Open Studio for Data Integration on the
 * August 14, 2022 at 1:54:03 PM IST
 ************************************************************************************************/