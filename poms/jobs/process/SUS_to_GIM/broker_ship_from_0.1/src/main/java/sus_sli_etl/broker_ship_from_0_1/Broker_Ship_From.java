...
/**
 * Job: Broker_Ship_From Purpose: Migrating data from referp to
 * BROKER_SHIP_FROM<br>
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "SITE_ID", "BROKER_ID", "SHIP_POINT", "IS_DELETED", "errorCode",
						"errorMessage", });
...
///////////////////////    			
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"SITE_ID\",\"BROKER_ID\",\"SHIP_POINT\",\"IS_DELETED\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"SHIP_POINT\" = ?,\"IS_DELETED\" = ? WHERE \"SITE_ID\" = ? AND \"BROKER_ID\" = ?";
...
// ###############################
				...
				String dbquery_tDBInput_1 = "SELECT \n  REFERP.REFCAT, \n  REFERP.REFKEY, \n  REFERP.REFDAT\nFROM REFERP WHERE REFERP.REFCAT='AEK' LIMIT 1000";
...
// Start of branch "BROKER_SHIP_FROM"
						if (BROKER_SHIP_FROM != null) {
							...
							if (BROKER_SHIP_FROM.SITE_ID == null) {
								...
								pstmt_tDBOutput_1.setString(1, BROKER_SHIP_FROM.SITE_ID);
							}

							if (BROKER_SHIP_FROM.BROKER_ID == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, BROKER_SHIP_FROM.BROKER_ID);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (BROKER_SHIP_FROM.SHIP_POINT == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, BROKER_SHIP_FROM.SHIP_POINT);
								}

								if (BROKER_SHIP_FROM.IS_DELETED == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.BOOLEAN);
								} else {
									pstmtUpdate_tDBOutput_1.setBoolean(2, BROKER_SHIP_FROM.IS_DELETED);
								}

								if (BROKER_SHIP_FROM.SITE_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, BROKER_SHIP_FROM.SITE_ID);
								}
								...
								try {
									...
									nb_line_tDBOutput_1++;
									row3 = new row3Struct();
									row3.SITE_ID = BROKER_SHIP_FROM.SITE_ID;
									row3.BROKER_ID = BROKER_SHIP_FROM.BROKER_ID;
									row3.SHIP_POINT = BROKER_SHIP_FROM.SHIP_POINT;
									row3.IS_DELETED = BROKER_SHIP_FROM.IS_DELETED;
								...
								if (BROKER_SHIP_FROM.SITE_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, BROKER_SHIP_FROM.SITE_ID);
								}

								if (BROKER_SHIP_FROM.BROKER_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, BROKER_SHIP_FROM.BROKER_ID);
								}

								if (BROKER_SHIP_FROM.SHIP_POINT == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, BROKER_SHIP_FROM.SHIP_POINT);
								}

								if (BROKER_SHIP_FROM.IS_DELETED == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.BOOLEAN);
								} else {
									pstmtInsert_tDBOutput_1.setBoolean(4, BROKER_SHIP_FROM.IS_DELETED);
								}
...
///////////////////////		
								...
								if (row3.BROKER_ID != null) { //
									row_tLogRow_1[1] = String.valueOf(row3.BROKER_ID);

								} //

								if (row3.SHIP_POINT != null) { //
									row_tLogRow_1[2] = String.valueOf(row3.SHIP_POINT);

								} //

								if (row3.IS_DELETED != null) { //
									row_tLogRow_1[3] = String.valueOf(row3.IS_DELETED);

								} //

								if (row3.errorCode != null) { //
									row_tLogRow_1[4] = String.valueOf(row3.errorCode);

								} //

								if (row3.errorMessage != null) { //
									row_tLogRow_1[5] = String.valueOf(row3.errorMessage);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Broker_Ship_From.class.getClassLoader()
					.getResourceAsStream("sus_sli_etl/broker_ship_from_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Broker_Ship_From.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Broker_Ship_From");
		}
...
/************************************************************************************************
 * 101184 characters generated by Talend Open Studio for Data Integration on the
 * July 21, 2022 at 5:05:51 PM IST
 ************************************************************************************************/