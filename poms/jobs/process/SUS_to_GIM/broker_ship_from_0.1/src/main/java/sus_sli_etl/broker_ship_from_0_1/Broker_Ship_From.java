...
package sus_sli_etl.broker_ship_from_0_1;
...
/**
 * Job: Broker_Ship_From Purpose: Migrating data from referp to BROKER_SHIP_FROM<br>
 * Description: Migrating data from referp to BROKER_SHIP_FROM <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Broker_Ship_From implements TalendJob {
	static {System.setProperty("TalendJob.log", "Broker_Ship_From.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Broker_Ship_From.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Broker_Ship_From";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Broker_Ship_From.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Broker_Ship_From.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Broker_Ship_From = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Broker_Ship_From = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Broker_Ship_From.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Broker_Ship_From.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Broker_Ship_From = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Broker_Ship_From = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Broker_Ship_From, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Broker_Ship_From, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Broker_Ship_From, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Broker_Ship_From, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Broker_Ship_From) {
 ...
 */
    ...
    public static void main(String[] args){
        final Broker_Ship_From Broker_Ship_FromClass = new Broker_Ship_From();

        int exitCode = Broker_Ship_FromClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Broker_Ship_From' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Broker_Ship_From' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Broker_Ship_From.class.getClassLoader().getResourceAsStream("sus_sli_etl/broker_ship_from_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Broker_Ship_From.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Broker_Ship_From");
        }
...
/************************************************************************************************
 *     255319 characters generated by Talend Open Studio for Data Integration 
 *     on the October 27, 2022 at 4:46:28 PM IST
 ************************************************************************************************/