...
package sus_sli_etl.inbound_scheduling_header_inbound_0_1;
...
/**
 * Job: Inbound_Scheduling_Header_Inbound Purpose: Migrating data from IMLDVXPF to INBOUND_SCHEDULING_HEADER<br>
 * Description: Migrating data from IMLDVXPF to INBOUND_SCHEDULING_HEADER <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Inbound_Scheduling_Header_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Inbound_Scheduling_Header_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Inbound_Scheduling_Header_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Inbound_Scheduling_Header_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_PEcYkER4Ee22MZO8DsrjmQ", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_PEcYkER4Ee22MZO8DsrjmQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Inbound_Scheduling_Header_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Inbound_Scheduling_Header_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound) {
...
System.out.println("Starting the Migrating Data from IMLDVXPF to INBOUND_SCHEDULING_HEADER...........");
...
public static class INBOUND_SCHEDULING_HEADERStruct implements routines.system.IPersistableRow<INBOUND_SCHEDULING_HEADERStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public java.util.Date SCHEDULE_DATE;
			    ...
			    public BigDecimal ADDRESS_SEQUENCE_NUMBER;

				public BigDecimal getADDRESS_SEQUENCE_NUMBER () {
					return this.ADDRESS_SEQUENCE_NUMBER;
				}
			    ...
			    public String VXPF_SVOP;

				public String getVXPF_SVOP () {
					return this.VXPF_SVOP;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.LOAD_NO == null) ? 0 : this.LOAD_NO.hashCode());
						...
						result = prime * result + ((this.SCHEDULE_DATE == null) ? 0 : this.SCHEDULE_DATE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final INBOUND_SCHEDULING_HEADERStruct other = (INBOUND_SCHEDULING_HEADERStruct) obj;
		
						if (this.LOAD_NO == null) {
							if (other.LOAD_NO != null)
								return false;
						
						} else if (!this.LOAD_NO.equals(other.LOAD_NO))
						...
						if (this.SCHEDULE_DATE == null) {
							if (other.SCHEDULE_DATE != null)
								return false;
						
						} else if (!this.SCHEDULE_DATE.equals(other.SCHEDULE_DATE))
	...
	public void copyDataTo(INBOUND_SCHEDULING_HEADERStruct other) {

		other.LOAD_NO = this.LOAD_NO;
	            other.SITE_ID = this.SITE_ID;
	            other.PURCHASE_ORDER_NO = this.PURCHASE_ORDER_NO;
	            other.SCHEDULE_DATE = this.SCHEDULE_DATE;
	            other.LOAD_STATUS = this.LOAD_STATUS;
	            other.BUYER_NO = this.BUYER_NO;
	            other.VENDOR_NO = this.VENDOR_NO;
	            other.ADDRESS_SEQUENCE_NUMBER = this.ADDRESS_SEQUENCE_NUMBER;
	            other.CREATED_TIMESTAMP = this.CREATED_TIMESTAMP;
	            other.CREATED_USER_ID = this.CREATED_USER_ID;
	            other.VXPF_SVOP = this.VXPF_SVOP;
	...
	public void copyKeysDataTo(INBOUND_SCHEDULING_HEADERStruct other) {
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.SCHEDULE_DATE,dos);
					
					// String
				
						writeString(this.LOAD_STATUS,dos);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.ADDRESS_SEQUENCE_NUMBER);
					...
					// String
						...
						writeString(this.VXPF_SVOP,dos);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(ADDRESS_SEQUENCE_NUMBER == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ADDRESS_SEQUENCE_NUMBER);
            			}
     ...
     * Compare keys
     */
    public int compareTo(INBOUND_SCHEDULING_HEADERStruct other) {

		int returnValue = -1;
		
						returnValue = checkNullsAndCompare(this.LOAD_NO, other.LOAD_NO);
						if(returnValue != 0) {
							return returnValue;
						}
						...
						returnValue = checkNullsAndCompare(this.SCHEDULE_DATE, other.SCHEDULE_DATE);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound = new byte[0];
			    ...
			    public String VXLOAD;

				public String getVXLOAD () {
					return this.VXLOAD;
				}
				
			    public String VXPO;

				public String getVXPO () {
					return this.VXPO;
				}
				
			    public BigDecimal VXSCDT;

				public BigDecimal getVXSCDT () {
					return this.VXSCDT;
				}
				
			    public String VXLDST;

				public String getVXLDST () {
					return this.VXLDST;
				}
				
			    public String VXBUYR;

				public String getVXBUYR () {
					return this.VXBUYR;
				}
				
			    public String VXVNBR;

				public String getVXVNBR () {
					return this.VXVNBR;
				}
				
			    public BigDecimal VXADCD;

				public BigDecimal getVXADCD () {
					return this.VXADCD;
				}
				
			    public BigDecimal VXEADT;

				public BigDecimal getVXEADT () {
					return this.VXEADT;
				}
				
			    public BigDecimal VXEATM;

				public BigDecimal getVXEATM () {
					return this.VXEATM;
				}
				
			    public String VXEAID;

				public String getVXEAID () {
					return this.VXEAID;
				}
				
			    public BigDecimal VXMODT;

				public BigDecimal getVXMODT () {
					return this.VXMODT;
				}
				
			    public BigDecimal VXMOTM;

				public BigDecimal getVXMOTM () {
					return this.VXMOTM;
				}
				
			    public String VXMOID;

				public String getVXMOID () {
					return this.VXMOID;
				}
				
			    public String VXMOPG;

				public String getVXMOPG () {
					return this.VXMOPG;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Inbound_Scheduling_Header_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.VXLOAD = readString(dis);
					
					this.VXPO = readString(dis);
					
						this.VXSCDT = (BigDecimal) dis.readObject();
					
					this.VXLDST = readString(dis);
					
					this.VXBUYR = readString(dis);
					
					this.VXVNBR = readString(dis);
					
						this.VXADCD = (BigDecimal) dis.readObject();
					
						this.VXEADT = (BigDecimal) dis.readObject();
					
						this.VXEATM = (BigDecimal) dis.readObject();
					
					this.VXEAID = readString(dis);
					
						this.VXMODT = (BigDecimal) dis.readObject();
					
						this.VXMOTM = (BigDecimal) dis.readObject();
					
					this.VXMOID = readString(dis);
					
					this.VXMOPG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.VXLOAD,dos);
					
					// String
				
						writeString(this.VXPO,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VXSCDT);
					
					// String
				
						writeString(this.VXLDST,dos);
					
					// String
				
						writeString(this.VXBUYR,dos);
					
					// String
				
						writeString(this.VXVNBR,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VXADCD);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VXEADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VXEATM);
					
					// String
				
						writeString(this.VXEAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VXMODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.VXMOTM);
					
					// String
				
						writeString(this.VXMOID,dos);
					
					// String
				
						writeString(this.VXMOPG,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("VXLOAD="+VXLOAD);
		sb.append(",VXPO="+VXPO);
		sb.append(",VXSCDT="+String.valueOf(VXSCDT));
		sb.append(",VXLDST="+VXLDST);
		sb.append(",VXBUYR="+VXBUYR);
		sb.append(",VXVNBR="+VXVNBR);
		sb.append(",VXADCD="+String.valueOf(VXADCD));
		sb.append(",VXEADT="+String.valueOf(VXEADT));
		sb.append(",VXEATM="+String.valueOf(VXEATM));
		sb.append(",VXEAID="+VXEAID);
		sb.append(",VXMODT="+String.valueOf(VXMODT));
		sb.append(",VXMOTM="+String.valueOf(VXMOTM));
		sb.append(",VXMOID="+VXMOID);
		sb.append(",VXMOPG="+VXMOPG);
	    sb.append("]");
...
INBOUND_SCHEDULING_HEADERStruct INBOUND_SCHEDULING_HEADER = new INBOUND_SCHEDULING_HEADERStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"INBOUND_SCHEDULING_HEADER");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"INBOUND_SCHEDULING_HEADER\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("INBOUND_SCHEDULING_HEADER");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("INBOUND_SCHEDULING_HEADER");
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"LOAD_STATUS\" = ?,\"BUYER_NO\" = ?,\"VENDOR_NO\" = ?,\"ADDRESS_SEQUENCE_NUMBER\" = ?,\"CREATED_TIMESTAMP\" = ?,\"CREATED_USER_ID\" = ?,\"VXPF_SVOP\" = ?,\"IS_ACTIVE\" = ?,\"UPDATED_USER_ID\" = ?,\"UPDATED_PROGRAM_ID\" = ?,\"UPDATED_TIMESTAMP\" = ?,\"IS_DELETED\" = ?,\"CREATED_ORIGIN\" = ?,\"CREATED_ORIGIN_TIMESTAMP\" = ?,\"UPDATED_ORIGIN\" = ?,\"UPDATED_ORIGIN_TIMESTAMP\" = ? WHERE \"LOAD_NO\" = ? AND \"SITE_ID\" = ? AND \"PURCHASE_ORDER_NO\" = ? AND \"SCHEDULE_DATE\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"LOAD_NO\",\"SITE_ID\",\"PURCHASE_ORDER_NO\",\"SCHEDULE_DATE\",\"LOAD_STATUS\",\"BUYER_NO\",\"VENDOR_NO\",\"ADDRESS_SEQUENCE_NUMBER\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"VXPF_SVOP\",\"IS_ACTIVE\",\"UPDATED_USER_ID\",\"UPDATED_PROGRAM_ID\",\"UPDATED_TIMESTAMP\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_INBOUND_SCHEDULING_HEADER_tMap_1 = 0;
				
INBOUND_SCHEDULING_HEADERStruct INBOUND_SCHEDULING_HEADER_tmp = new INBOUND_SCHEDULING_HEADERStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"IMLDVXPF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    IMLDVXPF.VXLOAD,    IMLDVXPF.VXPO,    IMLDVXPF.VXSCDT,    IMLDVXPF.VXLDST,    IMLDVXPF.VXBUYR,    IMLDVXPF.VXVNBR,    IMLDVXPF.VXADCD,    IMLDVXPF.VXEADT,    IMLDVXPF.VXEATM,    IMLDVXPF.VXEAID,    IMLDVXPF.VXMODT,    IMLDVXPF.VXMOTM,    IMLDVXPF.VXMOID,    IMLDVXPF.VXMOPG FROM IMLDVXPF ORDER BY IMLDVXPF.VXEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"VNBR, \n  IMLDVXPF.VXADCD, \n  IMLDVXPF.VXEADT, \n  IMLDVXPF.VXEATM, \n  IMLDVXPF.VXEAID, \n  IMLDVXPF.VXMODT, \n  IMLDVXPF.VX"
+"MOTM, \n  IMLDVXPF.VXMOID, \n  IMLDVXPF.VXMOPG\nFROM IMLDVXPF ORDER BY IMLDVXPF.VXEADT DESC";
        	...
        	row1.VXLOAD = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.VXPO = null;
							} else {
	                         		
        	row1.VXPO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.VXSCDT = null;
							} else {
		                          
            row1.VXSCDT = rs_tDBInput_1.getBigDecimal(3);
        	...
        	row1.VXLDST = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.VXBUYR = null;
							} else {
	                         		
        	row1.VXBUYR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.VXVNBR = null;
							} else {
	                         		
        	row1.VXVNBR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.VXADCD = null;
							} else {
		                          
            row1.VXADCD = rs_tDBInput_1.getBigDecimal(7);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.VXEADT = rs_tDBInput_1.getBigDecimal(8);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.VXEATM = rs_tDBInput_1.getBigDecimal(9);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.VXEAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.VXMODT = null;
							} else {
		                          
            row1.VXMODT = rs_tDBInput_1.getBigDecimal(11);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.VXMOTM = rs_tDBInput_1.getBigDecimal(12);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.VXMOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.VXMOPG = null;
							} else {
	                         		
        	row1.VXMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, true);
		                    }
...
Var.SCHEDULE_DATE = TimeStampConverting.convertToDate(row1.VXSCDT.toString()) ;
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.VXEADT.toString(),row1.VXEATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.VXMODT.toString(),row1.VXMOTM.toString()) ;// ###############################
        // ###############################
        // # Output tables

INBOUND_SCHEDULING_HEADER = null;


// # Output table : 'INBOUND_SCHEDULING_HEADER'
count_INBOUND_SCHEDULING_HEADER_tMap_1++;

INBOUND_SCHEDULING_HEADER_tmp.LOAD_NO = row1.VXLOAD ;
INBOUND_SCHEDULING_HEADER_tmp.SITE_ID = context.opco;
INBOUND_SCHEDULING_HEADER_tmp.PURCHASE_ORDER_NO = row1.VXPO;
INBOUND_SCHEDULING_HEADER_tmp.SCHEDULE_DATE = Var.SCHEDULE_DATE!=""? TalendDate.parseDate("dd-MM-yyyy",Var.SCHEDULE_DATE):TalendDate.parseDate("dd-MM-yyyy","01-01-0001") ;
INBOUND_SCHEDULING_HEADER_tmp.LOAD_STATUS = row1.VXLDST;
INBOUND_SCHEDULING_HEADER_tmp.BUYER_NO = row1.VXBUYR;
INBOUND_SCHEDULING_HEADER_tmp.VENDOR_NO = row1.VXVNBR;
INBOUND_SCHEDULING_HEADER_tmp.ADDRESS_SEQUENCE_NUMBER = row1.VXADCD;
INBOUND_SCHEDULING_HEADER_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
INBOUND_SCHEDULING_HEADER_tmp.CREATED_USER_ID = row1.VXEAID;
INBOUND_SCHEDULING_HEADER_tmp.VXPF_SVOP = context.svop;
INBOUND_SCHEDULING_HEADER_tmp.IS_ACTIVE = true;
INBOUND_SCHEDULING_HEADER_tmp.UPDATED_USER_ID = row1.VXMOID;
INBOUND_SCHEDULING_HEADER_tmp.UPDATED_PROGRAM_ID = row1.VXMOPG;
INBOUND_SCHEDULING_HEADER_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
INBOUND_SCHEDULING_HEADER_tmp.IS_DELETED = false;
INBOUND_SCHEDULING_HEADER_tmp.CREATED_ORIGIN = "SUS";
INBOUND_SCHEDULING_HEADER_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
INBOUND_SCHEDULING_HEADER_tmp.UPDATED_ORIGIN = "SUS";
INBOUND_SCHEDULING_HEADER_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
INBOUND_SCHEDULING_HEADER = INBOUND_SCHEDULING_HEADER_tmp;
log.debug("tMap_1 - Outputting the record " + count_INBOUND_SCHEDULING_HEADER_tMap_1 + " of the output table 'INBOUND_SCHEDULING_HEADER'.");
 ...
 */
// Start of branch "INBOUND_SCHEDULING_HEADER"
if(INBOUND_SCHEDULING_HEADER != null) { 
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1
							...
							,"INBOUND_SCHEDULING_HEADER"
						
						);
					}
					
    			if(log.isTraceEnabled()){
    				log.trace("INBOUND_SCHEDULING_HEADER - " + (INBOUND_SCHEDULING_HEADER==null? "": INBOUND_SCHEDULING_HEADER.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
            int updateFlag_tDBOutput_1=0;
                    if(INBOUND_SCHEDULING_HEADER.LOAD_STATUS == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, INBOUND_SCHEDULING_HEADER.LOAD_STATUS);
}

                    if(INBOUND_SCHEDULING_HEADER.BUYER_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, INBOUND_SCHEDULING_HEADER.BUYER_NO);
}

                    if(INBOUND_SCHEDULING_HEADER.VENDOR_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, INBOUND_SCHEDULING_HEADER.VENDOR_NO);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(4, INBOUND_SCHEDULING_HEADER.ADDRESS_SEQUENCE_NUMBER);

                    if(INBOUND_SCHEDULING_HEADER.CREATED_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.CREATED_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.TIMESTAMP);
}

                    if(INBOUND_SCHEDULING_HEADER.CREATED_USER_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6, INBOUND_SCHEDULING_HEADER.CREATED_USER_ID);
}

                    if(INBOUND_SCHEDULING_HEADER.VXPF_SVOP == null) {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(7, INBOUND_SCHEDULING_HEADER.VXPF_SVOP);
}

                    if(INBOUND_SCHEDULING_HEADER.IS_ACTIVE == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(8, INBOUND_SCHEDULING_HEADER.IS_ACTIVE);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_USER_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(9, INBOUND_SCHEDULING_HEADER.UPDATED_USER_ID);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_PROGRAM_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(10, INBOUND_SCHEDULING_HEADER.UPDATED_PROGRAM_ID);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(11, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.UPDATED_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.TIMESTAMP);
}

                    if(INBOUND_SCHEDULING_HEADER.IS_DELETED == null) {
pstmtUpdate_tDBOutput_1.setNull(12, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(12, INBOUND_SCHEDULING_HEADER.IS_DELETED);
}

                    if(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(13, INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN);
}

                    if(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(14, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.TIMESTAMP);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(15, INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN);
}

                    if(INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(16, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(16, java.sql.Types.TIMESTAMP);
}


                    if(INBOUND_SCHEDULING_HEADER.LOAD_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(17 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(17 + count_tDBOutput_1, INBOUND_SCHEDULING_HEADER.LOAD_NO);
}


                    if(INBOUND_SCHEDULING_HEADER.SITE_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(18 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(18 + count_tDBOutput_1, INBOUND_SCHEDULING_HEADER.SITE_ID);
}


                    if(INBOUND_SCHEDULING_HEADER.PURCHASE_ORDER_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(19 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(19 + count_tDBOutput_1, INBOUND_SCHEDULING_HEADER.PURCHASE_ORDER_NO);
}


                    if(INBOUND_SCHEDULING_HEADER.SCHEDULE_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(20 + count_tDBOutput_1, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.SCHEDULE_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(20 + count_tDBOutput_1, java.sql.Types.TIMESTAMP);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, INBOUND_SCHEDULING_HEADER.LOAD_NO);
}

                        if(INBOUND_SCHEDULING_HEADER.SITE_ID == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, INBOUND_SCHEDULING_HEADER.SITE_ID);
}

                        if(INBOUND_SCHEDULING_HEADER.PURCHASE_ORDER_NO == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, INBOUND_SCHEDULING_HEADER.PURCHASE_ORDER_NO);
}

                        if(INBOUND_SCHEDULING_HEADER.SCHEDULE_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.SCHEDULE_DATE.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(5, INBOUND_SCHEDULING_HEADER.LOAD_STATUS);
}

                        if(INBOUND_SCHEDULING_HEADER.BUYER_NO == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, INBOUND_SCHEDULING_HEADER.BUYER_NO);
}

                        if(INBOUND_SCHEDULING_HEADER.VENDOR_NO == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(7, INBOUND_SCHEDULING_HEADER.VENDOR_NO);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(8, INBOUND_SCHEDULING_HEADER.ADDRESS_SEQUENCE_NUMBER);

                        if(INBOUND_SCHEDULING_HEADER.CREATED_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.CREATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(10, INBOUND_SCHEDULING_HEADER.CREATED_USER_ID);
}

                        if(INBOUND_SCHEDULING_HEADER.VXPF_SVOP == null) {
pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(11, INBOUND_SCHEDULING_HEADER.VXPF_SVOP);
}

                        if(INBOUND_SCHEDULING_HEADER.IS_ACTIVE == null) {
pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_1.setBoolean(12, INBOUND_SCHEDULING_HEADER.IS_ACTIVE);
}

                        if(INBOUND_SCHEDULING_HEADER.UPDATED_USER_ID == null) {
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(13, INBOUND_SCHEDULING_HEADER.UPDATED_USER_ID);
}

                        if(INBOUND_SCHEDULING_HEADER.UPDATED_PROGRAM_ID == null) {
pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(14, INBOUND_SCHEDULING_HEADER.UPDATED_PROGRAM_ID);
}

                        if(INBOUND_SCHEDULING_HEADER.UPDATED_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(15, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.UPDATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setBoolean(16, INBOUND_SCHEDULING_HEADER.IS_DELETED);
}

                        if(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN == null) {
pstmtInsert_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(17, INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN);
}

                        if(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(19, INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN);
}

                        if(INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(20, new java.sql.Timestamp(INBOUND_SCHEDULING_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} // End of branch "INBOUND_SCHEDULING_HEADER"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'INBOUND_SCHEDULING_HEADER': " + count_INBOUND_SCHEDULING_HEADER_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"INBOUND_SCHEDULING_HEADER");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Inbound_Scheduling_Header_Inbound Inbound_Scheduling_Header_InboundClass = new Inbound_Scheduling_Header_Inbound();

        int exitCode = Inbound_Scheduling_Header_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Inbound_Scheduling_Header_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Inbound_Scheduling_Header_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Inbound_Scheduling_Header_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/inbound_scheduling_header_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Inbound_Scheduling_Header_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Inbound_Scheduling_Header_Inbound");
        }
...
/************************************************************************************************
 *     280156 characters generated by Talend Open Studio for Data Integration 
 *     on the October 28, 2022 at 10:58:11 AM IST
 ************************************************************************************************/