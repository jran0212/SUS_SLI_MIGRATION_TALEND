...
/**
 * Job: PO_Reason_Code_Inbound Purpose: Migrating data from IMPOL7RF to PO_REASON_CODE<br>
...
public class PO_Reason_Code_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "PO_Reason_Code_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(PO_Reason_Code_Inbound.class);
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_GL8AUAjvEe27itDdtrBWEw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_GL8AUAjvEe27itDdtrBWEw", "0.1");
...
System.out.println("Starting the Migrating Data from IMPOL7RF to PO_REASON_CODE...........");
...
public static class PO_REASON_CODEStruct implements routines.system.IPersistableRow<PO_REASON_CODEStruct> {
    ...
    public String loopKey;
			    ...
			    public String L7RF_SVOP;

				public String getL7RF_SVOP () {
					return this.L7RF_SVOP;
				}
	...
	public void copyDataTo(PO_REASON_CODEStruct other) {
		...
		other.PURCHASE_ORDER_NO = this.PURCHASE_ORDER_NO;
	            ...
	            other.L7RF_SVOP = this.L7RF_SVOP;
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.L7RF_SVOP,dos);
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"PO_REASON_CODE\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"PURCHASE_ORDER_NO\",\"SITE_ID\",\"ITEM_NO\",\"RECOMMENDED_ORDER_SEQ_NO\",\"ORIGINAL_QTY\",\"CONFIRMED_QTY\",\"REASON_CODE\",\"STATUS\",\"VERSION_NO\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"CREATED_PROGRAM_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"UPDATED_PROGRAM_ID\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"L7RF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_PO_REASON_CODE_tMap_1 = 0;
...
+"L7FUN4, \n  IMPOL7RF.L7FUN5, \n  IMPOL7RF.L7FUF1, \n  IMPOL7RF.L7FUF2, \n  IMPOL7RF.L7FUF3, \n  IMPOL7RF.L7F1ID, \n  IMPOL7RF."
+"L7F2ID, \n  IMPOL7RF.L7EADT, \n  IMPOL7RF.L7EATM, \n  IMPOL7RF.L7EAID, \n  IMPOL7RF.L7EAPG, \n  IMPOL7RF.L7MODT, \n  IMPOL7RF."
+"L7MOTM, \n  IMPOL7RF.L7MOID, \n  IMPOL7RF.L7MOPG\nFROM IMPOL7RF ORDER BY IMPOL7RF.L7EADT DESC";
...
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.L7EADT.toString(), row1.L7EATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.L7MODT.toString(), row1.L7MOTM.toString()) ;// ###############################
        // ###############################
        // # Output tables
...
count_PO_REASON_CODE_tMap_1++;

PO_REASON_CODE_tmp.PURCHASE_ORDER_NO = row1.L7TRPO ;
PO_REASON_CODE_tmp.SITE_ID = context.opco;
...
PO_REASON_CODE_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
PO_REASON_CODE_tmp.CREATED_USER_ID = row1.L7EAID ;
PO_REASON_CODE_tmp.CREATED_PROGRAM_ID = row1.L7EAPG ;
PO_REASON_CODE_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
...
PO_REASON_CODE_tmp.CREATED_ORIGIN = "SUS";
PO_REASON_CODE_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
PO_REASON_CODE_tmp.UPDATED_ORIGIN = "SUS";
PO_REASON_CODE_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
PO_REASON_CODE_tmp.L7RF_SVOP = context.svop;
PO_REASON_CODE = PO_REASON_CODE_tmp;
log.debug("tMap_1 - Outputting the record " + count_PO_REASON_CODE_tMap_1 + " of the output table 'PO_REASON_CODE'.");
...
if(PO_REASON_CODE != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("PO_REASON_CODE - " + (PO_REASON_CODE==null? "": PO_REASON_CODE.toLogString()));
    			}
...
} else {pstmt_tDBOutput_1.setString(1, PO_REASON_CODE.PURCHASE_ORDER_NO);
}

                    if(PO_REASON_CODE.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, PO_REASON_CODE.SITE_ID);
}

                    if(PO_REASON_CODE.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, PO_REASON_CODE.ITEM_NO);
}

                    pstmt_tDBOutput_1.setBigDecimal(4, PO_REASON_CODE.RECOMMENDED_ORDER_SEQ_NO);

                    pstmt_tDBOutput_1.setBigDecimal(5, PO_REASON_CODE.ORIGINAL_QTY);

                    pstmt_tDBOutput_1.setBigDecimal(6, PO_REASON_CODE.CONFIRMED_QTY);

                    if(PO_REASON_CODE.REASON_CODE == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, PO_REASON_CODE.REASON_CODE);
}

                    if(PO_REASON_CODE.STATUS == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, PO_REASON_CODE.STATUS);
}

                    pstmt_tDBOutput_1.setBigDecimal(9, PO_REASON_CODE.VERSION_NO);

                    if(PO_REASON_CODE.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(10, new java.sql.Timestamp(PO_REASON_CODE.CREATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(11, PO_REASON_CODE.CREATED_USER_ID);
}

                    if(PO_REASON_CODE.CREATED_PROGRAM_ID == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, PO_REASON_CODE.CREATED_PROGRAM_ID);
}

                    if(PO_REASON_CODE.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(13, new java.sql.Timestamp(PO_REASON_CODE.UPDATED_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(14, PO_REASON_CODE.UPDATED_USER_ID);
}

                    if(PO_REASON_CODE.UPDATED_PROGRAM_ID == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, PO_REASON_CODE.UPDATED_PROGRAM_ID);
}

                    pstmt_tDBOutput_1.setBoolean(16, PO_REASON_CODE.IS_DELETED);

                    if(PO_REASON_CODE.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, PO_REASON_CODE.CREATED_ORIGIN);
}

                    if(PO_REASON_CODE.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(PO_REASON_CODE.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.TIMESTAMP);
}

                    if(PO_REASON_CODE.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(19, PO_REASON_CODE.UPDATED_ORIGIN);
}

                    if(PO_REASON_CODE.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(20, new java.sql.Timestamp(PO_REASON_CODE.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(20, java.sql.Types.TIMESTAMP);
}

                    if(PO_REASON_CODE.L7RF_SVOP == null) {
pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(21, PO_REASON_CODE.L7RF_SVOP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'PO_REASON_CODE': " + count_PO_REASON_CODE_tMap_1 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = PO_Reason_Code_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'PO_Reason_Code_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'PO_Reason_Code_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = PO_Reason_Code_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/po_reason_code_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PO_Reason_Code_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PO_Reason_Code_Inbound");
        }
...
/************************************************************************************************
 *     291255 characters generated by Talend Open Studio for Data Integration 
