...
package sus_sli_etl.sli_main_mvp2_inbound_0_1;
...
/**
 * Job: SLI_Main_MVP2_Inbound Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class SLI_Main_MVP2_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "SLI_Main_MVP2_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(SLI_Main_MVP2_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "SLI_Main_MVP2_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_YGlw0ECOEe2loaSGMM96aw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_YGlw0ECOEe2loaSGMM96aw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SLI_Main_MVP2_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SLI_Main_MVP2_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("********************* Starting the SLI MVP2 Migration *********************");
                ...
                class BytesLimit65535_tRunJob_2{
                    ...
                    log4jParamters_tRunJob_2.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("PROCESS" + " = " + "Record_Count_Compare_MVP2");
                        log4jParamters_tRunJob_2.append(" | ");
                        ...
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("CONTEXTPARAMS" + " = " + "[{PARAM_NAME_COLUMN="+("opco")+", PARAM_VALUE_COLUMN="+("globalMap.get(\"opco\")")+"}, {PARAM_NAME_COLUMN="+("sopco")+", PARAM_VALUE_COLUMN="+("globalMap.get(\"sopco\")")+"}, {PARAM_NAME_COLUMN="+("SUS_Server")+", PARAM_VALUE_COLUMN="+("globalMap.get(\"server\")+\".na.sysco.net\"")+"}]");
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("PRINT_PARAMETER" + " = " + "false");
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("USE_CHILD_JVM_SETTING" + " = " + "true");
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("USE_CUSTOM_JVM_SETTING" + " = " + "false");
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("USE_DYNAMIC_CONTEXT" + " = " + "false");
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("USE_EXTRA_CLASSPATH" + " = " + "false");
                        log4jParamters_tRunJob_2.append(" | ");
                if(log.isDebugEnabled())
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_2_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/log4j-1.2-api-2.17.1.jar;../lib/commons-collections-3.2.2.jar;../lib/jboss-marshalling-river-2.0.12.Final.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/advancedPersistentLookupLib-1.3.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/trove.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;record_count_compare_mvp2_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(classpath_tRunJob_2_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "sus_sli_etl.record_count_compare_mvp2_0_1.Record_Count_Compare_MVP2");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-cp");
		      					...
		      					String classpath_tRunJob_2_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.17.1.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/jboss-marshalling-river-2.0.12.Final.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.3.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/record_count_compare_mvp2_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    ...
                    parentContextMap_tRunJob_2.put("between1", context.between1);
                    paraList_tRunJob_2.add("--context_type " + "between1" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between10", context.between10);
                    paraList_tRunJob_2.add("--context_type " + "between10" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between11", context.between11);
                    paraList_tRunJob_2.add("--context_type " + "between11" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between12", context.between12);
                    paraList_tRunJob_2.add("--context_type " + "between12" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between13", context.between13);
                    paraList_tRunJob_2.add("--context_type " + "between13" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between14", context.between14);
                    paraList_tRunJob_2.add("--context_type " + "between14" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between15", context.between15);
                    paraList_tRunJob_2.add("--context_type " + "between15" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between16", context.between16);
                    paraList_tRunJob_2.add("--context_type " + "between16" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between17", context.between17);
                    paraList_tRunJob_2.add("--context_type " + "between17" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between18", context.between18);
                    paraList_tRunJob_2.add("--context_type " + "between18" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between19", context.between19);
                    paraList_tRunJob_2.add("--context_type " + "between19" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between2", context.between2);
                    paraList_tRunJob_2.add("--context_type " + "between2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between20", context.between20);
                    paraList_tRunJob_2.add("--context_type " + "between20" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between21", context.between21);
                    paraList_tRunJob_2.add("--context_type " + "between21" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between22", context.between22);
                    paraList_tRunJob_2.add("--context_type " + "between22" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between23", context.between23);
                    paraList_tRunJob_2.add("--context_type " + "between23" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between24", context.between24);
                    paraList_tRunJob_2.add("--context_type " + "between24" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between25", context.between25);
                    paraList_tRunJob_2.add("--context_type " + "between25" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between26", context.between26);
                    paraList_tRunJob_2.add("--context_type " + "between26" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between3", context.between3);
                    paraList_tRunJob_2.add("--context_type " + "between3" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between4", context.between4);
                    paraList_tRunJob_2.add("--context_type " + "between4" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between5", context.between5);
                    paraList_tRunJob_2.add("--context_type " + "between5" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between6", context.between6);
                    paraList_tRunJob_2.add("--context_type " + "between6" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between7", context.between7);
                    paraList_tRunJob_2.add("--context_type " + "between7" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between8", context.between8);
                    paraList_tRunJob_2.add("--context_type " + "between8" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between9", context.between9);
                    paraList_tRunJob_2.add("--context_type " + "between9" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between1_2", context.between1_2);
                    paraList_tRunJob_2.add("--context_type " + "between1_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between10_2", context.between10_2);
                    paraList_tRunJob_2.add("--context_type " + "between10_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between11_2", context.between11_2);
                    paraList_tRunJob_2.add("--context_type " + "between11_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between12_2", context.between12_2);
                    paraList_tRunJob_2.add("--context_type " + "between12_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between13_2", context.between13_2);
                    paraList_tRunJob_2.add("--context_type " + "between13_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between14_2", context.between14_2);
                    paraList_tRunJob_2.add("--context_type " + "between14_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between15_2", context.between15_2);
                    paraList_tRunJob_2.add("--context_type " + "between15_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between16_2", context.between16_2);
                    paraList_tRunJob_2.add("--context_type " + "between16_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between17_2", context.between17_2);
                    paraList_tRunJob_2.add("--context_type " + "between17_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between18_2", context.between18_2);
                    paraList_tRunJob_2.add("--context_type " + "between18_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between19_2", context.between19_2);
                    paraList_tRunJob_2.add("--context_type " + "between19_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between2_2", context.between2_2);
                    paraList_tRunJob_2.add("--context_type " + "between2_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between20_2", context.between20_2);
                    paraList_tRunJob_2.add("--context_type " + "between20_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between21_2", context.between21_2);
                    paraList_tRunJob_2.add("--context_type " + "between21_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between22_2", context.between22_2);
                    paraList_tRunJob_2.add("--context_type " + "between22_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between23_2", context.between23_2);
                    paraList_tRunJob_2.add("--context_type " + "between23_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between24_2", context.between24_2);
                    paraList_tRunJob_2.add("--context_type " + "between24_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between25_2", context.between25_2);
                    paraList_tRunJob_2.add("--context_type " + "between25_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between3_2", context.between3_2);
                    paraList_tRunJob_2.add("--context_type " + "between3_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between4_2", context.between4_2);
                    paraList_tRunJob_2.add("--context_type " + "between4_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between5_2", context.between5_2);
                    paraList_tRunJob_2.add("--context_type " + "between5_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between6_2", context.between6_2);
                    paraList_tRunJob_2.add("--context_type " + "between6_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between7_2", context.between7_2);
                    paraList_tRunJob_2.add("--context_type " + "between7_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between8_2", context.between8_2);
                    paraList_tRunJob_2.add("--context_type " + "between8_2" + "=" + "id_String");
                    parentContextMap_tRunJob_2.put("between9_2", context.between9_2);
                    paraList_tRunJob_2.add("--context_type " + "between9_2" + "=" + "id_String");
...
globalMap.put("tRunJob_2_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_2 = consoleHelper_tRunJob_2.getNormalThread(ps_tRunJob_2);
                log.info("tRunJob_2 - The child job 'Record_Count_Compare_MVP2' starts on the version '0.1' with the context 'Default'.");
            normal_tRunJob_2.start();
                log.info("tRunJob_2 - The child job 'Record_Count_Compare_MVP2' is done.");
...
globalMap.put("tRunJob_2_ERROR_MESSAGE",tde.getMessage());
            	log.error("tRunJob_2 - thread was terminated.");
                ...
                class BytesLimit65535_tRunJob_3{
                    ...
                    log4jParamters_tRunJob_3.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("PROCESS" + " = " + "SLI_MVP2_Inbound");
                        log4jParamters_tRunJob_3.append(" | ");
                        ...
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("CONTEXTPARAMS" + " = " + "[{PARAM_NAME_COLUMN="+("opco")+", PARAM_VALUE_COLUMN="+("globalMap.get(\"opco\")")+"}, {PARAM_NAME_COLUMN="+("sopco")+", PARAM_VALUE_COLUMN="+("globalMap.get(\"sopco\")")+"}, {PARAM_NAME_COLUMN="+("SUS_Server")+", PARAM_VALUE_COLUMN="+("globalMap.get(\"server\")+\".na.sysco.net\"")+"}]");
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("PRINT_PARAMETER" + " = " + "false");
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("USE_CHILD_JVM_SETTING" + " = " + "true");
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("USE_CUSTOM_JVM_SETTING" + " = " + "false");
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("USE_DYNAMIC_CONTEXT" + " = " + "false");
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("USE_EXTRA_CLASSPATH" + " = " + "false");
                        log4jParamters_tRunJob_3.append(" | ");
                if(log.isDebugEnabled())
			...
			if (osName_tRunJob_3 != null && osName_tRunJob_3.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-Xms512M");
              					...
              					String classpath_tRunJob_3_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/crypto-utils-0.31.12.jar;sli_mvp2_inbound_0_1.jar;vendor_inventory_inbound_0_1.jar;item_vendor_ship_from_inbound_0_1.jar;item_transaction_history_inbound1_0_1.jar;strategic_broker_inbound_0_1.jar;obligation_detail1_inbound_0_1.jar;obligation_detail_inbound_0_1.jar;site_inbound_0_1.jar;item_note_inbound_0_1.jar;rdc_item_pay_to_vendor_update_inbound_0_1.jar;customer_inbound_0_1.jar;demand_history_inbound_0_1.jar;item_transaction_history_inbound_0_1.jar;user_inbound_0_1.jar;customer_ship_to_inbound_0_1.jar;inbound_scheduling_header_inbound_0_1.jar;entity_inbound_0_1.jar;purchase_order_header_inbound_0_1.jar;item_master_update_inbound_0_1.jar;strategic_broker_item_inbound_0_1.jar;item_transaction_history_inbound2_0_1.jar;purchase_order_detail_inbound_0_1.jar;hazard_detail_inbound_0_1.jar;purchase_order_detail_update_inbound_0_1.jar;item_period_demand_inbound_0_1.jar;obligation_detail2_inbound_0_1.jar;po_reason_code_inbound_0_1.jar;purchase_order_detail_insert_inbound_0_1.jar;buyer_inbound_0_1.jar;item_pay_to_vendor_inbound_0_1.jar;proforma_order_master_inbound_0_1.jar;vendor_ship_from_inbound_0_1.jar;vendor_header_inbound_0_1.jar;vendor_detail_inbound_0_1.jar;critical_item_sus_inbound_0_1.jar;item_warehouse_param_inbound_0_1.jar;ship_via_inbound_0_1.jar;order_process_header_inbound_0_1.jar;order_process_detail_inbound_0_1.jar;broker_ship_from_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, dealChildJobLibrary_tRunJob_3.replaceJarPathsFromCrcMap(classpath_tRunJob_3_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "sus_sli_etl.sli_mvp2_inbound_0_1.SLI_MVP2_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_3.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_3.addArgumentsTo(paraList_tRunJob_3, "-cp");
		      					...
		      					String classpath_tRunJob_3_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/sli_mvp2_inbound_0_1.jar:$ROOT_PATH/vendor_inventory_inbound_0_1.jar:$ROOT_PATH/item_vendor_ship_from_inbound_0_1.jar:$ROOT_PATH/item_transaction_history_inbound1_0_1.jar:$ROOT_PATH/strategic_broker_inbound_0_1.jar:$ROOT_PATH/obligation_detail1_inbound_0_1.jar:$ROOT_PATH/obligation_detail_inbound_0_1.jar:$ROOT_PATH/site_inbound_0_1.jar:$ROOT_PATH/item_note_inbound_0_1.jar:$ROOT_PATH/rdc_item_pay_to_vendor_update_inbound_0_1.jar:$ROOT_PATH/customer_inbound_0_1.jar:$ROOT_PATH/demand_history_inbound_0_1.jar:$ROOT_PATH/item_transaction_history_inbound_0_1.jar:$ROOT_PATH/user_inbound_0_1.jar:$ROOT_PATH/customer_ship_to_inbound_0_1.jar:$ROOT_PATH/inbound_scheduling_header_inbound_0_1.jar:$ROOT_PATH/entity_inbound_0_1.jar:$ROOT_PATH/purchase_order_header_inbound_0_1.jar:$ROOT_PATH/item_master_update_inbound_0_1.jar:$ROOT_PATH/strategic_broker_item_inbound_0_1.jar:$ROOT_PATH/item_transaction_history_inbound2_0_1.jar:$ROOT_PATH/purchase_order_detail_inbound_0_1.jar:$ROOT_PATH/hazard_detail_inbound_0_1.jar:$ROOT_PATH/purchase_order_detail_update_inbound_0_1.jar:$ROOT_PATH/item_period_demand_inbound_0_1.jar:$ROOT_PATH/obligation_detail2_inbound_0_1.jar:$ROOT_PATH/po_reason_code_inbound_0_1.jar:$ROOT_PATH/purchase_order_detail_insert_inbound_0_1.jar:$ROOT_PATH/buyer_inbound_0_1.jar:$ROOT_PATH/item_pay_to_vendor_inbound_0_1.jar:$ROOT_PATH/proforma_order_master_inbound_0_1.jar:$ROOT_PATH/vendor_ship_from_inbound_0_1.jar:$ROOT_PATH/vendor_header_inbound_0_1.jar:$ROOT_PATH/vendor_detail_inbound_0_1.jar:$ROOT_PATH/critical_item_sus_inbound_0_1.jar:$ROOT_PATH/item_warehouse_param_inbound_0_1.jar:$ROOT_PATH/ship_via_inbound_0_1.jar:$ROOT_PATH/order_process_header_inbound_0_1.jar:$ROOT_PATH/order_process_detail_inbound_0_1.jar:$ROOT_PATH/broker_ship_from_inbound_0_1.jar:";
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_3 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_3 {
                    ...
                    parentContextMap_tRunJob_3.put("GIM_Read_Only_AdditionalParams", context.GIM_Read_Only_AdditionalParams);
                    paraList_tRunJob_3.add("--context_type " + "GIM_Read_Only_AdditionalParams" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("GIM_Read_Only_Database", context.GIM_Read_Only_Database);
                    paraList_tRunJob_3.add("--context_type " + "GIM_Read_Only_Database" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("GIM_Read_Only_Login", context.GIM_Read_Only_Login);
                    paraList_tRunJob_3.add("--context_type " + "GIM_Read_Only_Login" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("GIM_Read_Only_Password", context.GIM_Read_Only_Password);
                    paraList_tRunJob_3.add("--context_type " + "GIM_Read_Only_Password" + "=" + "id_Password");
                    parentContextMap_tRunJob_3.put("GIM_Read_Only_Port", context.GIM_Read_Only_Port);
                    paraList_tRunJob_3.add("--context_type " + "GIM_Read_Only_Port" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("GIM_Read_Only_Schema_Inventory", context.GIM_Read_Only_Schema_Inventory);
                    paraList_tRunJob_3.add("--context_type " + "GIM_Read_Only_Schema_Inventory" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("GIM_Read_Only_Server", context.GIM_Read_Only_Server);
                    paraList_tRunJob_3.add("--context_type " + "GIM_Read_Only_Server" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between1", context.between1);
                    paraList_tRunJob_3.add("--context_type " + "between1" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between10", context.between10);
                    paraList_tRunJob_3.add("--context_type " + "between10" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between11", context.between11);
                    paraList_tRunJob_3.add("--context_type " + "between11" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between12", context.between12);
                    paraList_tRunJob_3.add("--context_type " + "between12" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between13", context.between13);
                    paraList_tRunJob_3.add("--context_type " + "between13" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between14", context.between14);
                    paraList_tRunJob_3.add("--context_type " + "between14" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between15", context.between15);
                    paraList_tRunJob_3.add("--context_type " + "between15" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between16", context.between16);
                    paraList_tRunJob_3.add("--context_type " + "between16" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between17", context.between17);
                    paraList_tRunJob_3.add("--context_type " + "between17" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between18", context.between18);
                    paraList_tRunJob_3.add("--context_type " + "between18" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between19", context.between19);
                    paraList_tRunJob_3.add("--context_type " + "between19" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between2", context.between2);
                    paraList_tRunJob_3.add("--context_type " + "between2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between20", context.between20);
                    paraList_tRunJob_3.add("--context_type " + "between20" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between21", context.between21);
                    paraList_tRunJob_3.add("--context_type " + "between21" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between22", context.between22);
                    paraList_tRunJob_3.add("--context_type " + "between22" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between23", context.between23);
                    paraList_tRunJob_3.add("--context_type " + "between23" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between24", context.between24);
                    paraList_tRunJob_3.add("--context_type " + "between24" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between25", context.between25);
                    paraList_tRunJob_3.add("--context_type " + "between25" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between26", context.between26);
                    paraList_tRunJob_3.add("--context_type " + "between26" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between3", context.between3);
                    paraList_tRunJob_3.add("--context_type " + "between3" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between4", context.between4);
                    paraList_tRunJob_3.add("--context_type " + "between4" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between5", context.between5);
                    paraList_tRunJob_3.add("--context_type " + "between5" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between6", context.between6);
                    paraList_tRunJob_3.add("--context_type " + "between6" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between7", context.between7);
                    paraList_tRunJob_3.add("--context_type " + "between7" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between8", context.between8);
                    paraList_tRunJob_3.add("--context_type " + "between8" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between9", context.between9);
                    paraList_tRunJob_3.add("--context_type " + "between9" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between1_2", context.between1_2);
                    paraList_tRunJob_3.add("--context_type " + "between1_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between10_2", context.between10_2);
                    paraList_tRunJob_3.add("--context_type " + "between10_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between11_2", context.between11_2);
                    paraList_tRunJob_3.add("--context_type " + "between11_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between12_2", context.between12_2);
                    paraList_tRunJob_3.add("--context_type " + "between12_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between13_2", context.between13_2);
                    paraList_tRunJob_3.add("--context_type " + "between13_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between14_2", context.between14_2);
                    paraList_tRunJob_3.add("--context_type " + "between14_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between15_2", context.between15_2);
                    paraList_tRunJob_3.add("--context_type " + "between15_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between16_2", context.between16_2);
                    paraList_tRunJob_3.add("--context_type " + "between16_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between17_2", context.between17_2);
                    paraList_tRunJob_3.add("--context_type " + "between17_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between18_2", context.between18_2);
                    paraList_tRunJob_3.add("--context_type " + "between18_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between19_2", context.between19_2);
                    paraList_tRunJob_3.add("--context_type " + "between19_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between2_2", context.between2_2);
                    paraList_tRunJob_3.add("--context_type " + "between2_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between20_2", context.between20_2);
                    paraList_tRunJob_3.add("--context_type " + "between20_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between21_2", context.between21_2);
                    paraList_tRunJob_3.add("--context_type " + "between21_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between22_2", context.between22_2);
                    paraList_tRunJob_3.add("--context_type " + "between22_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between23_2", context.between23_2);
                    paraList_tRunJob_3.add("--context_type " + "between23_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between24_2", context.between24_2);
                    paraList_tRunJob_3.add("--context_type " + "between24_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between25_2", context.between25_2);
                    paraList_tRunJob_3.add("--context_type " + "between25_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between3_2", context.between3_2);
                    paraList_tRunJob_3.add("--context_type " + "between3_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between4_2", context.between4_2);
                    paraList_tRunJob_3.add("--context_type " + "between4_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between5_2", context.between5_2);
                    paraList_tRunJob_3.add("--context_type " + "between5_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between6_2", context.between6_2);
                    paraList_tRunJob_3.add("--context_type " + "between6_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between7_2", context.between7_2);
                    paraList_tRunJob_3.add("--context_type " + "between7_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between8_2", context.between8_2);
                    paraList_tRunJob_3.add("--context_type " + "between8_2" + "=" + "id_String");
                    parentContextMap_tRunJob_3.put("between9_2", context.between9_2);
                    paraList_tRunJob_3.add("--context_type " + "between9_2" + "=" + "id_String");
                    ...
                    parentContextMap_tRunJob_3.put("SUS_Database_ARDBFA", context.SUS_Database_ARDBFA);
                    paraList_tRunJob_3.add("--context_type " + "SUS_Database_ARDBFA" + "=" + "id_String");
...
globalMap.put("tRunJob_3_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_3 = consoleHelper_tRunJob_3.getNormalThread(ps_tRunJob_3);
                log.info("tRunJob_3 - The child job 'SLI_MVP2_Inbound' starts on the version '0.1' with the context 'Default'.");
            normal_tRunJob_3.start();
                log.info("tRunJob_3 - The child job 'SLI_MVP2_Inbound' is done.");
...
globalMap.put("tRunJob_3_ERROR_MESSAGE",tde.getMessage());
            	log.error("tRunJob_3 - thread was terminated.");
...
System.out.println("********************* Completed the  MVP2 Job and Started Verification ********************");
                ...
                class BytesLimit65535_tRunJob_1{
                    ...
                    log4jParamters_tRunJob_1.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_1.append(" | ");
                            log4jParamters_tRunJob_1.append("PROCESS" + " = " + "Record_Count_Compare_MVP2");
                        log4jParamters_tRunJob_1.append(" | ");
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_1_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/log4j-1.2-api-2.17.1.jar;../lib/commons-collections-3.2.2.jar;../lib/jboss-marshalling-river-2.0.12.Final.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/advancedPersistentLookupLib-1.3.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/trove.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;record_count_compare_mvp2_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "sus_sli_etl.record_count_compare_mvp2_0_1.Record_Count_Compare_MVP2");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "-cp");
		      					...
		      					String classpath_tRunJob_1_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/log4j-1.2-api-2.17.1.jar:$ROOT_PATH/../lib/commons-collections-3.2.2.jar:$ROOT_PATH/../lib/jboss-marshalling-river-2.0.12.Final.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/advancedPersistentLookupLib-1.3.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/trove.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/record_count_compare_mvp2_0_1.jar:";
...
globalMap.put("tRunJob_1_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_1 = consoleHelper_tRunJob_1.getNormalThread(ps_tRunJob_1);
                log.info("tRunJob_1 - The child job 'Record_Count_Compare_MVP2' starts on the version '0.1' with the context 'Default'.");
            normal_tRunJob_1.start();
                log.info("tRunJob_1 - The child job 'Record_Count_Compare_MVP2' is done.");
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_SLI_Main_MVP2_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_SLI_Main_MVP2_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_SLI_Main_MVP2_Inbound) {
 ...
 */
    ...
    public static void main(String[] args){
        final SLI_Main_MVP2_Inbound SLI_Main_MVP2_InboundClass = new SLI_Main_MVP2_Inbound();

        int exitCode = SLI_Main_MVP2_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'SLI_Main_MVP2_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'SLI_Main_MVP2_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = SLI_Main_MVP2_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/sli_main_mvp2_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SLI_Main_MVP2_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SLI_Main_MVP2_Inbound");
        }
...
/************************************************************************************************
 *     387447 characters generated by Talend Open Studio for Data Integration 
 *     on the October 28, 2022 at 10:58:16 AM IST
 ************************************************************************************************/