...
public class Proforma_Order_Master_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Proforma_Order_Master_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Proforma_Order_Master_Inbound.class);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(FREIGHT_RATE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_RATE);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_RATE_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_RATE_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(UNLOADING_CHARGE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(UNLOADING_CHARGE);
            			}
            		
        			sb.append("|");
        		
        				if(UNLOADING_CHARGE_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(UNLOADING_CHARGE_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(PICKUP_ALLOWANCE_RATE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PICKUP_ALLOWANCE_RATE);
            			}
            		
        			sb.append("|");
        		
        				if(PICKUP_ALLOWANCE_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PICKUP_ALLOWANCE_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(PICKUP_ALLOWANCE_FROM_BRACKET == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PICKUP_ALLOWANCE_FROM_BRACKET);
            			}
            		
        			sb.append("|");
        		
        				if(PICKUP_ALLOWANCE_TO_BRACKET == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PICKUP_ALLOWANCE_TO_BRACKET);
            			}
        			...
        			sb.append("|");
        				...
        				if(ALLOWANCE_CHARGES_DISTRIB_TO_MERCHANDISE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ALLOWANCE_CHARGES_DISTRIB_TO_MERCHANDISE);
            			}
            		
        			sb.append("|");
        		
        				if(ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);
            			}
        			...
        			sb.append("|");
        				...
        				if(TOTAL_UNLOADING_CHARGE == null){
            				...
            				sb.append(TOTAL_UNLOADING_CHARGE);
            			}
            		
        			sb.append("|");
        		
        				if(TOTAT_FOB_COST == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TOTAT_FOB_COST);
            			}
        			...
        			sb.append("|");
        				...
        				if(TOTAL_PICKUP_ALLOWANCE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TOTAL_PICKUP_ALLOWANCE);
            			}
            		
        			sb.append("|");
        		
        				if(TOTAL_NON_DISTRIB_ALLOWANCE_CHARGES_TO_MERCH == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TOTAL_NON_DISTRIB_ALLOWANCE_CHARGES_TO_MERCH);
            			}
            		
        			sb.append("|");
        		
        				if(TOTAL_BRACKET_DIFFERENTIAL == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TOTAL_BRACKET_DIFFERENTIAL);
            			}
            		
        			sb.append("|");
        		
        				if(TOTAL_NON_DISTRB_ALLOWANCE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TOTAL_NON_DISTRB_ALLOWANCE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TERMS == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TERMS);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_FREIGHT_RATE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_RATE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_FREIGHT_RATE_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_RATE_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_UNLOADING_CHARGE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_UNLOADING_CHARGE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_UNLOADING_CHARGE_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_UNLOADING_CHARGE_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_PICKUP_ALLOWANCE_RATE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_PICKUP_ALLOWANCE_RATE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_PICKUP_ALLOWANCE_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_PICKUP_ALLOWANCE_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_PICKUP_ALLOWANCE_FROM_BRACKET == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_PICKUP_ALLOWANCE_FROM_BRACKET);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_PICKUP_ALLOWANCE_TO_BRACKET == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_PICKUP_ALLOWANCE_TO_BRACKET);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_FREIGHT_VENDOR_TERMS == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_VENDOR_TERMS);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_MERCH == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TOTAL_UNLOADING_CHARGE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_UNLOADING_CHARGE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TOTAL_FOB_COST == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_FOB_COST);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TOTAL_FREIGHT_COST == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_FREIGHT_COST);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TOTAL_AP_COST == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_AP_COST);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TOTAL_PICKUP_ALLOWANCE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_PICKUP_ALLOWANCE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGE_TO_MERCHANT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGE_TO_MERCHANT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_TOTAL_BRACKET_DIFFERENTIAL == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_BRACKET_DIFFERENTIAL);
            			}
            		
        			sb.append("|");
        		
        				if(MERCH_DEFAULT_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCH_DEFAULT_REASON_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_DEFAULT_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_DEFAULT_REASON_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_CASH_DISCOUNT_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_CASH_DISCOUNT_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_FREIGHT_CASH_DISCOUNT_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_CASH_DISCOUNT_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(MERCHANDISE_CASH_DISCOUNT_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCHANDISE_CASH_DISCOUNT_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_MERCH_CASH_DISCOUNT_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_MERCH_CASH_DISCOUNT_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(MERCH_NET_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCH_NET_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_NET_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_NET_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_MERCH_NET_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_MERCH_NET_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_FREIGHT_NET_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_NET_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(PROCUREMENT_PRE_APPROVAL_NUMBER == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PROCUREMENT_PRE_APPROVAL_NUMBER);
            			}
            		
        			sb.append("|");
        		
        				if(MERCH_ROUNDING_VARIANCE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCH_ROUNDING_VARIANCE);
            			}
        			...
        			sb.append("|");
        				...
        				if(REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGES == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGES);
            			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"PROFORMA_ORDER_HEADER\"");
                        log4jParamters_tDBOutput_2.append(" | ");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("PROFORMA_ORDER_HEADER");
        ...
        } else if (updateKeyCount_tDBOutput_2 == 66 && true) {
...
// ###############################
// # Outputs initialization
				int count_PROFORMA_ORDER_HEADER_tMap_5 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"IMHAE8FF\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT    IMHAE8FF.E8PO,    IMHAE8FF.E8FMFT,    IMHAE8FF.E8FMFR,    IMHAE8FF.E8FFRT,    IMHAE8FF.E8FULC,    IMHAE8FF.E8FULT,    IMHAE8FF.E8FPAL,    IMHAE8FF.E8FPUT,    IMHAE8FF.E8FPFB,    IMHAE8FF.E8FPTB,    IMHAE8FF.E8FFVT,    IMHAE8FF.E8FACM,    IMHAE8FF.E8FACF,    IMHAE8FF.E8FTUC,    IMHAE8FF.E8FTBC,    IMHAE8FF.E8FTFC,    IMHAE8FF.E8FTAC,    IMHAE8FF.E8FTPA,    IMHAE8FF.E8FNAC,    IMHAE8FF.E8FTBD,    IMHAE8FF.E8PNAF,    IMHAE8FF.E8RVFT,    IMHAE8FF.E8RVFR,    IMHAE8FF.E8RFRT,    IMHAE8FF.E8RULC,    IMHAE8FF.E8RUCT,    IMHAE8FF.E8RPAL,    IMHAE8FF.E8RPUT,    IMHAE8FF.E8RPFB,    IMHAE8FF.E8RPTB,    IMHAE8FF.E8RFVT,    IMHAE8FF.E8RACM,    IMHAE8FF.E8RACF,    IMHAE8FF.E8RTUG,    IMHAE8FF.E8RTBC,    IMHAE8FF.E8RTFC,    IMHAE8FF.E8RTAP,    IMHAE8FF.E8RTPA,    IMHAE8FF.E8RNAC,    IMHAE8FF.E8RTBD,    IMHAE8FF.E8MDRC,    IMHAE8FF.E8FDRC,    IMHAE8FF.E8FFCD,    IMHAE8FF.E8RFCD,    IMHAE8FF.E8FMCD,    IMHAE8FF.E8RMCD,    IMHAE8FF.E8PFNA,    IMHAE8FF.E8FPNA,    IMHAE8FF.E8RPFN,    IMHAE8FF.E8RFPN,    IMHAE8FF.E8PPAN,    IMHAE8FF.E8MERV,    IMHAE8FF.E8FTRV,    IMHAE8FF.E8RNAF,    IMHAE8FF.E8EADT,    IMHAE8FF.E8EATM,    IMHAE8FF.E8EAID,    IMHAE8FF.E8MODT,    IMHAE8FF.E8MOTM,    IMHAE8FF.E8MOID FROM IMHAE8FF ORDER BY IMHAE8FF.E8EADT DESC\"");
                        log4jParamters_tDBInput_2.append(" | ");
...
count_PROFORMA_ORDER_HEADER_tMap_5++;
...
log.debug("tMap_5 - Outputting the record " + count_PROFORMA_ORDER_HEADER_tMap_5 + " of the output table 'PROFORMA_ORDER_HEADER'.");
...
if(PROFORMA_ORDER_HEADER != null) { 
	...
	currentComponent="tDBOutput_2";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("PROFORMA_ORDER_HEADER - " + (PROFORMA_ORDER_HEADER==null? "": PROFORMA_ORDER_HEADER.toLogString()));
    			}
...
} else {pstmtUpdate_tDBOutput_2.setString(1, PROFORMA_ORDER_HEADER.TERMS);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(2, PROFORMA_ORDER_HEADER.FREIGHT_RATE);

                    if(PROFORMA_ORDER_HEADER.FREIGHT_RATE_TYPE == null) {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(3, PROFORMA_ORDER_HEADER.FREIGHT_RATE_TYPE);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(4, PROFORMA_ORDER_HEADER.UNLOADING_CHARGE);

                    if(PROFORMA_ORDER_HEADER.UNLOADING_CHARGE_TYPE == null) {
pstmtUpdate_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(5, PROFORMA_ORDER_HEADER.UNLOADING_CHARGE_TYPE);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(6, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_RATE);

                    if(PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_TYPE == null) {
pstmtUpdate_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(7, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_TYPE);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(8, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_FROM_BRACKET);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(9, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_TO_BRACKET);

                    if(PROFORMA_ORDER_HEADER.FREIGHT_VENDOR_TERMS == null) {
pstmtUpdate_tDBOutput_2.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(10, PROFORMA_ORDER_HEADER.FREIGHT_VENDOR_TERMS);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(11, PROFORMA_ORDER_HEADER.ALLOWANCE_CHARGES_DISTRIB_TO_MERCHANDISE);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(12, PROFORMA_ORDER_HEADER.ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(13, PROFORMA_ORDER_HEADER.TOTAL_UNLOADING_CHARGE);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(14, PROFORMA_ORDER_HEADER.TOTAT_FOB_COST);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(15, PROFORMA_ORDER_HEADER.TOTAL_FREIGHT_COST);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(16, PROFORMA_ORDER_HEADER.TOTAL_AP_COST);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(17, PROFORMA_ORDER_HEADER.TOTAL_PICKUP_ALLOWANCE);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(18, PROFORMA_ORDER_HEADER.TOTAL_NON_DISTRIB_ALLOWANCE_CHARGES_TO_MERCH);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(19, PROFORMA_ORDER_HEADER.TOTAL_BRACKET_DIFFERENTIAL);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(20, PROFORMA_ORDER_HEADER.TOTAL_NON_DISTRB_ALLOWANCE);

                    if(PROFORMA_ORDER_HEADER.REVISED_TERMS == null) {
pstmtUpdate_tDBOutput_2.setNull(21, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(21, PROFORMA_ORDER_HEADER.REVISED_TERMS);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(22, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_RATE);

                    if(PROFORMA_ORDER_HEADER.REVISED_FREIGHT_RATE_TYPE == null) {
pstmtUpdate_tDBOutput_2.setNull(23, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(23, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_RATE_TYPE);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(24, PROFORMA_ORDER_HEADER.REVISED_UNLOADING_CHARGE);

                    if(PROFORMA_ORDER_HEADER.REVISED_UNLOADING_CHARGE_TYPE == null) {
pstmtUpdate_tDBOutput_2.setNull(25, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(25, PROFORMA_ORDER_HEADER.REVISED_UNLOADING_CHARGE_TYPE);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(26, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_RATE);

                    if(PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_TYPE == null) {
pstmtUpdate_tDBOutput_2.setNull(27, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(27, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_TYPE);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(28, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_FROM_BRACKET);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(29, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_TO_BRACKET);

                    if(PROFORMA_ORDER_HEADER.REVISED_FREIGHT_VENDOR_TERMS == null) {
pstmtUpdate_tDBOutput_2.setNull(30, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(30, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_VENDOR_TERMS);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(31, PROFORMA_ORDER_HEADER.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(32, PROFORMA_ORDER_HEADER.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(33, PROFORMA_ORDER_HEADER.REVISED_TOTAL_UNLOADING_CHARGE);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(34, PROFORMA_ORDER_HEADER.REVISED_TOTAL_FOB_COST);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(35, PROFORMA_ORDER_HEADER.REVISED_TOTAL_FREIGHT_COST);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(36, PROFORMA_ORDER_HEADER.REVISED_TOTAL_AP_COST);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(37, PROFORMA_ORDER_HEADER.REVISED_TOTAL_PICKUP_ALLOWANCE);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(38, PROFORMA_ORDER_HEADER.REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGE_TO_MERCHANT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(39, PROFORMA_ORDER_HEADER.REVISED_TOTAL_BRACKET_DIFFERENTIAL);

                    if(PROFORMA_ORDER_HEADER.MERCH_DEFAULT_REASON_CODE == null) {
pstmtUpdate_tDBOutput_2.setNull(40, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(40, PROFORMA_ORDER_HEADER.MERCH_DEFAULT_REASON_CODE);
}

                    if(PROFORMA_ORDER_HEADER.FREIGHT_DEFAULT_REASON_CODE == null) {
pstmtUpdate_tDBOutput_2.setNull(41, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(41, PROFORMA_ORDER_HEADER.FREIGHT_DEFAULT_REASON_CODE);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(42, PROFORMA_ORDER_HEADER.FREIGHT_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(43, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(44, PROFORMA_ORDER_HEADER.MERCHANDISE_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(45, PROFORMA_ORDER_HEADER.REVISED_MERCH_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(46, PROFORMA_ORDER_HEADER.MERCH_NET_AMOUNT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(47, PROFORMA_ORDER_HEADER.FREIGHT_NET_AMOUNT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(48, PROFORMA_ORDER_HEADER.REVISED_MERCH_NET_AMOUNT);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(49, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_NET_AMOUNT);

                    if(PROFORMA_ORDER_HEADER.PROCUREMENT_PRE_APPROVAL_NUMBER == null) {
pstmtUpdate_tDBOutput_2.setNull(50, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(50, PROFORMA_ORDER_HEADER.PROCUREMENT_PRE_APPROVAL_NUMBER);
}

                    pstmtUpdate_tDBOutput_2.setBigDecimal(51, PROFORMA_ORDER_HEADER.MERCH_ROUNDING_VARIANCE);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(52, PROFORMA_ORDER_HEADER.FREIGHT_ROUNDING_VARIANCE);

                    pstmtUpdate_tDBOutput_2.setBigDecimal(53, PROFORMA_ORDER_HEADER.REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGES);

                    if(PROFORMA_ORDER_HEADER.E8FF_SVOP == null) {
pstmtUpdate_tDBOutput_2.setNull(54, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(54, PROFORMA_ORDER_HEADER.E8FF_SVOP);
}

                    if(PROFORMA_ORDER_HEADER.IS_ACTIVE == null) {
pstmtUpdate_tDBOutput_2.setNull(55, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_2.setBoolean(55, PROFORMA_ORDER_HEADER.IS_ACTIVE);
}

                    if(PROFORMA_ORDER_HEADER.CREATED_USER_ID == null) {
pstmtUpdate_tDBOutput_2.setNull(56, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(56, PROFORMA_ORDER_HEADER.CREATED_USER_ID);
}

                    if(PROFORMA_ORDER_HEADER.CREATED_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(57, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.CREATED_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(57, java.sql.Types.TIMESTAMP);
}

                    if(PROFORMA_ORDER_HEADER.UPDATED_USER_ID == null) {
pstmtUpdate_tDBOutput_2.setNull(58, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(58, PROFORMA_ORDER_HEADER.UPDATED_USER_ID);
}

                    if(PROFORMA_ORDER_HEADER.UPDATED_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(59, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.UPDATED_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(59, java.sql.Types.TIMESTAMP);
}

                    if(PROFORMA_ORDER_HEADER.IS_DELETED == null) {
pstmtUpdate_tDBOutput_2.setNull(60, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_2.setBoolean(60, PROFORMA_ORDER_HEADER.IS_DELETED);
}

                    if(PROFORMA_ORDER_HEADER.CREATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_2.setNull(61, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(61, PROFORMA_ORDER_HEADER.CREATED_ORIGIN);
}

                    if(PROFORMA_ORDER_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(62, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(62, java.sql.Types.TIMESTAMP);
}

                    if(PROFORMA_ORDER_HEADER.UPDATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_2.setNull(63, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(63, PROFORMA_ORDER_HEADER.UPDATED_ORIGIN);
}

                    if(PROFORMA_ORDER_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(64, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(64, java.sql.Types.TIMESTAMP);
}


                    if(PROFORMA_ORDER_HEADER.SITE_ID == null) {
pstmtUpdate_tDBOutput_2.setNull(65 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(65 + count_tDBOutput_2, PROFORMA_ORDER_HEADER.SITE_ID);
}


                    if(PROFORMA_ORDER_HEADER.PURCHASE_ORDER_NO == null) {
pstmtUpdate_tDBOutput_2.setNull(66 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(66 + count_tDBOutput_2, PROFORMA_ORDER_HEADER.PURCHASE_ORDER_NO);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, PROFORMA_ORDER_HEADER.SITE_ID);
}

                        if(PROFORMA_ORDER_HEADER.PURCHASE_ORDER_NO == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, PROFORMA_ORDER_HEADER.PURCHASE_ORDER_NO);
}

                        if(PROFORMA_ORDER_HEADER.TERMS == null) {
pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(3, PROFORMA_ORDER_HEADER.TERMS);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(4, PROFORMA_ORDER_HEADER.FREIGHT_RATE);

                        if(PROFORMA_ORDER_HEADER.FREIGHT_RATE_TYPE == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(5, PROFORMA_ORDER_HEADER.FREIGHT_RATE_TYPE);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(6, PROFORMA_ORDER_HEADER.UNLOADING_CHARGE);

                        if(PROFORMA_ORDER_HEADER.UNLOADING_CHARGE_TYPE == null) {
pstmtInsert_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(7, PROFORMA_ORDER_HEADER.UNLOADING_CHARGE_TYPE);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(8, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_RATE);

                        if(PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_TYPE == null) {
pstmtInsert_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(9, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_TYPE);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(10, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_FROM_BRACKET);

                        pstmtInsert_tDBOutput_2.setBigDecimal(11, PROFORMA_ORDER_HEADER.PICKUP_ALLOWANCE_TO_BRACKET);

                        if(PROFORMA_ORDER_HEADER.FREIGHT_VENDOR_TERMS == null) {
pstmtInsert_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(12, PROFORMA_ORDER_HEADER.FREIGHT_VENDOR_TERMS);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(13, PROFORMA_ORDER_HEADER.ALLOWANCE_CHARGES_DISTRIB_TO_MERCHANDISE);

                        pstmtInsert_tDBOutput_2.setBigDecimal(14, PROFORMA_ORDER_HEADER.ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(15, PROFORMA_ORDER_HEADER.TOTAL_UNLOADING_CHARGE);

                        pstmtInsert_tDBOutput_2.setBigDecimal(16, PROFORMA_ORDER_HEADER.TOTAT_FOB_COST);

                        pstmtInsert_tDBOutput_2.setBigDecimal(17, PROFORMA_ORDER_HEADER.TOTAL_FREIGHT_COST);

                        pstmtInsert_tDBOutput_2.setBigDecimal(18, PROFORMA_ORDER_HEADER.TOTAL_AP_COST);

                        pstmtInsert_tDBOutput_2.setBigDecimal(19, PROFORMA_ORDER_HEADER.TOTAL_PICKUP_ALLOWANCE);

                        pstmtInsert_tDBOutput_2.setBigDecimal(20, PROFORMA_ORDER_HEADER.TOTAL_NON_DISTRIB_ALLOWANCE_CHARGES_TO_MERCH);

                        pstmtInsert_tDBOutput_2.setBigDecimal(21, PROFORMA_ORDER_HEADER.TOTAL_BRACKET_DIFFERENTIAL);

                        pstmtInsert_tDBOutput_2.setBigDecimal(22, PROFORMA_ORDER_HEADER.TOTAL_NON_DISTRB_ALLOWANCE);

                        if(PROFORMA_ORDER_HEADER.REVISED_TERMS == null) {
pstmtInsert_tDBOutput_2.setNull(23, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(23, PROFORMA_ORDER_HEADER.REVISED_TERMS);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(24, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_RATE);

                        if(PROFORMA_ORDER_HEADER.REVISED_FREIGHT_RATE_TYPE == null) {
pstmtInsert_tDBOutput_2.setNull(25, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(25, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_RATE_TYPE);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(26, PROFORMA_ORDER_HEADER.REVISED_UNLOADING_CHARGE);

                        if(PROFORMA_ORDER_HEADER.REVISED_UNLOADING_CHARGE_TYPE == null) {
pstmtInsert_tDBOutput_2.setNull(27, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(27, PROFORMA_ORDER_HEADER.REVISED_UNLOADING_CHARGE_TYPE);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(28, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_RATE);

                        if(PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_TYPE == null) {
pstmtInsert_tDBOutput_2.setNull(29, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(29, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_TYPE);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(30, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_FROM_BRACKET);

                        pstmtInsert_tDBOutput_2.setBigDecimal(31, PROFORMA_ORDER_HEADER.REVISED_PICKUP_ALLOWANCE_TO_BRACKET);

                        if(PROFORMA_ORDER_HEADER.REVISED_FREIGHT_VENDOR_TERMS == null) {
pstmtInsert_tDBOutput_2.setNull(32, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(32, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_VENDOR_TERMS);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(33, PROFORMA_ORDER_HEADER.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);

                        pstmtInsert_tDBOutput_2.setBigDecimal(34, PROFORMA_ORDER_HEADER.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(35, PROFORMA_ORDER_HEADER.REVISED_TOTAL_UNLOADING_CHARGE);

                        pstmtInsert_tDBOutput_2.setBigDecimal(36, PROFORMA_ORDER_HEADER.REVISED_TOTAL_FOB_COST);

                        pstmtInsert_tDBOutput_2.setBigDecimal(37, PROFORMA_ORDER_HEADER.REVISED_TOTAL_FREIGHT_COST);

                        pstmtInsert_tDBOutput_2.setBigDecimal(38, PROFORMA_ORDER_HEADER.REVISED_TOTAL_AP_COST);

                        pstmtInsert_tDBOutput_2.setBigDecimal(39, PROFORMA_ORDER_HEADER.REVISED_TOTAL_PICKUP_ALLOWANCE);

                        pstmtInsert_tDBOutput_2.setBigDecimal(40, PROFORMA_ORDER_HEADER.REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGE_TO_MERCHANT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(41, PROFORMA_ORDER_HEADER.REVISED_TOTAL_BRACKET_DIFFERENTIAL);

                        if(PROFORMA_ORDER_HEADER.MERCH_DEFAULT_REASON_CODE == null) {
pstmtInsert_tDBOutput_2.setNull(42, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(42, PROFORMA_ORDER_HEADER.MERCH_DEFAULT_REASON_CODE);
}

                        if(PROFORMA_ORDER_HEADER.FREIGHT_DEFAULT_REASON_CODE == null) {
pstmtInsert_tDBOutput_2.setNull(43, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(43, PROFORMA_ORDER_HEADER.FREIGHT_DEFAULT_REASON_CODE);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(44, PROFORMA_ORDER_HEADER.FREIGHT_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(45, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(46, PROFORMA_ORDER_HEADER.MERCHANDISE_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(47, PROFORMA_ORDER_HEADER.REVISED_MERCH_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(48, PROFORMA_ORDER_HEADER.MERCH_NET_AMOUNT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(49, PROFORMA_ORDER_HEADER.FREIGHT_NET_AMOUNT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(50, PROFORMA_ORDER_HEADER.REVISED_MERCH_NET_AMOUNT);

                        pstmtInsert_tDBOutput_2.setBigDecimal(51, PROFORMA_ORDER_HEADER.REVISED_FREIGHT_NET_AMOUNT);

                        if(PROFORMA_ORDER_HEADER.PROCUREMENT_PRE_APPROVAL_NUMBER == null) {
pstmtInsert_tDBOutput_2.setNull(52, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(52, PROFORMA_ORDER_HEADER.PROCUREMENT_PRE_APPROVAL_NUMBER);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(53, PROFORMA_ORDER_HEADER.MERCH_ROUNDING_VARIANCE);

                        pstmtInsert_tDBOutput_2.setBigDecimal(54, PROFORMA_ORDER_HEADER.FREIGHT_ROUNDING_VARIANCE);

                        pstmtInsert_tDBOutput_2.setBigDecimal(55, PROFORMA_ORDER_HEADER.REVISED_TOTAL_NON_DISTRB_ALLOWANCE_CHARGES);

                        if(PROFORMA_ORDER_HEADER.E8FF_SVOP == null) {
pstmtInsert_tDBOutput_2.setNull(56, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(56, PROFORMA_ORDER_HEADER.E8FF_SVOP);
}

                        if(PROFORMA_ORDER_HEADER.IS_ACTIVE == null) {
pstmtInsert_tDBOutput_2.setNull(57, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_2.setBoolean(57, PROFORMA_ORDER_HEADER.IS_ACTIVE);
}

                        if(PROFORMA_ORDER_HEADER.CREATED_USER_ID == null) {
pstmtInsert_tDBOutput_2.setNull(58, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(58, PROFORMA_ORDER_HEADER.CREATED_USER_ID);
}

                        if(PROFORMA_ORDER_HEADER.CREATED_TIMESTAMP != null) {
pstmtInsert_tDBOutput_2.setTimestamp(59, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.CREATED_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_2.setNull(59, java.sql.Types.TIMESTAMP);
}

                        if(PROFORMA_ORDER_HEADER.UPDATED_USER_ID == null) {
pstmtInsert_tDBOutput_2.setNull(60, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(60, PROFORMA_ORDER_HEADER.UPDATED_USER_ID);
}

                        if(PROFORMA_ORDER_HEADER.UPDATED_TIMESTAMP != null) {
pstmtInsert_tDBOutput_2.setTimestamp(61, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.UPDATED_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_2.setNull(61, java.sql.Types.TIMESTAMP);
}

                        if(PROFORMA_ORDER_HEADER.IS_DELETED == null) {
pstmtInsert_tDBOutput_2.setNull(62, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_2.setBoolean(62, PROFORMA_ORDER_HEADER.IS_DELETED);
}

                        if(PROFORMA_ORDER_HEADER.CREATED_ORIGIN == null) {
pstmtInsert_tDBOutput_2.setNull(63, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(63, PROFORMA_ORDER_HEADER.CREATED_ORIGIN);
}

                        if(PROFORMA_ORDER_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_2.setTimestamp(64, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_2.setNull(64, java.sql.Types.TIMESTAMP);
}

                        if(PROFORMA_ORDER_HEADER.UPDATED_ORIGIN == null) {
pstmtInsert_tDBOutput_2.setNull(65, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(65, PROFORMA_ORDER_HEADER.UPDATED_ORIGIN);
}

                        if(PROFORMA_ORDER_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_2.setTimestamp(66, new java.sql.Timestamp(PROFORMA_ORDER_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_2.setNull(66, java.sql.Types.TIMESTAMP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_5 - Written records count in the table 'PROFORMA_ORDER_HEADER': " + count_PROFORMA_ORDER_HEADER_tMap_5 + ".");
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(MERCH_CHANGE_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCH_CHANGE_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_CHANGE_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_CHANGE_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(DROP_SHIP_QTY_CHANGE_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DROP_SHIP_QTY_CHANGE_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(MERCH_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCH_REASON_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_REASON_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(PO_ORDER_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_ORDER_QTY);
            			}
            		
        			sb.append("|");
        		
        				if(PO_FOB_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_FOB_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(PO_FREIGHT_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_FREIGHT_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(PO_AP_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_AP_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(PICKUP_ALLOWANCE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PICKUP_ALLOWANCE);
            			}
        			...
        			sb.append("|");
        				...
        				if(FREIGHT_RATE_OVERRIDE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_RATE_OVERRIDE);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_TYPE_OVERRIDE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_TYPE_OVERRIDE);
            			}
            		
        			sb.append("|");
        		
        				if(PICKUP_ALLOWANCE_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PICKUP_ALLOWANCE_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(BRACKET_DIFFERENTIAL_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(BRACKET_DIFFERENTIAL_PER_ITEM);
            			}
        			...
        			sb.append("|");
        				...
        				if(UNLOADING_CHARGE_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(UNLOADING_CHARGE_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(ALLOWANCE_CHARGES_DISTRIB_TO_MERCH == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);
            			}
        			...
        			sb.append("|");
        				...
        				if(AS_MANUALLY_ENTERED_LINE_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(AS_MANUALLY_ENTERED_LINE_FLAG);
            			}
        			...
        			sb.append("|");
        				...
        				if(PO_REVISED_ORDER_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_REVISED_ORDER_QTY);
            			}
            		
        			sb.append("|");
        		
        				if(PO_REVISED_FOB_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_REVISED_FOB_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(PO_REVISED_FREIGHT_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_REVISED_FREIGHT_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(PO_REVISED_AP_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PO_REVISED_AP_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_PICKUP_ALLOWANCE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_PICKUP_ALLOWANCE);
            			}
        			...
        			sb.append("|");
        				...
        				if(REVISED_FREIGHT_RATE_OVERRIDE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_RATE_OVERRIDE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_FREIGHT_TYPE_OVERRIDE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_TYPE_OVERRIDE);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_PICKUP_ALLOWANCE_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_PICKUP_ALLOWANCE_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_BRACKET_DIFFERENTIAL_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_BRACKET_DIFFERENTIAL_PER_ITEM);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_UNLOADING_CHARGE_PER_ITEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_UNLOADING_CHARGE_PER_ITEM);
            			}
        			...
        			sb.append("|");
        				...
        				if(REVISED_DROP_SHIP_RECEIVED_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_DROP_SHIP_RECEIVED_QTY);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_DROP_SHIP_RECEIVED_WEIGHT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_DROP_SHIP_RECEIVED_WEIGHT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_QTY);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_WGT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_WGT);
            			}
        			...
        			sb.append("|");
        				...
        				if(MERCH_CASH_DISCOUNT_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCH_CASH_DISCOUNT_AMOUNT);
            			}
        			...
        			sb.append("|");
        				...
        				if(REVISED_MERCH_EXTENDED_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_MERCH_EXTENDED_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_FREIGHT_EXTENDED_AMOUNT == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_FREIGHT_EXTENDED_AMOUNT);
            			}
            		
        			sb.append("|");
        		
        				if(MERCH_EXTENDED_AMOUNT_TO_BE_PAID == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MERCH_EXTENDED_AMOUNT_TO_BE_PAID);
            			}
            		
        			sb.append("|");
        		
        				if(FREIGHT_EXTENDED_AMOUNT_TO_BE_PAID == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREIGHT_EXTENDED_AMOUNT_TO_BE_PAID);
            			}
            		
        			sb.append("|");
        		
        				if(PRICE_OVERRIDE_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PRICE_OVERRIDE_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(REVISED_PRICE_OVERRIDE_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REVISED_PRICE_OVERRIDE_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(CARRIER_SHORT_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(CARRIER_SHORT_QTY);
            			}
            		
        			sb.append("|");
        		
        				if(VENDOR_SHORT_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(VENDOR_SHORT_QTY);
            			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"PROFORMA_ORDER_DETAIL\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("PROFORMA_ORDER_DETAIL");
        ...
        if(updateKeyCount_tDBOutput_1 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_1 == 69 && true) {
                    log.warn("For update, every Schema column can not be a key");
        }
...
// ###############################
// # Outputs initialization
				int count_PROFORMA_ORDER_DETAIL_tMap_4 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"IMHBE9FF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    IMHBE9FF.E9PO,    IMHBE9FF.E9ITEM,    IMHBE9FF.E9ROSQ,    IMHBE9FF.E9CPVN,    IMHBE9FF.E9FMCF,    IMHBE9FF.E9FFCF,    IMHBE9FF.E9FQCF,    IMHBE9FF.E9MRSC,    IMHBE9FF.E9RRSC,    IMHBE9FF.E9PFOQ,    IMHBE9FF.E9PFFB,    IMHBE9FF.E9PFFR,    IMHBE9FF.E9PFAP,    IMHBE9FF.E9FPAL,    IMHBE9FF.E9FPUT,    IMHBE9FF.E9FFRO,    IMHBE9FF.E9FFTO,    IMHBE9FF.E9FPAP,    IMHBE9FF.E9FBDP,    IMHBE9FF.E9FUOM,    IMHBE9FF.E9FUCI,    IMHBE9FF.E9FACM,    IMHBE9FF.E9FACF,    IMHBE9FF.E9FMEF,    IMHBE9FF.E9FMPF,    IMHBE9FF.E9FQPF,    IMHBE9FF.E9PROQ,    IMHBE9FF.E9PRFB,    IMHBE9FF.E9PRFR,    IMHBE9FF.E9PRAN,    IMHBE9FF.E9RPAL,    IMHBE9FF.E9RPUT,    IMHBE9FF.E9RFRO,    IMHBE9FF.E9RFTO,    IMHBE9FF.E9RPAP,    IMHBE9FF.E9RBDP,    IMHBE9FF.E9RUCI,    IMHBE9FF.E9RACM,    IMHBE9FF.E9RACF,    IMHBE9FF.E9RDRQ,    IMHBE9FF.E9RDRW,    IMHBE9FF.E9RDDQ,    IMHBE9FF.E9RDDW,    IMHBE9FF.E9FMFT,    IMHBE9FF.E9RVFT,    IMHBE9FF.E9FFCD,    IMHBE9FF.E9RFCD,    IMHBE9FF.E9FMCD,    IMHBE9FF.E9RMCD,    IMHBE9FF.E9RMEA,    IMHBE9FF.E9RFEA,    IMHBE9FF.E9MEAP,    IMHBE9FF.E9FEAP,    IMHBE9FF.E9FPOF,    IMHBE9FF.E9RPOF,    IMHBE9FF.E9QYSH,    IMHBE9FF.E9VSQY,    IMHBE9FF.E9EADT,    IMHBE9FF.E9EATM,    IMHBE9FF.E9EAID,    IMHBE9FF.E9MODT,    IMHBE9FF.E9MOTM,    IMHBE9FF.E9MOID FROM IMHBE9FF ORDER BY IMHBE9FF.E9EADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
count_PROFORMA_ORDER_DETAIL_tMap_4++;
...
log.debug("tMap_4 - Outputting the record " + count_PROFORMA_ORDER_DETAIL_tMap_4 + " of the output table 'PROFORMA_ORDER_DETAIL'.");
...
if(PROFORMA_ORDER_DETAIL != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("PROFORMA_ORDER_DETAIL - " + (PROFORMA_ORDER_DETAIL==null? "": PROFORMA_ORDER_DETAIL.toLogString()));
    			}
...
} else {pstmtUpdate_tDBOutput_1.setString(1, PROFORMA_ORDER_DETAIL.CUST_PREFERENCE_VENDOR);
}

                    if(PROFORMA_ORDER_DETAIL.MERCH_CHANGE_FLAG == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, PROFORMA_ORDER_DETAIL.MERCH_CHANGE_FLAG);
}

                    if(PROFORMA_ORDER_DETAIL.FREIGHT_CHANGE_FLAG == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, PROFORMA_ORDER_DETAIL.FREIGHT_CHANGE_FLAG);
}

                    if(PROFORMA_ORDER_DETAIL.DROP_SHIP_QTY_CHANGE_FLAG == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, PROFORMA_ORDER_DETAIL.DROP_SHIP_QTY_CHANGE_FLAG);
}

                    if(PROFORMA_ORDER_DETAIL.MERCH_REASON_CODE == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, PROFORMA_ORDER_DETAIL.MERCH_REASON_CODE);
}

                    if(PROFORMA_ORDER_DETAIL.FREIGHT_REASON_CODE == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6, PROFORMA_ORDER_DETAIL.FREIGHT_REASON_CODE);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(7, PROFORMA_ORDER_DETAIL.PO_ORDER_QTY);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(8, PROFORMA_ORDER_DETAIL.PO_FOB_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(9, PROFORMA_ORDER_DETAIL.PO_FREIGHT_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(10, PROFORMA_ORDER_DETAIL.PO_AP_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(11, PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE);

                    if(PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE_TYPE == null) {
pstmtUpdate_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(12, PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE_TYPE);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(13, PROFORMA_ORDER_DETAIL.FREIGHT_RATE_OVERRIDE);

                    if(PROFORMA_ORDER_DETAIL.FREIGHT_TYPE_OVERRIDE == null) {
pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(14, PROFORMA_ORDER_DETAIL.FREIGHT_TYPE_OVERRIDE);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(15, PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(16, PROFORMA_ORDER_DETAIL.BRACKET_DIFFERENTIAL_PER_ITEM);

                    if(PROFORMA_ORDER_DETAIL.UNIT_OF_MEASURE == null) {
pstmtUpdate_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(17, PROFORMA_ORDER_DETAIL.UNIT_OF_MEASURE);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(18, PROFORMA_ORDER_DETAIL.UNLOADING_CHARGE_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(19, PROFORMA_ORDER_DETAIL.ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(20, PROFORMA_ORDER_DETAIL.ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                    if(PROFORMA_ORDER_DETAIL.AS_MANUALLY_ENTERED_LINE_FLAG == null) {
pstmtUpdate_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(21, PROFORMA_ORDER_DETAIL.AS_MANUALLY_ENTERED_LINE_FLAG);
}

                    if(PROFORMA_ORDER_DETAIL.PAY_MERCH == null) {
pstmtUpdate_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(22, PROFORMA_ORDER_DETAIL.PAY_MERCH);
}

                    if(PROFORMA_ORDER_DETAIL.PAY_QTY == null) {
pstmtUpdate_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(23, PROFORMA_ORDER_DETAIL.PAY_QTY);
}

                    if(PROFORMA_ORDER_DETAIL.PO_REVISED_ORDER_QTY == null) {
pstmtUpdate_tDBOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(24, PROFORMA_ORDER_DETAIL.PO_REVISED_ORDER_QTY);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(25, PROFORMA_ORDER_DETAIL.PO_REVISED_FOB_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(26, PROFORMA_ORDER_DETAIL.PO_REVISED_FREIGHT_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(27, PROFORMA_ORDER_DETAIL.PO_REVISED_AP_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(28, PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE);

                    if(PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE_TYPE == null) {
pstmtUpdate_tDBOutput_1.setNull(29, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(29, PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE_TYPE);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(30, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_RATE_OVERRIDE);

                    if(PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_TYPE_OVERRIDE == null) {
pstmtUpdate_tDBOutput_1.setNull(31, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(31, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_TYPE_OVERRIDE);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(32, PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(33, PROFORMA_ORDER_DETAIL.REVISED_BRACKET_DIFFERENTIAL_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(34, PROFORMA_ORDER_DETAIL.REVISED_UNLOADING_CHARGE_PER_ITEM);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(35, PROFORMA_ORDER_DETAIL.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(36, PROFORMA_ORDER_DETAIL.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(37, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_RECEIVED_QTY);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(38, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_RECEIVED_WEIGHT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(39, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_QTY);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(40, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_WGT);

                    if(PROFORMA_ORDER_DETAIL.TERMS == null) {
pstmtUpdate_tDBOutput_1.setNull(41, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(41, PROFORMA_ORDER_DETAIL.TERMS);
}

                    if(PROFORMA_ORDER_DETAIL.REVISED_TERMS == null) {
pstmtUpdate_tDBOutput_1.setNull(42, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(42, PROFORMA_ORDER_DETAIL.REVISED_TERMS);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(43, PROFORMA_ORDER_DETAIL.FREIGHT_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(44, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(45, PROFORMA_ORDER_DETAIL.MERCH_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(46, PROFORMA_ORDER_DETAIL.REVISED_MERCH_CASH_DISCOUNT_AMOUNT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(47, PROFORMA_ORDER_DETAIL.REVISED_MERCH_EXTENDED_AMOUNT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(48, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_EXTENDED_AMOUNT);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(49, PROFORMA_ORDER_DETAIL.MERCH_EXTENDED_AMOUNT_TO_BE_PAID);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(50, PROFORMA_ORDER_DETAIL.FREIGHT_EXTENDED_AMOUNT_TO_BE_PAID);

                    if(PROFORMA_ORDER_DETAIL.PRICE_OVERRIDE_FLAG == null) {
pstmtUpdate_tDBOutput_1.setNull(51, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(51, PROFORMA_ORDER_DETAIL.PRICE_OVERRIDE_FLAG);
}

                    if(PROFORMA_ORDER_DETAIL.REVISED_PRICE_OVERRIDE_FLAG == null) {
pstmtUpdate_tDBOutput_1.setNull(52, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(52, PROFORMA_ORDER_DETAIL.REVISED_PRICE_OVERRIDE_FLAG);
}

                    pstmtUpdate_tDBOutput_1.setBigDecimal(53, PROFORMA_ORDER_DETAIL.CARRIER_SHORT_QTY);

                    pstmtUpdate_tDBOutput_1.setBigDecimal(54, PROFORMA_ORDER_DETAIL.VENDOR_SHORT_QTY);

                    if(PROFORMA_ORDER_DETAIL.E9FF_SVOP == null) {
pstmtUpdate_tDBOutput_1.setNull(55, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(55, PROFORMA_ORDER_DETAIL.E9FF_SVOP);
}

                    if(PROFORMA_ORDER_DETAIL.IS_ACTIVE == null) {
pstmtUpdate_tDBOutput_1.setNull(56, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(56, PROFORMA_ORDER_DETAIL.IS_ACTIVE);
}

                    if(PROFORMA_ORDER_DETAIL.CREATED_USER_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(57, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(57, PROFORMA_ORDER_DETAIL.CREATED_USER_ID);
}

                    if(PROFORMA_ORDER_DETAIL.CREATED_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(58, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.CREATED_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(58, java.sql.Types.TIMESTAMP);
}

                    if(PROFORMA_ORDER_DETAIL.UPDATED_USER_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(59, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(59, PROFORMA_ORDER_DETAIL.UPDATED_USER_ID);
}

                    if(PROFORMA_ORDER_DETAIL.UPDATED_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(60, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.UPDATED_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(60, java.sql.Types.TIMESTAMP);
}

                    if(PROFORMA_ORDER_DETAIL.IS_DELETED == null) {
pstmtUpdate_tDBOutput_1.setNull(61, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(61, PROFORMA_ORDER_DETAIL.IS_DELETED);
}

                    if(PROFORMA_ORDER_DETAIL.CREATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_1.setNull(62, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(62, PROFORMA_ORDER_DETAIL.CREATED_ORIGIN);
}

                    if(PROFORMA_ORDER_DETAIL.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(63, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(63, java.sql.Types.TIMESTAMP);
}

                    if(PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN == null) {
pstmtUpdate_tDBOutput_1.setNull(64, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(64, PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN);
}

                    if(PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(65, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(65, java.sql.Types.TIMESTAMP);
}


                    if(PROFORMA_ORDER_DETAIL.SITE_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(66 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(66 + count_tDBOutput_1, PROFORMA_ORDER_DETAIL.SITE_ID);
}


                    if(PROFORMA_ORDER_DETAIL.PURCHASE_ORDER_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(67 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(67 + count_tDBOutput_1, PROFORMA_ORDER_DETAIL.PURCHASE_ORDER_NO);
}


                    if(PROFORMA_ORDER_DETAIL.ITEM == null) {
pstmtUpdate_tDBOutput_1.setNull(68 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(68 + count_tDBOutput_1, PROFORMA_ORDER_DETAIL.ITEM);
}


                    pstmtUpdate_tDBOutput_1.setBigDecimal(69 + count_tDBOutput_1, PROFORMA_ORDER_DETAIL.RECOMMENDED_ORDER_SEQ_NO);
...
} else {pstmtInsert_tDBOutput_1.setString(1, PROFORMA_ORDER_DETAIL.SITE_ID);
}

                        if(PROFORMA_ORDER_DETAIL.PURCHASE_ORDER_NO == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, PROFORMA_ORDER_DETAIL.PURCHASE_ORDER_NO);
}

                        if(PROFORMA_ORDER_DETAIL.ITEM == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, PROFORMA_ORDER_DETAIL.ITEM);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(4, PROFORMA_ORDER_DETAIL.RECOMMENDED_ORDER_SEQ_NO);

                        if(PROFORMA_ORDER_DETAIL.CUST_PREFERENCE_VENDOR == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, PROFORMA_ORDER_DETAIL.CUST_PREFERENCE_VENDOR);
}

                        if(PROFORMA_ORDER_DETAIL.MERCH_CHANGE_FLAG == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, PROFORMA_ORDER_DETAIL.MERCH_CHANGE_FLAG);
}

                        if(PROFORMA_ORDER_DETAIL.FREIGHT_CHANGE_FLAG == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(7, PROFORMA_ORDER_DETAIL.FREIGHT_CHANGE_FLAG);
}

                        if(PROFORMA_ORDER_DETAIL.DROP_SHIP_QTY_CHANGE_FLAG == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, PROFORMA_ORDER_DETAIL.DROP_SHIP_QTY_CHANGE_FLAG);
}

                        if(PROFORMA_ORDER_DETAIL.MERCH_REASON_CODE == null) {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(9, PROFORMA_ORDER_DETAIL.MERCH_REASON_CODE);
}

                        if(PROFORMA_ORDER_DETAIL.FREIGHT_REASON_CODE == null) {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(10, PROFORMA_ORDER_DETAIL.FREIGHT_REASON_CODE);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(11, PROFORMA_ORDER_DETAIL.PO_ORDER_QTY);

                        pstmtInsert_tDBOutput_1.setBigDecimal(12, PROFORMA_ORDER_DETAIL.PO_FOB_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(13, PROFORMA_ORDER_DETAIL.PO_FREIGHT_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(14, PROFORMA_ORDER_DETAIL.PO_AP_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(15, PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE);

                        if(PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE_TYPE == null) {
pstmtInsert_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(16, PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE_TYPE);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(17, PROFORMA_ORDER_DETAIL.FREIGHT_RATE_OVERRIDE);

                        if(PROFORMA_ORDER_DETAIL.FREIGHT_TYPE_OVERRIDE == null) {
pstmtInsert_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(18, PROFORMA_ORDER_DETAIL.FREIGHT_TYPE_OVERRIDE);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(19, PROFORMA_ORDER_DETAIL.PICKUP_ALLOWANCE_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(20, PROFORMA_ORDER_DETAIL.BRACKET_DIFFERENTIAL_PER_ITEM);

                        if(PROFORMA_ORDER_DETAIL.UNIT_OF_MEASURE == null) {
pstmtInsert_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(21, PROFORMA_ORDER_DETAIL.UNIT_OF_MEASURE);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(22, PROFORMA_ORDER_DETAIL.UNLOADING_CHARGE_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(23, PROFORMA_ORDER_DETAIL.ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);

                        pstmtInsert_tDBOutput_1.setBigDecimal(24, PROFORMA_ORDER_DETAIL.ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                        if(PROFORMA_ORDER_DETAIL.AS_MANUALLY_ENTERED_LINE_FLAG == null) {
pstmtInsert_tDBOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(25, PROFORMA_ORDER_DETAIL.AS_MANUALLY_ENTERED_LINE_FLAG);
}

                        if(PROFORMA_ORDER_DETAIL.PAY_MERCH == null) {
pstmtInsert_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(26, PROFORMA_ORDER_DETAIL.PAY_MERCH);
}

                        if(PROFORMA_ORDER_DETAIL.PAY_QTY == null) {
pstmtInsert_tDBOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(27, PROFORMA_ORDER_DETAIL.PAY_QTY);
}

                        if(PROFORMA_ORDER_DETAIL.PO_REVISED_ORDER_QTY == null) {
pstmtInsert_tDBOutput_1.setNull(28, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(28, PROFORMA_ORDER_DETAIL.PO_REVISED_ORDER_QTY);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(29, PROFORMA_ORDER_DETAIL.PO_REVISED_FOB_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(30, PROFORMA_ORDER_DETAIL.PO_REVISED_FREIGHT_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(31, PROFORMA_ORDER_DETAIL.PO_REVISED_AP_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(32, PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE);

                        if(PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE_TYPE == null) {
pstmtInsert_tDBOutput_1.setNull(33, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(33, PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE_TYPE);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(34, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_RATE_OVERRIDE);

                        if(PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_TYPE_OVERRIDE == null) {
pstmtInsert_tDBOutput_1.setNull(35, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(35, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_TYPE_OVERRIDE);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(36, PROFORMA_ORDER_DETAIL.REVISED_PICKUP_ALLOWANCE_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(37, PROFORMA_ORDER_DETAIL.REVISED_BRACKET_DIFFERENTIAL_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(38, PROFORMA_ORDER_DETAIL.REVISED_UNLOADING_CHARGE_PER_ITEM);

                        pstmtInsert_tDBOutput_1.setBigDecimal(39, PROFORMA_ORDER_DETAIL.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_MERCH);

                        pstmtInsert_tDBOutput_1.setBigDecimal(40, PROFORMA_ORDER_DETAIL.REVISED_ALLOWANCE_CHARGES_DISTRIB_TO_FREIGHT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(41, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_RECEIVED_QTY);

                        pstmtInsert_tDBOutput_1.setBigDecimal(42, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_RECEIVED_WEIGHT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(43, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_QTY);

                        pstmtInsert_tDBOutput_1.setBigDecimal(44, PROFORMA_ORDER_DETAIL.REVISED_DROP_SHIP_DAMAGED_AND_ACCEPTED_WGT);

                        if(PROFORMA_ORDER_DETAIL.TERMS == null) {
pstmtInsert_tDBOutput_1.setNull(45, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(45, PROFORMA_ORDER_DETAIL.TERMS);
}

                        if(PROFORMA_ORDER_DETAIL.REVISED_TERMS == null) {
pstmtInsert_tDBOutput_1.setNull(46, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(46, PROFORMA_ORDER_DETAIL.REVISED_TERMS);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(47, PROFORMA_ORDER_DETAIL.FREIGHT_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(48, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(49, PROFORMA_ORDER_DETAIL.MERCH_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(50, PROFORMA_ORDER_DETAIL.REVISED_MERCH_CASH_DISCOUNT_AMOUNT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(51, PROFORMA_ORDER_DETAIL.REVISED_MERCH_EXTENDED_AMOUNT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(52, PROFORMA_ORDER_DETAIL.REVISED_FREIGHT_EXTENDED_AMOUNT);

                        pstmtInsert_tDBOutput_1.setBigDecimal(53, PROFORMA_ORDER_DETAIL.MERCH_EXTENDED_AMOUNT_TO_BE_PAID);

                        pstmtInsert_tDBOutput_1.setBigDecimal(54, PROFORMA_ORDER_DETAIL.FREIGHT_EXTENDED_AMOUNT_TO_BE_PAID);

                        if(PROFORMA_ORDER_DETAIL.PRICE_OVERRIDE_FLAG == null) {
pstmtInsert_tDBOutput_1.setNull(55, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(55, PROFORMA_ORDER_DETAIL.PRICE_OVERRIDE_FLAG);
}

                        if(PROFORMA_ORDER_DETAIL.REVISED_PRICE_OVERRIDE_FLAG == null) {
pstmtInsert_tDBOutput_1.setNull(56, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(56, PROFORMA_ORDER_DETAIL.REVISED_PRICE_OVERRIDE_FLAG);
}

                        pstmtInsert_tDBOutput_1.setBigDecimal(57, PROFORMA_ORDER_DETAIL.CARRIER_SHORT_QTY);

                        pstmtInsert_tDBOutput_1.setBigDecimal(58, PROFORMA_ORDER_DETAIL.VENDOR_SHORT_QTY);

                        if(PROFORMA_ORDER_DETAIL.E9FF_SVOP == null) {
pstmtInsert_tDBOutput_1.setNull(59, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(59, PROFORMA_ORDER_DETAIL.E9FF_SVOP);
}

                        if(PROFORMA_ORDER_DETAIL.IS_ACTIVE == null) {
pstmtInsert_tDBOutput_1.setNull(60, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_1.setBoolean(60, PROFORMA_ORDER_DETAIL.IS_ACTIVE);
}

                        if(PROFORMA_ORDER_DETAIL.CREATED_USER_ID == null) {
pstmtInsert_tDBOutput_1.setNull(61, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(61, PROFORMA_ORDER_DETAIL.CREATED_USER_ID);
}

                        if(PROFORMA_ORDER_DETAIL.CREATED_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(62, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.CREATED_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(62, java.sql.Types.TIMESTAMP);
}

                        if(PROFORMA_ORDER_DETAIL.UPDATED_USER_ID == null) {
pstmtInsert_tDBOutput_1.setNull(63, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(63, PROFORMA_ORDER_DETAIL.UPDATED_USER_ID);
}

                        if(PROFORMA_ORDER_DETAIL.UPDATED_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(64, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.UPDATED_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(64, java.sql.Types.TIMESTAMP);
}

                        if(PROFORMA_ORDER_DETAIL.IS_DELETED == null) {
pstmtInsert_tDBOutput_1.setNull(65, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_1.setBoolean(65, PROFORMA_ORDER_DETAIL.IS_DELETED);
}

                        if(PROFORMA_ORDER_DETAIL.CREATED_ORIGIN == null) {
pstmtInsert_tDBOutput_1.setNull(66, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(66, PROFORMA_ORDER_DETAIL.CREATED_ORIGIN);
}

                        if(PROFORMA_ORDER_DETAIL.CREATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(67, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(67, java.sql.Types.TIMESTAMP);
}

                        if(PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN == null) {
pstmtInsert_tDBOutput_1.setNull(68, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(68, PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN);
}

                        if(PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmtInsert_tDBOutput_1.setTimestamp(69, new java.sql.Timestamp(PROFORMA_ORDER_DETAIL.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(69, java.sql.Types.TIMESTAMP);
}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_4 - Written records count in the table 'PROFORMA_ORDER_DETAIL': " + count_PROFORMA_ORDER_DETAIL_tMap_4 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Proforma_Order_Master_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Proforma_Order_Master_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Proforma_Order_Master_Inbound' - Start.");
...
/************************************************************************************************
 *     658578 characters generated by Talend Open Studio for Data Integration 
 *     on the October 28, 2022 at 10:58:10 AM IST
 ************************************************************************************************/