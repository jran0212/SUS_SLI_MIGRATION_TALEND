...
package sus_sli_etl.obligation_detail_inbound_0_1;
...
/**
 * Job: Obligation_Detail_Inbound Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Obligation_Detail_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Obligation_Detail_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Obligation_Detail_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Obligation_Detail_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_NHLWADjEEe2XZpkYHNSlRw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_NHLWADjEEe2XZpkYHNSlRw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Obligation_Detail_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Obligation_Detail_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Obligation_Detail_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Obligation_Detail_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Obligation_Detail_Inbound) {
...
System.out.println("Starting the Migrating Data from OPNBB1PF to OBLIGATION_DETAIL1...........");
                ...
                class BytesLimit65535_tRunJob_1{
                    ...
                    log4jParamters_tRunJob_1.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_1.append(" | ");
                            log4jParamters_tRunJob_1.append("PROCESS" + " = " + "Obligation_Detail1_Inbound");
                        log4jParamters_tRunJob_1.append(" | ");
			...
			if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
              					...
              					String classpath_tRunJob_1_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;obligation_detail1_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "sus_sli_etl.obligation_detail1_inbound_0_1.Obligation_Detail1_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_1.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "-cp");
		      					...
		      					String classpath_tRunJob_1_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/obligation_detail1_inbound_0_1.jar:";
...
globalMap.put("tRunJob_1_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_1 = consoleHelper_tRunJob_1.getNormalThread(ps_tRunJob_1);
                log.info("tRunJob_1 - The child job 'Obligation_Detail1_Inbound' starts on the version '0.1' with the context 'Default'.");
            normal_tRunJob_1.start();
                log.info("tRunJob_1 - The child job 'Obligation_Detail1_Inbound' is done.");
...
System.out.println("********************* Completed the  OBLIGATION_DETAIL1 Job and Started OBLIGATION_DETAIL2 Migration ********************");
                ...
                class BytesLimit65535_tRunJob_2{
                    ...
                    log4jParamters_tRunJob_2.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_2.append(" | ");
                            log4jParamters_tRunJob_2.append("PROCESS" + " = " + "Obligation_Detail2_Inbound");
                        log4jParamters_tRunJob_2.append(" | ");
			...
			if (osName_tRunJob_2 != null && osName_tRunJob_2.toLowerCase().startsWith("win")){
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-Xms512M");
              					...
              					String classpath_tRunJob_2_5 = ".;../lib/routines.jar;../lib/log4j-slf4j-impl-2.17.1.jar;../lib/log4j-api-2.17.1.jar;../lib/log4j-core-2.17.1.jar;../lib/jboss-marshalling-2.0.12.Final.jar;../lib/dom4j-2.1.3.jar;../lib/slf4j-api-1.7.29.jar;../lib/jt400-9.8.jar;../lib/postgresql-42.2.14.jar;../lib/crypto-utils-0.31.12.jar;obligation_detail2_inbound_0_1.jar;";
	        					...
	        					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, dealChildJobLibrary_tRunJob_2.replaceJarPathsFromCrcMap(classpath_tRunJob_2_5), true);
		      					...
		      					jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "sus_sli_etl.obligation_detail2_inbound_0_1.Obligation_Detail2_Inbound");
						...
						System.getProperties().stringPropertyNames().stream()
							...
							.forEach(key -> paraList_tRunJob_2.add("-D" + key + "=" + System.getProperty(key)));
								...
								jvm_argument_helper_tRunJob_2.addArgumentsTo(paraList_tRunJob_2, "-cp");
		      					...
		      					String classpath_tRunJob_2_5 = ".:$ROOT_PATH:$ROOT_PATH/../lib/routines.jar:$ROOT_PATH/../lib/log4j-slf4j-impl-2.17.1.jar:$ROOT_PATH/../lib/log4j-api-2.17.1.jar:$ROOT_PATH/../lib/log4j-core-2.17.1.jar:$ROOT_PATH/../lib/jboss-marshalling-2.0.12.Final.jar:$ROOT_PATH/../lib/dom4j-2.1.3.jar:$ROOT_PATH/../lib/slf4j-api-1.7.29.jar:$ROOT_PATH/../lib/jt400-9.8.jar:$ROOT_PATH/../lib/postgresql-42.2.14.jar:$ROOT_PATH/../lib/crypto-utils-0.31.12.jar:$ROOT_PATH/obligation_detail2_inbound_0_1.jar:";
...
globalMap.put("tRunJob_2_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_2 = consoleHelper_tRunJob_2.getNormalThread(ps_tRunJob_2);
                log.info("tRunJob_2 - The child job 'Obligation_Detail2_Inbound' starts on the version '0.1' with the context 'Default'.");
            normal_tRunJob_2.start();
                log.info("tRunJob_2 - The child job 'Obligation_Detail2_Inbound' is done.");
...
System.out.println("********************* Completed the  OBLIGATION_DETAIL2 migration Job ********************");
System.out.println("Completed DateTime: " + java.time.LocalDate.now() + " " + java.time.LocalTime.now());  
System.out.println("**********************************************************************************");
 ...
 */
    ...
    public static void main(String[] args){
        final Obligation_Detail_Inbound Obligation_Detail_InboundClass = new Obligation_Detail_Inbound();

        int exitCode = Obligation_Detail_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Obligation_Detail_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Obligation_Detail_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Obligation_Detail_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/obligation_detail_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Obligation_Detail_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Obligation_Detail_Inbound");
        }
...
/************************************************************************************************
 *     324270 characters generated by Talend Open Studio for Data Integration 
 *     on the October 28, 2022 at 10:58:03 AM IST
 ************************************************************************************************/