...
public class Order_Process_Detail_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Order_Process_Detail_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Order_Process_Detail_Inbound.class);
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(ORDER_ENTRY_LINE_TYPE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_ENTRY_LINE_TYPE);
            			}
        			...
        			sb.append("|");
        				...
        				if(ALTERNATE_WHSE_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ALTERNATE_WHSE_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(COMPANIONS_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(COMPANIONS_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_DETAIL_NOTES_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_DETAIL_NOTES_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(DROP_SHIP_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DROP_SHIP_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(PRICING_AGREEMENTS_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PRICING_AGREEMENTS_INDICATOR);
            			}
        			...
        			sb.append("|");
        				...
        				if(QTY_ALLOC_AGAINST_ON_HAND == null){
        					sb.append("<null>");
        				}else{
            				sb.append(QTY_ALLOC_AGAINST_ON_HAND);
            			}
            		
        			sb.append("|");
        		
        				if(QTY_ALLOC_AGAINST_SCH_RECEIPTS == null){
        					sb.append("<null>");
        				}else{
            				sb.append(QTY_ALLOC_AGAINST_SCH_RECEIPTS);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_DETAIL_ALLOC == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_DETAIL_ALLOC);
            			}
        			...
        			sb.append("|");
        				...
        				if(SHIPPED_QTY == null){
            				...
            				sb.append(SHIPPED_QTY);
            			}
            		
        			sb.append("|");
        		
        				if(ORIGINAL_ITEM_UNIT_PRICE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORIGINAL_ITEM_UNIT_PRICE);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_DETAIL_EXTENDED_PRICE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_DETAIL_EXTENDED_PRICE);
            			}
        			...
        			sb.append("|");
        				...
        				if(HAND_PRICE_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(HAND_PRICE_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_GUIDE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_GUIDE_NO);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_GUIDE_LINE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_GUIDE_LINE_NO);
            			}
        			...
        			sb.append("|");
        				...
        				if(VENDOR_PAY_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(VENDOR_PAY_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(QA_TICKET_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(QA_TICKET_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(TOLERANCE_OVERRIDEN_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TOLERANCE_OVERRIDEN_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(ORIGINATOR_TRANSACTION == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORIGINATOR_TRANSACTION);
            			}
            		
        			sb.append("|");
        		
        				if(INVOICED_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(INVOICED_FLAG);
            			}
        			...
        			sb.append("|");
        				...
        				if(PO_LINE_NO == null){
            				...
            				sb.append(PO_LINE_NO);
            			}
            		
        			sb.append("|");
        		
        				if(REMOTE_STOCK_ACCEPT_SUBS == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REMOTE_STOCK_ACCEPT_SUBS);
            			}
            		
        			sb.append("|");
        		
        				if(SUBSTITUTE_REFERENCE_LINE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SUBSTITUTE_REFERENCE_LINE_NO);
            			}
        			...
        			sb.append("|");
        				...
        				if(FREE_GOODS_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FREE_GOODS_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(COUNT_AS_DEMAND_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(COUNT_AS_DEMAND_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(SUBFILE_REFERENCE_LINE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SUBFILE_REFERENCE_LINE_NO);
            			}
        			...
        			sb.append("|");
        				...
        				if(ORDER_GUIDE_VERSION_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_GUIDE_VERSION_NO);
            			}
        			...
        			sb.append("|");
        				...
        				if(ORDER_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_REASON_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(ORDER_LINE_ERROR_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORDER_LINE_ERROR_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(ORIGINALLY_ORDERED_ITEM_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORIGINALLY_ORDERED_ITEM_NO);
            			}
            		
        			sb.append("|");
        		
        				if(ORIGINAL_ITEM_CUST_PREFERENCE_VENDOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORIGINAL_ITEM_CUST_PREFERENCE_VENDOR);
            			}
            		
        			sb.append("|");
        		
        				if(REFERENCED_ORDER_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REFERENCED_ORDER_NO);
            			}
            		
        			sb.append("|");
        		
        				if(ORIG_ALT_COMPANION_LINE_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(ORIG_ALT_COMPANION_LINE_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(TEMPORARY_SUB_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TEMPORARY_SUB_FLAG);
            			}
        			...
        			sb.append("|");
        				...
        				if(ITEM_IDENTIFIER == null){
            				...
            				sb.append(ITEM_IDENTIFIER);
            			}
            		
        			sb.append("|");
        		
        				if(TRANSACTION_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TRANSACTION_QTY);
            			}
        			...
        			sb.append("|");
        				...
        				if(REFERENCE_DETAIL_LINE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REFERENCE_DETAIL_LINE_NO);
            			}
            		
        			sb.append("|");
        		
        				if(SUBSTITUTION_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SUBSTITUTION_REASON_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(SUBSTITUTION_QTY == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SUBSTITUTION_QTY);
            			}
        			...
        			sb.append("|");
        				...
        				if(PRICE_CALC_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PRICE_CALC_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(SUBSTITUTE_REQUEST == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SUBSTITUTE_REQUEST);
            			}
            		
        			sb.append("|");
        		
        				if(PARTIAL_FILL_REQUEST == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PARTIAL_FILL_REQUEST);
            			}
        			...
        			sb.append("|");
        				...
        				if(SCHEDULED_RECEIPT_CUTOFF_TIME == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SCHEDULED_RECEIPT_CUTOFF_TIME);
            			}
            		
        			sb.append("|");
        		
        				if(QTY_DEMANDED == null){
        					sb.append("<null>");
        				}else{
            				sb.append(QTY_DEMANDED);
            			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("SCHEMA_DB" + " = " + "context.GIM_Schema_Order_Processing");
                        log4jParamters_tDBOutput_1.append(" | ");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"ORDER_PROCESS_DETAIL\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
// ###############################
// # Outputs initialization
				int count_ORDER_PROCESS_DETAIL_tMap_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"OPNIB7PF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    OPNIB7PF.B7ORNO,    OPNIB7PF.B7ODLN,    OPNIB7PF.B7OETY,    OPNIB7PF.B7ITEM,    OPNIB7PF.B7ITDS,    OPNIB7PF.B7LOCN,    OPNIB7PF.B7ALTI,    OPNIB7PF.B7CMPI,    OPNIB7PF.B7ODNI,    OPNIB7PF.B7DRPI,    OPNIB7PF.B7PRAI,    OPNIB7PF.B7QNTY,    OPNIB7PF.B7SPLT,    OPNIB7PF.B7QAOH,    OPNIB7PF.B7QASR,    OPNIB7PF.B7ODAL,    OPNIB7PF.B7SHDT,    OPNIB7PF.B7SHPQ,    OPNIB7PF.B7PRIC,    OPNIB7PF.B7ODEP,    OPNIB7PF.B7SGPR,    OPNIB7PF.B7HPRF,    OPNIB7PF.B7OGNU,    OPNIB7PF.B7OGLN,    OPNIB7PF.B7CSIT,    OPNIB7PF.B7CUNO,    OPNIB7PF.B7SADD,    OPNIB7PF.B7CATG,    OPNIB7PF.B7TZNU,    OPNIB7PF.B7RQNU,    OPNIB7PF.B7VNBR,    OPNIB7PF.B7VPYF,    OPNIB7PF.B7QATI,    OPNIB7PF.B7TOVF,    OPNIB7PF.B7ORIN,    OPNIB7PF.B7INCF,    OPNIB7PF.B7ORST,    OPNIB7PF.B7BUYR,    OPNIB7PF.B7PO,    OPNIB7PF.B7POLN,    OPNIB7PF.B7RSAS,    OPNIB7PF.B7SRLN,    OPNIB7PF.B7CPVN,    OPNIB7PF.B7FEGD,    OPNIB7PF.B7CDFL,    OPNIB7PF.B7SBRN,    OPNIB7PF.B7BOKI,    OPNIB7PF.B7OGVN,    OPNIB7PF.B7IDFP,    OPNIB7PF.B7SIAV,    OPNIB7PF.B7ORRE,    OPNIB7PF.B7OLEI,    OPNIB7PF.B7OOIN,    OPNIB7PF.B7OICP,    OPNIB7PF.B7RONO,    OPNIB7PF.B7OACL,    OPNIB7PF.B7TSUB,    OPNIB7PF.B7CNVF,    OPNIB7PF.B7ITID,    OPNIB7PF.B7TRQT,    OPNIB7PF.B7DMST,    OPNIB7PF.B7STKT,    OPNIB7PF.B7RDLN,    OPNIB7PF.B7SBRC,    OPNIB7PF.B7SBQT,    OPNIB7PF.B7PTPC,    OPNIB7PF.B7PCAC,    OPNIB7PF.B7SBRQ,    OPNIB7PF.B7PFRQ,    OPNIB7PF.B7MACL,    OPNIB7PF.B7TZET,    OPNIB7PF.B7QTYD,    OPNIB7PF.B7EADT,    OPNIB7PF.B7EATM,    OPNIB7PF.B7EAID,    OPNIB7PF.B7MODT,    OPNIB7PF.B7MOTM,    OPNIB7PF.B7MOID FROM OPNIB7PF ORDER BY OPNIB7PF.B7EADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
count_ORDER_PROCESS_DETAIL_tMap_1++;
...
log.debug("tMap_1 - Outputting the record " + count_ORDER_PROCESS_DETAIL_tMap_1 + " of the output table 'ORDER_PROCESS_DETAIL'.");
...
if(ORDER_PROCESS_DETAIL != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("ORDER_PROCESS_DETAIL - " + (ORDER_PROCESS_DETAIL==null? "": ORDER_PROCESS_DETAIL.toLogString()));
    			}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'ORDER_PROCESS_DETAIL': " + count_ORDER_PROCESS_DETAIL_tMap_1 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Order_Process_Detail_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Order_Process_Detail_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Order_Process_Detail_Inbound' - Start.");
...
/************************************************************************************************
 *     398535 characters generated by Talend Open Studio for Data Integration 
