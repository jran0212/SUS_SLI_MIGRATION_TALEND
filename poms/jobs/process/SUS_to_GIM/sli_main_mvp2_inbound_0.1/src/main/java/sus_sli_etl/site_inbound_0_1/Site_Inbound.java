...
public class Site_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Site_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Site_Inbound.class);
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_qlKxQAjxEe27itDdtrBWEw", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_qlKxQAjxEe27itDdtrBWEw", "0.1");
...
System.out.println("Starting the Migrating Data from REFERP to SITE...........");
        	...
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(SYSTAR_FLAG == null){
            				...
            				sb.append(SYSTAR_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(STAGE_AND_HOLD_INDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(STAGE_AND_HOLD_INDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(PROCUREMENT_OC == null){
        					sb.append("<null>");
        				}else{
            				sb.append(PROCUREMENT_OC);
            			}
        			...
        			sb.append("|");
        				...
        				if(DOE_CENTRAL_WAREHOUSE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DOE_CENTRAL_WAREHOUSE);
            			}
        			...
        			sb.append("|");
        				...
        				if(DISTRIBUTION_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DISTRIBUTION_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(IC_STATEMENT_TRANS_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(IC_STATEMENT_TRANS_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(INTERCOMPANY_STATEMENT_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(INTERCOMPANY_STATEMENT_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(REGIONAL_DISTRIBUTION_CENTER == null){
        					sb.append("<null>");
        				}else{
            				sb.append(REGIONAL_DISTRIBUTION_CENTER);
            			}
            		
        			sb.append("|");
        		
        				if(FORECASTING_MANAGEMENT_SYSTEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(FORECASTING_MANAGEMENT_SYSTEM);
            			}
            		
        			sb.append("|");
        		
        				if(TRANSPORTATION_MANAGEMENT_SYSTEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(TRANSPORTATION_MANAGEMENT_SYSTEM);
            			}
            		
        			sb.append("|");
        		
        				if(WHSE_MANAGEMENT_SYSTEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(WHSE_MANAGEMENT_SYSTEM);
            			}
            		
        			sb.append("|");
        		
        				if(YANTRA_SYSTEM == null){
        					sb.append("<null>");
        				}else{
            				sb.append(YANTRA_SYSTEM);
            			}
            		
        			sb.append("|");
        		
        				if(RECEIPT_BASED_BILLING == null){
        					sb.append("<null>");
        				}else{
            				sb.append(RECEIPT_BASED_BILLING);
            			}
        			...
        			sb.append("|");
        				...
        				if(WMS_REASON_CODE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(WMS_REASON_CODE);
            			}
            		
        			sb.append("|");
        		
        				if(DPR_RAMPUP_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DPR_RAMPUP_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(SHIPPER_ID_TMS == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SHIPPER_ID_TMS);
            			}
            		
        			sb.append("|");
        		
        				if(MINILOAD_SYSTEM_INIDICATOR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(MINILOAD_SYSTEM_INIDICATOR);
            			}
            		
        			sb.append("|");
        		
        				if(SYGMA_REGION_OFFICE_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SYGMA_REGION_OFFICE_NO);
            			}
            		
        			sb.append("|");
        		
        				if(VALID_FLAG_ERO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(VALID_FLAG_ERO);
            			}
            		
        			sb.append("|");
        		
        				if(SYSCO_LOGISTICS_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SYSCO_LOGISTICS_FLAG);
            			}
            		
        			sb.append("|");
        		
        				if(SAP_SYSTEM_FLAG == null){
        					sb.append("<null>");
        				}else{
            				sb.append(SAP_SYSTEM_FLAG);
            			}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"SITE\"");
                        log4jParamters_tDBOutput_1.append(" | ");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    REFERP.REFCAT,    REFERP.REFKEY,    REFERP.REFDAT FROM REFERP WHERE REFERP.REFCAT='DM'\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
row2.SITE_ID = row1.REFKEY.trim();
row2.SITE_DESC = row1.REFDAT.substring(0,30).trim();
row2.SYSTAR_FLAG = row1.REFDAT.substring(30,31).trim();
row2.STAGE_AND_HOLD_INDICATOR = row1.REFDAT.substring(31,32).trim();
row2.PROCUREMENT_OC = row1.REFDAT.substring(32,33).trim();
row2.NOTE_TYPE = row1.REFDAT.substring(33,34).trim();
row2.DOE_CENTRAL_WAREHOUSE = row1.REFDAT.substring(34,39).trim();
row2.VENDOR_NO = row1.REFDAT.substring(39,49).trim();
row2.DISTRIBUTION_FLAG = row1.REFDAT.substring(49,50).trim();
row2.IC_STATEMENT_TRANS_CODE = row1.REFDAT.substring(50,55).trim();
row2.INTERCOMPANY_STATEMENT_CODE = row1.REFDAT.substring(55,60).trim();
row2.REGIONAL_DISTRIBUTION_CENTER = row1.REFDAT.substring(60,61).trim();
row2.FORECASTING_MANAGEMENT_SYSTEM = row1.REFDAT.substring(61,62).trim();
row2.TRANSPORTATION_MANAGEMENT_SYSTEM = row1.REFDAT.substring(62,63).trim();
row2.WHSE_MANAGEMENT_SYSTEM = row1.REFDAT.substring(63,64).trim();
row2.YANTRA_SYSTEM = row1.REFDAT.substring(64,65).trim();
row2.RECEIPT_BASED_BILLING = row1.REFDAT.substring(65,66).trim();
row2.RDC_NO = row1.REFDAT.substring(66,71).trim();
row2.WMS_REASON_CODE = row1.REFDAT.substring(71,72).trim();
row2.DPR_RAMPUP_FLAG = row1.REFDAT.substring(72,73).trim();
row2.SHIPPER_ID_TMS = row1.REFDAT.substring(73,81).trim();
row2.MINILOAD_SYSTEM_INIDICATOR = row1.REFDAT.substring(81,82).trim();
row2.SYGMA_REGION_OFFICE_NO = row1.REFDAT.substring(82,87).trim();
row2.VALID_FLAG_ERO = row1.REFDAT.substring(87,88).trim();
row2.SYSCO_LOGISTICS_FLAG = row1.REFDAT.substring(88,89).trim();
row2.SAP_SYSTEM_FLAG = row1.REFDAT.substring(89,90).trim();
row2.REGION_ID = "";
...
SITE_tmp.SHIPPER_ID_TMS = row2.SHIPPER_ID_TMS!="" && !row2.SHIPPER_ID_TMS.isEmpty()?new BigDecimal(row2.SHIPPER_ID_TMS):null ;
...
SITE = SITE_tmp;
log.debug("tMap_1 - Outputting the record " + count_SITE_tMap_1 + " of the output table 'SITE'.");
...
if(SITE != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("SITE - " + (SITE==null? "": SITE.toLogString()));
    			}
...
} else {pstmt_tDBOutput_1.setString(1, SITE.SITE_ID);
}

                    if(SITE.SITE_DESC == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, SITE.SITE_DESC);
}

                    if(SITE.SYSTAR_FLAG == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, SITE.SYSTAR_FLAG);
}

                    if(SITE.STAGE_AND_HOLD_INDICATOR == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, SITE.STAGE_AND_HOLD_INDICATOR);
}

                    if(SITE.PROCUREMENT_OC == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, SITE.PROCUREMENT_OC);
}

                    if(SITE.NOTE_TYPE == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, SITE.NOTE_TYPE);
}

                    if(SITE.DOE_CENTRAL_WAREHOUSE == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, SITE.DOE_CENTRAL_WAREHOUSE);
}

                    if(SITE.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8, SITE.VENDOR_NO);
}

                    if(SITE.DISTRIBUTION_FLAG == null) {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9, SITE.DISTRIBUTION_FLAG);
}

                    if(SITE.IC_STATEMENT_TRANS_CODE == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, SITE.IC_STATEMENT_TRANS_CODE);
}

                    if(SITE.INTERCOMPANY_STATEMENT_CODE == null) {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11, SITE.INTERCOMPANY_STATEMENT_CODE);
}

                    if(SITE.REGIONAL_DISTRIBUTION_CENTER == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, SITE.REGIONAL_DISTRIBUTION_CENTER);
}

                    if(SITE.FORECASTING_MANAGEMENT_SYSTEM == null) {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(13, SITE.FORECASTING_MANAGEMENT_SYSTEM);
}

                    if(SITE.TRANSPORTATION_MANAGEMENT_SYSTEM == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, SITE.TRANSPORTATION_MANAGEMENT_SYSTEM);
}

                    if(SITE.WHSE_MANAGEMENT_SYSTEM == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, SITE.WHSE_MANAGEMENT_SYSTEM);
}

                    if(SITE.YANTRA_SYSTEM == null) {
pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(16, SITE.YANTRA_SYSTEM);
}

                    if(SITE.RECEIPT_BASED_BILLING == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, SITE.RECEIPT_BASED_BILLING);
}

                    if(SITE.RDC_NO == null) {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(18, SITE.RDC_NO);
}

                    if(SITE.WMS_REASON_CODE == null) {
pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(19, SITE.WMS_REASON_CODE);
}

                    if(SITE.DPR_RAMPUP_FLAG == null) {
pstmt_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(20, SITE.DPR_RAMPUP_FLAG);
}

                    pstmt_tDBOutput_1.setBigDecimal(21, SITE.SHIPPER_ID_TMS);

                    if(SITE.MINILOAD_SYSTEM_INIDICATOR == null) {
pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(22, SITE.MINILOAD_SYSTEM_INIDICATOR);
}

                    if(SITE.SYGMA_REGION_OFFICE_NO == null) {
pstmt_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(23, SITE.SYGMA_REGION_OFFICE_NO);
}

                    if(SITE.VALID_FLAG_ERO == null) {
pstmt_tDBOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(24, SITE.VALID_FLAG_ERO);
}

                    if(SITE.SYSCO_LOGISTICS_FLAG == null) {
pstmt_tDBOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(25, SITE.SYSCO_LOGISTICS_FLAG);
}

                    if(SITE.SAP_SYSTEM_FLAG == null) {
pstmt_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(26, SITE.SAP_SYSTEM_FLAG);
}

                    if(SITE.REGION_ID == null) {
pstmt_tDBOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(27, SITE.REGION_ID);
}

                    pstmt_tDBOutput_1.setBoolean(28, SITE.IS_DELETED);
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'SITE': " + count_SITE_tMap_1 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Site_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Site_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Site_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Site_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/site_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Site_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Site_Inbound");
        }
...
/************************************************************************************************
 *     293671 characters generated by Talend Open Studio for Data Integration 
