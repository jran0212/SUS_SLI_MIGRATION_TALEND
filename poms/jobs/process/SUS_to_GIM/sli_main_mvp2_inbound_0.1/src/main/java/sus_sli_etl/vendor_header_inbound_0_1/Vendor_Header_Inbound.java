...
} else {pstmt_tDBOutput_1.setString(1, VENDOR_HEADER.VENDOR_TYPE);
}

                    if(VENDOR_HEADER.VENDOR_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, VENDOR_HEADER.VENDOR_NO);
}

                    if(VENDOR_HEADER.VENDOR_NAME == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, VENDOR_HEADER.VENDOR_NAME);
}

                    pstmt_tDBOutput_1.setBoolean(4, VENDOR_HEADER.IS_DELETED);

                    if(VENDOR_HEADER.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, VENDOR_HEADER.CREATED_ORIGIN);
}

                    if(VENDOR_HEADER.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(VENDOR_HEADER.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(7, VENDOR_HEADER.UPDATED_ORIGIN);
}

                    if(VENDOR_HEADER.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(VENDOR_HEADER.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(9, VENDOR_HEADER.A2PF_SVOP);
}

                    if(VENDOR_HEADER.IS_ACTIVE == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_1.setBoolean(10, VENDOR_HEADER.IS_ACTIVE);
}
...
/************************************************************************************************
 *     309058 characters generated by Talend Open Studio for Data Integration 
