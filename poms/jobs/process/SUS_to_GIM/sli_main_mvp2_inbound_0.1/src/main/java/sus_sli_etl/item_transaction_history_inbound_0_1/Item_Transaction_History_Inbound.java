...
System.out.println("Starting the Migrating Data from IMMMTUPF to ITEM_TRANSACTION_HISTORY...........");
...
globalMap.put("tRunJob_1_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_1 = consoleHelper_tRunJob_1.getNormalThread(ps_tRunJob_1);
                log.info("tRunJob_1 - The child job 'Item_Transaction_History_Inbound1' starts on the version '0.1' with the context 'Default'.");
...
System.out.println("********************* Completed the  ITEM_TRANSACTION_HISTORY1 Job and Started ITEM_TRANSACTION_HISTORY2 Migration ********************");
...
globalMap.put("tRunJob_2_ERROR_MESSAGE",ioe.getMessage());
        ...
        try {
            ...
            Thread normal_tRunJob_2 = consoleHelper_tRunJob_2.getNormalThread(ps_tRunJob_2);
                log.info("tRunJob_2 - The child job 'Item_Transaction_History_Inbound2' starts on the version '0.1' with the context 'Default'.");
...
System.out.println("********************* Completed the  ITEM_TRANSACTION_HISTORY2 migration Job ********************");
System.out.println("Completed DateTime: " + java.time.LocalDate.now() + " " + java.time.LocalTime.now());  
System.out.println("**********************************************************************************");
...
/************************************************************************************************
 *     272634 characters generated by Talend Open Studio for Data Integration 
 *     on the October 28, 2022 at 10:58:06 AM IST
 ************************************************************************************************/