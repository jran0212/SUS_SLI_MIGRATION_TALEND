...
/**
 * Job: Record_Count_Compare_MVP2 Purpose: Verification of migrated data from SUS to SLI<br>
...
public class Record_Count_Compare_MVP2 implements TalendJob {
	static {System.setProperty("TalendJob.log", "Record_Count_Compare_MVP2.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Record_Count_Compare_MVP2.class);
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Record_Count_Compare_MVP2Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Record_Count_Compare_MVP2' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Record_Count_Compare_MVP2' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Record_Count_Compare_MVP2.class.getClassLoader().getResourceAsStream("sus_sli_etl/record_count_compare_mvp2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Record_Count_Compare_MVP2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Record_Count_Compare_MVP2");
        }
...
/************************************************************************************************
 *     276023 characters generated by Talend Open Studio for Data Integration 
 *     on the October 28, 2022 at 10:57:46 AM IST
 ************************************************************************************************/