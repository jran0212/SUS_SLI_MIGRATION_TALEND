...
/**
 * Job: Item_Master_Inbound Purpose: Migrating data from USIAJFPF to Item Detail
 * and Item Header<br>
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "SITE_ID", "ITEM_NO", "EXTERNAL_UPC", "BUYER_NO", "ITEM_STATUS",
						"UNITS_PER_CASE", "ITEM_HAZARD_CODE", "PROPRIETARY_ITEM", "DEMAND_STATUS", "IS_DELETED",
...
///////////////////////    			
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1
								+ "\" WHERE \"SITE_ID\" = ? AND \"ITEM_NO\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"SITE_ID\",\"ITEM_NO\",\"EXTERNAL_UPC\",\"BUYER_NO\",\"ITEM_STATUS\",\"UNITS_PER_CASE\",\"ITEM_HAZARD_CODE\",\"PROPRIETARY_ITEM\",\"DEMAND_STATUS\",\"IS_DELETED\") VALUES (?,?,?,?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"EXTERNAL_UPC\" = ?,\"BUYER_NO\" = ?,\"ITEM_STATUS\" = ?,\"UNITS_PER_CASE\" = ?,\"ITEM_HAZARD_CODE\" = ?,\"PROPRIETARY_ITEM\" = ?,\"DEMAND_STATUS\" = ?,\"IS_DELETED\" = ? WHERE \"SITE_ID\" = ? AND \"ITEM_NO\" = ?";
				...
				util_tLogRow_2.addRow(new String[] { "ITEM_NO", "PACK", "BRAND", "ITEM_DESC", "MFG_CODE", "ITEM_SIZE",
...
///////////////////////    			
				...
				String url_tDBOutput_2 = "jdbc:postgresql://" + context.GIM_Server + ":" + context.GIM_Port + "/"
						+ context.GIM_Database + "?" + context.GIM_AdditionalParams;
				...
				java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_2 + "\" WHERE \"ITEM_NO\" = ?");
				resourceMap.put("pstmt_tDBOutput_2", pstmt_tDBOutput_2);
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2
						+ "\" (\"ITEM_NO\",\"PACK\",\"BRAND\",\"ITEM_DESC\",\"MFG_CODE\",\"ITEM_SIZE\",\"IS_DELETED\") VALUES (?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"PACK\" = ?,\"BRAND\" = ?,\"ITEM_DESC\" = ?,\"MFG_CODE\" = ?,\"ITEM_SIZE\" = ?,\"IS_DELETED\" = ? WHERE \"ITEM_NO\" = ?";
...
// ###############################
				...
				String dbquery_tDBInput_1 = "SELECT \n  USIAJFPF.JFITEM, \n  USIAJFPF.JFVNBR, \n  USIAJFPF.JFPACK, \n  USIAJFPF.JFBRND, \n  USIAJFPF.JFITDS, \n  USIAJFPF."
						...
						+ "FPF.JFRQCF, \n  USIAJFPF.JFNHZF, \n  USIAJFPF.JFRIST, \n  USIAJFPF.JFNCTN, \n  USIAJFPF.JFSCTC, \n  USIAJFPF.JFCATY, \n  USIAJ"
						+ "FPF.JFCTST, \n  USIAJFPF.JFPPGM, \n  USIAJFPF.JFEADT, \n  USIAJFPF.JFEATM, \n  USIAJFPF.JFEAID, \n  USIAJFPF.JFMODT, \n  USIAJ"
						+ "FPF.JFMOTM, \n  USIAJFPF.JFMOID, \n  USIAJFPF.JFMOPG\nFROM USIAJFPF WHERE USIAJFPF.JFITEM='1283092'";
...
// Start of branch "ITEM_DETAIL"
						if (ITEM_DETAIL != null) {
							...
							if (ITEM_DETAIL.SITE_ID == null) {
								...
								pstmt_tDBOutput_1.setString(1, ITEM_DETAIL.SITE_ID);
							}

							if (ITEM_DETAIL.ITEM_NO == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, ITEM_DETAIL.ITEM_NO);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								...
								if (ITEM_DETAIL.BUYER_NO == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(2, ITEM_DETAIL.BUYER_NO);
								}

								if (ITEM_DETAIL.ITEM_STATUS == null) {
									pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3, ITEM_DETAIL.ITEM_STATUS);
								}
								...
								if (ITEM_DETAIL.ITEM_HAZARD_CODE == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(5, ITEM_DETAIL.ITEM_HAZARD_CODE);
								}

								if (ITEM_DETAIL.PROPRIETARY_ITEM == null) {
									pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(6, ITEM_DETAIL.PROPRIETARY_ITEM);
								}

								if (ITEM_DETAIL.DEMAND_STATUS == null) {
									pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(7, ITEM_DETAIL.DEMAND_STATUS);
								}

								if (ITEM_DETAIL.IS_DELETED == null) {
								...
								if (ITEM_DETAIL.SITE_ID == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(9 + count_tDBOutput_1, ITEM_DETAIL.SITE_ID);
								}

								if (ITEM_DETAIL.ITEM_NO == null) {
									pstmtUpdate_tDBOutput_1.setNull(10 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(10 + count_tDBOutput_1, ITEM_DETAIL.ITEM_NO);
								}
								...
								try {
									...
									nb_line_tDBOutput_1++;
									row2 = new row2Struct();
									row2.SITE_ID = ITEM_DETAIL.SITE_ID;
									row2.ITEM_NO = ITEM_DETAIL.ITEM_NO;
									row2.EXTERNAL_UPC = ITEM_DETAIL.EXTERNAL_UPC;
									row2.BUYER_NO = ITEM_DETAIL.BUYER_NO;
									row2.ITEM_STATUS = ITEM_DETAIL.ITEM_STATUS;
									row2.UNITS_PER_CASE = ITEM_DETAIL.UNITS_PER_CASE;
									row2.ITEM_HAZARD_CODE = ITEM_DETAIL.ITEM_HAZARD_CODE;
									row2.PROPRIETARY_ITEM = ITEM_DETAIL.PROPRIETARY_ITEM;
									row2.DEMAND_STATUS = ITEM_DETAIL.DEMAND_STATUS;
									row2.IS_DELETED = ITEM_DETAIL.IS_DELETED;
								...
								if (ITEM_DETAIL.SITE_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, ITEM_DETAIL.SITE_ID);
								}

								if (ITEM_DETAIL.ITEM_NO == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, ITEM_DETAIL.ITEM_NO);
								}
								...
								if (ITEM_DETAIL.BUYER_NO == null) {
									...
									pstmtInsert_tDBOutput_1.setString(4, ITEM_DETAIL.BUYER_NO);
								}

								if (ITEM_DETAIL.ITEM_STATUS == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(5, ITEM_DETAIL.ITEM_STATUS);
								}
								...
								if (ITEM_DETAIL.ITEM_HAZARD_CODE == null) {
									...
									pstmtInsert_tDBOutput_1.setString(7, ITEM_DETAIL.ITEM_HAZARD_CODE);
								}

								if (ITEM_DETAIL.PROPRIETARY_ITEM == null) {
									pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(8, ITEM_DETAIL.PROPRIETARY_ITEM);
								}

								if (ITEM_DETAIL.DEMAND_STATUS == null) {
									pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(9, ITEM_DETAIL.DEMAND_STATUS);
								}
...
///////////////////////		
								...
								if (row2.EXTERNAL_UPC != null) { //
									row_tLogRow_1[2] = row2.EXTERNAL_UPC.setScale(0, java.math.RoundingMode.HALF_UP)
											.toPlainString();

								} //

								if (row2.BUYER_NO != null) { //
									row_tLogRow_1[3] = String.valueOf(row2.BUYER_NO);

								} //

								if (row2.ITEM_STATUS != null) { //
									row_tLogRow_1[4] = String.valueOf(row2.ITEM_STATUS);

								} //

								if (row2.UNITS_PER_CASE != null) { //
									row_tLogRow_1[5] = row2.UNITS_PER_CASE.setScale(0, java.math.RoundingMode.HALF_UP)
											.toPlainString();

								} //

								if (row2.ITEM_HAZARD_CODE != null) { //
									row_tLogRow_1[6] = String.valueOf(row2.ITEM_HAZARD_CODE);

								} //

								if (row2.PROPRIETARY_ITEM != null) { //
									row_tLogRow_1[7] = String.valueOf(row2.PROPRIETARY_ITEM);

								} //

								if (row2.DEMAND_STATUS != null) { //
									row_tLogRow_1[8] = String.valueOf(row2.DEMAND_STATUS);

								} //

								if (row2.IS_DELETED != null) { //
									row_tLogRow_1[9] = String.valueOf(row2.IS_DELETED);

								} //

								if (row2.errorCode != null) { //
									row_tLogRow_1[10] = String.valueOf(row2.errorCode);

								} //

								if (row2.errorMessage != null) { //
									row_tLogRow_1[11] = String.valueOf(row2.errorMessage);
...
// Start of branch "ITEM_HEADER"
						if (ITEM_HEADER != null) {
							...
							if (ITEM_HEADER.ITEM_NO == null) {
								...
								pstmt_tDBOutput_2.setString(1, ITEM_HEADER.ITEM_NO);
							}
							...
							if (checkCount_tDBOutput_2 > 0) {
								if (ITEM_HEADER.PACK == null) {
									...
									pstmtUpdate_tDBOutput_2.setString(1, ITEM_HEADER.PACK);
								}

								if (ITEM_HEADER.BRAND == null) {
									pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_2.setString(2, ITEM_HEADER.BRAND);
								}

								if (ITEM_HEADER.ITEM_DESC == null) {
									pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_2.setString(3, ITEM_HEADER.ITEM_DESC);
								}

								if (ITEM_HEADER.MFG_CODE == null) {
									pstmtUpdate_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_2.setString(4, ITEM_HEADER.MFG_CODE);
								}

								if (ITEM_HEADER.ITEM_SIZE == null) {
									pstmtUpdate_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_2.setString(5, ITEM_HEADER.ITEM_SIZE);
								}

								if (ITEM_HEADER.IS_DELETED == null) {
									pstmtUpdate_tDBOutput_2.setNull(6, java.sql.Types.BOOLEAN);
								} else {
									pstmtUpdate_tDBOutput_2.setBoolean(6, ITEM_HEADER.IS_DELETED);
								}

								if (ITEM_HEADER.ITEM_NO == null) {
									pstmtUpdate_tDBOutput_2.setNull(7 + count_tDBOutput_2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_2.setString(7 + count_tDBOutput_2, ITEM_HEADER.ITEM_NO);
								}
								...
								try {
									...
									nb_line_tDBOutput_2++;
									row3 = new row3Struct();
									row3.ITEM_NO = ITEM_HEADER.ITEM_NO;
									row3.PACK = ITEM_HEADER.PACK;
									row3.BRAND = ITEM_HEADER.BRAND;
									row3.ITEM_DESC = ITEM_HEADER.ITEM_DESC;
									row3.MFG_CODE = ITEM_HEADER.MFG_CODE;
									row3.ITEM_SIZE = ITEM_HEADER.ITEM_SIZE;
									row3.IS_DELETED = ITEM_HEADER.IS_DELETED;
									rejectedCount_tDBOutput_2 = rejectedCount_tDBOutput_2 + 1;
									row3.errorCode = ((java.sql.SQLException) e).getSQLState();
									row3.errorMessage = e.getMessage() + " - Line: " + tos_count_tDBOutput_2;
								}
							} else {
								if (ITEM_HEADER.ITEM_NO == null) {
									pstmtInsert_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(1, ITEM_HEADER.ITEM_NO);
								}

								if (ITEM_HEADER.PACK == null) {
									pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(2, ITEM_HEADER.PACK);
								}

								if (ITEM_HEADER.BRAND == null) {
									pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(3, ITEM_HEADER.BRAND);
								}

								if (ITEM_HEADER.ITEM_DESC == null) {
									pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(4, ITEM_HEADER.ITEM_DESC);
								}

								if (ITEM_HEADER.MFG_CODE == null) {
									pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(5, ITEM_HEADER.MFG_CODE);
								}

								if (ITEM_HEADER.ITEM_SIZE == null) {
									pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_2.setString(6, ITEM_HEADER.ITEM_SIZE);
								}

								if (ITEM_HEADER.IS_DELETED == null) {
									pstmtInsert_tDBOutput_2.setNull(7, java.sql.Types.BOOLEAN);
								} else {
...
///////////////////////		
								...
								if (row3.ITEM_NO != null) { //
									row_tLogRow_2[0] = String.valueOf(row3.ITEM_NO);

								} //

								if (row3.PACK != null) { //
									row_tLogRow_2[1] = String.valueOf(row3.PACK);

								} //

								if (row3.BRAND != null) { //
									row_tLogRow_2[2] = String.valueOf(row3.BRAND);

								} //

								if (row3.ITEM_DESC != null) { //
									row_tLogRow_2[3] = String.valueOf(row3.ITEM_DESC);

								} //

								if (row3.MFG_CODE != null) { //
									row_tLogRow_2[4] = String.valueOf(row3.MFG_CODE);

								} //

								if (row3.ITEM_SIZE != null) { //
									row_tLogRow_2[5] = String.valueOf(row3.ITEM_SIZE);

								} //

								if (row3.IS_DELETED != null) { //
									row_tLogRow_2[6] = String.valueOf(row3.IS_DELETED);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Item_Master_Inbound.class.getClassLoader()
					.getResourceAsStream("sus_sli_etl/item_master_inbound_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Item_Master_Inbound.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Item_Master_Inbound");
		}
...
/************************************************************************************************
 * 205528 characters generated by Talend Open Studio for Data Integration on the
 * July 21, 2022 at 5:28:21 PM IST
 ************************************************************************************************/