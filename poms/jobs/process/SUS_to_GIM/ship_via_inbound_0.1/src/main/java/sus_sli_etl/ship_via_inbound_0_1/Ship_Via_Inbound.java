	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "SITE_ID", "SHIPPED_VIA_CODE", "SHIPPED_VIA_DESC",
						"PRODUCT_CLASS_CODE", "IS_DELETED", "errorCode", "errorMessage", });
...
///////////////////////    			
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1
								+ "\" WHERE \"SITE_ID\" = ? AND \"SHIPPED_VIA_CODE\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"SITE_ID\",\"SHIPPED_VIA_CODE\",\"SHIPPED_VIA_DESC\",\"PRODUCT_CLASS_CODE\",\"IS_DELETED\") VALUES (?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"SHIPPED_VIA_DESC\" = ?,\"PRODUCT_CLASS_CODE\" = ?,\"IS_DELETED\" = ? WHERE \"SITE_ID\" = ? AND \"SHIPPED_VIA_CODE\" = ?";
...
// ###############################
				...
				String dbquery_tDBInput_1 = "SELECT \n  REFERP.REFCAT, \n  REFERP.REFKEY, \n  REFERP.REFDAT\nFROM REFERP WHERE REFERP.REFCAT='HA' LIMIT 100 ";
...
// Start of branch "SHIP_VIA"
						if (SHIP_VIA != null) {
							...
							if (SHIP_VIA.SITE_ID == null) {
								...
								pstmt_tDBOutput_1.setString(1, SHIP_VIA.SITE_ID);
							}

							if (SHIP_VIA.SHIPPED_VIA_CODE == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, SHIP_VIA.SHIPPED_VIA_CODE);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (SHIP_VIA.SHIPPED_VIA_DESC == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, SHIP_VIA.SHIPPED_VIA_DESC);
								}

								if (SHIP_VIA.PRODUCT_CLASS_CODE == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(2, SHIP_VIA.PRODUCT_CLASS_CODE);
								}

								if (SHIP_VIA.IS_DELETED == null) {
									pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.BOOLEAN);
								} else {
									pstmtUpdate_tDBOutput_1.setBoolean(3, SHIP_VIA.IS_DELETED);
								}

								if (SHIP_VIA.SITE_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(4 + count_tDBOutput_1, SHIP_VIA.SITE_ID);
								}

								if (SHIP_VIA.SHIPPED_VIA_CODE == null) {
									pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, SHIP_VIA.SHIPPED_VIA_CODE);
								}
								...
								try {
									...
									nb_line_tDBOutput_1++;
									row3 = new row3Struct();
									row3.SITE_ID = SHIP_VIA.SITE_ID;
									row3.SHIPPED_VIA_CODE = SHIP_VIA.SHIPPED_VIA_CODE;
									row3.SHIPPED_VIA_DESC = SHIP_VIA.SHIPPED_VIA_DESC;
									row3.PRODUCT_CLASS_CODE = SHIP_VIA.PRODUCT_CLASS_CODE;
									row3.IS_DELETED = SHIP_VIA.IS_DELETED;
								...
								if (SHIP_VIA.SITE_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, SHIP_VIA.SITE_ID);
								}

								if (SHIP_VIA.SHIPPED_VIA_CODE == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, SHIP_VIA.SHIPPED_VIA_CODE);
								}

								if (SHIP_VIA.SHIPPED_VIA_DESC == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, SHIP_VIA.SHIPPED_VIA_DESC);
								}

								if (SHIP_VIA.PRODUCT_CLASS_CODE == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(4, SHIP_VIA.PRODUCT_CLASS_CODE);
								}

								if (SHIP_VIA.IS_DELETED == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.BOOLEAN);
								} else {
									pstmtInsert_tDBOutput_1.setBoolean(5, SHIP_VIA.IS_DELETED);
								}
...
///////////////////////		
								...
								if (row3.SHIPPED_VIA_CODE != null) { //
									row_tLogRow_1[1] = String.valueOf(row3.SHIPPED_VIA_CODE);

								} //

								if (row3.SHIPPED_VIA_DESC != null) { //
									row_tLogRow_1[2] = String.valueOf(row3.SHIPPED_VIA_DESC);

								} //

								if (row3.PRODUCT_CLASS_CODE != null) { //
									row_tLogRow_1[3] = String.valueOf(row3.PRODUCT_CLASS_CODE);

								} //

								if (row3.IS_DELETED != null) { //
									row_tLogRow_1[4] = String.valueOf(row3.IS_DELETED);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Ship_Via_Inbound.class.getClassLoader()
					.getResourceAsStream("sus_sli_etl/ship_via_inbound_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Ship_Via_Inbound.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Ship_Via_Inbound");
		}
...
/************************************************************************************************
 * 104417 characters generated by Talend Open Studio for Data Integration on the
 * July 21, 2022 at 4:24:27 PM IST
 ************************************************************************************************/