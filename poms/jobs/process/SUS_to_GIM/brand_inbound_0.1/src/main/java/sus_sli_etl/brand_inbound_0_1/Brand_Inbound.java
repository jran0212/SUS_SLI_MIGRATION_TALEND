...
package sus_sli_etl.brand_inbound_0_1;
...
/**
 * Job: Brand_Inbound Purpose: Migrating data from referp to BRAND<br>
 * Description: Migrating data from referp to BRAND <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Brand_Inbound implements TalendJob {
	...
	private final String jobName = "Brand_Inbound";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Brand_Inbound.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Brand_Inbound.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_SUS_SLI_ETL_Brand_Inbound = new byte[0];
		static byte[] commonByteArray_SUS_SLI_ETL_Brand_Inbound = new byte[0];
		...
		public String SYSCO_BRAND_REPORT;

		public String getSYSCO_BRAND_REPORT() {
			return this.SYSCO_BRAND_REPORT;
		}

		public String HOUSE_BRAND;

		public String getHOUSE_BRAND() {
			return this.HOUSE_BRAND;
		}

		public String SYSCO_UPC;

		public String getSYSCO_UPC() {
			return this.SYSCO_UPC;
		}

		public String SMS_ONLY;

		public String getSMS_ONLY() {
			return this.SMS_ONLY;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.BRAND_CODE == null) ? 0 : this.BRAND_CODE.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.BRAND_CODE == null) {
				if (other.BRAND_CODE != null)
					return false;

			} else if (!this.BRAND_CODE.equals(other.BRAND_CODE))
		...
		public void copyDataTo(row4Struct other) {
			...
			other.BRAND_DESC = this.BRAND_DESC;
			other.LABEL = this.LABEL;
			other.SYSCO_BRAND_REPORT = this.SYSCO_BRAND_REPORT;
			other.HOUSE_BRAND = this.HOUSE_BRAND;
			other.SYSCO_UPC = this.SYSCO_UPC;
			other.SMS_ONLY = this.SMS_ONLY;
			other.EDI = this.EDI;
			other.PROPRIETARY = this.PROPRIETARY;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SUS_SLI_ETL_Brand_Inbound.length) {
					if (length < 1024 && commonByteArray_SUS_SLI_ETL_Brand_Inbound.length == 0) {
						commonByteArray_SUS_SLI_ETL_Brand_Inbound = new byte[1024];
					} else {
						commonByteArray_SUS_SLI_ETL_Brand_Inbound = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SUS_SLI_ETL_Brand_Inbound, 0, length);
				strReturn = new String(commonByteArray_SUS_SLI_ETL_Brand_Inbound, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Brand_Inbound, 0, length);
				strReturn = new String(commonByteArray_SUS_SLI_ETL_Brand_Inbound, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SUS_SLI_ETL_Brand_Inbound) {
				...
				try {
					...
					this.BRAND_CODE = readString(dis);

					this.BRAND_DESC = readString(dis);

					this.LABEL = readString(dis);

					this.SYSCO_BRAND_REPORT = readString(dis);

					this.HOUSE_BRAND = readString(dis);

					this.SYSCO_UPC = readString(dis);

					this.SMS_ONLY = readString(dis);

					this.EDI = readString(dis);

					this.PROPRIETARY = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.BRAND_CODE, dos);

				// String

				writeString(this.BRAND_DESC, dos);
				...
				writeString(this.SYSCO_BRAND_REPORT, dos);

				// String

				writeString(this.HOUSE_BRAND, dos);

				// String

				writeString(this.SYSCO_UPC, dos);

				// String

				writeString(this.SMS_ONLY, dos);

				// String

				writeString(this.EDI, dos);

				// String

				writeString(this.PROPRIETARY, dos);
		...
		public String toString() {
			...
			sb.append(",BRAND_CODE=" + BRAND_CODE);
			sb.append(",BRAND_DESC=" + BRAND_DESC);
			sb.append(",LABEL=" + LABEL);
			sb.append(",SYSCO_BRAND_REPORT=" + SYSCO_BRAND_REPORT);
			sb.append(",HOUSE_BRAND=" + HOUSE_BRAND);
			sb.append(",SYSCO_UPC=" + SYSCO_UPC);
			sb.append(",SMS_ONLY=" + SMS_ONLY);
			sb.append(",EDI=" + EDI);
			sb.append(",PROPRIETARY=" + PROPRIETARY);
		...
		public int compareTo(row4Struct other) {
			...
			returnValue = checkNullsAndCompare(this.BRAND_CODE, other.BRAND_CODE);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class BRANDStruct implements routines.system.IPersistableRow<BRANDStruct> {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final BRANDStruct other = (BRANDStruct) obj;
		...
		public void copyDataTo(BRANDStruct other) {
		...
		public void copyKeysDataTo(BRANDStruct other) {
...
///////////////////////    			
				...
				util_tLogRow_1.addRow(new String[] { "SITE_ID", "BRAND_CODE", "BRAND_DESC", "LABEL",
						"SYSCO_BRAND_REPORT", "HOUSE_BRAND", "SYSCO_UPC", "SMS_ONLY", "EDI", "PROPRIETARY", "GRADE",
...
///////////////////////    			
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("BRAND");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("BRAND");
				}
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1
								+ "\" WHERE \"SITE_ID\" = ? AND \"BRAND_CODE\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"SITE_ID\",\"BRAND_CODE\",\"BRAND_DESC\",\"LABEL\",\"SYSCO_BRAND_REPORT\",\"HOUSE_BRAND\",\"SYSCO_UPC\",\"SMS_ONLY\",\"EDI\",\"PROPRIETARY\",\"GRADE\",\"IS_DELETED\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"BRAND_DESC\" = ?,\"LABEL\" = ?,\"SYSCO_BRAND_REPORT\" = ?,\"HOUSE_BRAND\" = ?,\"SYSCO_UPC\" = ?,\"SMS_ONLY\" = ?,\"EDI\" = ?,\"PROPRIETARY\" = ?,\"GRADE\" = ?,\"IS_DELETED\" = ? WHERE \"SITE_ID\" = ? AND \"BRAND_CODE\" = ?";
...
// ###############################
				...
				String dbquery_tDBInput_1 = "SELECT \n  REFERP.REFCAT, \n  REFERP.REFKEY, \n  REFERP.REFDAT\nFROM REFERP WHERE REFERP.REFCAT='K6' LIMIT 1000";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						row2.SITE_ID = "056";
						row2.BRAND_CODE = row1.REFKEY;
						row2.BRAND_DESC = row1.REFDAT.substring(0, 25);
						row2.LABEL = row1.REFDAT.substring(25, 26);
						row2.SYSCO_BRAND_REPORT = row1.REFDAT.substring(26, 27);
						row2.HOUSE_BRAND = row1.REFDAT.substring(27, 28);
						row2.SYSCO_UPC = row1.REFDAT.substring(28, 29);
						row2.SMS_ONLY = row1.REFDAT.substring(29, 30);
						row2.EDI = row1.REFDAT.substring(30, 31);
						row2.PROPRIETARY = row1.REFDAT.substring(31, 32);
						row2.GRADE = row1.REFDAT.substring(32, 33);
...
// # Output table : 'BRAND'
							BRAND_tmp.SITE_ID = row2.SITE_ID;
							BRAND_tmp.BRAND_CODE = row2.BRAND_CODE.trim();
							BRAND_tmp.BRAND_DESC = row2.BRAND_DESC.trim();
							BRAND_tmp.LABEL = row2.LABEL;
							BRAND_tmp.SYSCO_BRAND_REPORT = row2.SYSCO_BRAND_REPORT;
							BRAND_tmp.HOUSE_BRAND = row2.HOUSE_BRAND;
							BRAND_tmp.SYSCO_UPC = row2.SYSCO_UPC;
							BRAND_tmp.SMS_ONLY = row2.SMS_ONLY;
							BRAND_tmp.EDI = row2.EDI;
							BRAND_tmp.PROPRIETARY = row2.PROPRIETARY;
							BRAND_tmp.GRADE = row2.GRADE;
							BRAND_tmp.IS_DELETED = row2.IS_DELETED;
							BRAND = BRAND_tmp;
// ###############################
...
// Start of branch "BRAND"
						if (BRAND != null) {
							...
							if (BRAND.SITE_ID == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(1, BRAND.SITE_ID);
							}

							if (BRAND.BRAND_CODE == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, BRAND.BRAND_CODE);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (BRAND.BRAND_DESC == null) {
									pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(1, BRAND.BRAND_DESC);
								}

								if (BRAND.LABEL == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(2, BRAND.LABEL);
								}

								if (BRAND.SYSCO_BRAND_REPORT == null) {
									pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3, BRAND.SYSCO_BRAND_REPORT);
								}

								if (BRAND.HOUSE_BRAND == null) {
									pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(4, BRAND.HOUSE_BRAND);
								}

								if (BRAND.SYSCO_UPC == null) {
									pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(5, BRAND.SYSCO_UPC);
								}

								if (BRAND.SMS_ONLY == null) {
									pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(6, BRAND.SMS_ONLY);
								}

								if (BRAND.EDI == null) {
									pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(7, BRAND.EDI);
								}

								if (BRAND.PROPRIETARY == null) {
									pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(8, BRAND.PROPRIETARY);
								}

								if (BRAND.GRADE == null) {
									pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(9, BRAND.GRADE);
								}

								if (BRAND.IS_DELETED == null) {
									pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.BOOLEAN);
								} else {
									pstmtUpdate_tDBOutput_1.setBoolean(10, BRAND.IS_DELETED);
								}

								if (BRAND.SITE_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(11 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(11 + count_tDBOutput_1, BRAND.SITE_ID);
								}

								if (BRAND.BRAND_CODE == null) {
									pstmtUpdate_tDBOutput_1.setNull(12 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(12 + count_tDBOutput_1, BRAND.BRAND_CODE);
								}
								...
								try {
									...
									nb_line_tDBOutput_1++;
									row3 = new row3Struct();
									row3.SITE_ID = BRAND.SITE_ID;
									row3.BRAND_CODE = BRAND.BRAND_CODE;
									row3.BRAND_DESC = BRAND.BRAND_DESC;
									row3.LABEL = BRAND.LABEL;
									row3.SYSCO_BRAND_REPORT = BRAND.SYSCO_BRAND_REPORT;
									row3.HOUSE_BRAND = BRAND.HOUSE_BRAND;
									row3.SYSCO_UPC = BRAND.SYSCO_UPC;
									row3.SMS_ONLY = BRAND.SMS_ONLY;
									row3.EDI = BRAND.EDI;
									row3.PROPRIETARY = BRAND.PROPRIETARY;
									row3.GRADE = BRAND.GRADE;
									row3.IS_DELETED = BRAND.IS_DELETED;
								...
								if (BRAND.SITE_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, BRAND.SITE_ID);
								}

								if (BRAND.BRAND_CODE == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, BRAND.BRAND_CODE);
								}

								if (BRAND.BRAND_DESC == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, BRAND.BRAND_DESC);
								}

								if (BRAND.LABEL == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(4, BRAND.LABEL);
								}

								if (BRAND.SYSCO_BRAND_REPORT == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(5, BRAND.SYSCO_BRAND_REPORT);
								}

								if (BRAND.HOUSE_BRAND == null) {
									pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(6, BRAND.HOUSE_BRAND);
								}

								if (BRAND.SYSCO_UPC == null) {
									pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(7, BRAND.SYSCO_UPC);
								}

								if (BRAND.SMS_ONLY == null) {
									pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(8, BRAND.SMS_ONLY);
								}

								if (BRAND.EDI == null) {
									pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(9, BRAND.EDI);
								}

								if (BRAND.PROPRIETARY == null) {
									pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(10, BRAND.PROPRIETARY);
								}

								if (BRAND.GRADE == null) {
									pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(11, BRAND.GRADE);
								}

								if (BRAND.IS_DELETED == null) {
									pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.BOOLEAN);
								} else {
									pstmtInsert_tDBOutput_1.setBoolean(12, BRAND.IS_DELETED);
								}
							...
							if (!whetherReject_tDBOutput_1) {
								row4 = new row4Struct();
								row4.SITE_ID = BRAND.SITE_ID;
								row4.BRAND_CODE = BRAND.BRAND_CODE;
								row4.BRAND_DESC = BRAND.BRAND_DESC;
								row4.LABEL = BRAND.LABEL;
								row4.SYSCO_BRAND_REPORT = BRAND.SYSCO_BRAND_REPORT;
								row4.HOUSE_BRAND = BRAND.HOUSE_BRAND;
								row4.SYSCO_UPC = BRAND.SYSCO_UPC;
								row4.SMS_ONLY = BRAND.SMS_ONLY;
								row4.EDI = BRAND.EDI;
								row4.PROPRIETARY = BRAND.PROPRIETARY;
								row4.GRADE = BRAND.GRADE;
								row4.IS_DELETED = BRAND.IS_DELETED;
							}
...
///////////////////////		
								...
								if (row4.SITE_ID != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.SITE_ID));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.BRAND_CODE != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.BRAND_CODE));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.BRAND_DESC != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.BRAND_DESC));
								...
								if (row4.LABEL != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.LABEL));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.SYSCO_BRAND_REPORT != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.SYSCO_BRAND_REPORT));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.HOUSE_BRAND != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.HOUSE_BRAND));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.SYSCO_UPC != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.SYSCO_UPC));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.SMS_ONLY != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.SMS_ONLY));
								...
								if (row4.EDI != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.EDI));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.PROPRIETARY != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.PROPRIETARY));
								...
								if (row4.GRADE != null) { //
									...
									strBuffer_tLogRow_2.append(String.valueOf(row4.GRADE));

								} //

								strBuffer_tLogRow_2.append("|");

								if (row4.IS_DELETED != null) { //

									strBuffer_tLogRow_2.append(String.valueOf(row4.IS_DELETED));
...
///////////////////////		
								...
								if (row3.BRAND_CODE != null) { //
									row_tLogRow_1[1] = String.valueOf(row3.BRAND_CODE);

								} //

								if (row3.BRAND_DESC != null) { //
									row_tLogRow_1[2] = String.valueOf(row3.BRAND_DESC);

								} //

								if (row3.LABEL != null) { //
									row_tLogRow_1[3] = String.valueOf(row3.LABEL);

								} //

								if (row3.SYSCO_BRAND_REPORT != null) { //
									row_tLogRow_1[4] = String.valueOf(row3.SYSCO_BRAND_REPORT);

								} //

								if (row3.HOUSE_BRAND != null) { //
									row_tLogRow_1[5] = String.valueOf(row3.HOUSE_BRAND);

								} //

								if (row3.SYSCO_UPC != null) { //
									row_tLogRow_1[6] = String.valueOf(row3.SYSCO_UPC);

								} //

								if (row3.SMS_ONLY != null) { //
									row_tLogRow_1[7] = String.valueOf(row3.SMS_ONLY);

								} //

								if (row3.EDI != null) { //
									row_tLogRow_1[8] = String.valueOf(row3.EDI);

								} //

								if (row3.PROPRIETARY != null) { //
									row_tLogRow_1[9] = String.valueOf(row3.PROPRIETARY);

								} //

								if (row3.GRADE != null) { //
									row_tLogRow_1[10] = String.valueOf(row3.GRADE);

								} //

								if (row3.IS_DELETED != null) { //
									row_tLogRow_1[11] = String.valueOf(row3.IS_DELETED);

								} //

								if (row3.errorCode != null) { //
									row_tLogRow_1[12] = String.valueOf(row3.errorCode);

								} //

								if (row3.errorMessage != null) { //
									row_tLogRow_1[13] = String.valueOf(row3.errorMessage);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Brand_Inbound Brand_InboundClass = new Brand_Inbound();

		int exitCode = Brand_InboundClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Brand_Inbound.class.getClassLoader()
					.getResourceAsStream("sus_sli_etl/brand_inbound_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Brand_Inbound.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Brand_Inbound");
		}
...
/************************************************************************************************
 * 139890 characters generated by Talend Open Studio for Data Integration on the
 * July 21, 2022 at 4:45:43 PM IST
 ************************************************************************************************/