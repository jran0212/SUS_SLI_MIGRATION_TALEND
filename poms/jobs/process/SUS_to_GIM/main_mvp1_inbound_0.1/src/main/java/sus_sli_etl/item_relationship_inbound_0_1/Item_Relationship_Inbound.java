...
package sus_sli_etl.item_relationship_inbound_0_1;
...
/**
 * Job: Item_Relationship_Inbound Purpose: Migrating data from USIFAFPF to Item Relationship<br>
 * Description: Migrating data from USIFAFPF to Item Relationship <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Item_Relationship_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Item_Relationship_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Item_Relationship_Inbound.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Item_Relationship_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_hMmqIPziEey2e-BRG5BbvQ", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_hMmqIPziEey2e-BRG5BbvQ", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Item_Relationship_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Item_Relationship_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Relationship_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Relationship_Inbound) {
...
System.out.println("Starting the Migrating Data from USIFAFPF to ITEM_RELATIONSHIP...........");
...
public static class ITEM_RELATIONSHIPStruct implements routines.system.IPersistableRow<ITEM_RELATIONSHIPStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Item_Relationship_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound = new byte[0];
    ...
    public String loopKey;
			    ...
			    public String RELATED_ITEM_NO;

				public String getRELATED_ITEM_NO () {
					return this.RELATED_ITEM_NO;
				}
				
			    public String SUBSTITUTION_TYPE;

				public String getSUBSTITUTION_TYPE () {
					return this.SUBSTITUTION_TYPE;
				}
			    ...
			    public java.util.Date DEMAND_START_DATE;

				public java.util.Date getDEMAND_START_DATE () {
			    ...
			    public String AFPF_SVOP;

				public String getAFPF_SVOP () {
					return this.AFPF_SVOP;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.RELATIONSHIP_TYPE == null) ? 0 : this.RELATIONSHIP_TYPE.hashCode());
					
						result = prime * result + ((this.RELATED_ITEM_NO == null) ? 0 : this.RELATED_ITEM_NO.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final ITEM_RELATIONSHIPStruct other = (ITEM_RELATIONSHIPStruct) obj;
						...
						if (this.RELATIONSHIP_TYPE == null) {
							if (other.RELATIONSHIP_TYPE != null)
								return false;
						
						} else if (!this.RELATIONSHIP_TYPE.equals(other.RELATIONSHIP_TYPE))
						
							return false;
					
						if (this.RELATED_ITEM_NO == null) {
							if (other.RELATED_ITEM_NO != null)
								return false;
						
						} else if (!this.RELATED_ITEM_NO.equals(other.RELATED_ITEM_NO))
	...
	public void copyDataTo(ITEM_RELATIONSHIPStruct other) {

		other.SITE_ID = this.SITE_ID;
	            other.ITEM_NO = this.ITEM_NO;
	            other.RELATIONSHIP_TYPE = this.RELATIONSHIP_TYPE;
	            other.RELATED_ITEM_NO = this.RELATED_ITEM_NO;
	            other.SUBSTITUTION_TYPE = this.SUBSTITUTION_TYPE;
	            other.CONVERSION_FACTOR = this.CONVERSION_FACTOR;
	            other.TO_DATE = this.TO_DATE;
	            other.FROM_DATE = this.FROM_DATE;
	            other.DEMAND_START_DATE = this.DEMAND_START_DATE;
	            ...
	            other.AFPF_SVOP = this.AFPF_SVOP;
	            
	}

	public void copyKeysDataTo(ITEM_RELATIONSHIPStruct other) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Relationship_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.RELATED_ITEM_NO = readString(dis);
					
					this.SUBSTITUTION_TYPE = readString(dis);
					
						this.CONVERSION_FACTOR = (BigDecimal) dis.readObject();
					
					this.TO_DATE = readDate(dis);
					
					this.FROM_DATE = readDate(dis);
					
					this.DEMAND_START_DATE = readDate(dis);
					
					this.PHASE = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.RELATED_ITEM_NO,dos);
					
					// String
				
						writeString(this.SUBSTITUTION_TYPE,dos);
					...
					// java.util.Date
						...
						writeDate(this.TO_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.FROM_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.DEMAND_START_DATE,dos);
					
					// String
				
						writeString(this.PHASE,dos);
					...
					// String
						...
						writeString(this.AFPF_SVOP,dos);
    ...
    public String toString() {
		...
		sb.append(",RELATED_ITEM_NO="+RELATED_ITEM_NO);
		sb.append(",SUBSTITUTION_TYPE="+SUBSTITUTION_TYPE);
		sb.append(",CONVERSION_FACTOR="+String.valueOf(CONVERSION_FACTOR));
		sb.append(",TO_DATE="+String.valueOf(TO_DATE));
		sb.append(",FROM_DATE="+String.valueOf(FROM_DATE));
		sb.append(",DEMAND_START_DATE="+String.valueOf(DEMAND_START_DATE));
        	...
        	StringBuilder sb = new StringBuilder();
        			...
        			sb.append("|");
        				...
        				if(RELATIONSHIP_TYPE == null){
            				...
            				sb.append(RELATIONSHIP_TYPE);
            			}
            		
        			sb.append("|");
        		
        				if(RELATED_ITEM_NO == null){
        					sb.append("<null>");
        				}else{
            				sb.append(RELATED_ITEM_NO);
            			}
        			...
        			sb.append("|");
        				...
        				if(DEMAND_START_DATE == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DEMAND_START_DATE);
            			}
     ...
     * Compare keys
     */
    public int compareTo(ITEM_RELATIONSHIPStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.RELATIONSHIP_TYPE, other.RELATIONSHIP_TYPE);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.RELATED_ITEM_NO, other.RELATED_ITEM_NO);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_SUS_SLI_ETL_Item_Relationship_Inbound = new byte[0];
			    ...
			    public String AFITEM;

				public String getAFITEM () {
					return this.AFITEM;
				}
				
			    public String AFITRL;

				public String getAFITRL () {
					return this.AFITRL;
				}
				
			    public String AFRITM;

				public String getAFRITM () {
					return this.AFRITM;
				}
				
			    public String AFSBTP;

				public String getAFSBTP () {
					return this.AFSBTP;
				}
				
			    public BigDecimal AFCNVF;

				public BigDecimal getAFCNVF () {
					return this.AFCNVF;
				}
				
			    public String AFCPVN;

				public String getAFCPVN () {
					return this.AFCPVN;
				}
				
			    public String AFRCPV;

				public String getAFRCPV () {
					return this.AFRCPV;
				}
				
			    public BigDecimal AFTDTE;

				public BigDecimal getAFTDTE () {
					return this.AFTDTE;
				}
				
			    public BigDecimal AFFDTE;

				public BigDecimal getAFFDTE () {
					return this.AFFDTE;
				}
				
			    public BigDecimal AFDFDT;

				public BigDecimal getAFDFDT () {
					return this.AFDFDT;
				}
				
			    public String AFPHAS;

				public String getAFPHAS () {
					return this.AFPHAS;
				}
				
			    public BigDecimal AFEADT;

				public BigDecimal getAFEADT () {
					return this.AFEADT;
				}
				
			    public BigDecimal AFEATM;

				public BigDecimal getAFEATM () {
					return this.AFEATM;
				}
				
			    public String AFEAID;

				public String getAFEAID () {
					return this.AFEAID;
				}
				
			    public BigDecimal AFMODT;

				public BigDecimal getAFMODT () {
					return this.AFMODT;
				}
				
			    public BigDecimal AFMOTM;

				public BigDecimal getAFMOTM () {
					return this.AFMOTM;
				}
				
			    public String AFMOID;

				public String getAFMOID () {
					return this.AFMOID;
				}
				
			    public String AFMOPG;

				public String getAFMOPG () {
					return this.AFMOPG;
				}
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Item_Relationship_Inbound) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.AFITEM = readString(dis);
					
					this.AFITRL = readString(dis);
					
					this.AFRITM = readString(dis);
					
					this.AFSBTP = readString(dis);
					
						this.AFCNVF = (BigDecimal) dis.readObject();
					
					this.AFCPVN = readString(dis);
					
					this.AFRCPV = readString(dis);
					
						this.AFTDTE = (BigDecimal) dis.readObject();
					
						this.AFFDTE = (BigDecimal) dis.readObject();
					
						this.AFDFDT = (BigDecimal) dis.readObject();
					
					this.AFPHAS = readString(dis);
					
						this.AFEADT = (BigDecimal) dis.readObject();
					
						this.AFEATM = (BigDecimal) dis.readObject();
					
					this.AFEAID = readString(dis);
					
						this.AFMODT = (BigDecimal) dis.readObject();
					
						this.AFMOTM = (BigDecimal) dis.readObject();
					
					this.AFMOID = readString(dis);
					
					this.AFMOPG = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.AFITEM,dos);
					
					// String
				
						writeString(this.AFITRL,dos);
					
					// String
				
						writeString(this.AFRITM,dos);
					
					// String
				
						writeString(this.AFSBTP,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFCNVF);
					
					// String
				
						writeString(this.AFCPVN,dos);
					
					// String
				
						writeString(this.AFRCPV,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFTDTE);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFFDTE);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFDFDT);
					
					// String
				
						writeString(this.AFPHAS,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFEADT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFEATM);
					
					// String
				
						writeString(this.AFEAID,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFMODT);
					
					// BigDecimal
				
       			    	dos.writeObject(this.AFMOTM);
					
					// String
				
						writeString(this.AFMOID,dos);
					
					// String
				
						writeString(this.AFMOPG,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("AFITEM="+AFITEM);
		sb.append(",AFITRL="+AFITRL);
		sb.append(",AFRITM="+AFRITM);
		sb.append(",AFSBTP="+AFSBTP);
		sb.append(",AFCNVF="+String.valueOf(AFCNVF));
		sb.append(",AFCPVN="+AFCPVN);
		sb.append(",AFRCPV="+AFRCPV);
		sb.append(",AFTDTE="+String.valueOf(AFTDTE));
		sb.append(",AFFDTE="+String.valueOf(AFFDTE));
		sb.append(",AFDFDT="+String.valueOf(AFDFDT));
		sb.append(",AFPHAS="+AFPHAS);
		sb.append(",AFEADT="+String.valueOf(AFEADT));
		sb.append(",AFEATM="+String.valueOf(AFEATM));
		sb.append(",AFEAID="+AFEAID);
		sb.append(",AFMODT="+String.valueOf(AFMODT));
		sb.append(",AFMOTM="+String.valueOf(AFMOTM));
		sb.append(",AFMOID="+AFMOID);
		sb.append(",AFMOPG="+AFMOPG);
	    sb.append("]");
...
ITEM_RELATIONSHIPStruct ITEM_RELATIONSHIP = new ITEM_RELATIONSHIPStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"ITEM_RELATIONSHIP");
					}
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"ITEM_RELATIONSHIP\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("ITEM_RELATIONSHIP");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("ITEM_RELATIONSHIP");
}
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"RELATIONSHIP_TYPE\",\"RELATED_ITEM_NO\",\"SUBSTITUTION_TYPE\",\"CONVERSION_FACTOR\",\"TO_DATE\",\"FROM_DATE\",\"DEMAND_START_DATE\",\"PHASE\",\"CREATED_TIMESTAMP\",\"CREATED_USER_ID\",\"UPDATED_TIMESTAMP\",\"UPDATED_USER_ID\",\"UPDATED_PROGRAM_ID\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"AFPF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
// # Outputs initialization
				int count_ITEM_RELATIONSHIP_tMap_1 = 0;
				
ITEM_RELATIONSHIPStruct ITEM_RELATIONSHIP_tmp = new ITEM_RELATIONSHIPStruct();
// ###############################
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"USIFAFPF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    USIFAFPF.AFITEM,    USIFAFPF.AFITRL,    USIFAFPF.AFRITM,    USIFAFPF.AFSBTP,    USIFAFPF.AFCNVF,    USIFAFPF.AFCPVN,    USIFAFPF.AFRCPV,    USIFAFPF.AFTDTE,    USIFAFPF.AFFDTE,    USIFAFPF.AFDFDT,    USIFAFPF.AFPHAS,    USIFAFPF.AFEADT,    USIFAFPF.AFEATM,    USIFAFPF.AFEAID,    USIFAFPF.AFMODT,    USIFAFPF.AFMOTM,    USIFAFPF.AFMOID,    USIFAFPF.AFMOPG FROM USIFAFPF ORDER BY USIFAFPF.AFEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
+"AFCPVN, \n  USIFAFPF.AFRCPV, \n  USIFAFPF.AFTDTE, \n  USIFAFPF.AFFDTE, \n  USIFAFPF.AFDFDT, \n  USIFAFPF.AFPHAS, \n  USIFAFPF."
+"AFEADT, \n  USIFAFPF.AFEATM, \n  USIFAFPF.AFEAID, \n  USIFAFPF.AFMODT, \n  USIFAFPF.AFMOTM, \n  USIFAFPF.AFMOID, \n  USIFAFPF."
+"AFMOPG\nFROM USIFAFPF ORDER BY USIFAFPF.AFEADT DESC";
        	...
        	row1.AFITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.AFITRL = null;
							} else {
	                         		
        	row1.AFITRL = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.AFRITM = null;
							} else {
	                         		
        	row1.AFRITM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.AFSBTP = null;
							} else {
	                         		
        	row1.AFSBTP = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.AFCNVF = null;
							} else {
		                          
            row1.AFCNVF = rs_tDBInput_1.getBigDecimal(5);
        	...
        	row1.AFCPVN = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.AFRCPV = null;
							} else {
	                         		
        	row1.AFRCPV = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.AFTDTE = null;
							} else {
		                          
            row1.AFTDTE = rs_tDBInput_1.getBigDecimal(8);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.AFFDTE = rs_tDBInput_1.getBigDecimal(9);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.AFDFDT = rs_tDBInput_1.getBigDecimal(10);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.AFPHAS = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.AFEADT = null;
							} else {
		                          
            row1.AFEADT = rs_tDBInput_1.getBigDecimal(12);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.AFEATM = rs_tDBInput_1.getBigDecimal(13);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.AFEAID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.AFMODT = null;
							} else {
		                          
            row1.AFMODT = rs_tDBInput_1.getBigDecimal(15);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.AFMOTM = rs_tDBInput_1.getBigDecimal(16);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.AFMOID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, true);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row1.AFMOPG = null;
							} else {
	                         		
        	row1.AFMOPG = routines.system.JDBCUtil.getString(rs_tDBInput_1, 18, true);
		                    }
...
Var.AFITEM = CharSetHandling.convertEBCDICStrToASCII(row1.AFITEM) ;
Var.AFITRL = CharSetHandling.convertEBCDICStrToASCII(row1.AFITRL) ;
Var.AFRITM = CharSetHandling.convertEBCDICStrToASCII(row1.AFRITM) ;
Var.AFSBTP = CharSetHandling.convertEBCDICStrToASCII(row1.AFSBTP) ;
Var.AFPHAS = CharSetHandling.convertEBCDICStrToASCII(row1.AFPHAS) ;
Var.AFEAID = CharSetHandling.convertEBCDICStrToASCII(row1.AFEAID) ;
Var.AFMOID = CharSetHandling.convertEBCDICStrToASCII(row1.AFMOID) ;
Var.AFMOPG = CharSetHandling.convertEBCDICStrToASCII(row1.AFMOPG) ;
Var.CREATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.AFEADT.toString(), row1.AFEATM.toString()) ;
Var.UPDATED_TIMESTAMP = TimeStampConverting.convertToTimeStamp(row1.AFMODT.toString(), row1.AFMOTM.toString()) ;
Var.TO_DATE = TimeStampConverting.convertToDate(row1.AFTDTE.toString()) ;
Var.FROM_DATE = TimeStampConverting.convertToDate(row1.AFFDTE.toString()) ;
Var.DEMAND_START_DATE = TimeStampConverting.convertToDate(row1.AFDFDT.toString()) ;// ###############################
        // ###############################
        // # Output tables

ITEM_RELATIONSHIP = null;


// # Output table : 'ITEM_RELATIONSHIP'
count_ITEM_RELATIONSHIP_tMap_1++;

ITEM_RELATIONSHIP_tmp.SITE_ID = context.opco;
ITEM_RELATIONSHIP_tmp.ITEM_NO = Var.AFITEM ;
ITEM_RELATIONSHIP_tmp.RELATIONSHIP_TYPE = Var.AFITRL ;
ITEM_RELATIONSHIP_tmp.RELATED_ITEM_NO = Var.AFRITM ;
ITEM_RELATIONSHIP_tmp.SUBSTITUTION_TYPE = Var.AFSBTP ;
ITEM_RELATIONSHIP_tmp.CONVERSION_FACTOR = row1.AFCNVF ;
ITEM_RELATIONSHIP_tmp.TO_DATE = Var.TO_DATE!=""? TalendDate.parseDate("dd-MM-yyyy",Var.TO_DATE):null ;
ITEM_RELATIONSHIP_tmp.FROM_DATE = Var.FROM_DATE!=""? TalendDate.parseDate("dd-MM-yyyy",Var.FROM_DATE):null ;
ITEM_RELATIONSHIP_tmp.DEMAND_START_DATE = Var.DEMAND_START_DATE!=""? TalendDate.parseDate("dd-MM-yyyy",Var.DEMAND_START_DATE):null ;
ITEM_RELATIONSHIP_tmp.PHASE = Var.AFPHAS ;
ITEM_RELATIONSHIP_tmp.CREATED_TIMESTAMP = Var.CREATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.CREATED_TIMESTAMP):null ;
ITEM_RELATIONSHIP_tmp.CREATED_USER_ID = Var.AFEAID ;
ITEM_RELATIONSHIP_tmp.UPDATED_TIMESTAMP = Var.UPDATED_TIMESTAMP!=""? TalendDate.parseDate("dd-MM-yyyy HH:mm:ss",Var.UPDATED_TIMESTAMP):null ;
ITEM_RELATIONSHIP_tmp.UPDATED_USER_ID = Var.AFMOID ;
ITEM_RELATIONSHIP_tmp.UPDATED_PROGRAM_ID = Var.AFMOPG ;
ITEM_RELATIONSHIP_tmp.IS_DELETED = false;
ITEM_RELATIONSHIP_tmp.CREATED_ORIGIN = "SUS";
ITEM_RELATIONSHIP_tmp.CREATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_RELATIONSHIP_tmp.UPDATED_ORIGIN = "SUS";
ITEM_RELATIONSHIP_tmp.UPDATED_ORIGIN_TIMESTAMP = TalendDate.parseDate("dd-MM-yyyy HH:mm:ss", TalendDate.getDate("dd-MM-yyyy HH:mm:ss")) ;
ITEM_RELATIONSHIP_tmp.AFPF_SVOP = context.svop;
ITEM_RELATIONSHIP = ITEM_RELATIONSHIP_tmp;
log.debug("tMap_1 - Outputting the record " + count_ITEM_RELATIONSHIP_tMap_1 + " of the output table 'ITEM_RELATIONSHIP'.");
 ...
 */
// Start of branch "ITEM_RELATIONSHIP"
if(ITEM_RELATIONSHIP != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("ITEM_RELATIONSHIP - " + (ITEM_RELATIONSHIP==null? "": ITEM_RELATIONSHIP.toLogString()));
    			}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(ITEM_RELATIONSHIP.SITE_ID == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, ITEM_RELATIONSHIP.SITE_ID);
}

                    if(ITEM_RELATIONSHIP.ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, ITEM_RELATIONSHIP.ITEM_NO);
}

                    if(ITEM_RELATIONSHIP.RELATIONSHIP_TYPE == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, ITEM_RELATIONSHIP.RELATIONSHIP_TYPE);
}

                    if(ITEM_RELATIONSHIP.RELATED_ITEM_NO == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, ITEM_RELATIONSHIP.RELATED_ITEM_NO);
}

                    if(ITEM_RELATIONSHIP.SUBSTITUTION_TYPE == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, ITEM_RELATIONSHIP.SUBSTITUTION_TYPE);
}

                    pstmt_tDBOutput_1.setBigDecimal(6, ITEM_RELATIONSHIP.CONVERSION_FACTOR);

                    if(ITEM_RELATIONSHIP.TO_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(ITEM_RELATIONSHIP.TO_DATE.getTime()));
} else {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_RELATIONSHIP.FROM_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(ITEM_RELATIONSHIP.FROM_DATE.getTime()));
} else {
pstmt_tDBOutput_1.setNull(8, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_RELATIONSHIP.DEMAND_START_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(ITEM_RELATIONSHIP.DEMAND_START_DATE.getTime()));
} else {
pstmt_tDBOutput_1.setNull(9, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_RELATIONSHIP.PHASE == null) {
pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10, ITEM_RELATIONSHIP.PHASE);
}

                    if(ITEM_RELATIONSHIP.CREATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(11, new java.sql.Timestamp(ITEM_RELATIONSHIP.CREATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(11, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_RELATIONSHIP.CREATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(12, ITEM_RELATIONSHIP.CREATED_USER_ID);
}

                    if(ITEM_RELATIONSHIP.UPDATED_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(13, new java.sql.Timestamp(ITEM_RELATIONSHIP.UPDATED_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(13, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_RELATIONSHIP.UPDATED_USER_ID == null) {
pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(14, ITEM_RELATIONSHIP.UPDATED_USER_ID);
}

                    if(ITEM_RELATIONSHIP.UPDATED_PROGRAM_ID == null) {
pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(15, ITEM_RELATIONSHIP.UPDATED_PROGRAM_ID);
}

                    pstmt_tDBOutput_1.setBoolean(16, ITEM_RELATIONSHIP.IS_DELETED);

                    if(ITEM_RELATIONSHIP.CREATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(17, ITEM_RELATIONSHIP.CREATED_ORIGIN);
}

                    if(ITEM_RELATIONSHIP.CREATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(18, new java.sql.Timestamp(ITEM_RELATIONSHIP.CREATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(18, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_RELATIONSHIP.UPDATED_ORIGIN == null) {
pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(19, ITEM_RELATIONSHIP.UPDATED_ORIGIN);
}

                    if(ITEM_RELATIONSHIP.UPDATED_ORIGIN_TIMESTAMP != null) {
pstmt_tDBOutput_1.setTimestamp(20, new java.sql.Timestamp(ITEM_RELATIONSHIP.UPDATED_ORIGIN_TIMESTAMP.getTime()));
} else {
pstmt_tDBOutput_1.setNull(20, java.sql.Types.TIMESTAMP);
}

                    if(ITEM_RELATIONSHIP.AFPF_SVOP == null) {
pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(21, ITEM_RELATIONSHIP.AFPF_SVOP);
}
...
} // End of branch "ITEM_RELATIONSHIP"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'ITEM_RELATIONSHIP': " + count_ITEM_RELATIONSHIP_tMap_1 + ".");
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"ITEM_RELATIONSHIP");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Item_Relationship_Inbound Item_Relationship_InboundClass = new Item_Relationship_Inbound();

        int exitCode = Item_Relationship_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Item_Relationship_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Item_Relationship_Inbound' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Item_Relationship_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/item_relationship_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Item_Relationship_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Item_Relationship_Inbound");
        }
...
/************************************************************************************************
 *     286702 characters generated by Talend Open Studio for Data Integration 
