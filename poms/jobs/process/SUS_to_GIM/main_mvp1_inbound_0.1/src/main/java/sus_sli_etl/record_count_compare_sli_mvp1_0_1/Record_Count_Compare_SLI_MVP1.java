...
package sus_sli_etl.record_count_compare_sli_mvp1_0_1;
...
/**
 * Job: Record_Count_Compare_SLI_MVP1 Purpose: Verification of migrated data from SUS to SLI<br>
 * Description: Verification of migrated data from SUS to SLI <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Record_Count_Compare_SLI_MVP1 implements TalendJob {
	static {System.setProperty("TalendJob.log", "Record_Count_Compare_SLI_MVP1.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Record_Count_Compare_SLI_MVP1.class);
...
public String getSUS_Server(){
	...
	private final String jobName = "Record_Count_Compare_SLI_MVP1";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_CBG6YF8tEe2INPxD2ImFZA", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_CBG6YF8tEe2INPxD2ImFZA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Record_Count_Compare_SLI_MVP1.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Record_Count_Compare_SLI_MVP1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1 = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1 = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Record_Count_Compare_SLI_MVP1) {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT 'ANTICIPATED_DEMAND',count(*) FROM demand.\\\"ANTICIPATED_DEMAND\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION   SELECT 'ITEM_INVENTORY',count(*) FROM inventory.\\\"ITEM_INVENTORY\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION   SELECT 'ITEM_RELATIONSHIP',count(*) FROM master.\\\"ITEM_RELATIONSHIP\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'ITEM_TRUE_VENDOR',count(*) FROM master.\\\"ITEM_TRUE_VENDOR\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false   UNION  SELECT 'VENDOR_ITEM',count(*) FROM master.\\\"VENDOR_ITEM\\\" WHERE \\\"SITE_ID\\\" = '\" + context.opco + \"' AND \\\"IS_DELETED\\\" is false\"");
                        log4jParamters_tDBInput_1.append(" | ");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"SELECT 'ANTICIPATED_DEMAND', COUNT(*) FROM immktnpf   UNION  SELECT 'ITEM_INVENTORY', COUNT(*) FROM immht7pf  UNION  SELECT 'ITEM_RELATIONSHIP', COUNT(*) FROM usifafpf  UNION  SELECT 'ITEM_TRUE_VENDOR', COUNT(*) FROM usiamqrf  UNION  SELECT 'VENDOR_ITEM', COUNT(*) FROM immatwtf\"");
                        log4jParamters_tDBInput_2.append(" | ");
...
+"LECT 'ITEM_RELATIONSHIP', COUNT(*) FROM usifafpf\nUNION\nSELECT 'ITEM_TRUE_VENDOR', COUNT(*) FROM usiamqrf\nUNION\nSELEC"
+"T 'VENDOR_ITEM', COUNT(*) FROM immatwtf";
 ...
 */
    ...
    public static void main(String[] args){
        final Record_Count_Compare_SLI_MVP1 Record_Count_Compare_SLI_MVP1Class = new Record_Count_Compare_SLI_MVP1();

        int exitCode = Record_Count_Compare_SLI_MVP1Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Record_Count_Compare_SLI_MVP1' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Record_Count_Compare_SLI_MVP1' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = Record_Count_Compare_SLI_MVP1.class.getClassLoader().getResourceAsStream("sus_sli_etl/record_count_compare_sli_mvp1_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Record_Count_Compare_SLI_MVP1.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Record_Count_Compare_SLI_MVP1");
        }
...
/************************************************************************************************
 *     265715 characters generated by Talend Open Studio for Data Integration 
 *     on the November 22, 2022 at 1:50:02 PM IST
 ************************************************************************************************/