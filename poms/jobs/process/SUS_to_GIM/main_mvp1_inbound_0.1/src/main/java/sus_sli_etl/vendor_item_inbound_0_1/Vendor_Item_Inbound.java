...
public class Vendor_Item_Inbound implements TalendJob {
	static {System.setProperty("TalendJob.log", "Vendor_Item_Inbound.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(Vendor_Item_Inbound.class);
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"VENDOR_ITEM\"");
                        log4jParamters_tDBOutput_1.append(" | ");
...
// ###############################
// # Outputs initialization
				int count_VENDOR_ITEM_tMap_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"IMMATWTF\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    IMMATWTF.TWITEM,    IMMATWTF.TWVNBR,    IMMATWTF.TWADCD,    IMMATWTF.TWBYGP,    IMMATWTF.TWBUYR,    IMMATWTF.TWITDS,    IMMATWTF.TWMNPC,    IMMATWTF.TWEUPC,    IMMATWTF.TWIUPC,    IMMATWTF.TWCPVN,    IMMATWTF.TWDPRI,    IMMATWTF.TWDPRD,    IMMATWTF.TWEADT,    IMMATWTF.TWEATM,    IMMATWTF.TWEAID,    IMMATWTF.TWEAPG,    IMMATWTF.TWMODT,    IMMATWTF.TWMOTM,    IMMATWTF.TWMOID,    IMMATWTF.TWMOPG FROM IMMATWTF ORDER BY IMMATWTF.TWEADT DESC\"");
                        log4jParamters_tDBInput_1.append(" | ");
...
log.debug("tMap_1 - Outputting the record " + count_VENDOR_ITEM_tMap_1 + " of the output table 'VENDOR_ITEM'.");
...
if(VENDOR_ITEM != null) { 
	...
	currentComponent="tDBOutput_1";
    			...
    			if(log.isTraceEnabled()){
    				log.trace("VENDOR_ITEM - " + (VENDOR_ITEM==null? "": VENDOR_ITEM.toLogString()));
    			}
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'VENDOR_ITEM': " + count_VENDOR_ITEM_tMap_1 + ".");
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = Vendor_Item_InboundClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'Vendor_Item_Inbound' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'Vendor_Item_Inbound' - Start.");
...
/************************************************************************************************
 *     275809 characters generated by Talend Open Studio for Data Integration 
