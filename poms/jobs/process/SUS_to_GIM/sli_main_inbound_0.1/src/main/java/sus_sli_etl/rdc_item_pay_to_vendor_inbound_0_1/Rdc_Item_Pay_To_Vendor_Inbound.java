...
package sus_sli_etl.rdc_item_pay_to_vendor_inbound_0_1;
...
/**
 * Job: Rdc_Item_Pay_To_Vendor_Inbound Purpose: Migrating data from USIBMIRF to RDC_ITEM_PAY_TO_VENDOR<br>
 * Description: Migrating data from USIBMIRF to RDC_ITEM_PAY_TO_VENDOR <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Rdc_Item_Pay_To_Vendor_Inbound implements TalendJob {
...
public String getSUS_Additional_Params(){
	...
	private final String jobName = "Rdc_Item_Pay_To_Vendor_Inbound";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_j8taQDUJEe2KwOMo2WUGhA", "0.1");
	MetterCatcherUtils tFlowMeterCatcher_1 = new MetterCatcherUtils("_j8taQDUJEe2KwOMo2WUGhA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Rdc_Item_Pay_To_Vendor_Inbound.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Rdc_Item_Pay_To_Vendor_Inbound.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class Main_StatStruct implements routines.system.IPersistableRow<Main_StatStruct> {
    final static byte[] commonByteArrayLock_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound = new byte[0];
    static byte[] commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound.length) {
				if(length < 1024 && commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound.length == 0) {
   					commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound = new byte[1024];
				} else {
   					commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound, 0, length);
			strReturn = new String(commonByteArray_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SUS_SLI_ETL_Rdc_Item_Pay_To_Vendor_Inbound) {
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"SITE_ID\",\"ITEM_NO\",\"VENDOR_NO\",\"BUYER_NO\",\"PRODUCT_SPECIALIST\",\"DEMAND_STATUS\",\"IS_DELETED\",\"CREATED_ORIGIN\",\"CREATED_ORIGIN_TIMESTAMP\",\"UPDATED_ORIGIN\",\"UPDATED_ORIGIN_TIMESTAMP\",\"MIRF_SVOP\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
    ...
    public static void main(String[] args){
        final Rdc_Item_Pay_To_Vendor_Inbound Rdc_Item_Pay_To_Vendor_InboundClass = new Rdc_Item_Pay_To_Vendor_Inbound();

        int exitCode = Rdc_Item_Pay_To_Vendor_InboundClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Rdc_Item_Pay_To_Vendor_Inbound.class.getClassLoader().getResourceAsStream("sus_sli_etl/rdc_item_pay_to_vendor_inbound_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Rdc_Item_Pay_To_Vendor_Inbound.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Rdc_Item_Pay_To_Vendor_Inbound");
        }
...
/************************************************************************************************
 *     232899 characters generated by Talend Open Studio for Data Integration 
